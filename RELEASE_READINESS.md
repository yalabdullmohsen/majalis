...
| البند | الحالة | شرط |
|---|---|---|
| تحسين شارة السورة عبر `QCF_BSML` أو SVG مصمّم | مؤجّل ⏸ | بعد الإطلاق؛ مشروط بمراجعة ترخيص مجمع الملك فهد — الشارة الحالية شريط بسيط بلا نقش طرفي |
| **تلوين أحكام التجويد داخل المصحف** | مؤجّل ⏸ · علم `TAJWEED_COLORING_FLAG=false` | لا يُشحن إلا ببيانات أحكام موثّقة ومراجَعة لكل كلمة؛ ممنوع التلوين باستنتاج برمجي تقريبي (خطأ القراءة أخطر من غياب التلوين) |
...
- نص المصحف في التطبيق = رواية حفص عن عاصم فقط؛ أوجه القراءات وصفية في `/quran-hub/qiraat` ولا تُحقن في `/mushaf`.
- تلاوات بقراءات أخرى: كتالوج فارغ حتى توثيق الترخيص في `LICENSE_RISKS.md`؛ طابور المراجعة: `artifacts/majalis/docs/QIRAAT_REVIEW_QUEUE.md`.
...
## دفعة 2026-08-24 (مراحل المنتج)

- [x] تجاوب (#1391) منشور
- [x] فقه (#1392) منشور
- [x] تلاوة AI (#1394) منشور
- [x] تدقيق محتوى (#1396) منشور
- [ ] أحرف سبعة (#1393) — rebase تم؛ بانتظار Verify build ثم نشر
- [ ] قياس كمون التلاوة على جهاز حقيقي (مؤجّل: يحتاج WS مستضاف)
- [ ] ركن الأطفال ومحتوى ذنوب معلّق — خارج هذه الدفعة عمدًا
