...
=======
| 10 تنقّل وأزرار | جارٍ | [#954](https://github.com/yalabdullmohsen/majalis/pull/954) | بانتظار Verify build |
| 7 القرّاء والتلاوة | جارٍ | [#955](https://github.com/yalabdullmohsen/majalis/pull/955) | بث + CREDITS + سقف تنزيل |
| 8 خريطة أحداث السيرة | جارٍ | هذا الفرع | أحداث موثّقة + طابور مراجعة |
| 9 ابتلاءات الأنبياء | معلّق | — | بعد دمج 8 |
>>>>>>> b1ee470fb (docs: تحديث جاهزية الإصدار لبنود UX/سيرة)
