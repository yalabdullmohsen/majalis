...
3. بعد انتهاء المهمة: ادفع الفرع وافتح/حدّث PR واحدًا (Ready وليس Draft)، **وتابع حتى يُدمج إلى `main` ويُنشر** (Auto-merge + Vercel). لا تتوقف عند فتح الـPR ولا تطلب من المستخدم دمجًا يدويًا. قيد «بلا دمج/نشر من الجلسة» **ملغى** (2026-07-27 بطلب المالك).
4. لا تترك PRs مفتوحة/Draft/فاشلة CI بعد اكتمال العمل. أصلِح Verify build؛ إن بقي PR قديم متسلسل، أغلقه لصالح PR واحد يستهدف `main`.
