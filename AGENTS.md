...
This is a **pnpm workspace monorepo** (Node.js 24, TypeScript 5.9) for **سُنّة**, an
...
|---|---|---|---|
| سُنّة web (primary) | `pnpm --filter @workspace/majalis run dev` | `PORT=24216 BASE_PATH=/` | 24216 |
| سُنّة mobile (Expo) | `pnpm --filter @workspace/majalis-mobile run dev` | `PORT=18881` | 18881 |
