...
| زخارف شارة السورة وخرطوش رقم الصفحة وعلامة الآية Unicode (SVG) | واجهة المصحف نمط آية | **رسم أصلي للمجلس العلمي** — شريط نباتي بوسط ممتد + وردة طرفية + علامة آية شبه دائرية؛ لا يُستخرج من تطبيق آخر — `artifacts/majalis/src/components/quran/MushafOrnaments.tsx` | داخلي |
