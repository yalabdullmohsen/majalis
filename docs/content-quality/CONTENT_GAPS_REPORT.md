...
| series deep links | `/learn/series/:slug` | REGRESSION-context | slug lost on redirect | **FIXED** Wave 8 — preserve → `/lessons/:slug` | P0 | gated |
...
| learn series redirects | IMPROVED_VERIFIED (Wave 8 — `/learn/series/:slug` → `/lessons/:slug`) |
