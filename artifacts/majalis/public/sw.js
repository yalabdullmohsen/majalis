/** PWA service worker v12 — network-first for app shell, cache-first for static Quran/lesson data. */

const SHELL_CACHE   = "majalis-shell-v12";
const DATA_CACHE    = "majalis-data-v12";
