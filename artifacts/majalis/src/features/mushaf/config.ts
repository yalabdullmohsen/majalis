...
/**
 * تعزيز بصري خفيف على مقياس المصحف (≈٤٪) — وضوح دون كسر شبكة QPC.
 * يُضرب في `--mushaf-scale` قبل الملاءمة؛ الحراس الأفقية/الرأسية تبقى.
 */
export const MUSHAF_OPTICAL_FONT_SCALE = 1.04;
