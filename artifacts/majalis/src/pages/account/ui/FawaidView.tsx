...
export default function FawaidPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "منصة لنشر ومشاركة الفوائد العلمية والشرعية، فوائد قرآنية وحديثية وعقدية وفقهية وتربوية. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "أقسام الفوائد العلمية والشرعية على المنصة؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
