...
export default function AccountDeletionPage() {
  ...
  return (
    <div className="page-shell">
      <header ref={heroRef} className="accd-hero" style={{ color: "var(--mj-danger)" }}>
        <ShieldOff size={36} className="accd-hero__icon" aria-hidden="true" />
        <h2 style={{ color: "var(--mj-danger)" }}>حذف الحساب نهائياً</h2>
      ...
      <section className="accd-info soft-card soft-card--on-light">
        ...
        <p className="accd-info__note">
          المحتوى العلمي العام المنشور غير المرتبط بملكية حسابك، مثل الدروس والقرآن والأحكام العامة، يبقى متاحًا للجميع.
