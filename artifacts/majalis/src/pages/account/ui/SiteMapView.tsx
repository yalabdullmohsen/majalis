...
const SECTIONS = [
  {
    ...
    links: [
      ...
      { href: "/quran-hub/tajweed",      label: "علم التجويد",        desc: "أحكام التجويد بالأمثلة" },
      { href: "/quran/surahs",       label: "فهرس السور",         desc: "أسماء السور وعدد الآيات" },
      { href: "/quran/revelation-order", label: "ترتيب النزول",   desc: "ترتيب السور حسب النزول" },
      { href: "/quran/surah-stories", label: "أسباب النزول",         desc: "سياقات النزول وأسباب التسمية والمحاور" },
      { href: "/quran/search",       label: "بحث قرآني",          desc: "بحث في النص القرآني" },
      { href: "/quran-circles",      label: "حلقات القرآن",       desc: "حلقات التحفيظ والمتابعة" },
      { href: "/ulum-quran",         label: "علوم القرآن",        desc: "مدخل علوم القرآن" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/fiqh-qawaid", label: "القواعد — صفحة كاملة", desc: "القواعد الخمس الكبرى" },
      { href: "/madhahib",       label: "المذاهب — صفحة كاملة", desc: "الحنفي والمالكي والشافعي والحنبلي" },
    ],
  },
  {
    ...
    links: [
      ...
      { href: "/tazkiya",           label: "التزكية والتوبة",      desc: "الذنوب والحقوق · التوبة والاستغفار" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dalail-nubuwwah",  label: "دلائل النبوة",         desc: "أدلة صدق الرسالة" },
      { href: "/reading-plans",    label: "خطط القراءة",          desc: "خطط ختم ومطالعة" },
      { href: "/arabic-language",  label: "النحو والعربية",        desc: "مدخل علوم العربية للطالب" },
          ],
  },
  {
    ...
    links: [
      ...
      { href: "/submit",             label: "أرسل محتوى",          desc: "شارك معلومة أو فائدة" },
