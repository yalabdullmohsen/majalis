  ...
  useEffect(() => {
    applyPageSeo({
      ...
      jsonLd: [{
        ...
        url: "https://www.ssunnah.com/flashcards",
        inLanguage: "ar",
  ...
  if (!isLoggedIn) {
    return (
      <PageStatusShell title="بطاقات المراجعة" className="page-shell narrow flc-login-prompt">
        ...
        <p className="flc-login-msg">سجّل الدخول لمراجعة البطاقات وحفظ تقدّمك.</p>
  ...
  return (
    <div className="page-shell narrow fc-page" dir="rtl">
      ...
      <div className="twh-share">
        <ShareButtons title="البطاقات التعليمية الإسلامية — سُنّة" url="https://www.ssunnah.com/flashcards" />
      </div>
