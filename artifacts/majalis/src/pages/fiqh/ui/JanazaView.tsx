...
const GHUSL_STEPS = [
  ...
  { num: "٢", title: "إزالة الأذى", desc: "يُغسَّل الفرج وتُزال القاذورات إن وُجدت قبل الوضوء." },
  ...
  { num: "٥", title: "الغسلة الأخيرة بالكافور", desc: "تُختم الغسلة الأخيرة بكافور إن وُجد؛ لتطييب الجسد وتخفيف تغيره." },
...
const TAKFIN_ITEMS = [
  {
    title: "تكفين الرجل",
    icon: "👨",
    desc: "السنة: ثلاثة أثواب بيض تُلفُّ لفاً. الواجب: ثوب واحد يستر جميع بدنه، بلا عمامة ولا قميص.",
  ...
  },
  {
    ...
    icon: "⚪",
    desc: "يُستحب أن يكون الكفن أبيضاً نظيفاً وسطاً، ويُؤخذ من مال الميت قبل الديون والميراث.",
  ...
  },
  {
    ...
    icon: "🔄",
    desc: "تُبسط اللفائف بعضها فوق بعض، ثم يُوضَع الميت على ظهره، وتُلفُّ اللفافة اليسرى على اليمنى ثم اليمنى على اليسرى.",
  ...
  },
  {
    ...
    icon: "⚔️",
    desc: "الشهيد في المعركة لا يُغسَّل ولا يُكفَّن بل يُدفَن في ثيابه التي قُتل فيها. ويُنزَع عنه الجلد والسلاح ونحو ذلك، لأن النبي ﷺ أمر بدفن.",
  ...
  },
  {
    ...
    icon: "📜",
    desc: "يُؤخذ الكفن من مال الميت مقدَّماً على الديون والميراث، فإن لم يكن له مال فعلى من تلزمه نفقته، وإلا فمن بيت المال أو الجماعة.",
...
const SALAH_ARKAN = [
  ...
  { num: "٢", title: "القيام", desc: "الصلاة واقفاً للقادر، بلا ركوع ولا سجود فيها." },
...
const DAFN_ITEMS = [
  ...
  { icon: "🌿", title: "وضع الجريدة", desc: "وضع النبي ﷺ جريدة على قبرين مخصوصين، ولا يُعمَّم ذلك على القبور." },
  ...
  { icon: "🙏", title: "الدعاء بعد الدفن", desc: "يُستحب أن يقف المشيِّعون ويدعوا للميت بالمغفرة والثبات عند السؤال." },
...
const TAAZIYA_AADAB = [
  ...
  { icon: "📖", title: "قراءة القرآن عند القبر", desc: "قراءة القرآن عند القبر محل خلاف بين الفقهاء، والثابت المتفق عليه الدعاء والاستغفار للميت." },
      ...
      jsonLd: [
        {
          ...
          itemListElement: GHUSL_STEPS.map((s, i) => ({
            ...
            url: `https://www.ssunnah.com/janaza#step-${i + 1}`,
          })),
        },
      ],
    });
    ...
    <main className="jnz-page" dir="rtl">
      ...
      <div className="jnz-body">
        ...
        <div className="twh-share">
          <ShareButtons title="أحكام الجنازة — سُنّة" url="https://www.ssunnah.com/janaza" />
        </div>
