...
const ZAKAT_FADAIL = [
  {
    ...
    text: "قال تعالى: ﴿خُذْ مِنْ أَمْوَالِهِمْ صَدَقَةً تُطَهِّرُهُمْ وَتُزَكِّيهِم بِهَا﴾. الزكاة طهارة للمال من الشُّح والتعلق، وتزكية للنفس من البخل. — مرجع معتمد في المجلس العلمي.",
    ref: "التوبة: ١٠٣",
  },
  {
    title: "ضمان البركة في الباقي",
    text: "قال ﷺ: «ما نقصت صدقة من مال». المال المُزكَّى يبارك الله فيه ويُنمِّيه. وقال: «ما فتح رجل باب عطية يريد بها صلة إلا زاده الله بها كثرة». — مرجع معتمد في المجلس العلمي.",
    ref: "مسلم: ٢٥٨٨",
  },
  {
  ...
  },
  {
    ...
    text: "قال ﷺ: «اتقوا النار ولو بشق تمرة». والزكاة الواجبة حاجز يحمي صاحبها من النار يوم القيامة، ومن حُرمَ أجرها عُذِّب بماله. — مرجع معتمد في المجلس العلمي. دليل تعليمي منظم.",
      ...
      jsonLd: [
        {
          ...
          description: "أنواع الزكاة المختلفة مع النصاب والشروط والأدلة الشرعية؛ مع حاسبة مبسّطة وأدلة من القرآن والسنة؛ دليل شامل في أحكام الزكاة",
