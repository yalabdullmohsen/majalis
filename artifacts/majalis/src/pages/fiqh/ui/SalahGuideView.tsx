...
export default function SalahGuidePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الدليل الشامل للصلاة: شروطها وأركانها وسورها ومراتب المصلين والنوافل والخشوع؛ يُعرض للتعلّم والاطلاع. يُستفاد منه في التعلم والتدبر؛ من",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الصلاة",
          description: "أركان الصلاة الثلاثة عشر مع الأدلة؛ يُعرض للتعلّم والاطلاع. يُستفاد منه في التعلم والتدبر — من مراجع المجلس العلمي الم؛ من أحكام الفقه",
