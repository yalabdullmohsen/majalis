...
const WAJIBAAT: Wajib[] = [
  {
    ...
    dhikr: "الله أكبر",
    desc: "كل تكبير بين أركان الصلاة ما عدا تكبيرة الإحرام التي هي ركن. يشمل التكبير عند الركوع والسجود والرفع منه والجلوس بين السجدتين؛ يُراعى فيه النطق الواضح والطمأنينة بين الأركان.",
  ...
  },
  {
    ...
    desc: "يقولها الإمام والمأموم والمنفرد جميعاً في حال الاعتدال من الركوع. الزيادة «حمداً كثيراً...» مستحبة لمن أمكنه. واجب أو سنة بحسب المذهب؛ والأكمل الإتيان به.",
  },
  {
    num: 4,
    title: "التسبيح في الركوع",
    dhikr: "سبحان ربي العظيم",
    desc: "يُقال مرة واحدة على أقل الكمال، والسنة ثلاث مرات. دليلها: «فأما الركوع فعظِّموا فيه الرب» — مسلم. واجب أو سنة بحسب المذهب؛ الحد الأدنى مرة والسنة ثلاث.",
  ...
  },
  {
    ...
    desc: "يقال في الجلسة بين السجدتين. دليلها: حديث حذيفة أن النبي ﷺ كان يقول بين السجدتين «رب اغفر لي» — أبو داود، صحيح. واجب أو سنة بحسب المذهب؛ والأكمل الإتيان به.",
  },
  {
    num: 7,
    title: "التشهد الأول",
  ...
  },
  {
    ...
    dhikr: "",
    desc: "الجلوس الذي يُؤدَّى فيه التشهد الأول واجب مستقل بذاته لمداومة النبي ﷺ عليه. وهو مرتبط بالتشهد الأول لكن يُعدّ واجباً قائماً بنفسه. لا ذِكر مستقل له سوى ألفاظ التشهد.",
...
const SHURUT = [
  ...
  { title: "ستر العورة", desc: "عورة الرجل من السرة إلى الركبة، وعورة المرأة البالغة في الصلاة جميع بدنها عدا الوجه، مع خلاف مشهور في الكفين والقدمين." },
  { title: "النية", desc: "في القلب لا يشترط التلفظ بها" },
];

const ARKAN = [
  { num: 1, title: "القيام", desc: "للقادر في الفريضة؛ والعاجز يصلّي حسب استطاعته." },
  { num: 2, title: "تكبيرة الإحرام", desc: "قول «الله أكبر» ركن قولي لا تصح الصلاة بدونه." },
  ...
  { num: 5, title: "الاعتدال من الركوع", desc: "الرفع حتى يستوي قائماً مع الطمأنينة." },
  { num: 6, title: "السجود", desc: "على سبعة أعظم: الجبهة مع الأنف، واليدان، والركبتان، وأطراف القدمين." },
  { num: 7, title: "الرفع من السجود", desc: "الجلوس بين السجدتين مع الطمأنينة" },
  { num: 8, title: "السجدة الثانية", desc: "كسجود الركعة الأولى في الهيئة والطمأنينة." },
  { num: 9, title: "الطمأنينة", desc: "استقرار الأعضاء في كل ركن زمناً يسيراً." },
  { num: 10, title: "الترتيب", desc: "أداء الأركان على الترتيب المشروع دون تقديم أو تأخير." },
  { num: 11, title: "التشهد الأخير", desc: "الجلوس له وقراءة التشهد فيه" },
  { num: 12, title: "الصلاة على النبي ﷺ", desc: "في التشهد الأخير بعد التشهد على القول الراجح." },
...
const KHUSHUU_WAYS = [
  ...
  { icon: "🌅", title: "الصلاة في أول وقتها", desc: "سُئل النبي ﷺ عن أفضل الأعمال فقال: «الصلاة لوقتها». التبكير بالصلاة يُعين على الخشوع ويجعلها عبادة لا عادة." },
      ...
      jsonLd: [
        {
          ...
          itemListElement: ARKAN.map((r, i) => ({
            ...
            url: `https://www.ssunnah.com/salah-guide#rukn-${r.num}`,
          })),
        },
      ],
    });
    ...
    <KnowledgeLayout kind="fiqh" className="sg-page" data-kx="1">
      ...
      <div className="sg-body">
        ...
        <div className="twh-share">
          <ShareButtons title="دليل الصلاة — سُنّة" url="https://www.ssunnah.com/salah-guide" />
        </div>
