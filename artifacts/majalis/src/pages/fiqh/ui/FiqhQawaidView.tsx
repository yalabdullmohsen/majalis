...
const QAWAID_KUBRA: Qaaida[] = [
  ...
  },
  {
    ...
    faraa: [
      ...
      "الأصل براءة الذمة حتى يثبت خلافها",
    ],
    examples: [
      ...
      { situation: "شك هل انتقض وضوؤه بعد تيقنه الطهارة", hukm: "الأصل بقاء الطهارة حتى يتيقن الحدث" },
    ],
    exceptions: [
  ...
  },
  {
    ...
    origin: "مستخرجة من حديث: «لا ضَرَرَ ولا ضِرَار» (رواه ابن ماجه وغيره؛ حسّنه جمع من أهل العلم وصححه آخرون، وعليه عمل الفقهاء).",
    conditions: [
...
const QAWAID_FARAA: FariyaQaaida[] = [
  { text: "الغُنم بالغُرم", parent: 1, explanation: "الغانم بالنفع ضامن للضرر، من يستفيد من شيء فعليه تحمل مسؤوليته.", example: "من انتفع بعينٍ مضمونة تحمل ضمانها عند التلف" },
  { text: "الخراج بالضمان", parent: 1, explanation: "نفع الشيء لمن عليه ضمانه، من يضمن شيئاً يستحق خراجه ومنافعه.", example: "إذا اشترى شخص سلعة ثم تبين عيبها وردّها، فغلتها في مدة حيازته له بضمانه" },
...
const DHAWAABIT: Daabita[] = [
  {
    ...
    rules: [
      ...
      { text: "الإمام يتحمل متابعة المأموم في أركان الصلاة الظاهرة.", example: "يتابع المأموم إمامه في الانتقالات ولا يسبقه في الأركان" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    rules: [
      ...
      { text: "النفقة مقدَّرة بحاجة المنفَق عليه ويُسر المنفِق.", example: "تزداد نفقة الزوجة بحسب المستوى المعيشي للزوجين معاً" },
    ],
  },
  {
    id: 4,
    ...
    rules: [
      ...
      { text: "لا قصاص بين الأصل والفرع عند جمهور الفقهاء.", example: "لا يُقتص من الأب بسبب قتل ابنه" },
    ],
  },
];
...
const TATBIQAT: TatbiqMasala[] = [
  ...
  },
  {
    ...
    source: "قرارات وفتاوى معاصرة متفرقة في العملات الرقمية",
  },
  {
  ...
  },
  {
    ...
    source: "موقف هيئات الإفتاء المعتمدة: لا يُستقل بالذكاء الاصطناعي في إصدار الفتوى",
  },
  {
  ...
  },
  {
    ...
    source: "اجتهاد تطبيقي معاصر — يُحال للتوثيق في المجامع؛ لا عزو قطعي لندوة بعينها هنا",
  },
  {
    title: "تأجير الأرحام",
  ...
  },
  {
    ...
    answer: "التحويل البنكي جائز إذا خلا من الفوائد الربوية. وبطاقات الدفع المباشر (Debit) جائزة مطلقاً. أما بطاقات الائتمان (Credit) ففيها خلاف: يجوز استعمالها إذا خلت من شرط الفائدة الربوية أو أمكن استعمالها دون الدخول في الفائدة، وإلا حَرُم ما اشتمل على الربا أو أفضى إليه.",
  ...
  },
  {
    ...
    answer: "يجوز الاستعانة بغير المسلمين في مجال الطب والخبرات التقنية إذا دعت الحاجة ولم يوجد كفء مسلم، إذ الحاجة تنزل منزلة الضرورة. وتبقى الاستعانة الفنية خاضعة لضوابط الأمانة وحفظ الخصوصية ومصلحة المرضى.",
  ...
  },
  {
    ...
    source: "المجلس الأوروبي للإفتاء والبحوث؛ وقرارات المجامع في مواقيت البلاد عالية العرض",
  },
  {
    ...
    source: "المجلس الأوروبي للإفتاء والبحوث، ومجمع فقهاء الشريعة بأمريكا الشمالية",
  },
  {
  ...
  },
  {
    ...
    answer: "يُحرَّم العمل في وظائف تتعلق مباشرة بالربا كعقد القرض الربوي وتسجيله، لحديث «لعن رسول الله آكل الربا ومؤكله وكاتبه وشاهديه» (رواه مسلم من حديث جابر رضي الله عنه). أما الوظائف التقنية أو الإدارية غير المرتبطة بالعمليات الربوية مباشرةً فقد أجاز بعض العلماء العمل فيها بضوابط.",
    source: "فتوى هيئة كبار العلماء بالمملكة العربية السعودية، ولجنة الفتوى بالأزهر",
  },
  {
    title: "العملات الرقمية الرسمية (CBDC) وأحكامها",
    qaaida: "العادة محكّمة / الأصل في المعاملات الإباحة",
    question: "ما الحكم الشرعي على العملات الرقمية الصادرة عن البنوك المركزية (CBDC)؟",
    answer: "تُبحث العملات الرقمية المركزية باعتبارها نقوداً قانونية إذا أصدرتها الدولة وضمنت قبولها، فتأخذ أحكام النقود في الصرف والزكاة والربا، إذ تصدرها الدولة وتضمن قيمتها. ويجري عليها ما يجري على النقود من أحكام الصرف والربا وزكاة الأموال. وتختلف عن العملات الرقمية اللامركزية (Bitcoin) في وجود جهة ضامنة تُخفف إشكالية الغرر.",
    source: "يُحال إلى قرارات المجامع في العملات الرقمية؛ لا عزو لندوة غير موثَّقة هنا",
  },
  {
    title: "توظيف الذكاء الاصطناعي في إدارة الوقف",
    qaaida: "المشقة تجلب التيسير / الأصل في المعاملات الإباحة",
    question: "هل يجوز استخدام أنظمة الذكاء الاصطناعي في إدارة الأوقاف واستثمارها وتوزيع غلّتها؟",
    answer: "يجوز توظيف الذكاء الاصطناعي أداةً لتعظيم غلة الوقف وتوزيعها وفق ما حدده الواقف، إذ هو وسيلة إدارية لا عقد مستقل. ويبقى الناظر مسؤولاً شرعاً عن القرار النهائي ومراجعة مخرجات النظام. واشتراط إشراف إنساني متخصص يدرأ الضرر المحتمل من خطأ النظام.",
    source: "اجتهاد تطبيقي معاصر — يُحال إلى المجامع وهيئات الفتوى بلا عزو قطعي لعنوان غير موثَّق",
  },
  {
    title: "بيع المنتجات الغذائية عبر منصات التوصيل",
    qaaida: "العادة محكّمة / الغرر الفاحش مفسد للعقد",
    question: "ما ضوابط بيع الطعام والمنتجات الغذائية عبر تطبيقات التوصيل الرقمية؟",
    answer: "بيع الطعام عبر منصات التوصيل جائز إذا توافرت شروط البيع الصحيح: وصف السلعة وصفاً كافياً يرفع الغرر الفاحش، وتحديد الثمن، وضمان البائع للسلعة حتى تسليمها. وما جرى به العرف من سياسات الإرجاع والاستبدال يُعدّ ملزماً للبائع. وإذا تبيّن اختلاف جوهري بين ما وُصف وما استُلم جاز للمشتري ردّ السلعة.",
    source: "ضوابط البيع والغرر في قرارات مجمع الفقه الإسلامي الدولي؛ ويُراجع المجلس الأوروبي للإفتاء والبحوث عند الحاجة",
  },
];
      ...
      jsonLd: [
        {
          ...
          itemListElement: QAWAID_KUBRA.map((q, i) => ({
            ...
            position: i + 1,
            name: q.text,
            url: `https://www.ssunnah.com/fiqh-qawaid#qaaida-${q.id}`,
          })),
        },
      ],
    });
      ...
      <section className="fq-hero">
        <div className="fq-hero__inner">
          ...
          <div className="fq-hero__stats">
            ...
            <div className="fq-stat"><span className="fq-stat__num">{TATBIQAT.length.toLocaleString("ar-EG")}</span><span className="fq-stat__label">تطبيق معاصر</span></div>
          </div>
        </div>
      </section>
