...
export default function RulingsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "موسوعة الأحكام الشرعية مرتّبةً حسب الأبواب الفقهية؛ مواد يجري إثراؤها وربطها بالمصادر تدريجيًا.",
      ...
      jsonLd: [
        {
          ...
          description: "أحكام فقهية مرتّبة حسب الأبواب؛ الإثراء وربط الأدلة يجري تدريجيًا حسب توفر المصادر.",
  ...
  return (
    <PageShell variant="narrow" className="content-hub-page rulings-encyclopedia-page">
      <PageHeader
        ...
        subtitle="مواد فقهية يجري ربطها بالأدلة والمصادر تدريجيًا."
      />
