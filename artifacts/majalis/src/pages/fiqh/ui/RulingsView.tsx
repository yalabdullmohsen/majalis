...
export default function RulingsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "موسوعة الأحكام الشرعية في الفقه الإسلامي، استعرض الأحكام مرتّبةً حسب الأبواب الفقهية والتصنيفات. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description: "أحكام الفقه الإسلامي مرتّبةً حسب الأبواب والتصنيفات الفقهية؛ عرض موثّق ضمن منهج سُنّة",
