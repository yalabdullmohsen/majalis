...
const MASHAER: Mashar[] = [
  ...
  },
  {
    ...
    desc: "وادٍ قريب من مكة يمكث فيه الحجاج ليلة الثامن، ويُرمى فيه الجمر في أيام التشريق.",
  ...
  },
  {
    ...
    icon: "🕋",
    day: "طوال الحج",
    desc: "بيت الله الحرام في مكة، تتجه إليه القلوب في الصلاة، ويطاف به في مناسك الحج والعمرة.",
  ...
  },
  {
    ...
    desc: "ثلاث جمرات في منى تُرمى في أيام التشريق: الصغرى والوسطى والكبرى (العقبة)، ويُبدأ بالصغرى.",
...
const UMRA_STEPS: UmraStep[] = [
  ...
  { num: 2, icon: "🌀", title: "الطواف (ركن)", desc: "سبعة أشواط حول الكعبة من الحجر الأسود؛ ﴿وَلْيَطَّوَّفُوا بِالْبَيْتِ الْعَتِيقِ﴾ — الحج: ٢٩." },
  { num: 3, icon: "🙏", title: "ركعتا الطواف (سنة)", desc: "سنة مؤكدة خلف مقام إبراهيم إن تيسّر؛ ﴿وَاتَّخِذُوا مِن مَّقَامِ إِبْرَاهِيمَ مُصَلًّى﴾ — البقرة: ١٢٥." },
  { num: 4, icon: "💧", title: "الشرب من زمزم (سنة)", desc: "مستحب بعد الطواف؛ قال ﷺ: «ماء زمزم لما شُرب له» — ابن ماجه ٣٠٦٢، صححه الألباني. وليس ركناً ولا واجباً." },
  { num: 5, icon: "🏃", title: "السعي (ركن)", desc: "سبعة أشواط بين الصفا والمروة؛ ﴿إِنَّ الصَّفَا وَالْمَرْوَةَ مِن شَعَائِرِ اللَّهِ﴾ — البقرة: ١٥٨." },
  { num: 6, icon: "✂️", title: "الحلق أو التقصير (ركن/واجب)", desc: "حلق الرأس أو تقصيره للرجال، وتقصر المرأة أنملة؛ قال ﷺ: «وليقصّر أو ليحلق» في أمره للمعتمرين — متفق عليه." },
];
      ...
      jsonLd: [
        {
          ...
          itemListElement: ARKAN.map((r, i) => ({
            ...
            position: i + 1,
            name: r.title,
            url: `https://www.ssunnah.com/hajj#${r.id}`,
          })),
        },
      ],
    });
    ...
    <main className="hj-page" dir="rtl">
      ...
      <div className="hj-body">
        ...
        {tab === "overview" && (
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-fadl-grid">
              {[
                { icon: "🏆", text: "الحج المبرور ليس له جزاء إلا الجنة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة للتعلم والتطبيق الشرعي.", ref: "متفق عليه" },
                ...
                { icon: "📿", text: "العمرة إلى العمرة كفارة لما بينهما، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة للتعلم والتطبيق الشرعي.", ref: "متفق عليه" },
        ...
        <div className="twh-share">
          <ShareButtons title="الحج والعمرة — سُنّة" url="https://www.ssunnah.com/hajj" />
        </div>
