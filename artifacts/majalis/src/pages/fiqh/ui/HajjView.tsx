...
const WAJIBAT: WajibHajj[] = [
  ...
  },
  {
    ...
    description: "المبيت بمزدلفة ليلة العاشر، والوقوف بها حتى بعد منتصف الليل على الأقل، مع مراعاة الخلاف المعتبر.",
    penalty: "دم",
  },
  {
    id: "rami",
    icon: "🪨",
    title: "رمي الجمرات",
    description: "رمي جمرة العقبة يوم العيد، ثم رمي الجمرات الثلاث في أيام التشريق وفق الترتيب والوقت المشروع.",
  ...
  },
  {
    ...
    description: "حلق الرأس أو تقصيره بعد رمي جمرة العقبة، والحلق أفضل للرجال عند جمهور أهل العلم.",
    penalty: "دم",
  },
  {
    id: "mabeet-mina",
    icon: "⛺",
    title: "المبيت بمنى",
    description: "المبيت بمنى ليالي أيام التشريق (١١ و١٢، وللمتعجل؛ و١٣ للمتأخر).",
    penalty: "دم",
  },
  {
    id: "tawaf-wada",
    icon: "👋",
    title: "طواف الوداع",
    description: "آخر عمل يفعله الحاج قبل مغادرة مكة، ويُعفى عنه الحائض والنفساء عند جمهور أهل العلم.",
    penalty: "دم",
  },
  {
    id: "tartib-rami",
  ...
  },
  {
    ...
    description: "يجب على المتمتع والقارن ذبح هدي: شاة، أو سُبع بدنة أو بقرة. يُذبح في أيام النحر (١٠–١٣) ويوزَّع على فقراء الحرم. من عجز صام ثلاثة أيام في الحج وسبعة إذا رجع.",
  ...
  },
  {
    ...
    description: "رمي الجمرات في أيام التشريق (١١، ١٢، ١٣) يكون بعد زوال الشمس ولا يجوز قبله. أما جمرة العقبة يوم النحر فيجوز رميها من منتصف الليل.",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الحج",
          description: "أركان الحج وأحكامه وخطواته التفصيلية مع الأدلة والتفصيل لمن أراد التوسع.",
