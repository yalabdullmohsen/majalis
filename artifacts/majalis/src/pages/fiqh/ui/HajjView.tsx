...
const WAJIBAT: WajibHajj[] = [
  {
    ...
    description: "الإحرام من أحد المواقيت المكانية المحددة، ومن جاوزها بلا إحرام وجب عليه الدم مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد",
    penalty: "دم (ذبح شاة)",
  },
  {
    id: "muzdalifa",
    ...
    description: "المبيت بمزدلفة ليلة العاشر، والوقوف بها حتى بعد منتصف الليل على الأقل — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف",
    penalty: "دم",
  },
  {
    id: "rami",
    icon: "🪨",
    title: "رمي الجمرات",
    description: "رمي جمرة العقبة يوم العيد، ورمي الجمرات الثلاث في أيام التشريق يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. — .",
  ...
  },
  {
    ...
    description: "حلق الرأس أو تقصيره بعد رمي جمرة العقبة، والحلق أفضل للرجال مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت. — .",
    penalty: "دم",
  },
  {
    id: "mabeet-mina",
    icon: "⛺",
    title: "المبيت بمنى",
    description: "المبيت بمنى ليالي أيام التشريق (11، 12، وللمتعجل، 13 للمتأخر) — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر.",
    penalty: "دم",
  },
  {
    id: "tawaf-wada",
    icon: "👋",
    title: "طواف الوداع",
    description: "آخر عمل يفعله الحاج قبل مغادرة مكة، ويُعفى عنه الحائض والنفساء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. — .",
    penalty: "دم",
  },
  {
    id: "tartib-rami",
    ...
    description: "يجب في أيام التشريق البداءة بالجمرة الصغرى ثم الوسطى ثم الكبرى، ولا يجوز عكس الترتيب مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن",
  ...
  },
  {
    ...
    description: "يجب على المتمتع والقارن ذبح هدي: شاة، أو سُبع بدنة أو بقرة. يُذبح في أيام النحر (10-13) ويوزَّع على فقراء الحرم. من عجز صام ثلاثة أيام في",
  ...
  },
  {
    ...
    description: "يجب على الحاج ألا يُفيض من عرفة إلا بعد غروب الشمس يوم التاسع؛ فمن انصرف قبل الغروب ولم يعد إلى عرفة قبل طلوع فجر العاشر وجب عليه دم عند",
...
const MASHAER: Mashar[] = [
  {
    ...
    icon: "📍",
    day: "قبل الإحرام",
    desc: "المواقيت المكانية هي الحدود التي يُحرم منها الحاج والمعتمر. للمدينة: ذو الحليفة. للشام: الجحفة. لليمن: يلملم. لنجد: قرن المنازل. للمشرق:",
  },
  {
    id: "mina",
    name: "منى",
    ...
    desc: "وادٍ قريب من مكة يمكث فيه الحجاج ليلة الثامن ويرمون فيه الجمرات في أيام التشريق يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا",
  ...
  },
  {
    ...
    icon: "⛰️",
    day: "9 ذو الحجة",
    desc: "الوقوف بعرفة ركن الحج الأعظم. تقع على بعد 20 كم من مكة. يمتد وقت الوقوف من زوال الشمس يوم 9 إلى فجر 10 مع التنبيه على ما يُستحب وما يُكره",
  ...
  },
  {
    ...
    desc: "منطقة بين عرفات ومنى. يُبيت بها الحاج ويُصلي المغرب والعشاء جمعاً وقصراً ويجمع حصى الجمرات — من الأحكام والآداب الشرعية المأثورة مع بيانها",
  ...
  },
  {
    ...
    icon: "🕋",
    day: "طوال الحج",
    desc: "بيت الله الحرام في مكة، تتجه إليه القلوب في الصلاة، ويطاف بها في مناسك الحج والعمرة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في",
  ...
  },
  {
    ...
    desc: "ثلاث جمرات في منى تُرمى في أيام التشريق: الجمرة الصغرى، الوسطى، والكبرى (العقبة). يُبدأ بالصغرى في أيام التشريق مع التنبيه على ما يُستحب",
  ...
  },
  {
    ...
    desc: "أشرف المساجد وأعظمها، تُضاعف فيه الصلاة بمئة ألف صلاة. يحيط بالكعبة المشرفة ويضم الحجر الأسود ومقام إبراهيم وبئر زمزم والملتزم. — . من",
  ...
  },
  {
    ...
    icon: "🤲",
    day: "بعد الطواف",
    desc: "المسافة بين الحجر الأسود وباب الكعبة المشرفة (نحو مترَين). يتعلق به الحاج داعياً ويلصق صدره وخده وذراعيه بجدار الكعبة. سُمِّي بالملتزم لأن",
...
const UMRA_STEPS: UmraStep[] = [
  { num: 1, icon: "🕌", title: "الإحرام من الميقات (ركن/شرط)", desc: "النية من الميقات مع التلبية؛ والاغتسال ولبس الإزار للرجال سنة. قال ﷺ: «هن لهن ولمن أتى عليهن من غيرهن ممن أراد الحج والعمرة» — متفق عليه — مرجع معتمد في المجلس العلمي." },
...
export default function HajjPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الحج والعمرة: الأركان والواجبات والسنن والمشاعر والدعاء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الحج",
          description: "أركان الحج وأحكامه وخطواته التفصيلية مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت. — دليل عملي منظم يُقرأ",
        ...
        {tab === "overview" && (
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-fadl-grid">
              {[
                { icon: "🏆", text: "الحج المبرور ليس له جزاء إلا الجنة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة — مرجع معتمد في المجلس العلمي للتعلم والتطبيق الشرعي. من أحكام الفقه المعتمدة", ref: "متفق عليه" },
                { icon: "✨", text: "من حج فلم يرفث ولم يفسق رجع كيوم ولدته أمه — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — مرجع معتمد في المجلس العلمي. دليل تعليمي منظم. من أحكام الفقه المعتمدة", ref: "متفق عليه" },
                { icon: "💰", text: "تابعوا بين الحج والعمرة فإنهما ينفيان الفقر والذنوب — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. — مرجع معتمد في المجلس العلمي. من أحكام الفقه المعتمدة", ref: "سنن الترمذي، صحيح" },
                { icon: "📿", text: "العمرة إلى العمرة كفارة لما بينهما، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة — مرجع معتمد في المجلس العلمي للتعلم والتطبيق الشرعي. من أحكام الفقه المعتمدة", ref: "متفق عليه" },
                { icon: "🌍", text: "وفد الله ثلاثة: الحاج والمعتمر والغازي — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — مرجع معتمد في المجلس العلمي. دليل تعليمي منظم. من أحكام الفقه المعتمدة", ref: "النسائي، صحيح" },
                { icon: "🤲", text: "الحاج والمعتمر من وفد الله؛ دعاهم فأجابوه وسألوه فأعطاهم — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. — مرجع معتمد في المجلس العلمي. من أحكام الفقه المعتمدة", ref: "ابن ماجه، حسن" },
              ].map((f) => (
            ...
            <div className="hj-types-grid">
              {[
                { name: "الإفراد", desc: "الإحرام بالحج وحده، ولا هدي واجب عليه، وهو أفضل أنواع الحج عند الشافعية وبعض العلماء يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في" },
                { name: "القِران", desc: "الإحرام بالحج والعمرة معاً بنية واحدة، ويلزمه هدي التمتع، وهو أفضل عند الأحناف مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب" },
                { name: "التمتع", desc: "الإحرام بالعمرة أولاً ثم يتحلل ثم يُحرم بالحج في أشهره، ويلزمه الهدي، وهو أفضل عند أحمد وكثير من المحدثين — من الأحكام والآداب الشرعية" },
              ].map((t) => (
