...
const COUNCIL_SECTIONS = [
  { href: "/fiqh-council",             label: "رئيسية المجمع",     desc: "بوابة المجمع الفقهي: قرارات وفتاوى وجلسات وأبحاث، مع فهرس موضوعي. المواد المعتمدة تُميَّز بوضوح عن قيد الإكمال." },
  ...
  { href: "/fiqh-council/resolutions", label: "القرارات",          desc: "قرارات هيئات الإفتاء والمجامع الفقهية، مرتّبة بحسب الموضوع مع ذكر المجلس والتاريخ عند اكتمال التوثيق." },
  { href: "/fiqh-council/fatwas",      label: "فتاوى المجمع",      desc: "فتاوى المجمع الفقهي مع بيان المذهب أو القول الراجح والأدلة عند توفر المصدر الرسمي." },
  ...
  { href: "/fiqh-council/nawazil",     label: "النوازل المعاصرة",  desc: "النوازل المعاصرة التي يعالجها المجمع: مسائل العصر من تقنية وطب واقتصاد." },
  ...
  useEffect(() => {
    ...
    void loadSeedQa().then((seed) => {
      ...
      applyPageSeo({
        ...
        description: "مرجع في الفقه الإسلامي: أحكام شرعية مع بيان حالة المراجعة، وأسئلة وأجوبة قيد الإكمال، وقرارات المجمع الفقهي. للتعلم والاطلاع لا كاعتماد نهائي لكل مادة.",
          ...
          <div role="tabpanel" id="fqp-panel-council" aria-labelledby="fqp-tab-council">
            <div className="mb-6">
              ...
              <p className="fqp-section-desc">
                قرارات وبيانات وفتاوى المجامع الفقهية مع مصادرها عند التوثيق
              </p>
            </div>
