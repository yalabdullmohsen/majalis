...
export default function MawarithCalculatorPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "احسب أنصبة الورثة الشرعية تلقائيًا وفق الفرائض والتعصيب والحجب والعول والردّ، مع شرح خطوة بخطوة. عرض موثّق ضمن منهج سُنّة",
      ...
      {step === "result" && result && estateBreakdown && (
        <div className="mwc-result mwc-print-area">
          ...
          <div className="twh-share no-print">
            <ShareButtons title="حاسبة المواريث الإسلامية — سُنّة" url="https://www.ssunnah.com/mawarith/calculator" />
          </div>
        </div>
      )}
