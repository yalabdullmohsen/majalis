...
const HUQUQ = [
  { num: 1, title: "مئونة التجهيز والدفن", desc: "تُخرج من أصل التركة نفقات تجهيز الميت وتكفينه ودفنه بالمعروف، وهي أول حق يؤخذ. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — .", priority: "الأول" },
  { num: 2, title: "الديون", desc: "كل دين ثابت في ذمة الميت سواء كان لله كالزكاة والكفارة أو للناس، يُسدَّد قبل الإرث. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — .", priority: "الثاني" },
  { num: 3, title: "الوصية", desc: "تُنفَّذ الوصية الشرعية وحدّها الأقصى ثلث التركة لغير الوارث؛ «الثلث والثلث كثير» متفق عليه، و«لا وصية لوارث» حسّنه الألباني. من أصول علم", priority: "الثالث" },
  { num: 4, title: "الإرث", desc: "بعد استيفاء الحقوق السابقة تُوزَّع التركة الباقية على الورثة وفق أنصبتهم الشرعية. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — .", priority: "الرابع" },
];

/* ── أسباب الإرث وموانعه ── */
const ASBAB_MAWAANI = {
  asbab: [
    { title: "النكاح الصحيح", desc: "عقد الزواج الصحيح، يُورث بين الزوجين ولو قبل الدخول؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — . دليل تعليمي منظم." },
    { title: "النسب", desc: "رابطة الدم، الأصول والفروع والحواشي؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — للتعلم والتطبيق الشرعي." },
    { title: "الولاء", desc: "عتق العبد، المعتِق يرث معتَقه إن لم يكن له وارث أقرب؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — . دليل تعليمي منظم." },
  ],
  mawaani: [
    { title: "القتل العمد", desc: "من قتل مورّثه عمداً وعدواناً لا يرثه، درءاً لتعجيل الإرث؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — . دليل تعليمي" },
    { title: "اختلاف الدين", desc: "المسلم لا يرث الكافر والكافر لا يرث المسلم، الحديث والإجماع؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — ." },
    { title: "الرقّ", desc: "العبد لا يرث ولا يُورث، وهو حكم تاريخي لا وجود لموضوعه الآن؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — . دليل تعليمي منظم." },
  ],
};
...
const ASAB_TYPES = [
  {
    type: "عَصَبة بنفسه",
    desc: "كل ذكر لا تتوسط في نسبته للميت أنثى، يأخذ ما بقي بعد أصحاب الفروض. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — . دليل تعليمي منظم.",
    ex: ["الابن وابن الابن", "الأب والجدّ", "الأخ الشقيق والأخ لأب", "العم وابن العم"],
  },
  {
    type: "عَصَبة بغيره",
    desc: "الأنثى تصير عَصَبة بوجود ذكر من نفس الدرجة يُعصّبها، فيقتسمان للذكر مثل حظ الأنثيين. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — .",
    ex: ["البنت مع الابن", "بنت الابن مع ابن الابن", "الأخت الشقيقة مع الأخ الشقيق"],
  },
  {
    type: "عَصَبة مع غيره",
    desc: "الأخت الشقيقة أو لأب تصير عَصَبة مع البنت أو بنت الابن، فيأخذن الباقي بعد نصيب البنات. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة",
...
const MASAIL = [
  {
    ...
    desc: "إذا اجتمع زوج وأبوان، أو زوجة وأبوان، فللزوج أو الزوجة نصيبه، وللأم ثلث الباقي لا ثلث جميع المال، وسُمّيتا بالعُمَريَّتَين لقضاء عمر ﵁ بهما",
    formula: "زوج ½ أو زوجة ¼ + أم ⅓ الباقي + أب الباقي",
  },
  {
    title: "مسألة المشتركة (الحِمارية)",
    desc: "زوج + أم + أخوان لأم + إخوة أشقاء. سُمّيت الحِمارية لأن بعض الأشقاء قال لعمر: هبْ أن أبانا كان حماراً! فأشركهم في الثلث. من أحكام المواريث",
    formula: "الزوج ½ + الأم ⅙ + الإخوة لأم ⅓ + الأشقاء يشاركونهم في الثلث",
  },
  {
    title: "الميراث عبر الحساب",
    desc: "أصل المسألة: أصغر عدد صحيح تنقسم عليه التركة، كالجذر المشترك للمقامات. ثم تُضرب النسبة × أصل المسألة. من أصول علم الفرائض المعتمد يُراعى في",
    formula: "أصل المسألة = م.م.م (للمقامات) ← ثم توزيع الحصص",
  },
  {
    title: "المسألة المنبرية",
    desc: "توفي رجل عن زوجة وبنتين وأبوين؛ لما سُئل عنها علي ﵁ على المنبر أجاب في الحال، فسُمّيت بالمنبرية. من أحكام المواريث في الفقه الإسلامي — .",
    formula: "زوجة ⅛ + بنتان ⅔ + أم ⅙ + أب ⅙ = تعول من ٢٤ إلى ٢٧",
  },
  {
    title: "مسألة الغرَّاوَين",
    desc: "توفيت وعنها زوج وأبوان فقط أو زوجة وأبوان — يكون للأم ثلث الباقي بعد نصيب الزوج/الزوجة، لا ثلث الجميع. من أصول علم الفرائض المعتمد — .",
    formula: "زوج ½ + أم ثلث الباقي (⅙) + أب الباقي (⅙+تعصيب)",
  },
  {
    title: "مسألة الأكدرية",
    desc: "زوج وأم وجد وأخت شقيقة — سُميت كذلك لكدرها قواعد الجد، إذ كدّرت على الجد بأخذه جزءاً من نصيب الأخت. من أصول علم الفرائض المعتمد يُراعى في",
    formula: "زوج ½ + أم ⅓ + جد ⅙ + أخت ½ ← ثم تعول المسألة إلى ٩ وتُصحَّح بقسمة نصيب الجد والأخت",
  },
  {
    title: "مسألة العَوْل",
    desc: "إذا زادت السهام عن رأس المال يُزاد في أصل المسألة حتى تستوعب الحصص — هذا هو العَوْل، وبه قضى عمر ﵁. من أصول علم الفرائض المعتمد يُراعى في",
    formula: "مثال: زوج ½ + أختان ⅔ = ٤/٦+٤/٦ > ١ → أصل ٩ بدل ٦",
  },
  {
    title: "مسألة الرَّدّ",
    desc: "إذا بقي من التركة فضل بعد توزيع ذوي الفروض وانعدم العصبة — يُردّ الباقي على أصحاب الفروض بنسب حصصهم. من أصول علم الفرائض المعتمد يُراعى في",
    formula: "مثال: أم ⅙ + بنت ½ + لا عصبة → يُرد الثلث الباقي بالنسبة",
  },
  {
    title: "توريث الخنثى المُشكِل",
    desc: "مَن لا يُعلم أذكر أم أنثى — يُوقف جزء من التركة حتى يتبين، وعند تعذر التبين يأخذ نصف نصيب ذكر ونصف نصيب أنثى. من أصول علم الفرائض المعتمد",
    formula: "نصيبه = (نصيب ذكر + نصيب أنثى) ÷ ٢",
  },
  {
    title: "مسألة الجدّ مع الإخوة (مسائل ابن مسعود)",
    desc: "الجدّ مع الإخوة موضع خلاف مشهور: ذهب أبو بكر وعثمان وابن عباس إلى أن الجد يحجب الإخوة تماماً كالأب. وذهب عمر وعلي وزيد بن ثابت وجمهور",
    formula: "الجد: أفضل ثلاثة: ثلث الكل / السدس / المقاسمة",
  },
  {
    title: "المفقود وتوزيع ميراثه",
    desc: "المفقود الذي انقطع خبره يُنتظر حتى يُحكم بموته من المحكمة (أو مضي مدة اجتهادية)، وحينئذ يُوزَّع ميراثه على ورثته الأحياء وقت الحكم بوفاته",
    formula: "تاريخ الوفاة الحكمية ← يُعاد احتساب الورثة والحصص",
  },
  {
    title: "ميراث ما أُدلي بمحرومَين (ذوو الأرحام)",
    desc: "ذوو الأرحام هم القرابة الذين لا يرثون بفرض ولا تعصيب كابن البنت والخال وبنت الأخ. ورَّثهم الحنفية والحنابلة عند غياب أصحاب الفروض والعصبة،",
    formula: "يرثون عند تعذر وجود صاحب فرض أو عصبة",
  },
  {
    title: "ميراث الحمل (الجنين في بطن أمه)",
    desc: "يُحجز للجنين نصيبه حتى يُولد، فإن وُلد حياً ورث، وإن ولد ميتاً أو أُسقط فلا إرث له. ويُعطى الورثةُ الآخرون أقلَّ الحظَّين احتياطاً: إذ",
    formula: "تأجيل التقسيم أو منح الورثة أقل حصة محتملة حتى الولادة",
  },
  {
    title: "مسألة التخارج (الصلح على الميراث)",
    desc: "اتفاق بعض الورثة على أن يأخذ أحدهم مبلغاً معيناً من التركة مقابل تنازله عن حصته للباقين. جائز فقهياً وفق اتفاق الحنفية والمالكية والحنابلة",
  ...
  },
  {
    ...
    desc: "يموت أحد الورثة قبل أن تُقسَّم التركة الأولى، فتُنقل حصته إلى ورثته — مما ينشئ مسألةً ثانية متشعبة من الأولى. تحلّ بدمج المسألتين في أصل",
      ...
      jsonLd: [
        {
          ...
          description: "الورثة وأنصبتهم وشروط إرثهم في الفقه الإسلامي؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع شامل في علم الفرائض — . دليل تعليمي منظم.",
  ...
  return (
    <main className="mw-page" dir="rtl">
      ...
      <Link href="/mawarith/calculator" className="mwod-card" style={{ display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none" }}>
        <Calculator size={28} strokeWidth={1.6} aria-hidden="true" style={{ color: "var(--mj-brand)", flexShrink: 0 }} />
        <div>
