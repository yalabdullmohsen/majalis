...
const HUQUQ = [
  ...
  { num: 3, title: "الوصية", desc: "تُنفَّذ الوصية الشرعية وحدّها الأقصى ثلث التركة لغير الوارث؛ «الثلث والثلث كثير» متفق عليه، و«لا وصية لوارث» حسّنه الألباني.", priority: "الثالث" },
...
const ASBAB_MAWAANI = {
  asbab: [
    { title: "النكاح الصحيح", desc: "عقد الزواج الصحيح، يُورث بين الزوجين ولو قبل الدخول يُراعى في توزيع التركة." },
    { title: "النسب", desc: "رابطة الدم، الأصول والفروع والحواشي يُستفاد في حاسبة الفرائض." },
    { title: "الولاء", desc: "عتق العبد، المعتِق يرث معتَقه إن لم يكن له وارث أقرب يُستفاد في حاسبة الفرائض." },
  ],
  mawaani: [
    { title: "القتل العمد", desc: "من قتل مورّثه عمداً وعدواناً لا يرثه، درءاً لتعجيل الإرث يُستفاد في حاسبة الفرائض دليل تعليمي." },
    { title: "اختلاف الدين", desc: "المسلم لا يرث الكافر والكافر لا يرث المسلم، الحديث والإجماع يُستفاد في حاسبة الفرائض." },
    { title: "الرقّ", desc: "العبد لا يرث ولا يُورث، وهو حكم تاريخي لا وجود لموضوعه الآن يُراعى في توزيع التركة." },
  ],
};
...
const MASAIL = [
  ...
  },
  {
    ...
    desc: "زوج + أم + أخوان لأم + إخوة أشقاء. سُمّيت الحِمارية لأن بعض الأشقاء قال لعمر: هبْ أن أبانا كان حماراً! فأشركهم في الثلث.",
  ...
  },
  {
    ...
    desc: "توفي رجل عن زوجة وبنتين وأبوين؛ لما سُئل عنها علي ﵁ على المنبر أجاب في الحال، فسُمّيت بالمنبرية.",
      ...
      jsonLd: [
        {
          ...
          description: "الورثة وأنصبتهم وشروط إرثهم في الفقه الإسلامي؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع شامل في علم الفرائض.",
          numberOfItems: WARASA.length,
          itemListElement: WARASA.map((w, i) => ({
            "@type": "ListItem",
            position: i + 1,
            name: w.name,
            url: `https://www.ssunnah.com/mawarith#warith-${i + 1}`,
          })),
        },
      ],
    });
    ...
    <main className="mw-page" dir="rtl">
      ...
      <div className="mw-body">
        ...
        <div className="twh-share">
          <ShareButtons title="علم المواريث — سُنّة" url="https://www.ssunnah.com/mawarith" />
        </div>
