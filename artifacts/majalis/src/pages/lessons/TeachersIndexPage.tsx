...
export default function TeachersIndexPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      path: "/teachers",
      title: "المشايخ المعاصرون — دروس الكويت | المجلس العلمي",
      description:
        "فهرس المشايخ المعاصرين من دروس الكويت المجدولة في المجلس العلمي — أسماء ومواعيد من بيانات الدروس فقط. لعلماء التراث راجع قسم أعلام الإسلام.",
      keywords: ["مشايخ", "دروس الكويت", "محاضرات", "المجلس العلمي"],
    });
  }, []);
  ...
  return (
    <PageShell variant="narrow" className="tch-page">
      ...
      <p className="tch-notice">
        ...
        {" "}
        <Link href="/scholars">راجع قسم أعلام الإسلام</Link>.
      </p>
