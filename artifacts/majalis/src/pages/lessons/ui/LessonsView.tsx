...
export default function LessonsPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "دروس شرعية وعلمية من أئمة وعلماء الكويت، فقه وعقيدة وقرآن وسيرة ولغة عربية. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description:
            "دروس ودورات علمية من أئمة وعلماء الكويت في الفقه والعقيدة والقرآن والسيرة؛ عرض موثّق ضمن منهج سُنّة",
