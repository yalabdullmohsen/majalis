...
export default function LessonsPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "دروس شرعية وعلمية من أئمة وعلماء الكويت والعالم، فقه وعقيدة وقرآن وسيرة ولغة عربية. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description:
            "دروس ودورات علمية من أئمة وعلماء الكويت في الفقه والعقيدة والقرآن والسيرة؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
          numberOfItems: 4,
          itemListElement: [
