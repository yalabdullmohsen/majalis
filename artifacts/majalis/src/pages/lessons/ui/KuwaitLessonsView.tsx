...
export default function KuwaitLessonsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "جميع الدروس العلمية القادمة لمشايخ الكويت، محدَّثة تلقائياً من مصادر معتمدة. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "قائمة الدروس الشرعية القادمة لعلماء ومشايخ الكويت؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
        ...
        },
        {
          ...
          description: "دروس شرعية منتظمة في مساجد ومراكز الكويت العلمية؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
          location: {
            "@type": "Country",
            name: "الكويت",
          },
