...
export default function KuwaitLessonsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "جميع الدروس العلمية القادمة لمشايخ الكويت، محدَّثة تلقائياً من مصادر معتمدة. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description: "قائمة الدروس الشرعية القادمة لعلماء ومشايخ الكويت؛ عرض موثّق ضمن منهج سُنّة",
        ...
        },
        {
          ...
          description: "دروس شرعية منتظمة في مساجد ومراكز الكويت العلمية؛ عرض موثّق ضمن منهج سُنّة",
          location: {
            "@type": "Country",
            name: "الكويت",
          },
