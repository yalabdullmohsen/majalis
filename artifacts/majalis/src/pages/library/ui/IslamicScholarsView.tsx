...
export default function IslamicScholarsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "سِيَر أبرز علماء الإسلام عبر القرون، الأئمة الأربعة، المحدثون، العلماء المعاصرون؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي؛ — مرج",
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          name: "أعلام الإسلام عبر القرون",
          description: "سِيَر أبرز علماء الإسلام: الأئمة الأربعة والمحدثون والفقهاء والمعاصرون؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
