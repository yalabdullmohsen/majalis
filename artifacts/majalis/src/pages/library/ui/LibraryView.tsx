...
export default function LibraryPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مكتبة رقمية شاملة من الكتب والمراجع الشرعية، في الفقه والعقيدة والتفسير والحديث والسيرة والتزكية. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "تصنيفات كتب المكتبة الإسلامية في المجلس العلمي؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
