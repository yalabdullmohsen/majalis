    ...
    <div>
      ...
      <div style={{ background: C.emeraldDeep, color: C.parchment }}>
        <div style={{ maxWidth: "48rem", margin: "0 auto", padding: "3.5rem 1.25rem", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "2.5rem", fontWeight: 700, fontFamily: "Amiri, serif", margin: "0 0 0.75rem" }}>مجالس</h1>
          ...
          <p style={{ fontSize: "1.0625rem", color: "#E8E0CE", lineHeight: 1.9, margin: 0 }}>
            منصةٌ علمية شرعية تجمع الدروس والمشايخ والمكتبة العلمية والإعجاز العلمي والفوائد في مكانٍ واحد،
            بمحتوى موثّق ومعتمد، خدمةً لطالب العلم والباحث عن المعرفة الشرعية الصحيحة.
          </p>
        </div>
      </div>
