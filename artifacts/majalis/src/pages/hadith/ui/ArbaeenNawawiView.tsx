...
export default function ArbaeenNawawiPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الأربعون حديثاً النووية مع شرح موجز وفوائد ومصدر لكل حديث، مرجع حديثي مختصر لطالب العلم. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "الأربعون حديثاً النووية الجامعة لأحكام الإسلام؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
