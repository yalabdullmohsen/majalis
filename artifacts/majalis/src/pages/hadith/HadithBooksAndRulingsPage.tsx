...
export default function HadithBooksAndRulingsPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "المتون الحديثية وأحاديث الأحكام: الأربعون النووية، وعمدة الأحكام، وبلوغ المرام، والمنتقى من أخبار المصطفى. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
