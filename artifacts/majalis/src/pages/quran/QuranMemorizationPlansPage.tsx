...
const PLANS: Plan[] = [
  { id: "review-30", title: "مراجعة مكثفة، 30 يومًا", description: "للحافظ الذي يريد المرور على المصحف كاملًا؛ ليست وعدًا بحفظ جديد في شهر. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 30, kind: "review" },
  { id: "year-1", title: "خطة سنة", description: "ستة أيام أسبوعيًا ويوم مرن للمراجعة أو التعويض. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 312, kind: "memorization" },
  { id: "year-2", title: "خطة سنتين", description: "وتيرة متوازنة تناسب طالب العلم ومن لديه وقت يومي ثابت. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 624, kind: "memorization" },
  { id: "year-3", title: "خطة 3 سنوات", description: "مقدار صغير مع مساحة أوسع للتكرار والتثبيت. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 936, kind: "memorization" },
  { id: "year-5", title: "خطة 5 سنوات", description: "وتيرة هادئة للكبار والموظفين، بلا ضغط عند الانقطاع. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 1560, kind: "memorization" },
  { id: "children", title: "خطة الأطفال", description: "نصف صفحة في الجلسة مع التلقين والمراجعة بإشراف المعلّم. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 1208, kind: "memorization" },
  { id: "employee", title: "خطة الموظف", description: "صفحة في الجلسة وخمسة أيام أسبوعيًا، مع يومين مرنين. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 604, kind: "memorization" },
  { id: "student", title: "خطة طالب العلم", description: "صفحتان تقريبًا في الجلسة مع اختبار أسبوعي وربط بالتسميع. يُعرض للتعلّم والاطلاع. في المجلس العلمي", sessions: 312, kind: "memorization" },
...
export default function QuranMemorizationPlansPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "خطط مرنة لحفظ القرآن ومراجعته حسب الوقت والعمر، مع متابعة محلية وأيام تعويض واختبار تسميع. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
