...
export default function QuranMemorizationPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "12 نوعًا من اختبارات حفظ القرآن الكريم مع نظام المراجعة المتباعدة (المراجعة المتباعدة). اختبر حفظك وتتبّع تقدمك سورةً سورة. محتوى معتمد في منهج سُنّة",
      keywords: ["حفظ القرآن", "اختبار الحفظ", "مراجعة متباعدة", "حفظ السور", "مراجعة القرآن"],
      jsonLd: [{
