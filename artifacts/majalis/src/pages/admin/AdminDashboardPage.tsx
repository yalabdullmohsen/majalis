...
export default function AdminDashboardPage() {
  ...
  const STAT_CARDS = stats
    ? [
        { label: "المستخدمون", value: stats.totalUsers, icon: "👥", color: "bg-blue-50 border-blue-200", text: "text-blue-700" },
        { label: "الدروس", value: stats.totalLessons, icon: "📚", color: "bg-green-50 border-green-200", text: "text-green-700" },
        { label: "الكتب", value: stats.totalBooks, icon: "📖", color: "bg-amber-50 border-amber-200", text: "text-amber-700" },
        { label: "الفوائد", value: stats.totalBenefits, icon: "💡", color: "bg-purple-50 border-purple-200", text: "text-purple-700" },
        { label: "الأسئلة", value: stats.totalQA, icon: "❓", color: "bg-indigo-50 border-indigo-200", text: "text-indigo-700" },
        { label: "التفريغات", value: stats.totalTranscriptions, icon: "🎙️", color: "bg-teal-50 border-teal-200", text: "text-teal-700" },
        { label: "بلاغات معلّقة", value: stats.pendingReports, icon: "🚨", color: "bg-red-50 border-red-200", text: "text-red-700" },
        { label: "مشاهدات اليوم", value: stats.todayViews, icon: "👁️", color: "bg-slate-50 border-slate-200", text: "text-slate-700" },
      ]
    : [];
