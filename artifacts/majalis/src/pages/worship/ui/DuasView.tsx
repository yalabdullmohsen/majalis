...
const DUAS: DuaEntry[] = [
  {
    ...
    occasion: "يُقال صباحًا ضمن أوراد اليوم",
    virtue: "من أذكار الصباح الجامعة لتوحيد الله وحمده، ويُذكر لله لا للرياء",
  },
  {
    id: "sabah-2",
  ...
  },
  {
    ...
    category: "الصباح والمساء",
    occasion: "مساءً، ويُستحب بعد الفرائض ضمن الأذكار الراتبة",
  ...
  },
  {
    ...
    meaning: "تسبيح السجود: تنزيه الله بوصف العلو وهو أقرب ما يكون العبد من ربه",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    source: "متفق عليه",
    category: "الصلاة",
    occasion: "في الصلاة بعد التشهد وقبل السلام",
    virtue: "أوصى النبي ﷺ أصحابه بهذا الدعاء بعد التشهد، ويُذكر لله لا للرياء",
  },
  {
    id: "akl-1",
    ...
    occasion: "عند بدء تناول الطعام قبل اللقمة الأولى",
    virtue: "الأمر بالتسمية عند الأكل كما في حديث مسلم، ويُذكر لله لا للرياء",
  },
  {
    id: "akl-2",
    ...
    meaning: "حمد بعد الطعام: يشكر الله على الإطعام والسقاية وعلى نعمة الإسلام",
    source: "سنن الترمذي، صحيح",
    category: "الأكل والشرب",
    occasion: "عند الفراغ من الطعام شكرًا لله",
  },
  {
    id: "akl-3",
    ...
    category: "الأكل والشرب",
    occasion: "بعد الطعام والشراب عند تمام النعمة",
  },
  {
    id: "safar-1",
    ...
    meaning: "تكبير وتسبيح عند الركوب: إقرار بتسخير المركوب والرجوع إلى الله",
    source: "صحيح مسلم",
    category: "السفر",
    occasion: "عند ركوب الدابة أو السيارة أو الطائرة للسفر",
  ...
  },
  {
    ...
    category: "السفر",
    occasion: "عند الخروج من المنزل إلى حاجة أو عمل",
  ...
  },
  {
    ...
    occasion: "عند الاستلقاء للنوم قبل غلبة النعاس",
  },
  {
    id: "nawm-2",
    ...
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من النوم في أول اليقظة",
  },
  {
    id: "karb-1",
    ...
    occasion: "عند اشتداد الكرب والضيق والحاجة إلى الفرج",
  ...
  },
  {
    ...
    source: "الأنبياء: 87",
    category: "الكرب والهم",
    occasion: "في أوقات الضيق والكرب وما شابهها من الهم",
  ...
  },
  {
    ...
    category: "الكرب والهم",
    occasion: "عند الهم والحزن وطلب تفريج الصدر",
  ...
  },
  {
    ...
    occasion: "يُقال في أي وقت من ليل أو نهار",
  ...
  },
  {
    ...
    category: "الدعاء العام",
    occasion: "في أي وقت، ويُؤكَّد في أوقات الفتن",
    virtue: "كان النبي ﷺ يكثر من هذا الدعاء في أحواله، ويُذكر لله لا للرياء",
  },
  {
    id: "jumuah-1",
  ...
  },
  {
    ...
    virtue: "علّمه النبي ﷺ لعائشة رضي الله عنها في الدعاء، ويُذكر لله لا للرياء",
  },
  {
    id: "masjid-1",
    ...
    meaning: "دعاء دخول المسجد: يسأل الله أن يفتح له أبواب رحمته عند دخول بيته",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "عند الخروج من المسجد يسأل العبد ربه من فضله بعد الفراغ من الصلاة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "دعاء الجلسة بين السجدتين: طلب المغفرة في موضع ذلّ بين السجدتين",
    source: "سنن ابن ماجه، صحيح",
    category: "الصلاة",
    occasion: "في الجلسة بين السجدتين أثناء الصلاة",
  },
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    category: "الكرب والهم",
    occasion: "عند الخوف والشدة وطلب الحفظ من الله",
  ...
  },
  {
    ...
    source: "البقرة: 286",
    category: "الكرب والهم",
    occasion: "عند الخطأ أو النسيان مع طلب العفو من الله",
  ...
  },
  {
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "دعاء ذي النون في الكرب: توحيد لله وتنزيهه مع الاعتراف بالتقصير",
    source: "الأنبياء: 87، صحيح الترمذي",
    category: "الكرب والهم",
    occasion: "عند الضيق وطلب رفع البلاء والكرب",
  ...
  /* ── دعاء عام، إضافية ── */
  {
    ...
    meaning: "دعاء طالب العلم: نفع العلم، وطلب المزيد مما ينفع في الدنيا والآخرة",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
    occasion: "بعد الانتهاء من الدراسة أو القراءة",
    virtue: "من جوامع الأدعية في طلب العلم النافع والبركة فيه، مع حسن التوكل",
  },
  {
    id: "am-5",
    title: "دعاء الشفاء",
    ...
    source: "متفق عليه",
    category: "الدعاء العام",
    occasion: "عند زيارة المريض أو رقيته بما ثبت",
  ...
  },
  {
    ...
    category: "الدعاء العام",
    occasion: "عند الضيق المادي وطلب الرزق الحلال",
  ...
  },
  {
    ...
    source: "صحيح الجامع",
    category: "الدعاء العام",
    occasion: "في أي وقت، ويُستحب خصوصًا عند المساء",
    virtue: "من جوامع الأدعية في سؤال حسن الخاتمة والثبات، ويُذكر لله لا للرياء",
  },
  /* ── أدعية النوم، إضافية ── */
  {
    id: "nawm-3",
    ...
    virtue: "كان النبي ﷺ يداوم عليه كل ليلة قبل النوم، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-4",
    ...
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "أول ما يُقال فور الاستيقاظ من النوم",
  },
  /* ── السفر، إضافية ── */
  {
    id: "safar-3",
    ...
    source: "متفق عليه",
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    source: "سنن الترمذي، حسن",
    category: "المناسبات",
    occasion: "عند رؤية هلال كل شهر هجري",
  ...
  },
  {
    ...
    source: "صحيح مسلم",
    category: "المناسبات",
    occasion: "بعد الانتهاء من الوضوء، بعد تمام الطهارة",
  ...
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    source: "صحيح مسلم",
    category: "الصباح والمساء",
    occasion: "يقولها ثلاثاً حين يمسي كل يوم",
  ...
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    category: "النوم واليقظة",
    occasion: "عند الفزع من النوم، من أذكار اليوم والليلة",
    virtue: "كان عبد الله بن عمرو يعلمها من بلغ من أبنائه، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-6",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    virtue: "تسمية الله تحرم الشيطان من مشاركة الطعام، ويُذكر لله لا للرياء",
  },
  /* ── الأكل والشرب، إضافية ── */
  {
    id: "akl-5",
    ...
    category: "الأكل والشرب",
    occasion: "يقوله بعد شرب اللبن خاصةً، شكراً لله على النعمة",
  ...
  /* ─── إضافات الصباح والمساء ─── */
  {
    ...
    category: "الصباح والمساء",
    occasion: "بعد صلاة الفجر، وفق الثابت في السنة",
    virtue: "جامعة لخيري الدنيا والآخرة في كلمات موجزة، ويُذكر لله لا للرياء",
  },
  {
    id: "sabah-7",
    ...
    meaning: "سؤال العفو والعافية في الدنيا والآخرة؛ من جوامع الأدعية اليومية",
    source: "أبو داود: ٥٠٧٤، ابن ماجه: ٣٨٧١، صحيح",
    category: "الصباح والمساء",
    occasion: "صباحاً ومساءً، ضمن الأذكار الراتبة إن تيسّر",
    virtue: "كان النبي ﷺ لا يدع هذا الدعاء صباحاً ومساءً، ويُذكر لله لا للرياء",
  },
  {
    id: "sabah-8",
    ...
    meaning: "استعاذة بأتمّ كلمات الله من شرّ كل مخلوق؛ حرز عند المساء والنزول",
    source: "صحيح مسلم: ٢٧٠٩",
    category: "الصباح والمساء",
    occasion: "ثلاث مرات عند المساء، ضمن الأذكار الراتبة إن تيسّر",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    virtue: "من أودع أخاه المسافر بهذا الدعاء حفظه الله، مع التوكل على الله",
  },
  {
    id: "safar-7",
    ...
    meaning: "دعاء توديع: سؤال التقوى والمغفرة وتيسير الخير في الحلّ والترحال",
    source: "الترمذي: ٣٤٤٤، صحيح",
    category: "السفر",
    occasion: "يقوله المُودِّع للمسافر عند الوداع",
  ...
  },
  {
    ...
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير",
    virtue: "كان النبي ﷺ يقولها عند رجوعه من كل سفر وغزوة، ويُذكر لله لا للرياء",
  },
  /* ─── إضافات الصلاة ─── */
  {
    id: "salah-7",
  ...
  },
  {
    ...
    virtue: "علَّمه النبي ﷺ الحسنَ بن علي رضي الله عنهما، ويُذكر لله لا للرياء",
  },
  {
    id: "salah-9",
    ...
    category: "الصلاة",
    occasion: "بين السجدتين في كل ركعة من الصلاة",
  ...
  },
  {
    ...
    category: "الصلاة",
    occasion: "عقب كل صلاة مفروضة، وفق الثابت في السنة",
    virtue: "من قالها حُطَّت خطاياه وإن كانت مثل زبد البحر، ويُذكر لله لا للرياء",
  },
  /* ─── إضافات النوم ─── */
  {
    id: "nawm-7",
  ...
  },
  {
    ...
    meaning: "حمد بعد تمام النعمة أو العمل الصالح؛ نسبة التوفيق إلى الله وحده",
    source: "ابن ماجه: ٣٨٠٣، حسن",
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من رؤيا حسنة، من أذكار اليوم والليلة",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    category: "الكرب والهم",
    occasion: "عند الغضب الشديد طلباً لسكون النفس",
  ...
  },
  {
    ...
    virtue: "جامع لكل أسباب الضعف الداخلي والضغوط الخارجية، ويُذكر لله لا للرياء",
  },
  {
    id: "karb-10",
    ...
    category: "الكرب والهم",
    occasion: "عند الكرب والضيق الشديد، مع حسن الظن بالله",
    virtue: "دعاء الكرب الذي يُفرِّج الكروب ببركة التوحيد الخالص، مع حسن التوكل",
  },
  /* ─── إضافات الدعاء العام ─── */
  {
    id: "du-8",
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "دعاء ثبات القلب على الدين، مع الإقرار بأن تقليب القلوب بيد الله",
  ...
  /* ── الأكل والشرب ── */
  {
    ...
    source: "مسلم: ٢٠٢٢",
    category: "الأكل والشرب",
    occasion: "قبل الشرب، شكراً لله على النعمة",
    virtue: "من سنن النبي ﷺ التسمية عند الشرب والحمد بعده، ويُذكر لله لا للرياء",
  },
  {
    id: "akl-10",
  ...
  /* ── السفر ── */
  {
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "دعاء الرجوع: رجوع وتوبة وعبادة وحمد لله على تمام السفر والسلامة",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير",
  ...
  },
  {
    ...
    meaning: "وداع المؤتمنين: استيداع الأهل والأحبة عند الله الذي لا تضيع ودائعه",
  ...
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    source: "البخاري: ٦٣٦٩",
    category: "الصباح والمساء",
    occasion: "من أذكار الصباح والمساء، ضمن الأذكار الراتبة إن تيسّر",
    virtue: "يُقال في الصباح والمساء للحفظ من آفات الدنيا، مع التوكل على الله",
  },
  {
    id: "sabah-10",
    ...
    source: "أبو داود: ٥٠٧٤، ابن ماجه: ٣٨٧١، صحيح",
    category: "الصباح والمساء",
    occasion: "دعاء الصباح والمساء، ضمن الأذكار الراتبة إن تيسّر",
    virtue: "قال ﷺ: لم يُسأل الله شيء أحبّ إليه من العافية، ويُذكر لله لا للرياء",
  },
  {
    id: "sabah-11",
    ...
    source: "مسلم: ٢٧٢٣",
    category: "الصباح والمساء",
    occasion: "أوّل الصباح، ضمن الأذكار الراتبة إن تيسّر",
    virtue: "ذكر جامع يُفتتح به اليوم بتوحيد الله وحمده، ويُذكر لله لا للرياء",
  },
  /* ─── النوم واليقظة — إضافي ─── */
  {
    id: "nawm-10",
    ...
    virtue: "يقيه من الشيطان ويرد عنه الفزع عند اليقظة، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-11",
  ...
  /* ─── الكرب والهم — إضافي ─── */
  {
    ...
    category: "الكرب والهم",
    occasion: "عند اشتداد الكرب والضيق، مع حسن الظن بالله",
  ...
  /* ─── الصلاة — إضافي ─── */
  {
    ...
    category: "الصلاة",
    occasion: "افتتاح صلاة الليل والتهجد، وفق الثابت في السنة",
  ...
  /* ─── الأكل والشرب — إضافي ─── */
  {
    ...
    category: "الأكل والشرب",
    occasion: "بعد الفراغ من الطعام، شكراً لله على النعمة",
