...
const DUAS: DuaEntry[] = [
  {
    ...
    virtue: "من أذكار الصباح الجامعة لتوحيد الله وحمده؛ يُحافظ عليه بقدر الاستطاعة مع الإخلاص.",
  },
  {
    id: "sabah-2",
    ...
    virtue: "من قالها موقناً بها صباحاً فمات من يومه دخل الجنة — كما في البخاري؛ مع الإخلاص وترك الرياء.",
  },
  {
    id: "masa-1",
    ...
    virtue: "من قرأ آية الكرسي إذا أوى إلى فراشه لم يزل عليه من الله حافظ ولا يقربه شيطان حتى يصبح — كما في البخاري.",
  },
  {
    id: "salah-1",
  ...
  },
  {
    ...
    virtue: "مما علّمه النبي ﷺ أصحابه بعد التشهد؛ يُقال في موضعه من الصلاة مع حضور القلب.",
  },
  {
    id: "akl-1",
    ...
    virtue: "الأمر بالتسمية عند الأكل ثابتٌ في صحيح مسلم؛ سنةٌ يومية يسيرة.",
  },
  {
    id: "akl-2",
  ...
  },
  {
    ...
    virtue: "ثابت عن النبي ﷺ في صحيح مسلم عند ركوب الدابة أو المركوب.",
  },
  {
    id: "safar-2",
    ...
    virtue: "من قالها قيل له: كُفيتَ ووُقيتَ وتنحّى عنه الشيطان — كما ورد في السنن المعتبرة.",
  },
  {
    id: "nawm-1",
    title: "دعاء النوم",
  ...
  },
  {
    ...
    virtue: "كان النبي ﷺ يقولها عند اشتداد الكرب؛ ذكرٌ يفتح باب التفريج مع حسن الظن بالله.",
  },
  {
    id: "karb-2",
    ...
    virtue: "دعاء كربٍ مأثور؛ يُقال مع اليقين بالله دون الجزم بثوابٍ لم يُنقل بنصٍّ صحيح صريح.",
  },
  {
    id: "karb-3",
    ...
    virtue: "دعاءٌ مشهورٌ في تفريج الهمّ؛ يُذكر مع الإخلاص، ويُرجع في درجة الحديث إلى كتب التخريج.",
  },
  {
    id: "am-1",
    ...
    virtue: "كان النبي ﷺ يكثر من هذا الذكر في يومه؛ جوامع كلمٍ تُقال في سائر الأحوال.",
  },
  {
    id: "am-2",
    ...
    virtue: "كان النبي ﷺ يكثر من هذا الدعاء في أحواله؛ يُداوم عليه بقدر الاستطاعة.",
  },
  {
    id: "jumuah-1",
    ...
    virtue: "من صلّى على النبي ﷺ واحدة صلّى الله عليه بها عشراً — كما في صحيح مسلم.",
  },
  {
    id: "ramadan-1",
    ...
    virtue: "علّمه النبي ﷺ عائشة رضي الله عنها لليالي العشر؛ دعاءٌ موجزٌ عظيم القدر.",
  },
  {
    id: "masjid-1",
  ...
  /* ── أدعية إضافية، الصلاة ── */
  {
    ...
    virtue: "علّمه النبي ﷺ ابن مسعود رضي الله عنه كما يُعلّم السورة من القرآن.",
  },
  {
    id: "salah-6",
  ...
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    virtue: "قالها إبراهيم ﷺ حين أُلقي في النار، وقالها النبي ﷺ عند اشتداد الخوف في الغزو؛ توكلٌ خالص على الله.",
  },
  {
    id: "karb-5",
    ...
    virtue: "من أواخر سورة البقرة؛ قراءتها في الليل ثابتة الفضل في الصحيح، بلا هيئات محدثة.",
  },
  {
    id: "karb-6",
    ...
    virtue: "دعاء كربٍ مأثور؛ يُقال مع اليقين، ويُرجع في ثبوت اللفظ إلى كتب الحديث.",
  },
  /* ── دعاء عام، إضافية ── */
  {
    id: "am-4",
    ...
    virtue: "من جوامع الأدعية في طلب العلم النافع والبركة فيه.",
  },
  {
    id: "am-5",
    title: "دعاء الشفاء",
    ...
    virtue: "ثابت في صحيح البخاري من أدعية النبي ﷺ.",
  },
  {
    id: "am-6",
    ...
    virtue: "من الأدعية الجامعة في طلب الكفاية بالحلال والاستغناء بفضل الله.",
  },
  {
    id: "am-7",
    ...
    virtue: "من جوامع الأدعية في سؤال حسن الخاتمة والثبات على الحق.",
  },
  /* ── أدعية النوم، إضافية ── */
  {
    id: "nawm-3",
    ...
    virtue: "كان النبي ﷺ يداوم عليه كل ليلة قبل النوم.",
  },
  {
    id: "nawm-4",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    virtue: "كان النبي ﷺ يقوله عند القدوم من السفر.",
  },
  {
    id: "safar-4",
    ...
    virtue: "يُشرع عند المبيت؛ مما يُذكر في حفظ البيت والطعام من مشاركة الشيطان إن تُرك ذكر الله.",
  },
  /* ── كرب، إضافية ── */
  {
    id: "karb-7",
    ...
    virtue: "دعاءٌ في تفريج الهمّ؛ يُقال مع الإخلاص، ويُرجع في درجة الحديث إلى أهل التخريج.",
  },
  /* ── مناسبات، إضافية ── */
  {
    id: "hilal-1",
    ...
    virtue: "مما يُروى في استقبال الشهر؛ يُقال مع الإخلاص دون الجزم بثوابٍ زائد لم يثبت.",
  },
  {
    id: "masjid-3",
  ...
  },
  {
    ...
    virtue: "من قالها بعد الوضوء فتحت له أبواب الجنة — كما في مسلم؛ مع الإخلاص.",
  },
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    virtue: "من قاله مساءً لم يضره شيء حتى يصبح إن شاء الله — كما ورد في السنن.",
  },
  {
    id: "masa-2",
  ...
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    virtue: "كان عبد الله بن عمرو رضي الله عنهما يعلّمها من بلغ من أبنائه.",
  },
  {
    id: "nawm-6",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    virtue: "التسمية عند الأكل سنةٌ ثابتة؛ وتُذكر لصرف مشاركة الشيطان كما في الحديث.",
  },
  /* ── الأكل والشرب، إضافية ── */
  {
    id: "akl-5",
    ...
    virtue: "دعاءٌ عند شرب اللبن؛ يُشكر الله على نعمةٍ كانت من طعام النبي ﷺ.",
  },
  {
    id: "akl-6",
    title: "دعاء الإفطار",
  ...
  },
  {
    ...
    virtue: "دعاءٌ عند إفطار الضيف أو الصائم؛ يجمع الشكر والدعاء لصاحب الطعام.",
  },
  /* ── مناسبات، إضافية ── */
  {
    id: "nikah-1",
    ...
    virtue: "دعاءٌ نبويٌّ عند التهنئة بالزواج؛ أهدى من ألفاظ الجاهلية.",
  },
  {
    id: "marid-1",
    ...
    virtue: "كان النبي ﷺ يرقي بها المرضى بما ثبت عنه في السنة.",
  },
  {
    id: "suq-1",
  ...
  },
  {
    ...
    virtue: "يُقال عند الركوب مع الحمد والتهليل والتكبير؛ مما ورد في حفظ المسافر.",
  },
  ...
  },
  {
    ...
    virtue: "من قالها ثلاث مرات حين يمسي لم يضره شيء تلك الليلة إن شاء الله — كما ورد.",
  },
  /* ─── إضافات السفر ─── */
  {
    id: "safar-6",
    ...
    virtue: "يُقال عند توديع المسافر؛ توكلٌ ودعاءٌ بالحفظ لا ضمانٌ بلفظٍ زائد.",
  },
  {
    id: "safar-7",
    ...
    virtue: "من أحسن ما يُقال في توديع المسافر؛ دعاءٌ بالحفظ والكفاية.",
  },
  {
    id: "safar-8",
    ...
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير، في موضعه من السنة",
    virtue: "كان النبي ﷺ يقولها عند رجوعه من السفر.",
  },
  /* ─── إضافات الصلاة ─── */
  {
    id: "salah-7",
  ...
  },
  {
    ...
    virtue: "علّمه النبي ﷺ الحسن بن علي رضي الله عنهما في القنوت.",
  },
  {
    id: "salah-9",
    ...
    virtue: "كان النبي ﷺ يُكثر منه بين السجدتين كما في السنن.",
  },
  {
    id: "salah-10",
    ...
    virtue: "من قالها بعد الصلاة حُطّت خطاياه وإن كانت مثل زبد البحر — كما في مسلم.",
  },
  /* ─── إضافات النوم ─── */
  {
    id: "nawm-7",
    ...
    virtue: "علّمه النبي ﷺ أصحابه كما يُعلّمهم السورة من القرآن.",
  },
  {
    id: "nawm-8",
    ...
    virtue: "الرؤيا الصالحة جزء من ستة وأربعين جزءاً من النبوة — كما في الصحيح.",
  },
  {
    id: "nawm-9",
    ...
    virtue: "عند الرؤيا المكروهة: يتعوّذ ويتفل عن يساره ولا يحدّث بها — كما في السنة.",
  },
  /* ─── إضافات الكرب والهم ─── */
  {
    id: "karb-8",
    ...
    virtue: "دعاءٌ عند الوسوسة والهمّ؛ يُقال مع اليقين بالله.",
  },
  {
    id: "karb-9",
    ...
    virtue: "جامعٌ للاستعاذة من الهمّ والعجز والجبن والبخل وغلبة الدين.",
  },
  {
    id: "karb-10",
    ...
    virtue: "دعاء كربٍ يقوم على التوحيد؛ يُقال مع حسن الظن بالله.",
  },
  /* ─── إضافات الدعاء العام ─── */
  {
    id: "du-8",
    ...
    virtue: "كان النبي ﷺ يُكثر من هذا الدعاء في يومه وليلته.",
  },
  {
    id: "du-9",
    ...
    virtue: "قالها إبراهيم ﷺ عند إلقائه في النار، وقالها النبي ﷺ يوم قيل: إن الناس قد جمعوا لكم فاخشوهم",
  },
  {
    id: "du-10",
    ...
    virtue: "كان ﷺ يقوله في السجود؛ من أجلّ الأدعية المأثورة.",
  },
  /* ── الأكل والشرب ── */
  {
    id: "akl-12",
  ...
  },
  {
    ...
    virtue: "دعاءٌ جامعٌ للشكر على الطعام وعلى نعمة الإسلام.",
  },
  {
    id: "akl-8",
    ...
    virtue: "دعاءٌ لصاحب الطعام يجمع الثناء والبركة.",
  },
  /* ── السفر ── */
  {
    id: "safar-10",
    ...
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير، في موضعه من السنة",
    virtue: "كان النبي ﷺ يقوله كلما رجع من سفره.",
  },
  {
    id: "safar-11",
    ...
    virtue: "يُقال عند وداع الأهل قبل السفر؛ استحفاظٌ بهم عند الله.",
  },
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    virtue: "يُقال صباحاً ومساءً للحفظ؛ مع التوكل على الله بلا غلو.",
  },
  {
    id: "sabah-10",
    ...
    virtue: "قال ﷺ: لم يُسأل الله شيء أحبّ إليه من العافية — كما ورد.",
  },
  {
    id: "sabah-11",
    ...
    virtue: "ذكرٌ جامعٌ يُفتتح به اليوم بتوحيد الله وحمده.",
  },
  /* ─── النوم واليقظة — إضافي ─── */
  {
    id: "nawm-10",
    ...
    virtue: "يُقال عند اليقظة من النوم؛ ذكرٌ يطرد الفزع ويذكّر بالله.",
  },
  {
    id: "nawm-11",
    ...
    virtue: "من أدعية النبي ﷺ عند قيام الليل والتهجد.",
  },
  /* ─── الكرب والهم — إضافي ─── */
  {
    id: "karb-11",
    ...
    virtue: "كان النبي ﷺ يدعو بهذا عند الكرب؛ ذكرٌ لعظمة الله يفتح باب التفريج.",
  },
  /* ─── الصلاة — إضافي ─── */
  {
    id: "salah-11",
    ...
    virtue: "من دعاء النبي ﷺ حين يقوم إلى صلاة الليل؛ يجمع الحمد والتوحيد.",
  },
  /* ─── السفر — إضافي ─── */
  {
    id: "safar-9",
    ...
    virtue: "دعاءٌ قرآني (الزخرف: ١٣–١٤) عند الركوب؛ يذكّر بنعمة التسخير وبالآخرة.",
  },
  /* ─── الدعاء العام — إضافي ─── */
  {
    id: "du-11",
    ...
    virtue: "دعاءٌ يجمع سؤال هداية القلب والتقوى وعفة النفس والاستغناء عن الناس.",
  },
  /* ─── الأكل والشرب — إضافي ─── */
  {
    id: "akl-9",
    ...
    virtue: "من قاله بعد الطعام غُفر له ما تقدّم من ذنبه — كما ورد؛ مع الإقرار بأن الرزق من الله.",
  },
];
...
export default function DuasPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "أدعية مأثورة للصباح والمساء والصلاة والسفر والكرب، مع المعنى والمصدر وبيان الفضل دون مبالغة",
