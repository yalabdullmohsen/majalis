...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "دعاء جامع لخيري الدنيا والآخرة مع الاستعاذة من النار",
  ...
  },
  {
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "دعاء ذي النون عند الكرب: توحيد وتنزيه وإقرار بالتقصير",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "استيداع المسافر عند الله؛ توكل بأن ودائع الله لا تضيع",
  ...
  },
  {
    ...
    meaning: "دعاء بين السجدتين: تكرار طلب المغفرة في موضع ذلّ وخضوع",
