...
const DUAS: DuaEntry[] = [
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك، وأنا على عهدك ووعدك ما استطعت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب",
    source: "صحيح البخاري",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "آية الكرسي، سيدة آي القرآن — فائدة الدعاء",
  ...
  },
  {
    ...
    meaning: "سبحانك اللهم وبحمدك، وتبارك اسمك، وتعالى جدك، ولا إله غيرك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
  ...
  },
  {
    ...
    meaning: "سبحان ربي العظيم، تسبيح في الركوع — فائدة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "سبحان ربي الأعلى، تسبيح في السجود — فائدة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "بسم الله، تسمية عند بدء الطعام — فائدة",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخّر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "صحيح مسلم",
    category: "السفر",
  ...
  },
  {
    ...
    meaning: "باسمك اللهم أموت وأحيا — فائدة الدعاء وفضله",
    source: "صحيح البخاري",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "متفق عليه",
  ...
  },
  {
    ...
    meaning: "اللهم إني عبدك وابن عبدك، ناصيتي بيدك، ماضٍ فيَّ حكمك، عدلٌ فيَّ قضاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع",
  ...
  },
  {
    ...
    meaning: "ربنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
  ...
  },
  {
    ...
    meaning: "يا مقلب القلوب ثبت قلبي على دينك — فائدة",
  ...
  },
  {
    ...
    meaning: "اللهم صلّ على محمد وعلى آل محمد كما صليت على إبراهيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إنك عفو تحب العفو فاعف عني — فائدة",
    source: "صحيح الترمذي",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم افتح لي أبواب رحمتك — فائدة الدعاء",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك من فضلك — فائدة الدعاء وفضله",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، دعاء الجلسة بين السجدتين — فائدة",
  ...
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    meaning: "حسبنا الله ونعم الوكيل — فائدة الدعاء وفضله",
  ...
  },
  {
    ...
    meaning: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا — فائدة",
    source: "البقرة: 286",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين، دعاء ذي النون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
  ...
  /* ── دعاء عام، إضافية ── */
  {
    ...
    meaning: "اللهم انفعني بما علمتني وعلمني ما ينفعني وزدني علماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس اشفه وأنت الشافي لا شفاء إلا شفاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "متفق عليه",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم اجعل خير عمري آخره وخير عملي خواتيمه وخير أيامي يوم ألقاك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "صحيح الجامع",
    category: "الدعاء العام",
  ...
  /* ── أدعية النوم، إضافية ── */
  {
    ...
    meaning: "المعوذتان والإخلاص ثلاثاً، ثم ينفث في الكفين ويمسح الجسد — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    meaning: "آيبون تائبون عابدون لربنا حامدون — فائدة",
    source: "متفق عليه",
    category: "السفر",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك خير المولج وخير المخرج، دعاء دخول البيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
    source: "سنن أبي داود، صحيح",
    category: "السفر",
  ...
  /* ── كرب، إضافية ── */
  {
    ...
    meaning: "دعاء جامع لإزالة الهم والحزن بالتوسل بأسماء الله الحسنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "اللهم أهل علينا هذا الهلال بالأمن والإيمان والسلامة والإسلام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "سنن الترمذي، حسن",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أشهد أن لا إله إلا الله وحده لا شريك له وأشهد أن محمداً عبده ورسوله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أمسينا وأمسى الملك لله، والحمد لله لا شريك له، دعاء جامع لمساء المسلم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من غضبه وعقابه وشر عباده ومن همزات الشياطين وأن يحضرون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله الواحد القهار رب السماوات والأرض وما بينهما العزيز الغفار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة،",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "بسم الله في أوله وآخره، يقولها من نسي التسمية في بداية طعامه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "اللهم بارك لنا فيه وزدنا منه — فائدة الدعاء",
  ...
  },
  {
    ...
    meaning: "اللهم لك صمت وعلى رزقك أفطرت — فائدة الدعاء",
  ...
  },
  {
    ...
    meaning: "أفطر عندكم الصائمون وأكل طعامكم الأبرار وصلت عليكم الملائكة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس واشفه أنت الشافي لا شفاء إلا شفاؤك شفاءً لا يترك سقماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله وحده لا شريك له، له الملك وله الحمد يحيي ويميت وهو حي لا يموت، بيده الخير وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
    source: "سنن الترمذي، صحيح",
    category: "المناسبات",
  ...
  /* ─── إضافات الصباح والمساء ─── */
  {
    ...
    meaning: "اللهم إني أسألك علماً نافعاً ورزقاً طيباً وعملاً متقبلاً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "أستودعك الله الذي لا تضيع ودائعه — فائدة",
  ...
  /* ─── إضافات الصلاة ─── */
  {
    ...
    meaning: "اللهم باعد بيني وبين خطاياي كما باعدت بين المشرق والمغرب، اللهم نقني من الخطايا كما يُنقى الثوب الأبيض من الدنس؛ فائدة الدعاء وفضله في",
  ...
  },
  {
    ...
    meaning: "اللهم اهدني فيمن هديت، وعافني فيمن عافيت، وتولني فيمن توليت، وبارك لي فيما أعطيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، رب اغفر لي — فائدة الدعاء وفضله",
  ...
  /* ─── إضافات النوم ─── */
  {
    ...
    meaning: "اللهم إني أستخيرك بعلمك وأستقدرك بقدرتك وأسألك من فضلك العظيم، فإنك تقدر ولا أقدر وتعلم ولا أعلم وأنت علام الغيوب؛ فائدة الدعاء وفضله في",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي بنعمته تتم الصالحات — فائدة",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم — فائدة الدعاء",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من الهم والحزن والعجز والكسل والجبن والبخل وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم، لا إله إلا الله رب السماوات ورب الأرض ورب العرش الكريم؛ فائدة الدعاء وفضله",
  ...
  /* ─── إضافات الدعاء العام ─── */
  {
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "يا مقلِّب القلوب ثبِّت قلبي على دينك — فائدة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ برضاك من سخطك وبمعافاتك من عقوبتك وأعوذ بك منك، لا أحصي ثناءً عليك أنت كما أثنيت على نفسك؛ فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "أكل طعامكم الأبرار وصلّت عليكم الملائكة وأفطر عندكم الصائمون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة",
  ...
  /* ── السفر ── */
  {
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "راجعون تائبون عابدون لربنا حامدون — فائدة",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر",
  ...
  },
  {
    ...
    meaning: "أودعكم الله الذي لا تضيع ودائعه — فائدة",
  ...
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    meaning: "اللهم أعوذ بك من الهم والحزن، والعجز والكسل، والجبن والبخل، وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب",
    source: "البخاري: ٦٣٦٩",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع",
    source: "مسلم: ٢٧٢٣",
    category: "الصباح والمساء",
  ...
  /* ─── الصلاة — إضافي ─── */
  {
    ...
    meaning: "اللهم لك الحمد أنت نور السماوات والأرض ومن فيهن، ولك الحمد أنت قيوم السماوات والأرض ومن فيهن، ولك الحمد أنت الحق ووعدك الحق؛ فائدة الدعاء",
  ...
  /* ─── الأكل والشرب — إضافي ─── */
  {
    ...
    meaning: "الحمد لله الذي أطعمني هذا ورزقنيه من غير حول مني ولا قوة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق",
