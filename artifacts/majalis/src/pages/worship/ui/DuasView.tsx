...
const ADHKAR_QUICK_LINKS = [
  { href: "/adhkar/morning", label: "أذكار الصباح" },
  { href: "/adhkar/evening", label: "أذكار المساء" },
  { href: "/adhkar/sleep", label: "أذكار النوم" },
  { href: "/adhkar/after-salah", label: "بعد الصلاة" },
  { href: "/adhkar/travel", label: "السفر" },
  { href: "/adhkar/distress", label: "الكرب" },
] as const;
...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك، وأنا على عهدك ووعدك ما استطعت، أعوذ بك من شر ما صنعت، أبوء لك بنعمتك علي وأبوء بذنبي فاغفر لي فإنه لا يغفر الذنوب إلا أنت",
    source: "صحيح البخاري",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "الله لا إله إلا هو الحي القيوم، لا تأخذه سنة ولا نوم، له ما في السماوات وما في الأرض",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من عذاب جهنم، ومن عذاب القبر، ومن فتنة المحيا والممات، ومن شر فتنة المسيح الدجال",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  {
    id: "akl-3",
    title: "حمد بعد الطعام والشراب",
    arabic: "الْحَمْدُ لِلَّهِ الَّذِي أَطْعَمَنَا وَسَقَانَا وَجَعَلَنَا مُسْلِمِينَ",
    transliteration: "Al-hamdu lillahil-ladhi at'amana wa saqana wa ja'alana muslimin",
    meaning: "الحمد لله الذي أطعمنا وسقانا وجعلنا مسلمين",
    source: "سنن أبي داود والترمذي — حسّنه أهل العلم",
    category: "الأكل والشرب",
    occasion: "بعد الطعام والشراب",
  },
  {
    id: "safar-1",
  ...
  },
  {
    ...
    source: "أحمد ٣٧١٢ — صححه الألباني في صحيح الجامع ٣٣٨٨",
    category: "الكرب والهم",
  ...
  /* ── أدعية إضافية، الصلاة ── */
  {
    ...
    meaning: "التحيات لله والصلوات والطيبات، السلام على النبي ورحمة الله وبركاته، السلام علينا وعلى عباد الله الصالحين، أشهد أن لا إله إلا الله وأشهد أن محمدًا عبده ورسوله",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا، ربنا ولا تحمل علينا إصرًا كما حملته على الذين من قبلنا",
    source: "البقرة: 286",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    meaning: "أمسينا وأمسى الملك لله، والحمد لله لا شريك له، لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير، رب أسألك خير ما في هذه الليلة وخير ما بعدها، وأعوذ بك من شر ما في هذه الليلة وشر ما بعدها",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    source: "الترمذي ٣٤٢٨ وابن ماجه — ضعّفه الألباني؛ فلا يُتّخذ ذكراً ثابتاً بجزاءٍ مضمون",
    category: "المناسبات",
    occasion: "يُذكر مع بيان ضعفه عند دخول الأسواق؛ والاستغفار والتسبيح الثابتان يغنيان",
    virtue: "اللفظ مشهور لكن إسناده ضعيف عند جمع من المحققين؛ لا يُبنى عليه ثواب «ألف ألف» مضمون",
  },
  {
    id: "rukub-1",
  ...
  },
  {
    ...
    meaning: "اللهم اهدني فيمن هديت، وعافني فيمن عافيت، وتولني فيمن توليت، وبارك لي فيما أعطيت، وقني شر ما قضيت، فإنك تقضي ولا يُقضى عليك، وإنه لا يذل من واليت، تباركت ربنا وتعاليت",
  ...
  },
  {
    ...
    meaning: "اللهم رب جبريل وميكائيل وإسرافيل، فاطر السماوات والأرض، عالم الغيب والشهادة، أنت تحكم بين عبادك فيما كانوا فيه يختلفون، اهدني لما اختلف فيه",
    source: "مسلم: ٧٧٠",
    category: "النوم واليقظة",
...
export default function DuasPage() {
  ...
  return (
    <PageShell className="duas-page">
      ...
      <nav className="duas-adhkar-rail" aria-label="أذكار حسب الموقف">
        <span className="duas-adhkar-rail__label">أذكار حسب الموقف:</span>
        {ADHKAR_QUICK_LINKS.map((item) => (
          <Link key={item.href} href={item.href} className="duas-adhkar-rail__link">
            {item.label}
          </Link>
        ))}
      </nav>
