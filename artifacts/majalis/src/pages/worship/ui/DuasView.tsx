...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "دعاء الاستفتاح: تسبيح وحمد وتعظيم لاسم الله مع إفراد الألوهية",
  ...
  },
  {
    ...
    meaning: "تسبيح الركوع: تنزيه الله بالعظمة في هيئة الخضوع أثناء الصلاة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    virtue: "ثابت عن النبي ﷺ في صحيح مسلم عند الركوب، ويُذكر لله لا للرياء",
  },
  {
    id: "safar-2",
    ...
    meaning: "دعاء الخروج: تسمية وتوكّل واستعانة بالله عند مغادرة البيت",
  ...
  },
  {
    ...
    meaning: "دعاء الاستيقاظ: حمد على الحياة بعد النوم مع تذكّر البعث",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  },
  {
    ...
    meaning: "دعاء الكرب الأعظم: توحيد وتعظيم لله رب العرش عند شدة الهم",
    source: "متفق عليه",
    category: "الكرب والهم",
    occasion: "عند اشتداد الكرب والضيق والحاجة إلى الفرج",
    virtue: "كان النبي ﷺ يقولها عند اشتداد الكرب، ويُذكر لله لا للرياء",
  },
  {
    id: "karb-2",
    ...
    meaning: "دعاء يونس: توحيد وتنزيه واعتراف بالظلم على النفس عند الكرب",
    source: "الأنبياء: 87",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    meaning: "دعاء جامع يطلب حسنتي الدنيا والآخرة مع الوقاية من عذاب النار",
    source: "البقرة: 201، متفق عليه",
    category: "الدعاء العام",
    occasion: "يُقال في أي وقت من ليل أو نهار",
    virtue: "كان النبي ﷺ يكثر من هذا الذكر في يومه، ويُذكر لله لا للرياء",
  },
  {
    id: "am-2",
  ...
  },
  {
    ...
    virtue: "ثابت في صحيح البخاري من أدعية النبي ﷺ، ويُذكر لله لا للرياء",
  },
  {
    id: "am-6",
    ...
    meaning: "سؤال الكفاية بالحلال عن الحرام، والاستغناء بفضل الله عن الخلق",
    source: "سنن الترمذي، حسن",
    category: "الدعاء العام",
    occasion: "عند الضيق المادي وطلب الرزق الحلال",
    virtue: "من الأدعية الجامعة في طلب سعة الرزق الحلال، مع حسن التوكل",
  },
  {
    id: "am-7",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    virtue: "كان النبي ﷺ يقوله عند القدوم من السفر، ويُذكر لله لا للرياء",
  },
  {
    id: "safar-4",
    ...
    virtue: "من فوائده طرد الشيطان عن المبيت والطعام، ويُذكر لله لا للرياء",
  },
  /* ── كرب، إضافية ── */
  {
    id: "karb-7",
  ...
  },
  {
    ...
    meaning: "تشميت العاطس: يُقال «يرحمك الله» بعد أن يحمد العاطس ربه",
    source: "صحيح البخاري",
    category: "المناسبات",
  ...
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    meaning: "استعاذة بكلمات الله التامات من شرّ كل مخلوق؛ من أذكار المساء",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "دعاء اللبن أو الشراب: طلب البركة والزيادة في الرزق المباح",
  ...
  },
  {
    ...
    meaning: "دعاء الإفطار: يُقرّ أن الصيام لله وأن الإفطار من رزقه سبحانه",
  ...
  },
  {
    ...
    virtue: "كان النبي ﷺ يرقي بها المرضى بما ثبت عنه، ويُذكر لله لا للرياء",
  },
  {
    id: "suq-1",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "استيداع المسافر عند الله مع التوكل بأن ودائعه سبحانه لا تضيع",
  ...
  },
  {
    ...
    virtue: "من أفضل ما يُقال في توديع المسافر، ويُحرص عليه مع الإخلاص",
  },
  {
    id: "safar-8",
  ...
  },
  {
    ...
    meaning: "بين السجدتين يُكرر طلب المغفرة في موضع ذلّ وخضوع بين يدي الله",
  ...
  },
  {
    ...
    meaning: "استعاذة من الشيطان ومن شرّ الرؤيا المكروهة عند الاستيقاظ منها",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    meaning: "الاستعاذة بالله من الشيطان الرجيم عند الوسوسة أو بدء القراءة",
  ...
  /* ── السفر ── */
  {
    ...
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير",
    virtue: "كان النبي ﷺ يقوله كلما رجع من سفره، ويُذكر لله لا للرياء",
  },
  {
    id: "safar-11",
  ...
  },
  {
    ...
    virtue: "من أدعية النبي ﷺ عند قيام الليل والتهجد، ويُذكر لله لا للرياء",
  },
  /* ─── الكرب والهم — إضافي ─── */
  {
    id: "karb-11",
  ...
  /* ─── الدعاء العام — إضافي ─── */
  {
    ...
    meaning: "سؤال الهدى والتقوى والعفاف والغنى؛ جوامع خير الدين والدنيا",
    source: "مسلم: ٢٧٢١",
    category: "الدعاء العام",
