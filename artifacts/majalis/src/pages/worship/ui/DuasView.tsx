...
const DUAS: DuaEntry[] = [
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
    occasion: "يُقال صباحًا ضمن أوراد اليوم، ضمن أذكار اليوم والليلة",
    virtue: "من أذكار الصباح الجامعة لتوحيد الله وحمده، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "sabah-2",
    ...
    source: "صحيح البخاري",
    category: "الصباح والمساء",
    occasion: "سيد الاستغفار، صباحاً ومساءً، ضمن أذكار اليوم والليلة",
    virtue: "من قالها إيماناً وهو موقن بها صباحاً فمات في يومه دخل الجنة، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "masa-1",
    ...
    category: "الصباح والمساء",
    occasion: "مساءً، ويُستحب بعد الفرائض ضمن الأذكار الراتبة، في موضعه من السنة",
    virtue: "من قرأها في ليلة لم يزل عليه من الله حافظ ولا يقربه شيطان حتى يصبح، مع ملازمة الإخلاص",
  },
  {
    id: "salah-1",
    ...
    meaning: "دعاء الاستفتاح: تسبيح وحمد وتعظيم لاسم الله مع إفراد الألوهية، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود، صحيح",
    category: "الصلاة",
    occasion: "في بداية الصلاة بعد تكبيرة الإحرام، في موضعها من الصلاة",
  },
  {
    id: "salah-2",
    title: "دعاء الركوع",
    ...
    meaning: "تسبيح الركوع: تنزيه الله بالعظمة في هيئة الخضوع أثناء الصلاة، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "متفق عليه",
    category: "الصلاة",
    occasion: "يقال في الركوع ثلاث مرات على الأقل، في موضعها من الصلاة",
  },
  {
    id: "salah-3",
    title: "دعاء السجود",
    ...
    meaning: "تسبيح السجود: تنزيه الله بوصف العلو وهو أقرب ما يكون العبد من ربه، بمعناه الظاهر بلا تكلّف",
    source: "متفق عليه",
    category: "الصلاة",
    occasion: "يقال في السجود ثلاث مرات على الأقل، في موضعها من الصلاة",
  },
  {
    id: "salah-4",
    ...
    source: "متفق عليه",
    category: "الصلاة",
    occasion: "في الصلاة بعد التشهد وقبل السلام، في موضعها من الصلاة",
    virtue: "أوصى النبي ﷺ أصحابه بهذا الدعاء بعد التشهد، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "akl-1",
    ...
    meaning: "يُسمّي الآكل باسم الله عند بدء الطعام؛ أدب شرعي يُبارك فيه الطعام ويُصرف الشيطان",
    source: "صحيح مسلم",
    category: "الأكل والشرب",
    occasion: "عند بدء تناول الطعام قبل اللقمة الأولى، شكرًا لله على النعمة",
    virtue: "الأمر بالتسمية عند الأكل كما في حديث مسلم، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "akl-2",
    ...
    meaning: "حمد بعد الطعام: يشكر الله على الإطعام والسقاية وعلى نعمة الإسلام، بمعناه الظاهر بلا تكلّف",
    source: "سنن الترمذي، صحيح",
    category: "الأكل والشرب",
    occasion: "عند الفراغ من الطعام شكرًا لله، في موضعه من السنة",
  },
  {
    id: "akl-3",
    ...
    category: "الأكل والشرب",
    occasion: "بعد الطعام والشراب عند تمام النعمة، شكرًا لله على النعمة",
  },
  {
    id: "safar-1",
    ...
    meaning: "تكبير وتسبيح عند الركوب: إقرار بتسخير المركوب والرجوع إلى الله، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم",
    category: "السفر",
    occasion: "عند ركوب الدابة أو السيارة أو الطائرة للسفر، طلبًا للحفظ والتيسير",
    virtue: "ثابت عن النبي ﷺ في صحيح مسلم عند الركوب، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "safar-2",
    ...
    meaning: "دعاء الخروج: تسمية وتوكّل واستعانة بالله عند مغادرة البيت، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود والترمذي",
    category: "السفر",
    occasion: "عند الخروج من المنزل إلى حاجة أو عمل، في موضعه من السنة",
    virtue: "من قالها قيل له: كُفيتَ ووُقيتَ وتنحّى عنه الشيطان، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-1",
    title: "دعاء النوم",
    ...
    meaning: "باسمك اللهم أموت وأحيا: تفويض للنوم واليقظة إلى الله، مع استحضار أن الحياة والموت بيده",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "عند الاستلقاء للنوم قبل غلبة النعاس، من أذكار اليوم والليلة",
  },
  {
    id: "nawm-2",
    ...
    meaning: "دعاء الاستيقاظ: حمد على الحياة بعد النوم مع تذكّر البعث، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من النوم في أول اليقظة، من أذكار اليوم والليلة",
  },
  {
    id: "karb-1",
    ...
    meaning: "دعاء الكرب الأعظم: توحيد وتعظيم لله رب العرش عند شدة الهم، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "متفق عليه",
    category: "الكرب والهم",
    occasion: "عند اشتداد الكرب والضيق والحاجة إلى الفرج، مع حسن الظن بالله",
    virtue: "كان النبي ﷺ يقولها عند اشتداد الكرب، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "karb-2",
    ...
    meaning: "دعاء يونس: توحيد وتنزيه واعتراف بالظلم على النفس عند الكرب، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "الأنبياء: 87",
    category: "الكرب والهم",
    occasion: "في أوقات الضيق والكرب وما شابهها من الهم، مع حسن الظن بالله",
    virtue: "ما دعا بها مكروب إلا فرّج الله عنه كما جاء في الأثر، ويُذكر لله لا للرياء",
  },
  {
    id: "karb-3",
    ...
    category: "الكرب والهم",
    occasion: "عند الهم والحزن وطلب تفريج الصدر، مع حسن الظن بالله",
    virtue: "ما أصاب عبداً قط هم ولا حزن فقالها إلا أذهب الله همه وأبدله فرحاً، مع ملازمة الإخلاص",
  },
  {
    id: "am-1",
    ...
    meaning: "دعاء جامع يطلب حسنتي الدنيا والآخرة مع الوقاية من عذاب النار، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "البقرة: 201، متفق عليه",
    category: "الدعاء العام",
    occasion: "يُقال في أي وقت من ليل أو نهار، في موضعه من السنة",
    virtue: "كان النبي ﷺ يكثر من هذا الذكر في يومه، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "am-2",
    ...
    meaning: "دعاء ثبات: يطلب من الله — مقلّب القلوب — تثبيت القلب على دينه عند الفتن والضعف",
    source: "الترمذي ٢١٤٠ — صححه الألباني",
    category: "الدعاء العام",
    occasion: "في أي وقت، ويُؤكَّد في أوقات الفتن، في موضعه من السنة",
    virtue: "كان النبي ﷺ يكثر من هذا الدعاء في أحواله، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "jumuah-1",
    ...
    meaning: "الصلاة الإبراهيمية: سؤال الصلاة على النبي ﷺ وآله كما صُلي على إبراهيم",
    source: "متفق عليه",
    category: "المناسبات",
    occasion: "يوم الجمعة والإكثار من الصلاة على النبي ﷺ، في موضعها من الصلاة",
    virtue: "من صلّى على النبي ﷺ واحدة صلّى الله عليه بها عشراً، ويُذكر لله لا للرياء",
  },
  {
    id: "ramadan-1",
    ...
    meaning: "سؤال العفو من الله في ليالي الفضل؛ يقرّ بأن الله عفوّ يحب العفو ويسأل الصفح عن الذنوب",
    source: "صحيح الترمذي",
    category: "المناسبات",
    occasion: "في ليالي رمضان خاصةً ليلة القدر، في موضعه من السنة",
    virtue: "علّمه النبي ﷺ لعائشة رضي الله عنها في الدعاء، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "masjid-1",
    ...
    meaning: "دعاء دخول المسجد: يسأل الله أن يفتح له أبواب رحمته عند دخول بيته، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم",
    category: "المناسبات",
    occasion: "عند دخول المسجد مع تقديم القدم اليمنى، أدبًا مع بيوت الله",
  },
  {
    id: "masjid-2",
    ...
    meaning: "عند الخروج من المسجد يسأل العبد ربه من فضله بعد الفراغ من الصلاة، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم",
    category: "المناسبات",
    occasion: "عند الخروج من المسجد مع تقديم القدم اليسرى، أدبًا مع بيوت الله",
  },
  /* ── أدعية إضافية، الصلاة ── */
  {
    id: "salah-5",
    ...
    source: "متفق عليه",
    category: "الصلاة",
    occasion: "في الجلسة الوسطى والأخيرة في الصلاة، في موضعها من الصلاة",
    virtue: "علّمه النبي ﷺ ابن مسعود رضي الله عنه كالسورة من القرآن، ويُذكر لله لا للرياء",
  },
  {
    id: "salah-6",
    ...
    meaning: "دعاء الجلسة بين السجدتين: طلب المغفرة في موضع ذلّ بين السجدتين، بمعناه الظاهر بلا تكلّف",
    source: "سنن ابن ماجه، صحيح",
    category: "الصلاة",
    occasion: "في الجلسة بين السجدتين أثناء الصلاة، في موضعها من الصلاة",
  },
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    meaning: "حسبنا الله ونعم الوكيل: توكل كامل على الله عند الخوف أو الهم أو مواجهة العدو",
    source: "صحيح البخاري، آل عمران: 173",
    category: "الكرب والهم",
    occasion: "عند الخوف والشدة وطلب الحفظ من الله، في موضعه من السنة",
    virtue: "قالها إبراهيم ﷺ حين أُلقي في النار، وقالها النبي ﷺ في غزوة أحد، مع ملازمة الإخلاص",
  },
  {
    id: "karb-5",
    ...
    source: "البقرة: 286",
    category: "الكرب والهم",
    occasion: "عند الخطأ أو النسيان مع طلب العفو من الله، في موضعه من السنة",
    virtue: "من آخر آيات سورة البقرة التي تُقرأ لدرء الكوارث، ويُذكر لله لا للرياء",
  },
  {
    id: "karb-6",
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "دعاء ذي النون في الكرب: توحيد لله وتنزيهه مع الاعتراف بالتقصير، بمعناه الظاهر بلا تكلّف",
    source: "الأنبياء: 87، صحيح الترمذي",
    category: "الكرب والهم",
    occasion: "عند الضيق وطلب رفع البلاء والكرب، مع حسن الظن بالله",
    virtue: "ما دعا بها مكروب قط إلا استجاب الله له كما ورد، ويُذكر لله لا للرياء",
  },
  /* ── دعاء عام، إضافية ── */
  {
    id: "am-4",
    ...
    meaning: "دعاء طالب العلم: نفع العلم، وطلب المزيد مما ينفع في الدنيا والآخرة، بمعناه الظاهر بلا تكلّف",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
    occasion: "بعد الانتهاء من الدراسة أو القراءة، في موضعه من السنة",
    virtue: "من جوامع الأدعية في طلب العلم النافع والبركة فيه، مع حسن التوكل، مع ملازمة الإخلاص",
  },
  {
    id: "am-5",
    title: "دعاء الشفاء",
    ...
    meaning: "اللهم رب الناس أذهب البأس اشفه وأنت الشافي لا شفاء إلا شفاؤك، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "متفق عليه",
    category: "الدعاء العام",
    occasion: "عند زيارة المريض أو رقيته بما ثبت، في موضعه من السنة",
    virtue: "ثابت في صحيح البخاري من أدعية النبي ﷺ، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "am-6",
    ...
    meaning: "سؤال الكفاية بالحلال عن الحرام، والاستغناء بفضل الله عن الخلق، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن الترمذي، حسن",
    category: "الدعاء العام",
    occasion: "عند الضيق المادي وطلب الرزق الحلال، مع حسن الظن بالله",
    virtue: "من الأدعية الجامعة في طلب سعة الرزق الحلال، مع حسن التوكل، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "am-7",
    ...
    meaning: "اللهم اجعل خير عمري آخره وخير عملي خواتيمه وخير أيامي يوم ألقاك، بمعناه الظاهر بلا تكلّف",
    source: "صحيح الجامع",
    category: "الدعاء العام",
    occasion: "في أي وقت، ويُستحب خصوصًا عند المساء، ضمن أذكار اليوم والليلة",
    virtue: "من جوامع الأدعية في سؤال حسن الخاتمة والثبات، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  /* ── أدعية النوم، إضافية ── */
  {
    id: "nawm-3",
    ...
    meaning: "المعوذتان والإخلاص ثلاثاً، ثم ينفث في الكفين ويمسح الجسد، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "قبل النوم: اقرأها في كفيك وانفث ثم امسح ما استطعت من جسدك، من أذكار اليوم والليلة",
    virtue: "كان النبي ﷺ يداوم عليه كل ليلة قبل النوم، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "nawm-4",
    ...
    source: "صحيح البخاري",
    category: "النوم واليقظة",
    occasion: "أول ما يُقال فور الاستيقاظ من النوم، من أذكار اليوم والليلة",
  },
  /* ── السفر، إضافية ── */
  {
    id: "safar-3",
    ...
    meaning: "دعاء الرجوع من السفر: إقرار بالرجوع والتوبة والعبادة والحمد لله على السلامة",
    source: "متفق عليه",
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير، في موضعه من السنة",
    virtue: "كان النبي ﷺ يقوله عند القدوم من السفر، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "safar-4",
    ...
    meaning: "اللهم إني أسألك خير المولج وخير المخرج، دعاء دخول البيت، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود، صحيح",
    category: "السفر",
    occasion: "عند دخول البيت، التسمية واجبة، في موضعه من السنة",
    virtue: "من فوائده طرد الشيطان عن المبيت والطعام، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  /* ── كرب، إضافية ── */
  {
    id: "karb-7",
    ...
    meaning: "دعاء جامع لإزالة الهم والحزن بالتوسل بأسماء الله الحسنى، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "مسند أحمد، صحيح ابن حبان",
    category: "الكرب والهم",
    occasion: "عند الحزن الشديد والهموم المتراكمة، مع حسن الظن بالله",
    virtue: "ما أصاب أحداً قط همٌّ ولا حزن فقالها إلا أذهب الله همه وحزنه، مع ملازمة الإخلاص وترك الرياء",
  },
  /* ── مناسبات، إضافية ── */
  {
    id: "hilal-1",
    ...
    meaning: "اللهم أهل علينا هذا الهلال بالأمن والإيمان والسلامة والإسلام، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن الترمذي، حسن",
    category: "المناسبات",
    occasion: "عند رؤية هلال كل شهر هجري، في موضعه من السنة",
    virtue: "إحياء سنة النبي ﷺ في استقبال الشهر الجديد بالدعاء، ويُذكر لله لا للرياء",
  },
  {
    id: "masjid-3",
    ...
    meaning: "تشميت العاطس: يُقال «يرحمك الله» بعد أن يحمد العاطس ربه، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "صحيح البخاري",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أشهد أن لا إله إلا الله وحده لا شريك له وأشهد أن محمداً عبده ورسوله، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم",
    category: "المناسبات",
    occasion: "بعد الانتهاء من الوضوء، بعد تمام الطهارة، في موضعه من السنة",
    virtue: "من قالها فتحت له أبواب الجنة الثمانية يدخل من أيها شاء، ويُذكر لله لا للرياء",
  },
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    meaning: "استعاذة بكلمات الله التامات من شرّ كل مخلوق؛ من أذكار المساء، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
    occasion: "يقولها ثلاثاً حين يمسي كل يوم، في موضعه من السنة",
    virtue: "من قاله مساءً لم يضره شيء حتى يصبح إن شاء الله، ويُذكر لله لا للرياء",
  },
  {
    id: "masa-2",
    ...
    source: "صحيح مسلم",
    category: "الصباح والمساء",
    occasion: "يقوله مساءً — وفي الصباح يقول: أصبحنا وأصبح الملك لله، ضمن أذكار اليوم والليلة",
  },
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    category: "النوم واليقظة",
    occasion: "عند الفزع من النوم، من أذكار اليوم والليلة، في موضعه من السنة",
    virtue: "كان عبد الله بن عمرو يعلمها من بلغ من أبنائه، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "nawm-6",
    ...
    category: "النوم واليقظة",
    occasion: "عند التقلب في الفراش وتعذّر النوم، من أذكار اليوم والليلة",
  },
  /* ── الأكل والشرب، إضافية ── */
  {
    id: "akl-4",
    ...
    meaning: "بسم الله في أوله وآخره، يقولها من نسي التسمية في بداية طعامه، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود، سنن الترمذي، حسن صحيح",
    category: "الأكل والشرب",
    occasion: "إذا نسي التسمية في أول الطعام قالها في أثنائه، شكرًا لله على النعمة",
    virtue: "تسمية الله تحرم الشيطان من مشاركة الطعام، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  /* ── الأكل والشرب، إضافية ── */
  {
    id: "akl-5",
    ...
    meaning: "دعاء اللبن أو الشراب: طلب البركة والزيادة في الرزق المباح، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود والترمذي، صحيح",
    category: "الأكل والشرب",
    occasion: "يقوله بعد شرب اللبن خاصةً، شكراً لله على النعمة، في موضعه من السنة",
  ...
  },
  {
    ...
    meaning: "دعاء الإفطار: يُقرّ أن الصيام لله وأن الإفطار من رزقه سبحانه، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود، حسن",
    category: "الأكل والشرب",
    occasion: "عند الإفطار من صوم رمضان أو غيره، في موضعه من السنة",
    virtue: "يجمع الإخلاص وشكر النعمة وتمجيد المنعم في جملة واحدة، ويُذكر لله لا للرياء",
  },
  {
    id: "akl-7",
    ...
    meaning: "أفطر عندكم الصائمون وأكل طعامكم الأبرار وصلت عليكم الملائكة، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "سنن أبي داود وابن ماجه، صحيح",
    category: "الأكل والشرب",
    occasion: "يقوله من أُكرم بالطعام لمن أطعمه، شكرًا لله على النعمة",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "دعاء للمتزوجين بالبركة واجتماع الخير في حياتهما، بمعناه الظاهر من اللفظ",
    source: "سنن أبي داود، سنن الترمذي، صحيح",
    category: "المناسبات",
    occasion: "يقوله المهنئ للمتزوج عند تهنئته، في موضعه من السنة",
    virtue: "هذا الدعاء النبوي المأثور أفضل من أسلوب الجاهلية: بالرفاء والبنين، مع ملازمة الإخلاص",
  },
  {
    id: "marid-1",
    ...
    source: "متفق عليه",
    category: "المناسبات",
    occasion: "يضع يده على المريض ويقولها سبع مرات، في موضعه من السنة",
    virtue: "كان النبي ﷺ يرقي بها المرضى بما ثبت عنه، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "suq-1",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون، بمعناه الظاهر بلا تكلّف",
    source: "سنن الترمذي، صحيح",
    category: "المناسبات",
    occasion: "عند ركوب السيارة أو الطائرة أو أي مركبة، طلبًا للحفظ والتيسير",
    virtue: "من قرأها حين يركب ثم حمد الله ثم هلل وكبّر ثم دعا كان في أمان الله، مع ملازمة الإخلاص",
  },
  /* ─── إضافات الصباح والمساء ─── */
  {
    ...
    meaning: "اللهم إني أسألك علماً نافعاً ورزقاً طيباً وعملاً متقبلاً، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "ابن ماجه: ٩٢٥، صحيح",
    category: "الصباح والمساء",
    occasion: "بعد صلاة الفجر، وفق الثابت في السنة، في موضعها من الصلاة",
    virtue: "جامعة لخيري الدنيا والآخرة في كلمات موجزة، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "sabah-7",
    ...
    meaning: "سؤال العفو والعافية في الدنيا والآخرة؛ من جوامع الأدعية اليومية، بمعناه الظاهر بلا تكلّف",
    source: "أبو داود: ٥٠٧٤، ابن ماجه: ٣٨٧١، صحيح",
    category: "الصباح والمساء",
    occasion: "صباحاً ومساءً، ضمن الأذكار الراتبة إن تيسّر، في موضعه من السنة",
    virtue: "كان النبي ﷺ لا يدع هذا الدعاء صباحاً ومساءً، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "sabah-8",
    ...
    meaning: "استعاذة بأتمّ كلمات الله من شرّ كل مخلوق؛ حرز عند المساء والنزول، بمعناه الظاهر بلا تكلّف",
    source: "صحيح مسلم: ٢٧٠٩",
    category: "الصباح والمساء",
    occasion: "ثلاث مرات عند المساء، ضمن الأذكار الراتبة إن تيسّر، في موضعه من السنة",
    virtue: "من قالها ثلاث مرات حين يمسي لم يضره لدغة تلك الليلة، ويُذكر لله لا للرياء",
  },
  /* ─── إضافات السفر ─── */
  {
    id: "safar-6",
    ...
    meaning: "استيداع المسافر عند الله مع التوكل بأن ودائعه سبحانه لا تضيع، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "ابن ماجه: ٢٨٢٦، صحيح",
    category: "السفر",
    occasion: "يقوله المُقيم لمن يُودِّعه للسفر، طلبًا للحفظ والتيسير",
    virtue: "من أودع أخاه المسافر بهذا الدعاء حفظه الله، مع التوكل على الله، مع ملازمة الإخلاص",
  },
  {
    id: "safar-7",
    ...
    meaning: "دعاء توديع: سؤال التقوى والمغفرة وتيسير الخير في الحلّ والترحال، بمعناه الظاهر بلا تكلّف",
    source: "الترمذي: ٣٤٤٤، صحيح",
    category: "السفر",
    occasion: "يقوله المُودِّع للمسافر عند الوداع، طلبًا للحفظ والتيسير",
    virtue: "من أفضل ما يُقال في توديع المسافر، ويُحرص عليه مع الإخلاص، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "safar-8",
    ...
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير، في موضعه من السنة",
    virtue: "كان النبي ﷺ يقولها عند رجوعه من كل سفر وغزوة، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  /* ─── إضافات الصلاة ─── */
  {
    id: "salah-7",
    ...
    category: "الصلاة",
    occasion: "دعاء الاستفتاح في أول ركعة بعد تكبيرة الإحرام، في موضعه من السنة",
    virtue: "من أثبت أدعية الاستفتاح وأكثرها وروداً في الصحيحين، ويُذكر لله لا للرياء",
  },
  {
    id: "salah-8",
    ...
    category: "الصلاة",
    occasion: "يُقال في قنوت الوتر قبل الركوع أو بعده، في موضعها من الصلاة",
    virtue: "علَّمه النبي ﷺ الحسنَ بن علي رضي الله عنهما، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "salah-9",
    ...
    meaning: "بين السجدتين يُكرر طلب المغفرة في موضع ذلّ وخضوع بين يدي الله، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "أبو داود: ٨٧٤، صحيح",
    category: "الصلاة",
    occasion: "بين السجدتين في كل ركعة من الصلاة، في موضعها من الصلاة",
    virtue: "كان النبي ﷺ يُطيل الجلوس بين السجدتين ويكرر هذا الدعاء، ويُذكر لله لا للرياء",
  },
  {
    id: "salah-10",
    ...
    category: "الصلاة",
    occasion: "عقب كل صلاة مفروضة، وفق الثابت في السنة، في موضعها من الصلاة",
    virtue: "من قالها حُطَّت خطاياه وإن كانت مثل زبد البحر، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  /* ─── إضافات النوم ─── */
  {
    id: "nawm-7",
    ...
    category: "النوم واليقظة",
    occasion: "يُصلى ركعتان ثم يُدعى بهذا الدعاء قبل أي أمر مهم، مع حسن الظن بالله",
    virtue: "علَّمه النبي ﷺ أصحابه كما يُعلِّمهم السورة من القرآن، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-8",
    ...
    meaning: "حمد بعد تمام النعمة أو العمل الصالح؛ نسبة التوفيق إلى الله وحده، بمعناه الظاهر بلا تكلّف",
    source: "ابن ماجه: ٣٨٠٣، حسن",
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من رؤيا حسنة، من أذكار اليوم والليلة، في موضعه من السنة",
    virtue: "الرؤيا الصالحة جزء من ستة وأربعين جزءاً من النبوة، ويُذكر لله لا للرياء",
  },
  {
    id: "nawm-9",
    ...
    meaning: "استعاذة من الشيطان ومن شرّ الرؤيا المكروهة عند الاستيقاظ منها، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "صحيح مسلم: ٢٢٦١",
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من حلم مزعج أو مخيف، من أذكار اليوم والليلة",
    virtue: "من فعل ذلك لم يضره ذلك الحلم ولا يُحدِّث به أحداً، ويُذكر لله لا للرياء",
  },
  /* ─── إضافات الكرب والهم ─── */
  {
    id: "karb-8",
    ...
    meaning: "الاستعاذة بالله من الشيطان الرجيم عند الوسوسة أو بدء القراءة، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "متفق عليه: البخاري ٣٢٨٢، مسلم ٢٦١٠",
    category: "الكرب والهم",
    occasion: "عند الغضب الشديد طلباً لسكون النفس، مع حسن الظن بالله",
    virtue: "قال ﷺ: إن رجلاً يقول الله لو قال هذا لذهب عنه ما يجد، ويُذكر لله لا للرياء",
  },
  {
    id: "karb-9",
    ...
    category: "الكرب والهم",
    occasion: "يُقال صباحاً ومساءً وعند الهم والحزن، ضمن أذكار اليوم والليلة",
    virtue: "جامع لكل أسباب الضعف الداخلي والضغوط الخارجية، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "karb-10",
    ...
    category: "الكرب والهم",
    occasion: "عند الكرب والضيق الشديد، مع حسن الظن بالله، في موضعه من السنة",
    virtue: "دعاء الكرب الذي يُفرِّج الكروب ببركة التوحيد الخالص، مع حسن التوكل، مع ملازمة الإخلاص",
  },
  /* ─── إضافات الدعاء العام ─── */
  {
    id: "du-8",
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "دعاء ثبات القلب على الدين، مع الإقرار بأن تقليب القلوب بيد الله، بمعناه الظاهر بلا تكلّف",
    source: "الترمذي: ٣٥٢٢، صحيح",
    category: "الدعاء العام",
    occasion: "يُكثر منه في كل وقت لا سيما عند الفتن وضعف الإيمان، في موضعه من السنة",
    virtue: "كان النبي ﷺ يُكثر من هذا الدعاء في يومه وليلته، ويُذكر لله لا للرياء",
  },
  {
    id: "du-9",
    ...
    category: "الدعاء العام",
    occasion: "عند مواجهة أمر صعب أو تهديد أو ضيق، مع حسن الظن بالله",
  ...
  },
  {
    ...
    category: "الدعاء العام",
    occasion: "دعاء جامع يُقال في أي وقت لا سيما في السجود، في موضعها من الصلاة",
    virtue: "كان ﷺ يقوله في السجود وهو من أجلِّ الأدعية المأثورة، ويُذكر لله لا للرياء",
  },
  /* ── الأكل والشرب ── */
  {
    id: "akl-12",
    ...
    arabic: "بِسْمِ اللَّهِ",
    transliteration: "Bismillah",
    meaning: "يُسمّي الشارب باسم الله عند الشرب كما يُسمّي عند الأكل، بمعناه الظاهر من اللفظ",
    source: "مسلم: ٢٠٢٢",
    category: "الأكل والشرب",
    occasion: "قبل الشرب، شكراً لله على النعمة، في موضعه من السنة",
    virtue: "من سنن النبي ﷺ التسمية عند الشرب والحمد بعده، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "akl-10",
    ...
    category: "الأكل والشرب",
    occasion: "بعد الفراغ من الطعام والشراب، شكرًا لله على النعمة",
    virtue: "دعاء جامع يشمل الشكر على نعمة الطعام والإسلام معاً، ويُذكر لله لا للرياء",
  },
  {
    id: "akl-8",
    ...
    meaning: "أكل طعامكم الأبرار وصلّت عليكم الملائكة وأفطر عندكم الصائمون، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "أبو داود: ٣٨٥٤، حسن صحيح",
    category: "الأكل والشرب",
    occasion: "يقوله صاحب الطعام للضيف الذي أكل عنده أو أفطر، شكرًا لله على النعمة",
    virtue: "دعاء يُبرك على صاحب الطعام ويجمع الثناء والدعاء، ويُذكر لله لا للرياء",
  },
  /* ── السفر ── */
  {
    id: "safar-10",
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "دعاء الرجوع: رجوع وتوبة وعبادة وحمد لله على تمام السفر والسلامة، بمعناه الظاهر بلا تكلّف",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر، طلباً للحفظ والتيسير، في موضعه من السنة",
    virtue: "كان النبي ﷺ يقوله كلما رجع من سفره، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  {
    id: "safar-11",
    ...
    meaning: "وداع المؤتمنين: استيداع الأهل والأحبة عند الله الذي لا تضيع ودائعه، بمعناه الظاهر بلا تكلّف",
    source: "ابن ماجه: ٢٨٢٥، صحيح",
    category: "السفر",
    occasion: "يقوله المسافر لأهله عند وداعهم، مع حسن الظن بالله",
    virtue: "دعاء الوداع للأهل قبل السفر استحفاظ بهم عند الله، ويُذكر لله لا للرياء",
  },
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    source: "البخاري: ٦٣٦٩",
    category: "الصباح والمساء",
    occasion: "من أذكار الصباح والمساء، ضمن الأذكار الراتبة إن تيسّر، في موضعه من السنة",
    virtue: "يُقال في الصباح والمساء للحفظ من آفات الدنيا، مع التوكل على الله، مع ملازمة الإخلاص",
  },
  {
    id: "sabah-10",
    ...
    source: "أبو داود: ٥٠٧٤، ابن ماجه: ٣٨٧١، صحيح",
    category: "الصباح والمساء",
    occasion: "دعاء الصباح والمساء، ضمن الأذكار الراتبة إن تيسّر، في موضعه من السنة",
    virtue: "قال ﷺ: لم يُسأل الله شيء أحبّ إليه من العافية، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "sabah-11",
    ...
    source: "مسلم: ٢٧٢٣",
    category: "الصباح والمساء",
    occasion: "أوّل الصباح، ضمن الأذكار الراتبة إن تيسّر، في موضعه من السنة",
    virtue: "ذكر جامع يُفتتح به اليوم بتوحيد الله وحمده، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  /* ─── النوم واليقظة — إضافي ─── */
  {
    id: "nawm-10",
    ...
    category: "النوم واليقظة",
    occasion: "عند الاستيقاظ من المنام خائفاً أو مفزوعاً، من أذكار اليوم والليلة",
    virtue: "يقيه من الشيطان ويرد عنه الفزع عند اليقظة، ويُذكر لله لا للرياء، ويُداوم عليه بحسب الاستطاعة",
  },
  {
    id: "nawm-11",
    ...
    source: "مسلم: ٧٧٠",
    category: "النوم واليقظة",
    occasion: "عند القيام من الليل للتهجد أو الاستيقاظ، من أذكار اليوم والليلة",
    virtue: "من أدعية النبي ﷺ عند قيام الليل والتهجد، ويُذكر لله لا للرياء، مع ملازمة الإخلاص وترك الرياء",
  },
  /* ─── الكرب والهم — إضافي ─── */
  {
    id: "karb-11",
    ...
    category: "الكرب والهم",
    occasion: "عند اشتداد الكرب والضيق، مع حسن الظن بالله، في موضعه من السنة",
    virtue: "كان النبي ﷺ يدعو بهذا الدعاء عند الكرب — ذكر لعظمة الله يُذهب الهم، مع ملازمة الإخلاص",
  },
  /* ─── الصلاة — إضافي ─── */
  {
    id: "salah-11",
    ...
    category: "الصلاة",
    occasion: "افتتاح صلاة الليل والتهجد، وفق الثابت في السنة، في موضعها من الصلاة",
    virtue: "من دعاء النبي ﷺ حين يقوم إلى صلاة الليل — يجمع حمد الله وتوحيده، مع ملازمة الإخلاص",
  },
  /* ─── السفر — إضافي ─── */
  {
    id: "safar-9",
    ...
    meaning: "سبحان الذي سخّر لنا هذا وما كنا له مقرنين، وإنا إلى ربنا لمنقلبون، بمعناه الظاهر بلا تكلّف",
    source: "أبو داود: ٢٦٠٢، الترمذي: ٣٤٤٦، صحيح",
    category: "السفر",
    occasion: "عند ركوب الدابة أو السيارة أو أي مركبة، طلبًا للحفظ والتيسير",
    virtue: "دعاء قرآني (الزخرف: ١٣-١٤) يُذكّر بنعمة التسخير ويستحضر الآخرة، مع ملازمة الإخلاص",
  },
  /* ─── الدعاء العام — إضافي ─── */
  {
    id: "du-11",
    ...
    meaning: "سؤال الهدى والتقوى والعفاف والغنى؛ جوامع خير الدين والدنيا، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "مسلم: ٢٧٢١",
    category: "الدعاء العام",
    occasion: "في أي وقت — دعاء جامع لخيري الدنيا والدين، في موضعه من السنة",
  ...
  /* ─── الأكل والشرب — إضافي ─── */
  {
    ...
    meaning: "الحمد لله الذي أطعمني هذا ورزقنيه من غير حول مني ولا قوة، ويُفهم بمعناه الظاهر دون تكلّف",
    source: "أبو داود: ٤٠٢٣، الترمذي: ٣٤٥٨، صحيح",
    category: "الأكل والشرب",
    occasion: "بعد الفراغ من الطعام، شكراً لله على النعمة، في موضعه من السنة",
