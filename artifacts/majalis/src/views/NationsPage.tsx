...
export default function NationsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "موسوعة الأمم والأقوام المذكورين في القرآن والسنة الصحيحة: النبي المرسل إليهم، وذنبهم، ونوع العقوبة، ومن نجا، والدروس المستفادة — بالآيات والأحاديث ومع تمييز ما ثبت مما لم يثبت. محتوى تعليمي معتمد في منهج مجالس العلم",
