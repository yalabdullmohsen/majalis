...
export default function NationsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "موسوعة الأمم والأقوام المذكورين في القرآن والسنة: النبي المرسل إليهم، وذنبهم، ونوع العقوبة، والناجون والمؤمنون المذكورون، والدروس المستفادة — بالآيات، وما صح من السنة عند وجوده، مع تمييز ما ثبت مما لم يثبت.",
  ...
  return (
    <div className="page-shell nations-page" dir="rtl">
      <PageHeader
        eyebrow="قصص القرآن"
        title="الأمم السابقة"
        subtitle={`${NATIONS.length} أمة وقوماً — بالآيات، وما صح من السنة عند وجوده، مع تمييز ما ثبت مما لم يثبت.`}
      />
