...
export default function MindMapPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "خرائط ذهنية تفاعلية تُنظّم العلوم الإسلامية، الفقه والعقيدة والحديث والسيرة وطريق التعلم. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description: "خرائط ذهنية تفاعلية تنظّم العلوم الإسلامية من فقه وعقيدة وحديث وسيرة؛ عرض موثّق ضمن منهج سُنّة",
