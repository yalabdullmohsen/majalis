...
export default function MindMapPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "خرائط ذهنية تفاعلية تُنظّم العلوم الإسلامية، الفقه والعقيدة والحديث والسيرة وطريق التعلم. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "خرائط ذهنية تفاعلية تنظّم العلوم الإسلامية من فقه وعقيدة وحديث وسيرة؛ محتوى معتمد في منهج مجالس العلم",
