...
export const RANKS = [
  ...
  },
  {
    ...
    text: "من حافظ على حدود الصلاة وجاهد الشيطان والخواطر حتى لا يسرق من صلاته، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    benefit: "هذه أعلى المراتب: صلاة القلوب المقبلة على الله حباً وتعظيماً وأنساً — فائدة عملية يُستحسن العمل بها مع الدعاء بالتوفيق والثبات على الطاعة. فائدة عملية يُستحب تطبيقها",
  },
];
...
const PRAYER_VIRTUES = [
  {
    title: "عمود الإسلام",
    text: "رأس الأمر الإسلام، وعموده الصلاة، وذروة سنامه الجهاد في سبيل الله، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    text: "بشِّر المشّائين في الظُّلَم إلى المساجد بالنور التام يوم القيامة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    text: "الصلاة نور، والصدقة برهان، والصبر ضياء، والقرآن حجة لك أو عليك، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    text: "صلاة في مسجدي هذا أفضل من ألف صلاة فيما سواه إلا المسجد الحرام — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. محتوى معتمد في منهج مجالس العلم",
            ...
            <div key={v.title} className="prv-virtue-card ui-card">
              ...
              <p className="prv-virtue-text">
                {v.source.startsWith("الع") || v.source.startsWith("سبأ") || v.grade === "قرآن"
                  ? v.text
                  : "«${v.text}» حديثٌ يُعرض بلفظه دون تحريف يُراعى ثبوته قبل الاستدلال — من مراجع مجالس العلم — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد في منهج مجالس ال"}
              </p>
