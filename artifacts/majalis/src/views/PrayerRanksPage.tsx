...
export const RANKS = [
  {
    ...
    text: "من نقص من وضوئها ومواقيتها وحدودها وأركانها، فلم يحفظ لها حقها الظاهر — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. محتوى معتمد في منهج المجلس العلمي",
  ...
  },
  {
    ...
    text: "من حافظ على المواقيت والحدود والأركان الظاهرة، لكنه أضاع مجاهدة نفسه في الوسوسة والخواطر — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. محتوى معتمد في منهج المجلس العلمي",
  ...
  },
  {
    ...
    text: "من حافظ على حدود الصلاة وجاهد الشيطان والخواطر حتى لا يسرق من صلاته، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج المجلس العلمي؛ من فضائل الصلاة ومراتبها",
  ...
  },
  {
    ...
    ruling: "مثاب مأجور",
    text: "من قام إلى الصلاة فأكمل حقوقها وحدودها، واستغرق قلبه في حفظها وأدائها كما ينبغي — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. محتوى معتمد في منهج المجلس العلمي",
...
const PRAYER_VIRTUES = [
  {
    title: "عمود الإسلام",
    text: "رأس الأمر الإسلام، وعموده الصلاة، وذروة سنامه الجهاد في سبيل الله، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج المجلس العلمي؛ من فضائل الصلاة ومراتبها",
  ...
  {
    title: "كفّارة للذنوب",
    text: "أرأيتم لو أن نهراً بباب أحدكم يغتسل منه كل يوم خمس مرات، هل يبقى من درنه شيء؟ قالوا: لا يبقى من درنه شيء. قال: فذلك مثل الصلوات الخمس يمحو الله بهن الخطايا. محتوى معتمد في منهج المجلس العلمي",
  ...
  },
  {
    ...
    text: "قسمتُ الصلاة بيني وبين عبدي نصفين، ولعبدي ما سأل. فإذا قال العبد: الحمد لله رب العالمين. قال الله: حمدني عبدي. محتوى معتمد في منهج المجلس العلمي يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
  ...
  },
  {
    ...
    text: "قلتُ: أيُّ العمل أحبُّ إلى الله؟ قال: الصلاة على وقتها. قلت: ثم أيّ؟ قال: بر الوالدين. قلت: ثم أيّ؟ قال: الجهاد في سبيل الله. محتوى معتمد في منهج المجلس العلمي يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
  ...
  },
  {
    ...
    text: "بشِّر المشّائين في الظُّلَم إلى المساجد بالنور التام يوم القيامة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج المجلس العلمي؛ من فضائل الصلاة ومراتبها",
  ...
  },
  {
    ...
    text: "صلاة الجماعة تفضل صلاة الفذِّ بسبع وعشرين درجة — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. محتوى معتمد في منهج المجلس العلمي يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
  ...
  },
  {
    ...
    text: "حُبِّبَ إليَّ من دنياكم: النساء والطيب، وجُعلت قرة عيني في الصلاة — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. محتوى معتمد في منهج المجلس العلمي",
  ...
  },
  {
    ...
    text: "الصلاة نور، والصدقة برهان، والصبر ضياء، والقرآن حجة لك أو عليك، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. محتوى معتمد في منهج المجلس العلمي؛ من فضائل الصلاة ومراتبها",
  ...
  },
  {
    ...
    text: "صلاة في مسجدي هذا أفضل من ألف صلاة فيما سواه إلا المسجد الحرام — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. محتوى معتمد في منهج المجلس العلمي؛ من فضائل الصلاة ومراتبها",
