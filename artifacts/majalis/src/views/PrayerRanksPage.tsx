...
export default function PrayerRanksPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مراتب الناس الخمسة في الصلاة بحسب ابن القيم، مع فضائل الصلاة من القرآن والسنة الصحيحة ووصايا في إصلاح الصلاة يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. من فضائل الصلاة ومراتبها",
