...
export const RANKS = [
  {
    ...
    benefit: "أول طريق إصلاح الصلاة: تعلم شروطها وأركانها والمواظبة على وقتها، وهذا من أسباب قبول العمل ورفع الدرجات عند الله تعالى. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية",
  },
  {
    ...
    benefit: "حضور القلب عبادة تحتاج مجاهدة، وليس مجرد أداء حركات — فائدة عملية يُستحسن العمل بها مع الدعاء بالتوفيق والثبات على الطاعة. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية",
  },
  {
    ...
    benefit: "مدافعة الخواطر وطلب الخشوع من أعظم أسباب قبول الصلاة — يُستحب للمسلم أن يجعل هذه الفائدة منهاجًا يوميًا لا مجرد معلومة. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية",
  },
  {
    ...
    benefit: "إتقان الظاهر والباطن يرفع الصلاة من عادة يومية إلى عبادة حاضرة، وهذا من أسباب قبول العمل ورفع الدرجات عند الله تعالى. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية",
  },
  {
    ...
    benefit: "هذه أعلى المراتب: صلاة القلوب المقبلة على الله حباً وتعظيماً وأنساً — فائدة عملية يُستحسن العمل بها مع الدعاء بالتوفيق والثبات على الطاعة. فائدة عملية يُستحب تطبيقها؛ من فضائل الصلاة ومراتبها",
  },
];
