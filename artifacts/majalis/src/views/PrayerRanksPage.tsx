...
export const RANKS = [
  ...
  },
  {
    ...
    benefit: "حضور القلب عبادة تحتاج مجاهدة، وليس مجرد أداء حركات — فائدة عملية يُستحسن العمل بها مع الدعاء بالتوفيق والثبات على الطاعة.",
  },
  {
  ...
  },
  {
    ...
    ruling: "مقرّب من ربه",
    text: "من قام إلى الصلاة وقد أخذ قلبه ووضعه بين يدي ربه، ناظراً بقلبه إليه، ممتلئاً من محبته وتعظيمه — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم.",
    benefit: "هذه أعلى المراتب: صلاة القلوب المقبلة على الله حباً وتعظيماً وأنساً — فائدة عملية يُستحسن العمل بها مع الدعاء بالتوفيق والثبات على الطاعة.",
  },
];
...
const PRAYER_VIRTUES = [
  {
    title: "عمود الإسلام",
    text: "رأس الأمر الإسلام، وعموده الصلاة، وذروة سنامه الجهاد في سبيل الله، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة.",
  ...
  },
  {
    ...
    text: "أول ما يُحاسب به العبد يوم القيامة من عمله صلاته، فإن صلحت فقد أفلح وأنجح، وإن فسدت فقد خاب وخسر — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم.",
  ...
  },
  {
    ...
    text: "﴿إِنَّ الصَّلَاةَ تَنْهَى عَنِ الْفَحْشَاءِ وَالْمُنكَرِ﴾ — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.",
    source: "العنكبوت: ٤٥",
    grade: "قرآن",
    narrator: "",
  },
  ...
  },
  {
    ...
    text: "بشِّر المشّائين في الظُّلَم إلى المساجد بالنور التام يوم القيامة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة.",
  ...
  },
  {
    ...
    text: "صلاة الجماعة تفضل صلاة الفذِّ بسبع وعشرين درجة — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم.",
  ...
  },
  {
    ...
    text: "حُبِّبَ إليَّ من دنياكم: النساء والطيب، وجُعلت قرة عيني في الصلاة — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.",
  ...
  },
  {
    ...
    text: "الصلاة نور، والصدقة برهان، والصبر ضياء، والقرآن حجة لك أو عليك، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة.",
  ...
  },
  {
    ...
    text: "من صلى البردين دخل الجنة — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.",
  ...
  },
  {
    ...
    text: "صلاة في مسجدي هذا أفضل من ألف صلاة فيما سواه إلا المسجد الحرام — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.",
...
const PRAYER_TIPS = [
  ...
  { num: "٤", tip: "قراءة الفاتحة بتدبر ووقوف، واسأل الله الهداية مع كل ﴿اهدنا الصراط المستقيم﴾." },
  ...
  { num: "٩", tip: "صلِّ قدر الإمكان في المسجد جماعةً، فالصف المستقيم ومتابعة الإمام يُعينان على الخشوع." },
  { num: "١٠", tip: "إذا فاتتك ركعة أو أدركك السهو فلا تجزع؛ تعلّم الحكم وأتمّ صلاتك على هدي السنة." },
...
export default function PrayerRanksPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مراتب الناس الخمسة في الصلاة بحسب ابن القيم، مع فضائل الصلاة من القرآن والسنة الصحيحة ووصايا في إصلاح الصلاة يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة.",
