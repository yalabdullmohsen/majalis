...
export const RANKS = [
  {
    ...
    benefit: "أول طريق إصلاح الصلاة: تعلم شروطها وأركانها والمواظبة على وقتها، وهذا من أسباب قبول العمل ورفع الدرجات عند الله تعالى. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية؛ من فضائل الصلاة ومراتبها",
  },
  {
  ...
  },
  {
    ...
    benefit: "إتقان الظاهر والباطن يرفع الصلاة من عادة يومية إلى عبادة حاضرة، وهذا من أسباب قبول العمل ورفع الدرجات عند الله تعالى. فائدة عملية يُستحب تطبيقها يُحفظ على الدوام — من مراجع مجالس العلم الشرعية؛ من فضائل الصلاة ومراتبها",
  },
  {
