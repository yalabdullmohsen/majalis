...
function UniversitiesContent() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل للجامعات والمعاهد الإسلامية حول العالم، ابحث وقارن بين الجامعات حسب التخصص والمستوى وطريقة الدراسة. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "جامعات ومعاهد إسلامية في عشرات الدول العربية والإسلامية؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
