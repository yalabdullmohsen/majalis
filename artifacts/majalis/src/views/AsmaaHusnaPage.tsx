      ...
      jsonLd: [
        {
          ...
          description: "أسماء الله الحسنى مع المعنى والمصدر والتنبيه على ضعف السرد التفصيلي؛ عرض موثّق ضمن منهج سُنّة",
          numberOfItems: ASMAA.length,
          itemListElement: ASMAA.map((a, i) => ({
            "@type": "ListItem",
            position: i + 1,
            name: `${a.arabic} — ${a.meaning}`,
            url: `https://www.ssunnah.com/asma-husna#name-${a.num}`,
          })),
        },
      ],
    });
  ...
  return (
    ...
    <PageShell className="ah-page">
      ...
      <div className="twh-share">
        <ShareButtons title="الأسماء الحسنى — سُنّة" url="https://www.ssunnah.com/asma-husna" />
      </div>
