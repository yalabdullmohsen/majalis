...
const ASMAA: AsmaaEntry[] = [
  ...
  { num:17, arabic:"الوهاب",    transliteration:"Al-Wahhab",     meaning:"كثير العطاء بلا منّة",                            reference:"﴿رَبَّنَا لَا تُزِغْ قُلُوبَنَا بَعْدَ إِذْ هَدَيْتَنَا وَهَبْ لَنَا مِن لَّدُنكَ رَحْمَةً﴾ آل عمران:8",benefit:"يُكثر العطاء والنعم",                          category:"الرحمة" },
  ...
  { num:32, arabic:"الخبير",    transliteration:"Al-Khabir",     meaning:"العالم بدقائق الأمور",                            reference:"﴿إِنَّ اللَّهَ خَبِيرٌ بِمَا تَعْمَلُونَ﴾ الحشر:18",        benefit:"يوقن بأن الله يعلم ما يخفيه",                  category:"العلم" },
