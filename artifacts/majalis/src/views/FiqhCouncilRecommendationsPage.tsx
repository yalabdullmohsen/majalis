...
export default function FiqhCouncilRecommendationsPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "توصيات المجمع الفقهي", url: "https://www.ssunnah.com/fiqh-council/recommendations", about: { "@type": "Thing", name: "التوصيات الفقهية الجماعية" } }],
    });
  }, []);
  ...
  return (
    <>
      ...
      <div className="px-4 pb-6 mt-4">
        <SectionQuiz route="/fiqh-council/recommendations" title="اختبر معلوماتك في القضايا الفقهية" count={4} />
      </div>
    </>
  );
}
