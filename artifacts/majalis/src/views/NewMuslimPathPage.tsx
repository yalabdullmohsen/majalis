...
export default function NewMuslimPathPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "برنامج تدريجي مدته 30 يومًا يرافقك خطوة بخطوة في أول أيامك مسلمًا. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في",
    });
