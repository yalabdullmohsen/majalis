    ...
    >
      ...
      {node.era && !isAnc && (
        <text
          ...
          textAnchor="middle" dominantBaseline="middle"
          fontSize={8.5} fontFamily="Almarai, sans-serif"
      ...
      {isAnc && (
        <text
          ...
          fill="rgba(255,255,255,0.6)" fontFamily="Almarai, sans-serif"
        >
          ···
        </text>
      )}
...
export default function ProphetsFamilyTreePage() {
  ...
  return (
    <div dir="rtl" style={{ minHeight: "100vh", background: "#F0F5F2", fontFamily: "Almarai, sans-serif" }}>
      {/* Header */}
      <header style={{
