...
export default function ProphetsFamilyTreePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "رسم بياني تفاعلي لنسب الأنبياء الـ25 المذكورين في القرآن الكريم من آدم إلى محمد ﷺ؛ محتوى معتمد في منهج مجالس العلم",
      keywords: ["أنبياء", "شجرة نسب", "سيرة", "تاريخ إسلامي"],
      jsonLd: [{
        "@context": "https://schema.org",
        "@type": "WebPage",
        name: "شجرة أنساب الأنبياء",
        description: "رسم بياني تفاعلي لنسب الأنبياء الـ25 المذكورين في القرآن الكريم. محتوى معتمد في منهج مجالس العلم",
