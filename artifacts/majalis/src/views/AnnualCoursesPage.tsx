...
export default function AnnualCoursesPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دورات علمية سنوية في الفقه والعقيدة والقرآن والسيرة، تصفح البرامج واشترك في طلب العلم المنظم. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
