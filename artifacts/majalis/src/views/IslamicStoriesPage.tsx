      ...
      jsonLd: [
        {
          ...
          description: "قصص الصحابة والفتوحات والتاريخ الإسلامي عبر العصور؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس ال",
