...
const SHURUT: Shart[] = [
  ...
  { num: 2, title: "الندم على ما فات", desc: "أن يتألم العبد ويحزن على ما صدر منه من معصية، وهو من أعظم شروط التوبة النصوح.", dalil: "الندم توبة، الحديث" },
...
const ANWAA: Nawaa[] = [
  ...
  },
  {
    ...
    icon: "👁️",
    desc: "معصية يعلم بها الآخرون، قال السلف: إن التوبة من العلنية تكون علناً، بحيث يرى من عرف المعصية أن صاحبها قد تاب، إلا إذا كان الإعلان يُفضي إلى مفسدة أكبر فيُكتفى بإظهار الصلاح دون تفصيل الذنب.",
...
const MAWANI: { title: string; desc: string }[] = [
  ...
  { title: "تأخير التوبة حتى الاحتضار", desc: "قال تعالى: (وَلَيْسَتِ التَّوْبَةُ لِلَّذِينَ يَعْمَلُونَ السَّيِّئَاتِ حَتَّىٰ إِذَا حَضَرَ أَحَدَهُمُ الْمَوْتُ قَالَ إِنِّي تُبْتُ الْآنَ). فباب التوبة مفتوح ما لم تُغرغر الروح." },
  ...
  { title: "التسويف والتأجيل", desc: "قول «سأتوب بعد قليل» أو «عسى الله أن يتوب علي لاحقاً» بدون حرص على المبادرة. والتسويف مَصيَدة الشيطان لمن نوى الخير لكن ترك التنفيذ، وقد يفجأه الأجل قبل التوبة." },
  ...
  { title: "ضعف الاتصال بالله (قلة الذكر والدعاء)", desc: "القلب الذي انقطع عن الذكر والقرآن يُصبح قاسياً لا يستجيب لنداء التوبة. ومن علاجه: الإكثار من ذكر الله ولو بلا انكسار في البداية، فالذكر يلين القلب شيئاً فشيئاً." },
];
...
const ATHAAR: { icon: string; title: string; desc: string; dalil?: string }[] = [
  ...
  { icon: "🧹", title: "تنقية النفس والبعد عن الرفاق السيئين", desc: "التوبة الصادقة تدفع صاحبها إلى تغيير بيئته واختيار الأصحاب الصالحين الذين يُعينونه على الاستقامة، فيتحول من موقع الضعف إلى موقع العون على الطاعة." },
      ...
      jsonLd: [
        {
          ...
          description: "شروط التوبة النصوح الخمسة بالأدلة وأقوال العلماء، بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة.",
  ...
  return (
    <main className="tw-page" dir="rtl">
      ...
      <div className="px-4 pb-6 mt-4">
        <SectionQuiz sectionId="adhkar" title="اختبر معلوماتك في التوبة والتزكية" count={4} />
      </div>
    </main>
  );
}
