...
const SHURUT: Shart[] = [
  { num: 1, title: "الإقلاع عن الذنب", desc: "الكفّ الفوري والكامل عن المعصية التي يتوب منها، ولا تصح التوبة مع الاستمرار في الذنب — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال.", dalil: "قُلْ يَا عِبَادِيَ الَّذِينَ أَسْرَفُوا عَلَىٰ أَنفُسِهِمْ لَا تَقْنَطُوا مِن رَّحْمَةِ اللَّهِ، الزمر: 53" },
  { num: 2, title: "الندم على ما فات", desc: "أن يتألم العبد ويحزن على ما صدر منه من معصية، وهو من أعظم شروط التوبة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب.", dalil: "الندم توبة، الحديث" },
  { num: 3, title: "العزم على عدم العودة", desc: "تصميم قلبي حقيقي بعدم الرجوع إلى المعصية في المستقبل، وهو يختلف عن مجرد القول مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { num: 4, title: "ردّ المظالم (إن كانت)", desc: "إذا كانت التوبة من حق آدمي كسرقة أو غيبة فلا بد من ردّ الحق أو طلب العفو من صاحبه — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال.", dalil: "من كان لأخيه عنده ظُلامة من مال أو عرض فليتحلّله، البخاري" },
  { num: 5, title: "أن تكون قبل الغرغرة", desc: "تُقبل التوبة ما لم تُغرغر الروح (ما لم يبلغ الأجل)، فإذا حضر الأجل أُغلق باب التوبة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب.", dalil: "إن الله يقبل توبة العبد ما لم يُغرغر، الترمذي" },
];
...
const ANWAA: Nawaa[] = [
  {
    ...
    icon: "🔥",
    desc: "كالزنا والقتل والسحر والشرك وعقوق الوالدين، تجب التوبة منها فوراً ويُخشى إن ماتَ عليها مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة.",
    hukm: "واجبة فوراً",
  },
  {
    title: "التوبة من الصغائر",
    icon: "⚠️",
    desc: "تُكفَّر بالحسنات وباجتناب الكبائر، ومع ذلك فالتوبة منها مأمور بها لأنها رجوع إلى الله من كل تقصير — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال.",
    hukm: "واجبة",
  },
  {
    title: "التوبة الكلية",
    icon: "♻️",
    desc: "التوبة الشاملة من جميع الذنوب والعصيان دفعة واحدة، وهي المراد بقوله: (تُوبُوا إِلَى اللَّهِ تَوْبَةً نَّصُوحًا) يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب.",
    hukm: "مأمور بها",
  },
  {
    title: "التوبة من حق الله",
    icon: "🕌",
    desc: "كتارك الصلاة والصيام، يتوب ويستأنف العبادة ويُكثر من النوافل جبراً للفريضة مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة.",
    hukm: "واجبة",
  },
  {
    title: "التوبة من حق الإنسان",
    icon: "🤝",
    desc: "كالسرقة والغيبة والنميمة، لا تكتمل إلا بردّ الحق أو الاستحلال ممن وقع عليه الظلم — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال.",
    hukm: "واجبة مع الاستحلال",
  },
  {
    title: "التوبة بعد الإصرار الطويل",
    icon: "🔄",
    desc: "لا تحدّد الشريعة أمداً تسقط بعده التوبة؛ باب الرجوع إلى الله مفتوح مادام الإنسان حياً. غير أن الإصرار الطويل يستلزم توبةً أشد صدقاً ومحاسبةً وجبراً للفارق.",
    hukm: "مقبولة قبل الغرغرة",
  },
  {
    title: "التوبة عن المعصية الظاهرة",
    icon: "👁️",
    desc: "معصية يعلم بها الآخرون، قال السلف: إن التوبة من العلنية تكون علناً، بحيث يرى من عرف المعصية أن صاحبها قد تاب، إلا إذا كان الإعلان يُفضي إلى ضرر أكبر.",
...
const MAWANI: { title: string; desc: string }[] = [
  ...
  { title: "اليأس من رحمة الله", desc: "القنوط من العفو الإلهي كبيرة بذاتها، قال تعالى: (لَا تَقْنَطُوا مِن رَّحْمَةِ اللَّهِ) مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  ...
  { title: "عدم ردّ المظالم", desc: "إذا كانت التوبة من حق آدمي فلا يُقبل استغفار المرء ما لم يردّ الحق أو يستحلّ صاحبه يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
  { title: "التوبة بلا عزم صادق", desc: "إذا كانت التوبة على اللسان فقط دون إرادة حقيقية للترك فهي كاذبة لا تُقبل مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { title: "الاستهانة بالذنب", desc: "احتقار المعصية وعدم الإحساس بخطورتها أمام الله يُفضي إلى عدم التوبة منها، والصغيرة المُصَرُّ عليها تصير كبيرة — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  { title: "صحبة أهل الغفلة", desc: "مجالسة من لا يذكرون الله ويُزيّنون المعاصي تُضعف اليقين بالعقوبة وتُهوّن الذنوب في النفس يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
  ...
  { title: "ضعف الإرادة والتسليم للشهوة", desc: "النفس الأمارة بالسوء تُقاوم التغيير بطبيعتها؛ والإرادة الضعيفة لا تُفرز عزماً حقيقياً على الترك. تُقوَّى الإرادة بالمجاهدة المتدرّجة ومجالسة الصالحين والصوم والعبادات التي تُروّض النفس." },
  { title: "الانشغال بالدنيا وضغوطها", desc: "حين تملأ مشاغل الحياة الوقت كله يُؤجَّل الانكسار لله. وقد نبَّه العلماء إلى أن قلة التفرغ للتأمل الذاتي من أخطر أسباب الإعراض عن التوبة، وأوصوا بخلوة أسبوعية للمحاسبة." },
  { title: "ضعف الاتصال بالله (قلة الذكر والدعاء)", desc: "القلب الذي انقطع عن الذكر والقرآن يُصبح قاسياً لا يستجيب لنداء التوبة. ومن علاجه: الإكثار من ذكر الله ولو بلا انكسار في البداية، فالذكر يُليّن القلب تدريجياً ويُعيد صاحبه إلى ساحة المناجاة." },
];
...
const ATHAAR: { icon: string; title: string; desc: string; dalil?: string }[] = [
  ...
  { icon: "📈", title: "زيادة اليقين بعفو الله", desc: "كل توبة صادقة تُرسّخ في القلب يقيناً جديداً بأن الله الغفور الرحيم، فيزداد العبد قُرباً من ربه ومحبةً له مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { icon: "🌿", title: "تجديد الصلة بالله", desc: "التوبة مسار دائم لتجديد العهد مع الله واستئناف حياة الطاعة بقلب منيب، وليست حدثاً عابراً بعد الذنب فقط — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
...
export default function TawbaPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل للتوبة النصوح: شروطها وأنواعها وآداب الاستغفار وأفضل أدعية المغفرة — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر.",
      ...
      jsonLd: [
        {
          ...
          description: "شروط التوبة النصوح الخمسة بالأدلة وأقوال العلماء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة.",
          ...
          <div role="tabpanel" id="twb-panel-adhkar" aria-labelledby="twb-tab-adhkar" className="tw-section">
            ...
            <div className="tw-afdhal-awqat">
              ...
              <div className="tw-awqat-grid">
                {[
                  { waqt: "الأسحار", desc: "آخر الليل قبيل الفجر، (وَبِالْأَسْحَارِ هُمْ يَسْتَغْفِرُونَ) — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
                  { waqt: "بعد الصلوات", desc: "ثلاث مرات بعد كل صلاة، من هدي النبي ﷺ يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب. مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
                  { waqt: "يوم الجمعة", desc: "فيه ساعة إجابة تُستحب فيها الأدعية والاستغفار مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة. — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
                  { waqt: "بين الأذان والإقامة", desc: "لا يُرد فيها الدعاء، من أفضل أوقات الاستجابة — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال. يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
                  { waqt: "عند المطر", desc: "الدعاء لا يُرد وقت نزول الغيث يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب. مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
                  { waqt: "في السجود", desc: "أقرب ما يكون العبد من ربه وهو ساجد، فأكثر من الدعاء مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
                ].map((a) => (
