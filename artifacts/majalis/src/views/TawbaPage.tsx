...
const SHURUT: Shart[] = [
  ...
  { num: 2, title: "الندم على ما فات", desc: "أن يتألم العبد ويحزن على ما صدر منه من معصية، وهو من أعظم شروط التوبة من.", dalil: "الندم توبة، الحديث" },
  ...
  { num: 5, title: "أن تكون قبل الغرغرة", desc: "تُقبل التوبة ما لم تُغرغر الروح، فإذا حضر الأجل أُغلق باب التوبة.", dalil: "إن الله يقبل توبة العبد ما لم يُغرغر، الترمذي" },
];
...
const ANWAA: Nawaa[] = [
  ...
  },
  {
    ...
    icon: "⚠️",
    desc: "تُكفَّر بالحسنات وباجتناب الكبائر، ومع ذلك فالتوبة منها مأمور بها لأنها رجوع إلى الله من كل تقصير.",
    hukm: "واجبة",
  },
  {
    title: "التوبة الكلية",
    icon: "♻️",
    desc: "التوبة الشاملة من جميع الذنوب دفعة واحدة، وهي المراد بقوله: ﴿تُوبُوا إِلَى اللَّهِ تَوْبَةً نَّصُوحًا﴾.",
    hukm: "مأمور بها",
  },
  {
...
const MAWANI: { title: string; desc: string }[] = [
  ...
  { title: "صحبة أهل الغفلة", desc: "مجالسة من لا يذكرون الله ويُزيّنون المعاصي تُضعف اليقين وتُهوّن الذنوب في النفس." },
...
const ATHAAR: { icon: string; title: string; desc: string; dalil?: string }[] = [
  ...
  { icon: "🚪", title: "فتح أبواب الرزق", desc: "قال تعالى في الاستغفار: ﴿يُرْسِلِ السَّمَاءَ عَلَيْكُم مِّدْرَارًا ۝ وَيُمْدِدْكُم بِأَمْوَالٍ وَبَنِينَ﴾، نوح: 11-12." },
  { icon: "😌", title: "انشراح الصدر وطمأنينة القلب", desc: "التوبة تُزيل ثقل المعاصي عن القلب وتملأه بالإيمان والأنس بالله تعالى." },
  { icon: "🌟", title: "فرحة الله بتوبة العبد", desc: "«لله أشد فرحاً بتوبة عبده من رجل وجد راحلته بعد أن فقدها»، مثل ضربه النبي ﷺ لشدة فرح الله بالتائب، البخاري ومسلم." },
  { icon: "💎", title: "محو الذنوب ورفع الدرجات", desc: "«التائب من الذنب كمن لا ذنب له» — ابن ماجه ٤٢٥٠، حسّنه الألباني. والتوبة الصادقة ترفع صاحبها إلى منازل المقرّبين." },
  ...
  { icon: "🌿", title: "تجديد الصلة بالله", desc: "التوبة مسار دائم لتجديد العهد مع الله واستئناف حياة الطاعة بقلب منيب، وليست حدثاً عابراً بعد الذنب فقط." },
