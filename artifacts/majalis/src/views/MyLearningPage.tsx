...
export default function MyLearningPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "لوحتي التعليمية الشخصية — تقدمي في طلب العلم وإنجازاتي ومكتبتي الشخصية؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي مع",
