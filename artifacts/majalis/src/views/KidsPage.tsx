...
export default function KidsPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "ركن الأطفال في المجلس العلمي قيد التجهيز — محتوى تعليمي ميسّر وآمن قريبًا. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي ",
