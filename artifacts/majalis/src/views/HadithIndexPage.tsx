...
const SECTIONS: SectionDef[] = [
  {
    cls: "sahih",
    href: "/hadith/sahih",
    description: "الأحاديث الصحيحة والحسنة الثابتة عن النبي ﷺ من مصادر موثوقة ومحققة. محتوى معتمد في منهج مجالس العلم",
    accent: "#1F6E54",
    Icon: BadgeCheck,
  },
  {
    cls: "daif",
    href: "/hadith/daif",
    description: "الأحاديث الضعيفة الإسناد، تُبيَّن درجتها للتحذير من الاحتجاج بها. رواية ضعيفة لا تُعد حجةً ثابتة يُستغنى بما ثبت في الصحيح — سياسة مجالس",
    accent: "#143F35",
    Icon: AlertTriangle,
  },
  {
    cls: "mawdu",
    href: "/hadith/mawdu",
    description: "الأحاديث الموضوعة والمكذوبة على النبي ﷺ، يُحذَّر منها ولا تجوز نسبتها إليه. محتوى معتمد في منهج مجالس العلم",
    accent: "#B91C1C",
    Icon: Ban,
  },
];
