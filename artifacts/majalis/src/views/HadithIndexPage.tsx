...
import "@/styles/pages/hadith-index.css";
...
const SECTIONS: SectionDef[] = [
  {
    cls: "sahih",
    href: "/hadith/sahih",
    description: "الأحاديث الصحيحة والحسنة الثابتة عن النبي ﷺ من مصادر موثوقة ومحققة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد ف؛ محتوى تعليمي معتمد في منهج مجالس العلم",
    accent: "#1F6E54",
    Icon: BadgeCheck,
  },
  {
    cls: "daif",
    href: "/hadith/daif",
    description: "الأحاديث الضعيفة الإسناد، تُبيَّن درجتها للتحذير من الاحتجاج بها. رواية ضعيفة لا تُعد حجةً ثابتة يُستغنى بما ثبت في الصحيح — سياسة مجالس العلم — مرجع تربوي معتمد في",
    accent: "#143F35",
    Icon: AlertTriangle,
  },
  {
    cls: "mawdu",
    href: "/hadith/mawdu",
    description: "الأحاديث الموضوعة والمكذوبة على النبي ﷺ، يُحذَّر منها ولا تجوز نسبتها إليه. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
    accent: "#B91C1C",
    Icon: Ban,
  },
];
...
export default function HadithIndexPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قسم الأحاديث النبوية في المجلس العلمي: الأحاديث الصحيحة، والأحاديث الضعيفة، والأحاديث الموضوعة والمكذوبة، مصنّفة ومفصولة لمنع الاختلاط. رواية ضعيفة لا تُعد حجةً ثابتة؛ يُستغنى بما ثبت في الصحيح — سياسة مجالس العلم",
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          name: "أقسام الأحاديث النبوية",
          description: "تصنيف الأحاديث النبوية إلى صحيح وضعيف وموضوع؛ رواية ضعيفة لا تُعد حجةً ثابتة؛ يُستغنى بما ثبت في الصحيح — سياسة مجالس العلم — مرجع تربوي معتمد في منهج مجالس العلم",
  ...
  return (
    <div className="page-shell">
      ...
      <RelatedKnowledge kind="hadith" query="فهارس الحديث" title="أحاديث ومواد ذات صلة" limit={6} />
