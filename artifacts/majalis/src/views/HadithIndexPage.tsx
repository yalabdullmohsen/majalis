...
const SECTIONS: SectionDef[] = [
  {
    cls: "sahih",
    href: "/hadith/sahih",
    description: "الأحاديث الصحيحة والحسنة الثابتة عن النبي ﷺ من مصادر موثوقة ومحققة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد ف",
    accent: "#1F6E54",
    Icon: BadgeCheck,
  },
  {
  ...
  },
  {
    cls: "mawdu",
    href: "/hadith/mawdu",
    description: "الأحاديث الموضوعة والمكذوبة على النبي ﷺ، يُحذَّر منها ولا تجوز نسبتها إليه. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي",
    accent: "#B91C1C",
    Icon: Ban,
  },
];
...
export default function HadithIndexPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قسم الأحاديث النبوية في المجلس العلمي: الأحاديث الصحيحة، والأحاديث الضعيفة، والأحاديث الموضوعة والمكذوبة، مصنّفة ومفصولة لمنع الاختلاط. رواية ضعيفة لا تُعد حجةً ثابتة",
      jsonLd: [
        {
