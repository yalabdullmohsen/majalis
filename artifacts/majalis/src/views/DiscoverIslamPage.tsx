...
const VISITOR_PATHS: VisitorPath[] = [
  { id: "first-time", label: "أتعرّف لأول مرة", desc: "مدخل عام مبسّط للإسلام؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد في م؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/articles/what-is-islam" },
  { id: "believe-questions", label: "أؤمن بالله ولديّ أسئلة", desc: "أسئلة حول النبوة والعبادة والقرآن؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/questions?category=prophethood" },
  { id: "atheist", label: "لا أؤمن بوجود الله", desc: "أدلة عقلية على وجود الخالق؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/questions?category=god-existence" },
  { id: "other-religion", label: "أنتمي إلى ديانة أخرى", desc: "تصوّر الإسلام لله والنبوة والوحي؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/questions?category=prophethood" },
  { id: "doubts", label: "لديّ شبهات", desc: "ردود موثّقة على أشهر الشبهات؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/doubts" },
  { id: "considering", label: "أفكّر في الدخول", desc: "خطوات عملية وواضحة؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد في منهج؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/how-to-convert" },
  { id: "new-muslim", label: "دخلت الإسلام حديثًا", desc: "مسار الثلاثين يومًا الأول؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد ف؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/new-muslim" },
  { id: "contact", label: "أريد التحدث مع مختص", desc: "تواصل سري مع داعية أو داعية؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع تربوي معتمد؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام", href: "/discover-islam/contact" },
];
