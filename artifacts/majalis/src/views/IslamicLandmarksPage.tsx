...
export default function IslamicLandmarksPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "استكشف أبرز المشاهد الإسلامية والمساجد التاريخية حول العالم: المسجد الحرام، المسجد النبوي، المسجد الأقصى، الجامع الأزهر، وأكثر من 19 موقعًا إسلاميًا بارزًا. محتوى معتمد في منهج مجالس العلم",
      keywords: [
        "مساجد إسلامية",
        "مشاهد إسلامية",
        "المسجد الحرام",
