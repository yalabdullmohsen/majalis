...
export default function FiqhCouncilComparePage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      title: "مقارنة قرارات المجمع الفقهي | سُنّة",
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "مقارنة قرارات المجمع الفقهي", url: "https://www.ssunnah.com/fiqh-council/compare", about: { "@type": "Thing", name: "تحليل ومقارنة الفتاوى الفقهية" } }],
    });
  }, []);
  ...
  return (
    <div className="page-shell wide content-hub-page fiqh-council-page fiqh-compare-page">
      ...
      <div className="twh-share">
        <ShareButtons title="مقارنة مواد المجمع الفقهي — سُنّة" url="https://www.ssunnah.com/fiqh-council/compare" />
      </div>
