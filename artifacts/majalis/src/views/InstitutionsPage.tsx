...
const INSTITUTIONS: Institution[] = [
  // مساجد
  {
    ...
    description: "أقدس المساجد وقبلة المسلمين، يضم الكعبة المشرفة والمسعى وبئر زمزم. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    country: "المملكة العربية السعودية",
    description: "ثاني أشرف المساجد، يضم قبر النبي ﷺ والروضة الشريفة ومنبره. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
    website: "https://www.gph.gov.sa",
  ...
  },
  {
    ...
    city: "القدس",
    country: "فلسطين",
    description: "ثالث الحرمين الشريفين وأولى القبلتين وقبلة الأنبياء والمرسلين. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "المدينة المنورة",
    country: "المملكة العربية السعودية",
    description: "أول مسجد بُني في الإسلام، والصلاة فيه كعمرة كاملة. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة — مر",
  ...
  // مراكز إسلامية
  {
    ...
    city: "كوالالمبور",
    country: "ماليزيا",
    description: "مؤسسة أكاديمية رائدة تجمع الدراسات الإسلامية مع العلوم الحديثة. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "المدينة المنورة",
    country: "المملكة العربية السعودية",
    description: "جامعة متخصصة في الشريعة والقرآن وعلوم الدين، تستقبل طلاباً من شتى أنحاء العالم. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "مكة المكرمة",
    country: "المملكة العربية السعودية",
    description: "من أعرق الجامعات السعودية، متخصصة في الشريعة والعلوم الإسلامية واللغة العربية. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  // مكتبات
  {
    ...
    city: "الرياض",
    country: "المملكة العربية السعودية",
    description: "أكبر مكتبات المملكة العربية السعودية، تضم ملايين الوثائق والمخطوطات والكتب. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "القاهرة",
    country: "مصر",
    description: "أقدم مكتبة وطنية في الشرق الأوسط، تأسست عام 1870م، تحتوي على نفائس المخطوطات. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "عبر الإنترنت",
    country: "عالمي",
    description: "أكبر مكتبة إسلامية رقمية مجانية، تضم آلاف الكتب والمتون الشرعية المُحققة. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  // مراكز بحثية وهيئات
  {
    ...
    city: "الرياض",
    country: "المملكة العربية السعودية",
    description: "أعلى هيئة دينية في المملكة، تتولى إصدار الفتاوى في القضايا الكبرى. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "جدة",
    country: "المملكة العربية السعودية",
    description: "مؤسسة فقهية دولية تابعة لمنظمة التعاون الإسلامي، تُصدر قرارات في النوازل المعاصرة. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  // إضافات، مساجد
  {
    ...
    city: "الكويت",
    country: "الكويت",
    description: "أكبر مساجد الكويت وأبرزها، يستوعب آلاف المصلين ويُقام فيه دروس علمية أسبوعية. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "الكويت",
    country: "الكويت",
    description: "من أبرز مساجد الكويت العلمية، يُعقد فيه درس منتظم للشيخ عبدالله المطلق. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    country: "بروناي",
    description: "من أجمل المساجد في جنوب شرق آسيا، بمعمار إسلامي بديع ومئذنة تطل على بحيرة. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "الدار البيضاء",
    country: "المغرب",
    description: "ثالث أكبر مساجد العالم، يضم مئذنة بارتفاع 210م، وقاعات تعليمية ومركزاً ثقافياً. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "الرياض",
    country: "المملكة العربية السعودية",
    description: "مؤسسة علمية رائدة في الشريعة والأصول والحديث والدعوة، لها فروع في أنحاء العالم. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  },
  {
    ...
    city: "عمّان",
    country: "الأردن",
    description: "من أعرق كليات الشريعة في المشرق، تتبنى منهج الوسطية وتُصدر مجلة البحوث الإسلامية. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  // إضافات، مكتبات
  {
    ...
    city: "مكة المكرمة",
    country: "المملكة العربية السعودية",
    description: "تضم آلاف الكتب والمخطوطات المتعلقة بشعائر الحج والسيرة النبوية وفضائل الأماكن. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
  ...
  // مراكز إسلامية إضافية
  {
    ...
    city: "مكة المكرمة",
    country: "المملكة العربية السعودية",
    description: "منظمة إسلامية دولية تأسست عام 1382هـ، تضطلع بنشر الإسلام وتوحيد الجهود الإسلامية ودعم المسلمين في العالم. من أبرز المؤسسات الإسلامية في العالم",
  ...
  },
  {
    ...
    description: "مركز أكاديمي رائد يتبع جامعة أكسفورد، يُجري أبحاثاً في الشريعة والحضارة الإسلامية ويعزز الحوار الثقافي. من أبرز المؤسسات الإسلامية في العالم",
  ...
  },
  {
    ...
    city: "أنقرة",
    country: "تركيا",
    description: "أكبر مؤسسة إسلامية رسمية في العالم من حيث الميزانية والانتشار، تشرف على أكثر من ثمانين ألف مسجد وتُصدر الفتاوى. من أبرز المؤسسات الإسلامية في العالم",
  ...
  // مكتبات إضافية
  {
    ...
    city: "عبر الإنترنت",
    country: "عالمي",
    description: "برنامج المكتبة الشاملة يحتوي على أكثر من ستة آلاف كتاب إسلامي رقمي قابل للبحث، ويُعدّ المرجع الرقمي الأول للباحثين. من أبرز المؤسسات الإسلامية في العالم",
    website: "https://shamela.ws",
  },
  {
    ...
    city: "إسطنبول",
    country: "تركيا",
    description: "أعظم مستودعات المخطوطات الإسلامية في العالم، تضم أكثر من مئة وثمانين ألف مخطوطة في مختلف علوم الشريعة واللغة والتاريخ. من أبرز المؤسسات الإسلامية في العالم",
...
export default function InstitutionsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل المؤسسات الإسلامية والمراكز الشرعية، مساجد ومعاهد وجامعات وهيئات إسلامية. من أبرز المؤسسات الإسلامية في العالم يُستفاد منها في التعلم والبحث والعبادة",
      ...
      jsonLd: [
        {
          ...
          description: "دليل المساجد والمعاهد والجامعات والهيئات الإسلامية؛ من أبرز المؤسسات الإسلامية في العالم؛ يُستفاد منها في التعلم والبحث والعبادة — ",
