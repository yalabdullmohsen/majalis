...
export default function FiqhCouncilResearchPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      title: "بحوث المجمع الفقهي | سُنّة",
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "بحوث المجمع الفقهي", url: "https://www.ssunnah.com/fiqh-council/research", about: { "@type": "Thing", name: "البحوث والدراسات الفقهية المعاصرة" } }],
    });
  }, []);
