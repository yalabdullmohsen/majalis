...
export default function FiqhCouncilResearchPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "بحوث المجمع الفقهي", url: "https://www.majlisilm.com/fiqh-council/research", about: { "@type": "Thing", name: "البحوث والدراسات الفقهية المعاصرة" } }],
    });
  }, []);
