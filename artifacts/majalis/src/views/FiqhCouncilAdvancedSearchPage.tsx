...
export default function FiqhCouncilAdvancedSearchPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      title: "البحث المتقدم في المجمع الفقهي | سُنّة",
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "البحث المتقدم في المجمع الفقهي", url: "https://www.ssunnah.com/fiqh-council/advanced-search", about: { "@type": "Thing", name: "محرك البحث الفقهي المتقدم" } }],
    });
  }, []);
  ...
  return (
    <div className="page-shell narrow content-hub-page fiqh-council-page fiqh-search-page">
      ...
      <div className="twh-share">
        <ShareButtons title="البحث المتقدم في المجمع الفقهي — سُنّة" url="https://www.ssunnah.com/fiqh-council/search" />
      </div>
