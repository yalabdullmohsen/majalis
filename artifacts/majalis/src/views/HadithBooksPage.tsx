...
export default function HadithBooksPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "تصفّح الكتب الحديثية الكاملة: صحيح البخاري (7563 حديثاً)، صحيح مسلم (3033)، الأربعون النووية، الأحاديث القدسية، والسنن الأربعة — مع البحث والتصفح بالكتاب والباب. محتوى تعليمي معتمد في منهج مجالس العلم",
