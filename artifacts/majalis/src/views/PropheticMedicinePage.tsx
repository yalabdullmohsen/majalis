  ...
  useEffect(() => {
    ...
    void import("@/lib/prophetic-medicine-seed").then((m) => {
      ...
      applyPageSeo({
        ...
        description: "موسوعة الطب النبوي، هدي النبي ﷺ في الصحة والتداوي بالأغذية والأعشاب والرقية الشرعية. عرض موثّق ضمن منهج سُنّة",
        ...
        jsonLd: [
          {
            ...
            description: "هدي النبي ﷺ في الصحة والتداوي من الأغذية والأعشاب والرقية الشرعية؛ عرض موثّق ضمن منهج سُنّة",
            ...
            itemListElement: m.PROPHETIC_MEDICINE_ITEMS.slice(0, 20).map((item: { id: string; name: string }, i: number) => ({
              ...
              position: i + 1,
              name: item.name,
              url: `https://www.ssunnah.com/prophetic-medicine#${item.id}`,
            })),
          },
        ],
      });
  ...
  return (
    ...
    <div className="page-shell ds-page">
      ...
      <div className="twh-share">
        <ShareButtons title="الطب النبوي — سُنّة" url="https://www.ssunnah.com/prophetic-medicine" />
      </div>
