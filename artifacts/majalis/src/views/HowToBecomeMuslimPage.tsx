...
export default function HowToBecomeMuslimPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل هادئ وواضح لمعنى الدخول في الإسلام، والشهادتين، والخطوات الأولى — بلا ضغط وبلا استعجال. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    });
  }, []);
