...
export default function HowToBecomeMuslimPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل هادئ وواضح لمعنى الدخول في الإسلام، والشهادتين، والخطوات الأولى — بلا ضغط وبلا استعجال. محتوى معتمد في منهج سُنّة",
    });
  }, []);
    ...
    <div className="page-shell narrow dii-question-page">
      ...
      <div className="ui-card" style={{ marginTop: "1rem" }}>
        ...
        <div className="dii-faq-mini">
          ...
          <p><strong>هل يُشترط ختان أو شعائر إضافية للدخول؟</strong> الدخول يتم بالشهادتين. ما سوى ذلك من سنن أو أحكام يُتعلَّم لاحقًا بحسب الجنس والصحة والاستطاعة، ويُسأل فيه أهل العلم عند الحاجة.</p>
          <p><strong>ماذا عن صلاتي الأولى؟</strong> تعلّم الوضوء والفاتحة وصلاة واحدة بإتقان، ثم أضف بقية الصلوات. راجع مقال «الصلاة في الإسلام» أو ابدأ اليوم الثاني والثالث من مسار المسلم الجديد.</p>
        </div>
      </div>
