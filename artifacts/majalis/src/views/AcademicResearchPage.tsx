...
export default function AcademicResearchPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "فهرس أكاديمي متخصص في جمع وتنظيم الأبحاث والدراسات الشرعية الموثقة، مع حفظ حقوق الباحثين والجهات العلمية.",
      keywords: ["أبحاث شرعية", "رسائل ماجستير", "دكتوراه", "فقه", "حديث", "تفسير", "فهرس أكاديمي"],
      jsonLd: [
        {
          ...
          description: "فهرس أكاديمي متخصص في الأبحاث الشرعية الموثقة",
        },
      ],
    });
  }, []);
  ...
  return (
    <SectionTemplatePage
      ...
      subtitle="فهرس أكاديمي متخصص في جمع وتنظيم الأبحاث والدراسات الشرعية الموثقة، مع حفظ حقوق الباحثين والجهات العلمية."
    ...
    <div className="sr-page">
      ...
      <ShareButtons title="الأبحاث الشرعية — سُنّة" url="https://www.ssunnah.com/academic-research" />
    </div>
    </SectionTemplatePage>
  );
}
