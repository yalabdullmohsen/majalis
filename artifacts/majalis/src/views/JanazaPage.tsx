...
const SALAH_ARKAN = [
  { num: "١", title: "النية", desc: "نية الصلاة على الميت في القلب" },
  { num: "٢", title: "القيام", desc: "الصلاة واقفاً قادراً ولا قعود فيها" },
  { num: "٣", title: "التكبيرات الأربع", desc: "أربع تكبيرات مع رفع اليدين في كل تكبيرة عند بعض العلماء" },
  { num: "٤", title: "الفاتحة", desc: "قراءة الفاتحة بعد التكبيرة الأولى" },
  { num: "٥", title: "الصلاة على النبي", desc: "الصلاة الإبراهيمية بعد التكبيرة الثانية" },
  { num: "٦", title: "الدعاء للميت", desc: "الدعاء للميت بعد التكبيرة الثالثة" },
  { num: "٧", title: "التسليم", desc: "تسليمة واحدة عن اليمين (أو اثنتان) في نهاية الصلاة" },
];
