...
/* ─── data ─── */
const GHUSL_STEPS = [
  { num: "١", title: "النية والبسملة", desc: "يبدأ بالنية ثم التسمية، وينبغي ستر العورة طوال الغسل — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  ...
  { num: "٣", title: "الوضوء", desc: "يُوضَّأ كوضوء الصلاة تماماً دون إدخال الماء في الأنف والفم مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { num: "٤", title: "الغسل بالماء والسدر", desc: "يُغسَّل الرأس والوجه أولاً، ثم الشق الأيمن، ثم الأيسر ثلاثاً — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  { num: "٥", title: "الغسلة الأخيرة بالكافور", desc: "تُختم الغسلة الأخيرة بكافور إن وُجد؛ لتطييب الجسد وتخفيف تغيره يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
...
const TAKFIN_ITEMS = [
  ...
  },
  {
    title: "تكفين المرأة",
    icon: "👩",
    desc: "السنة: خمسة أثواب (إزار، خمار، قميص، ولفافتان). والواجب: ثوب يستر جميع بدنها مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة.",
...
const SALAH_ARKAN = [
  { num: "١", title: "النية", desc: "نية الصلاة على الميت في القلب، ولا يُشترط التلفظ بها — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  ...
  { num: "٣", title: "التكبيرات الأربع", desc: "أربع تكبيرات، يرفع يديه مع كل تكبيرة إلى حذو المنكبين أو شحمتَي الأذنين مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  ...
  { num: "٥", title: "الصلاة على النبي", desc: "الصلاة الإبراهيمية كاملة بعد التكبيرة الثانية كما في التشهد يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
  ...
  { num: "٨", title: "ترتيب الإمام", desc: "يقف الإمام عند رأس الرجل ووسط المرأة. وأفضل الصفوف الأول فالأول كالصلاة المعتادة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
];
...
const DAFN_ITEMS = [
  ...
  { icon: "📿", title: "الدعاء عند الدفن", desc: "يُقال: بسم الله وعلى سنة رسول الله ﷺ، ويُنثَر التراب بيده ثلاثاً من جهة الرأس مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { icon: "🗿", title: "العلامة على القبر", desc: "يُجعَل على القبر حجر أو ما يشبهه علامةً لمعرفته، ويُكره تجصيصه والبناء عليه — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
...
const TAAZIYA_AADAB = [
  ...
  { icon: "🍽️", title: "إعداد الطعام لأهل الميت", desc: "يُستحب أن يُعِدَّ جيران الميت وأقاربه طعاماً لأهل الميت لأنهم مشغولون عن أنفسهم — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  ...
  { icon: "🚫", title: "المنهيات", desc: "يُكره البكاء بصوت عال والنياحة وشق الجيوب ولطم الخدود والدعاء بالويل والثبور مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
  { icon: "📅", title: "زيارة القبور", desc: "زيارة القبور مشروعة للرجال بإجماع، وللنساء خلاف، والغاية التذكر والدعاء للأموات — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
  ...
  { icon: "🤍", title: "ذكر الميت بخير", desc: "قال ﷺ: «اذكروا محاسن موتاكم، وكُفُّوا عن مساوئهم» — أبو داود ٤٩٠٩، حسّنه الألباني. ومن مات على الإسلام فله الترحّم والاستغفار." },
...
export default function JanazaPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الجنائز: الغسل والتكفين والصلاة والدفن والتعزية والزيارة يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة.",
