...
export default function SurahStoriesPage() {
  ...
  useEffect(() => {
    ...
    applyPageSeo({
      ...
      description: "سبب التسمية ومحاور السور وقصصها من القرآن والسنة الصحيحة — بلا إسرائيليات ولا روايات ضعيفة في الفضائل. يُستغنى بما ثبت في الصحيح — سياسة مجالس العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
