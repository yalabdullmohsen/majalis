...
export default function SurahStoriesPage() {
  ...
  useEffect(() => {
    ...
    applyPageSeo({
      ...
      description: "سبب التسمية ومحاور السور وقصصها من القرآن والسنة الصحيحة — بلا إسرائيليات ولا روايات ضعيفة في الفضائل. يُستغنى بما ثبت في الصحيح — سياسة مجالس العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ رواية ضعيفة لا تُعد حجةً ثابتة",
      ...
      jsonLd: [
        {
          ...
          description: "قصص وأسباب نزول ١١٤ سورة من سور القرآن الكريم؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ يُعرض للتذكّر والاعتبار بما ثبت من القرآن والسنة الصحيحة؛ محتوى تعليمي معتمد في منهج مجالس العلم",
          numberOfItems: 114,
