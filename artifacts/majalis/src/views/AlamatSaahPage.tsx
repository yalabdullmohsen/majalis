...
const SUGHRA: Alama[] = [
  ...
  },
  {
    ...
    desc: "ورد في بعض روايات الفتن ذكر انقلاب الأولويات الأسرية وضعف البر بالوالدين، وهو معنى تؤكده النصوص العامة في وجوب البر وصلة الرحم.",
    source: "الترمذي، وفي ثبوته خلاف",
    status: "جارية",
  },
  {
  ...
  {
    title: "إسناد الأمر إلى غير أهله",
    desc: "قال ﷺ: «إذا ضُيِّعت الأمانة فانتظر الساعة». قيل: كيف إضاعتها؟ قال: «إذا وُسِّد الأمر إلى غير أهله فانتظر الساعة».",
    source: "البخاري: ٥٩",
    status: "جارية",
  },
  ...
  },
  {
    ...
    source: "أبو داود والترمذي، صححه بعض أهل العلم",
    status: "لم تقع",
  },
  {
