...
const SUGHRA: Alama[] = [
  ...
  {
    title: "وفاة النبي ﷺ",
    desc: "من علامات الساعة التي أخبر عنها عوف بن مالك رضي الله عنه: «وفاة النبي ﷺ». فهي من أول العلامات وقوعاً بعد بعثته.",
    source: "البخاري: ٣١٧٦",
    status: "وقعت",
  },
  {
  ...
  },
  {
    ...
    desc: "جاء في أحاديث أشراط الساعة ذكر ظهور الزنا وشرب الخمر ورفع العلم، وهي من دلائل فساد الأخلاق آخر الزمان.",
  ...
  },
  {
    ...
    desc: "«ليكوننَّ من أمتي أقوام يستحلُّون الحِرَ والحرير والخمر والمعازف».",
    source: "البخاري: ٥٥٩٠",
    status: "جارية",
  },
  {
  ...
  },
  {
    ...
    desc: "«يُقبَض العلم» بموت العلماء دون أن يُخلَف عنهم، فيسود الجهل ويُفتى بغير علم.",
    source: "البخاري: ١٠٠",
    status: "جارية",
  },
  {
    title: "كثرة القتل وانتشار الفتن",
    desc: "«لا تقوم الساعة حتى يكثر الهرج». قالوا: وما الهرج؟ قال: «القتل القتل».",
    source: "مسلم: ١١٦",
    status: "جارية",
  },
  {
    title: "كثرة الزلازل",
    desc: "قال ﷺ في جملة من أشراط الساعة: «وتكثر الزلازل». نروي النص كما ورد دون تنزيله على أحداث معيّنة.",
    source: "البخاري: ١٠٣٦",
    status: "جارية",
  },
  {
    title: "نزول المطر وقلة النبات",
    desc: "قال ﷺ: «لا تقوم الساعة حتى يُمطَر المطر ولا تُنبِت الأرض شيئاً». ويُشير إلى انقطاع البركة من الأرض.",
    source: "أحمد، صحيح",
    status: "لم تقع",
  },
  {
    title: "ضياع الأمانة",
    desc: "قال ﷺ: «إذا ضُيِّعت الأمانة فانتظر الساعة». قيل: كيف إضاعتها؟ قال: «إذا وُسِّد الأمر إلى غير أهله فانتظر الساعة».",
    source: "البخاري: ٥٩",
    status: "جارية",
  },
  {
    title: "انتشار الكهانة والتنجيم",
    desc: "من مظاهر الفتن آخر الزمان رجوع الناس إلى الكهانة والتنجيم وطلب الغيب من غير الوحي، وهو مما نهت عنه الشريعة وشددت فيه.",
    source: "أحاديث النهي عن الكهانة في مسلم وغيره",
    status: "جارية",
  },
  {
    title: "تمنِّي الموت لشدة الفتن",
    desc: "قال ﷺ: «لا تقوم الساعة حتى يمر الرجل بقبر الرجل فيقول: يا ليتني مكانه» من شدة الكرب والفتن التي يمر بها.",
    source: "البخاري: ٧١١٥",
    status: "جارية",
  },
  {
    title: "استباحة الحرام في الكسب",
    desc: "قال ﷺ: «يأتي على الناس زمان لا يبالي المرء بما أخذ المال، أمن حلال أم من حرام».",
    source: "البخاري: ٢٠٥٩",
    status: "جارية",
  },
  {
  ...
  {
    title: "خروج المهدي",
    desc: "وردت أحاديث في ظهور رجل من أهل البيت يوافق اسمه اسم النبي ﷺ، يملأ الأرض قسطاً وعدلاً كما مُلئت جوراً. يُبايَع بين الركن والمقام. نقتصر على ما ثبت عند أهل العلم دون تفاصيل لم تتحرر.",
    source: "أبو داود والترمذي وغيرهما؛ صحح جملةً منها جمع من أهل العلم",
    status: "لم تقع",
  },
  {
    title: "كثرة النساء وقلة الرجال",
    desc: "قال ﷺ: «من أشراط الساعة أن يقلَّ الرجال وتكثر النساء، حتى يكون لخمسين امرأة قيِّمٌ واحد».",
...
const TAHDHUKAT: Alama[] = [
  {
    ...
    desc: "الإكثار من ذكر الله من أعظم أسباب الثبات في الفتن، فالذاكر يستحضر الآخرة ولا يغتر بتقلبات الدنيا.",
  ...
  },
  {
    ...
    desc: "«تصدَّق بصدقة قبل أن لا تجد من يقبلها». الصدقة في أوقات الشدة والفتن ترتفع درجاتها وتُعظَّم بركاتها.",
    source: "البخاري: ١٤١١",
  },
  {
  ...
  },
  {
    ...
    desc: "يُستحب قراءة سورة الكهف يوم الجمعة؛ وجاء في فضلها روايات حسّنها بعض أهل العلم. والثابت في الصحيح: «من حفظ عشر آيات من أول سورة الكهف عُصِم من الدجال».",
    source: "مسلم: ٨٠٩؛ وروايات الجمعة حسّنها جمع من أهل العلم",
  },
  {
    title: "الحرص على الجماعة وعدم الانعزال",
    desc: "«يد الله مع الجماعة». ومن علامات النجاة في الفتن لزوم أهل العلم والحق، وعدم الدخول في الفتن بغير بيّنة.",
