...
const FIQH_TOPICS: FiqhTopic[] = [
  ...
  { emoji: "🕌", title: "الصلاة",            desc: "أحكام الصلاة وأوقاتها",          href: "/salah-guide",  color: "#173D35" },
  ...
  { emoji: "🕋", title: "الحج والعمرة",       desc: "مناسك الحج والعمرة",             href: "/hajj",         color: "#28584D" },
  { emoji: "🕯️", title: "الجنائز",           desc: "أحكام الجنائز والتعزية",         href: "/janaza",       color: "#68716D" },
  { emoji: "⚖️", title: "المواريث",          desc: "حاسبة الفرائض والتركات",         href: "/mawarith",     color: "#DC2626" },
  { emoji: "📐", title: "القواعد الفقهية",   desc: "القواعد الخمس الكبرى وفروعها",   href: "/fiqh-qawaid",  color: "#173D35" },
  ...
  { emoji: "🏦", title: "المال الإسلامي",   desc: "أحكام البنوك والتأمين والاستثمار",  href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#173D35" },
  ...
  { emoji: "⚡", title: "النوازل المعاصرة", desc: "مسائل العصر ومستجداته الفقهية",    href: "/fiqh-council/nawazil", color: "#68716D" },
  ...
  { emoji: "🌍", title: "فقه الأقليات",    desc: "أحكام المسلمين في غير ديار الإسلام", href: "/fiqh-council/nawazil", color: "#173D35" },
  { emoji: "💻", title: "فقه التقنية",     desc: "أحكام الإنترنت والذكاء الاصطناعي والألعاب",  href: "/fiqh-council/nawazil", color: "#0F766E" },
  { emoji: "🩺", title: "فقه العبادات للمرضى", desc: "أحكام الصلاة والصيام والطهارة للمرضى",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#68716D" },
