...
const FIQH_TOPICS: FiqhTopic[] = [
  { emoji: "🚿", title: "الطهارة",           desc: "الوضوء والغسل والتيمم ونواقضها بترتيب عملي للمبتدئ.",          href: "/tahara",       color: "#0F766E" },
  { emoji: "🕌", title: "الصلاة",            desc: "أحكام الصلاة: أركانها وشروطها وواجباتها وسننها وأوقاتها، مع ما يتعلق بالجماعة والمسافر.",          href: "/salah-guide",  color: "#143F35" },
  { emoji: "💰", title: "الزكاة",            desc: "أحكام الزكاة: أنواعها وشروط وجوبها ونصابها ومصارفها، مع حاسبة مبسّطة للأموال الزكوية.",           href: "/zakat",        color: "#0F5132" },
  { emoji: "🌙", title: "الصيام",            desc: "أحكام الصيام: فرض رمضان والنوافل والقضاء والكفارة، مع ما يتعلق بالمسافر والمريض والحامل.",           href: "/sawm",         color: "#5B21B6" },
  { emoji: "🕋", title: "الحج والعمرة",       desc: "مناسك الحج والعمرة: أركانها وواجباتها ومحرمات الإحرام، مرتّبة على مراحل السفر والطواف والرمي.",             href: "/hajj",         color: "#226A56" },
  { emoji: "🕯️", title: "الجنائز",           desc: "أحكام الجنائز: غسل الميت والكفن والصلاة والدفن والتعزية، مع آداب زيارة القبور والدعاء للمتوفى.",         href: "/janaza",       color: "#5C5C56" },
  { emoji: "📿", title: "صلاة الجمعة",       desc: "حكم الجمعة وشروطها وهيئة الخطبة والصلاة وآداب اليوم، مع ما يسقط الحضور من الأعذار.",                 href: "/jumuah",       color: "#143F35" },
  { emoji: "🚫", title: "الربا",             desc: "تعريف الربا وأنواعه وحرمة الفائدة، مع البدائل الشرعية وضوابط التحرز من الشبهات المعاصرة.",           href: "/riba",         color: "#991B1B" },
  { emoji: "💍", title: "النكاح",            desc: "أركان عقد النكاح وشروطه والمهر وحقوق الزوجين، مع المحاذير الشرعية في العقود.",                      href: "/nikah",        color: "#7C3AED" },
  { emoji: "📄", title: "الطلاق والعدة",     desc: "أنواع الطلاق والعدة والخلع وأدب الفراق وحفظ حقوق الأولاد بعد الفرقة.",                             href: "/talaq",        color: "#5B21B6" },
  { emoji: "🐐", title: "الأضحية",           desc: "حكم الأضحية وشروطها ووقتها وعيوبها المانعة وآداب الذبح والتوزيع.",                                  href: "/udhiya",       color: "#0F766E" },
  { emoji: "📖", title: "الرقية الشرعية",    desc: "مشروعية الرقية وضوابط التوحيد وما يُحذر منه من الشرك والدجل، مع الجمع بين الرقية والطب.",         href: "/ruqya",        color: "#0F5132" },
  { emoji: "🕊️", title: "الوقف",             desc: "حقيقة الوقف وشروطه وأمانة النظّار، والفرق بينه وبين الصدقة الجارية المعاصرة.",                     href: "/waqf",         color: "#226A56" },
  { emoji: "🤲", title: "الصدقة",            desc: "فضل الصدقة وآداب الإنفاق والفرق بينها وبين الزكاة، وصدقة كل معروف.",                               href: "/sadaqa",       color: "#065F46" },
  { emoji: "⚖️", title: "المواريث",          desc: "حاسبة الفرائض: توزيع التركة على الورثة وفق أنصبتهم الشرعية، مع بيان الحجب والعصبة والمسائل الشائعة.",         href: "/mawarith",     color: "#DC2626" },
  { emoji: "📐", title: "القواعد الفقهية",   desc: "القواعد الفقهية الكبرى: اليقين لا يزول بالشك والمشقة تجلب التيسير وغيرها، مع أمثلة تطبيقية في الفروع.",   href: "/fiqh-qawaid",  color: "#143F35" },
  { emoji: "📚", title: "المذاهب الأربعة",   desc: "المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي، مؤسسوها ومناهجها ومصادرها وانتشارها.", href: "/madhahib",  color: "#7C3AED" },
  { emoji: "❓", title: "الأسئلة والأجوبة",  desc: "الأسئلة والأجوبة الشرعية: مسائل يطرحها طلاب العلم مع إجابات موثّقة بالأدلة من القرآن والسنة والإجماع.",              href: "/qa",           color: "#0F766E" },
  { emoji: "🏛️", title: "المجمع الفقهي",    desc: "قرارات المجامع الفقهية المعتمدة في النوازل والمسائل المختلف فيها، مع بيان الأدلة والترجيح.",          href: "/fiqh-council", color: "#0F5132" },
  { emoji: "📋", title: "الأحكام الشرعية",   desc: "موسوعة الأحكام الشرعية: فتاوى وأحكام موثّقة بالأدلة من القرآن والسنة وقول العلماء المعتمدين.",        href: "/rulings",      color: "#065F46" },
  { emoji: "🤝", title: "المعاملات",        desc: "أحكام المعاملات: البيع والإجارة والشركات والغرر، مع ضوابط الحلال والحرام في التجارة.",           href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#0F766E" },
  { emoji: "🥩", title: "الأطعمة",          desc: "أحكام الأطعمة والأشربة: الحلال والحرام والذبائح وشروط الذبح، مع ما يتعلق بالمذبوحات والمشتبهات.",           href: `/rulings?category=${encodeURIComponent("الأطعمة والأشربة")}`, color: "#DC2626" },
  { emoji: "🏥", title: "الفقه الطبي",      desc: "الفقه الطبي: أحكام العلاج والأدوية والعمليات والتبرع بالأعضاء، مع ضوابط الشرع في الطب الحديث.",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#065F46" },
  { emoji: "🏦", title: "المال الإسلامي",   desc: "المال الإسلامي: أحكام البنوك والتأمين والاستثمار والصكوك، مع ضوابط التمويل الحلال.",  href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#143F35" },
  { emoji: "📖", title: "أصول الفقه",      desc: "أصول الفقه: مصادر التشريع من قرآن وسنة وإجماع وقياس، وطرق الاستنباط والترجيح بين الأقوال.",      href: "/learning/paths", color: "#226A56" },
  { emoji: "⚡", title: "النوازل المعاصرة", desc: "النوازل المعاصرة تُحال إلى قرارات المجامع وهيئات الفتوى المعتمدة؛ لا يُفتى فيها ابتداءً هنا بل يُرجع إلى قراراتها.", href: "/fiqh-council/nawazil", color: "#5C5C56" },
  { emoji: "🔐", title: "الحدود والجنايات", desc: "أحكام الحدود والقصاص والديات: شروطها وضوابطها وما يتعلق بالجرائم والعقوبات في الشريعة.",     href: `/rulings?category=${encodeURIComponent("القضاء والحدود")}`,        color: "#991B1B" },
  { emoji: "🌍", title: "فقه الأقليات",    desc: "فقه الأقليات: مسائل المسلمين في غير بلاد الإسلام، عبر قرارات المجمع الفقهي المعتمد والفتاوى الرسمية.", href: "/fiqh-council", color: "#143F35" },
  { emoji: "💻", title: "فقه التقنية",     desc: "فقه التقنية: نوازل الإنترنت والذكاء الاصطناعي والعملات الرقمية، عبر قرارات المجامع الفقهية المعتمدة.",  href: "/fiqh-council/nawazil", color: "#0F766E" },
  { emoji: "🩺", title: "فقه العبادات للمرضى", desc: "فقه العبادات للمرضى: أحكام الصلاة والصيام والطهارة عند العجز أو المرض، مع الرخص الشرعية المعتمدة.",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#5C5C56" },
  { emoji: "🏦", title: "التمويل الإسلامي", desc: "التمويل الإسلامي: الصيرفة الإسلامية والتكافل والاستثمار الحلال، بضوابط الشرع في المعاملات المالية.",        href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#065F46" },
];
