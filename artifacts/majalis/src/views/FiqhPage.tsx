...
const FIQH_TOPICS: FiqhTopic[] = [
  ...
  { emoji: "💍", title: "النكاح والطلاق",   desc: "أحكام النكاح والطلاق: شروط العقد وحقوق الزوجين والمهر والعدة والخلع والفرقة، بالأدلة الشرعية.",         href: `/rulings?category=${encodeURIComponent("الأسرة")}`, color: "#7C3AED" },
  { emoji: "🤝", title: "المعاملات",        desc: "أحكام المعاملات: البيع والإجارة والشركات والربا والغرر، مع ضوابط الحلال والحرام في التجارة.",           href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#0F766E" },
  ...
  { emoji: "🕊️", title: "الوقف والهبة",    desc: "أحكام الوقف والهبة: شروط الوقف والصدقة الجارية والهبة وقبولها، مع ما يتعلق بإدارة الأوقاف.", href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الوقف")}`, color: "#0F5132" },
