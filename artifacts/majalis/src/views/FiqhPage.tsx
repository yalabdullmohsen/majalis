...
const FIQH_TOPICS: FiqhTopic[] = [
  ...
  { emoji: "🏦", title: "المال الإسلامي",   desc: "أحكام البنوك والتأمين والاستثمار",  href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#176B57" },
  ...
  { emoji: "🩺", title: "فقه العبادات للمرضى", desc: "أحكام الصلاة والصيام والطهارة للمرضى",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#374151" },
