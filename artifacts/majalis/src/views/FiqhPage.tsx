...
const FIQH_TOPICS: FiqhTopic[] = [
  ...
  { emoji: "🏦", title: "المال الإسلامي",   desc: "أحكام البنوك والتأمين والاستثمار",  href: "/rulings?cat=المعاملات", color: "#173D35" },
  ...
  { emoji: "🩺", title: "فقه العبادات للمرضى", desc: "أحكام الصلاة والصيام والطهارة للمرضى",   href: "/rulings?cat=الصحة",  color: "#68716D" },
