...
const FIQH_TOPICS: FiqhTopic[] = [
  ...
  { emoji: "🕌", title: "الصلاة",            desc: "أحكام الصلاة وأوقاتها",          href: "/salah-guide",  color: "#143F35" },
  { emoji: "💰", title: "الزكاة",            desc: "أحكام الزكاة وحسابها",           href: "/zakat",        color: "#0F5132" },
  { emoji: "🌙", title: "الصيام",            desc: "أحكام رمضان والنوافل",           href: "/sawm",         color: "#143F35" },
  { emoji: "🕋", title: "الحج والعمرة",       desc: "مناسك الحج والعمرة",             href: "/hajj",         color: "#226A56" },
  { emoji: "🕯️", title: "الجنائز",           desc: "أحكام الجنائز والتعزية",         href: "/janaza",       color: "#5C5C56" },
  ...
  { emoji: "📚", title: "المذاهب الأربعة",   desc: "الحنفي والمالكي والشافعي والحنبلي", href: "/madhahib",  color: "#226A56" },
  ...
  { emoji: "💍", title: "النكاح والطلاق",   desc: "أحكام عقد الزواج والفراق",         href: `/rulings?category=${encodeURIComponent("الأسرة")}`, color: "#B8963F" },
  ...
  { emoji: "🏥", title: "الفقه الطبي",      desc: "أحكام العلاج والأدوية والعمليات",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#065F46" },
  { emoji: "🏦", title: "المال الإسلامي",   desc: "أحكام البنوك والتأمين والاستثمار",  href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#143F35" },
  { emoji: "🕊️", title: "الوقف والهبة",    desc: "أحكام الوقف والصدقة الجارية والهبة", href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الوقف")}`, color: "#0F5132" },
  { emoji: "📖", title: "أصول الفقه",      desc: "مصادر التشريع وطرق الاستنباط",      href: "/learning/paths", color: "#226A56" },
  { emoji: "⚡", title: "النوازل المعاصرة", desc: "مسائل تُحال إلى قرارات المجامع وهيئات الفتوى — لا يُفتى فيها ابتداءً هنا", href: "/fiqh-council/nawazil", color: "#5C5C56" },
  { emoji: "🔐", title: "الحدود والجنايات", desc: "أحكام الحدود والقصاص والديات",     href: `/rulings?category=${encodeURIComponent("القضاء والحدود")}`,        color: "#991B1B" },
  { emoji: "🌍", title: "فقه الأقليات",    desc: "مسائل الأقليات عبر المجمع الفقهي المعتمد", href: "/fiqh-council", color: "#143F35" },
  { emoji: "💻", title: "فقه التقنية",     desc: "نوازل التقنية عبر قرارات المجامع المعتمدة",  href: "/fiqh-council/nawazil", color: "#0F766E" },
  { emoji: "🩺", title: "فقه العبادات للمرضى", desc: "أحكام الصلاة والصيام والطهارة للمرضى",   href: `/rulings?category=${encodeURIComponent("النوازل المعاصرة")}&subcategory=${encodeURIComponent("الطب")}`,  color: "#5C5C56" },
  { emoji: "🏦", title: "التمويل الإسلامي", desc: "الصيرفة والتكافل والاستثمار الحلال",        href: `/rulings?category=${encodeURIComponent("المعاملات")}`, color: "#065F46" },
];
