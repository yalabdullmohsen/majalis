...
/* ── Wudu ── */
const WUDU_FARDH = [
  { num: "١", icon: "🤲", title: "النية", desc: "نية الوضوء في القلب لرفع الحدث؛ «إنما الأعمال بالنيات» — متفق عليه" },
  { num: "٢", icon: "💦", title: "غسل الوجه", desc: "من منابت شعر الرأس إلى الذقن طولاً، ومن أذن إلى أذن عرضاً — المائدة: ٦" },
  { num: "٣", icon: "🖐️", title: "غسل اليدين", desc: "مع المرفقين من رؤوس الأصابع إلى المرفقين — المائدة: ٦" },
  { num: "٤", icon: "🧠", title: "مسح الرأس", desc: "مسح كامل الرأس مرة واحدة عند الجمهور — المائدة: ٦" },
  { num: "٥", icon: "🦶", title: "غسل القدمين", desc: "مع الكعبين من رؤوس الأصابع إلى الكعبين — المائدة: ٦" },
  { num: "٦", icon: "⬇️", title: "الترتيب", desc: "الترتيب بين الأعضاء كما في آية المائدة؛ وهو فرض عند الجمهور" },
];
...
const WUDU_NAWAQIDH = [
  { icon: "💨", title: "خروج الريح", desc: "خروج الريح من الدبر، بصوت أو بغير صوت، ناقض للوضوء باتفاق الفقهاء" },
  { icon: "🚽", title: "خروج البول أو الغائط", desc: "خروج البول أو الغائط من السبيلين ينقض الوضوء ويوجب الاستنجاء أو الاستجمار" },
  { icon: "💤", title: "النوم المستغرق", desc: "النوم الثقيل الذي يزيل الشعور، أما النعاس اليسير فلا ينقض" },
  { icon: "😵", title: "زوال العقل", desc: "الإغماء أو الجنون أو السكر ينقض الوضوء؛ لأنه يزيل الشعور بما يخرج من الإنسان" },
...
const TAYAMMUM_KAYFIYYA = [
  { num: "١", step: "النية", desc: "ينوي بقلبه التيمم لاستباحة الصلاة أو رفع الحدث عند من يقول بذلك" },
  { num: "٢", step: "التسمية", desc: "يقول بسم الله في أول التيمم استحباباً، كما تُستحب في أول الوضوء" },
...
const NAJASAT_ITEMS = [
  ...
  },
  {
    ...
    color: "amber",
    items: [
      { icon: "👶", title: "بول الرضيع الذكر", desc: "يكفي نضحه بالماء إذا كان رضيعاً لم يطعم غير اللبن، بخلاف بول الجارية فيُغسل" },
    ],
  },
  {
    type: "mutawassita",
  ...
  return (
    <main className="th-page" dir="rtl">
      ...
      <section className="th-hero">
        ...
        <div className="th-ayah" style={{ marginTop: "0.75rem" }}>
          <p className="th-ayah__text">
            يَا أَيُّهَا الَّذِينَ آمَنُوا إِذَا قُمْتُمْ إِلَى الصَّلَاةِ فَاغْسِلُوا وُجُوهَكُمْ وَأَيْدِيَكُمْ إِلَى الْمَرَافِقِ وَامْسَحُوا بِرُءُوسِكُمْ وَأَرْجُلَكُمْ إِلَى الْكَعْبَيْنِ
          </p>
          <cite className="th-ayah__ref">المائدة: 6 — أصل فرائض الوضوء</cite>
        </div>
        <p className="th-hero__sub" style={{ marginTop: "0.75rem", fontSize: "0.9rem" }}>
          وقال ﷺ في تعليم الوضوء: «من توضأ نحو وضوئي هذا ثم صلى ركعتين لا يحدّث فيهما نفسه غُفر له ما تقدّم من ذنبه» — البخاري ١٥٩. والطهور شطر الإيمان — مسلم ٢٢٣.
        </p>
