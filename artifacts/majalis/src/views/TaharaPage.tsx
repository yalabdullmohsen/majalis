...
/* ── Wudu ── */
const WUDU_FARDH = [
  { num: "١", icon: "🤲", title: "النية", desc: "نية الوضوء في القلب لرفع الحدث؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. من فرائض أو سنن", evidence: "«إنما الأعمال بالنيات» — متفق عليه: البخاري 1، مسلم 1907. وذهب الحنفية إلى أنها سنة لا فرض." },
  ...
  { num: "٣", icon: "🖐️", title: "غسل اليدين", desc: "مع المرفقين من رؤوس الأصابع إلى المرفقين؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم ال؛ من فرائض أو سنن", evidence: "﴿وَأَيْدِيَكُمْ إِلَى الْمَرَافِقِ﴾ — المائدة: 6." },
  { num: "٤", icon: "🧠", title: "مسح الرأس", desc: "مسح كامل الرأس مرة واحدة عند الجمهور؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتم؛ من فرائض أو سنن", evidence: "﴿وَامْسَحُوا بِرُءُوسِكُمْ﴾ — المائدة: 6. واختلفوا في القدر المجزئ: الجمهور على استيعابه، والشافعية على إجزاء بعضه." },
  { num: "٥", icon: "🦶", title: "غسل القدمين", desc: "مع الكعبين من رؤوس الأصابع إلى الكعبين؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المع؛ من فرائض أو سنن", evidence: "﴿وَأَرْجُلَكُمْ إِلَى الْكَعْبَيْنِ﴾ — المائدة: 6، وقال ﷺ لمن ترك موضعاً في قدمه: «ويلٌ للأعقاب من النار» — متفق عليه." },
...
const WUDU_NAWAQIDH = [
  { icon: "💨", title: "خروج الريح", desc: "من الدبر صوتاً أو بلا صوت؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم المعتمدة. — م؛ من أحكام الفقه", evidence: "«لا وضوء إلا من صوتٍ أو ريح» — رواه الترمذي (74) وحسّنه، وأصله في الصحيحين: «لا ينصرف حتى يسمع صوتاً أو يجد ريحاً»." },
  { icon: "🚽", title: "خروج البول أو الغائط", desc: "من القبل أو الدبر؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم المعتمدة. — من مراجع؛ من أحكام الفقه", evidence: "﴿أَوْ جَاءَ أَحَدٌ مِّنكُم مِّنَ الْغَائِطِ﴾ — المائدة: 6." },
  ...
  { icon: "😵", title: "زوال العقل", desc: "الإغماء أو الجنون أو السكر؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم المعتمدة. من أحكام الفقه", evidence: "قياساً على النوم من باب أولى، لأنه أذهبُ للشعور منه — وعليه إجماع أهل العلم كما نقله ابن المنذر." },
...
const GHUSL_MUJIBAT = [
  ...
  { icon: "🌸", title: "انقطاع الحيض", desc: "يجب على المرأة الغسل بعد انقطاع دم الحيض؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم ال؛ من فرائض أو سنن", evidence: "﴿فَإِذَا تَطَهَّرْنَ فَأْتُوهُنَّ مِنْ حَيْثُ أَمَرَكُمُ اللَّهُ﴾ — البقرة: 222، وقال ﷺ لفاطمة بنت أبي حبيش: «فإذا أدبرت فاغتسلي وصلّي» — متفق عليه." },
  { icon: "🤱", title: "انقطاع النفاس", desc: "يجب الغسل بعد انتهاء دم النفاس؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. من فرائض أو سنن", evidence: "قياساً على الحيض بإجماع أهل العلم، ولأن دم النفاس دم حيضٍ مجتمع." },
  { icon: "☠️", title: "الموت", desc: "يُغسَّل الميت المسلم قبل الصلاة عليه؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم ال؛ من أحكام الفقه", evidence: "قال ﷺ في المحرِم الذي وقصته ناقته: «اغسلوه بماءٍ وسِدر» — متفق عليه." },
  { icon: "☪️", title: "الإسلام", desc: "يُستحب الغسل عند الإسلام وإن قيل بوجوبه؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم الم؛ من فرائض أو سنن", evidence: "أمر النبي ﷺ قيس بن عاصم لما أسلم أن يغتسل — رواه الترمذي (605) وحسّنه؛ وذهب الجمهور إلى الاستحباب وبعضهم إلى الوجوب." },
...
const GHUSL_FARAIDH = [
  { icon: "💭", title: "النية", desc: "نية رفع الجنابة أو الحدث الأكبر؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. من فرائض أو سنن" },
...
const TAYAMMUM_KAYFIYYA = [
  { num: "١", step: "النية", desc: "نية التيمم لاستباحة الصلاة؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. — من م؛ من فرائض أو سنن" },
  { num: "٢", step: "التسمية", desc: "قول بسم الله؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم المعتمدة. — من مراجع مجالس؛ من أحكام الفقه" },
  ...
  { num: "٤", step: "المسح على الوجه", desc: "مسح الوجه كاملاً بباطن الكفين؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. — م؛ من فرائض أو سنن" },
...
const NAJASAT_ITEMS = [
  {
    ...
    items: [
      ...
      { icon: "🐷", title: "الخنزير", desc: "يُحكم بنجاسة ذاته وما يتصل بها من رطوبة؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم؛ من أحكام الفقه" },
    ],
  },
  {
    type: "mukhaffafa",
  ...
  },
  {
    ...
    color: "orange",
    items: [
      { icon: "🩸", title: "الدم السائل والقيح", desc: "يُعفى عن يسيره، ويُغسل الكثير منه؛ من فرائض أو سنن الطهارة؛ يُعتنى به عند الوضوء والغسل — من مراجع مجالس العلم المعتمدة. من فرائض أو سنن" },
      ...
      { icon: "🍺", title: "الخمر السائل", desc: "نجس عند الجمهور، ويطهر بتخليله إلى خل؛ من أحكام الطهارة المعتمدة؛ يُراعى الخلاف الفقهي حيث وُجد — من مراجع مجالس العلم ا؛ من أحكام الفقه" },
...
export default function TaharaPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الطهارة: الوضوء والغسل والتيمم وأنواع المياه والنجاسات؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر؛ من",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "فرائض الوضوء",
          description: "فرائض الوضوء الستة مع الأدلة والأحكام؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر — من مراجع مجالس العلم؛ من فرائض أو سنن",
