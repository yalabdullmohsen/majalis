...
export default function TaharaPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الطهارة: الوضوء والغسل والتيمم وأنواع المياه والنجاسات؛ يُعرض للتعلّم والاطلاع. يُستفاد منه في التعلم والتدبر؛ من",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "فرائض الوضوء",
          description: "فرائض الوضوء الستة مع الأدلة والأحكام؛ يُعرض للتعلّم والاطلاع. يُستفاد منه في التعلم والتدبر — من مراجع المجلس العلمي؛ من فرائض أو سنن",
