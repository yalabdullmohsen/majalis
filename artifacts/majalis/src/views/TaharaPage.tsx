...
const WUDU_NAWAQIDH = [
  ...
  { icon: "🔥", title: "أكل لحم الإبل", desc: "عند الحنابلة، وهو قول لبعض أهل العلم بدليل صحيح", evidence: "سُئل ﷺ: أنتوضأ من لحوم الإبل؟ قال: «نعم» — رواه مسلم (360) من حديث جابر بن سمرة ﵁. وبه قال أحمد وإسحاق، وخالف الجمهور." },
