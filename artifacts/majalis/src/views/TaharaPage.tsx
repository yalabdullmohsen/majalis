...
/* ── Wudu ── */
const WUDU_FARDH = [
  { num: "١", icon: "🤲", title: "النية", desc: "نية الوضوء في القلب لرفع الحدث", evidence: "«إنما الأعمال بالنيات» — متفق عليه: البخاري 1، مسلم 1907. وذهب الحنفية إلى أنها سنة لا فرض." },
  { num: "٢", icon: "💦", title: "غسل الوجه", desc: "من منابت شعر الرأس إلى الذقن طولاً، ومن أذن إلى أذن عرضاً", evidence: "﴿فَاغْسِلُوا وُجُوهَكُمْ﴾ — المائدة: 6." },
  { num: "٣", icon: "🖐️", title: "غسل اليدين", desc: "مع المرفقين من رؤوس الأصابع إلى المرفقين", evidence: "﴿وَأَيْدِيَكُمْ إِلَى الْمَرَافِقِ﴾ — المائدة: 6." },
  { num: "٤", icon: "🧠", title: "مسح الرأس", desc: "مسح كامل الرأس مرة واحدة عند الجمهور", evidence: "﴿وَامْسَحُوا بِرُءُوسِكُمْ﴾ — المائدة: 6. واختلفوا في القدر المجزئ: الجمهور على استيعابه، والشافعية على إجزاء بعضه." },
  { num: "٥", icon: "🦶", title: "غسل القدمين", desc: "مع الكعبين من رؤوس الأصابع إلى الكعبين", evidence: "﴿وَأَرْجُلَكُمْ إِلَى الْكَعْبَيْنِ﴾ — المائدة: 6، وقال ﷺ لمن ترك موضعاً في قدمه: «ويلٌ للأعقاب من النار» — متفق عليه." },
  { num: "٦", icon: "⬇️", title: "الترتيب", desc: "الترتيب بين الأعضاء كما جاء في الآية الكريمة", evidence: "لدلالة ترتيب الأعضاء في آية المائدة: 6، ولفعله ﷺ الذي واظب عليه. وهو فرض عند الشافعية والحنابلة، سنة عند الحنفية والمالكية." },
];
...
const WUDU_NAWAQIDH = [
  { icon: "💨", title: "خروج الريح", desc: "من الدبر صوتاً أو بلا صوت", evidence: "«لا وضوء إلا من صوتٍ أو ريح» — رواه الترمذي (74) وحسّنه، وأصله في الصحيحين: «لا ينصرف حتى يسمع صوتاً أو يجد ريحاً»." },
  { icon: "🚽", title: "خروج البول أو الغائط", desc: "من القبل أو الدبر", evidence: "﴿أَوْ جَاءَ أَحَدٌ مِّنكُم مِّنَ الْغَائِطِ﴾ — المائدة: 6." },
  { icon: "💤", title: "النوم المستغرق", desc: "النوم الثقيل الذي يزيل الشعور، أما النعاس اليسير فلا ينقض", evidence: "«العينُ وِكاءُ السَّهِ، فمن نام فليتوضأ» — رواه أبو داود (203) وحسّنه الألباني؛ ولحديث صفوان: «كان يأمرنا ألا ننزع خفافنا... إلا من جنابة، لكن من غائط وبول ونوم» — رواه الترمذي (96) وحسّنه." },
  { icon: "😵", title: "زوال العقل", desc: "الإغماء أو الجنون أو السكر", evidence: "قياساً على النوم من باب أولى، لأنه أذهبُ للشعور منه — وعليه إجماع أهل العلم كما نقله ابن المنذر." },
  { icon: "👄", title: "لمس الفرج", desc: "باليد مباشرة بشهوة أو بلا شهوة عند الجمهور", evidence: "«من مسّ ذكره فليتوضأ» — رواه الترمذي (82) وصححه؛ وذهب الحنفية إلى عدم النقض لحديث طلق بن علي، والمسألة خلافية معتبرة." },
  { icon: "🔥", title: "أكل لحم الإبل", desc: "عند الحنابلة، وهو قول لبعض أهل العلم بدليل صحيح", evidence: "سُئل ﷺ: أنتوضأ من لحوم الإبل؟ قال: «نعم» — رواه مسلم (360) من حديث جابر بن سمرة رضي الله عنه. وبه قال أحمد وإسحاق، وخالف الجمهور." },
...
/* ── Ghusl ── */
const GHUSL_MUJIBAT = [
  { icon: "🌙", title: "الجنابة", desc: "بإنزال المني أو الجماع، وهي أعظم موجبات الغسل", evidence: "﴿وَإِن كُنتُمْ جُنُبًا فَاطَّهَّرُوا﴾ — المائدة: 6، وقال ﷺ: «إذا جلس بين شعبها الأربع ثم جهدها فقد وجب الغسل» — متفق عليه." },
  { icon: "🌸", title: "انقطاع الحيض", desc: "يجب على المرأة الغسل بعد انقطاع دم الحيض", evidence: "﴿فَإِذَا تَطَهَّرْنَ فَأْتُوهُنَّ مِنْ حَيْثُ أَمَرَكُمُ اللَّهُ﴾ — البقرة: 222، وقال ﷺ لفاطمة بنت أبي حبيش: «فإذا أدبرت فاغتسلي وصلّي» — متفق عليه." },
  { icon: "🤱", title: "انقطاع النفاس", desc: "يجب الغسل بعد انتهاء دم النفاس", evidence: "قياساً على الحيض بإجماع أهل العلم، ولأن دم النفاس دم حيضٍ مجتمع." },
  { icon: "☠️", title: "الموت", desc: "يُغسَّل الميت المسلم قبل الصلاة عليه", evidence: "قال ﷺ في المحرِم الذي وقصته ناقته: «اغسلوه بماءٍ وسِدر» — متفق عليه." },
  { icon: "☪️", title: "الإسلام", desc: "يُستحب الغسل عند الإسلام وإن قيل بوجوبه", evidence: "أمر النبي ﷺ قيس بن عاصم لما أسلم أن يغتسل — رواه الترمذي (605) وحسّنه؛ وذهب الجمهور إلى الاستحباب وبعضهم إلى الوجوب." },
