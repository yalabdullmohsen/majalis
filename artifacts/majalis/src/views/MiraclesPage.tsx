...
export default function MiraclesPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "موضوعات تُعرض بحذر للتأمل في دلائل الآيات الكونية عند ثبوت المعنى؛ المعتمد في منهج الموقع: الإعجاز البياني والغيبي والتشريعي — لا إعجاز عددي ولا ربط بنظريات قابلة للنقض. محتوى تعليمي معتمد في منهج مجالس العلم",
