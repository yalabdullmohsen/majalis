...
export default function MiraclesPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "موضوعات تُعرض بحذر للتأمل في دلائل الآيات الكونية عند ثبوت المعنى؛ المعتمد في منهج الموقع: الإعجاز البياني والغيبي والتشريعي — لا إعجاز",
      ...
      jsonLd: [
        {
          ...
          description: "موضوعات للتأمل في آيات الخلق مع تنبيه منهجي على حدود الاستدلال؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
