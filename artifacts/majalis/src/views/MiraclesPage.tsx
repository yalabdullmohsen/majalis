...
export default function MiraclesPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "موضوعات تُعرض بحذر للتأمل في دلائل الآيات الكونية عند ثبوت المعنى؛ المعتمد في منهج الموقع: الإعجاز البياني والغيبي والتشريعي — لا إعجاز عددي ولا ربط بنظريات قابلة للنقض. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      ...
      jsonLd: [
        {
          ...
          description: "موضوعات للتأمل في آيات الخلق مع تنبيه منهجي على حدود الاستدلال؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في م؛ محتوى تعليمي معتمد في منهج مجالس العلم",
