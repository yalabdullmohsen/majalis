  ...
  return (
    <LegalPageLayout eyebrow="تفضيلات المستخدم" title="الإعدادات">
      ...
      <LegalSection title="الواجهة">
        ...
        <p className="settings-note">يُطبَّق حجم الخط على جميع صفحات المنصة بما فيها المصحف والقراءة.</p>
        <label className="settings-field">
      ...
      <LegalSection title="الخصوصية والأمان">
        ...
        <div className="settings-actions">
          <button type="button" className="ui-card-btn" onClick={() => {
            const blob = new Blob([JSON.stringify({ preferences, themePreference }, null, 2)], { type: "application/json" });
