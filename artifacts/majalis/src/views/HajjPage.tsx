...
const WAJIBAT: WajibHajj[] = [
  ...
  },
  {
    ...
    description: "المبيت بمزدلفة ليلة العاشر، والوقوف بها حتى بعد منتصف الليل على الأقل — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر.",
    penalty: "دم",
  },
  {
    id: "rami",
...
const MASHAER: Mashar[] = [
  ...
  },
  {
    ...
    desc: "وادٍ قريب من مكة يمكث فيه الحجاج ليلة الثامن ويرمون فيه الجمرات في أيام التشريق يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب.",
  ...
  },
  {
    ...
    icon: "🕋",
    day: "طوال الحج",
    desc: "بيت الله الحرام في مكة، تتجه إليه القلوب في الصلاة، ويطاف بها في مناسك الحج والعمرة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب.",
...
const UMRA_STEPS: UmraStep[] = [
  { num: 1, icon: "🕌", title: "الإحرام من الميقات (ركن/شرط)", desc: "النية من الميقات مع التلبية؛ والاغتسال ولبس الإزار للرجال سنة. قال ﷺ: «هن لهن ولمن أتى عليهن من غيرهن ممن أراد الحج والعمرة» — متفق عليه" },
...
export default function HajjPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الحج والعمرة: الأركان والواجبات والسنن والمشاعر والدعاء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة.",
        ...
        {tab === "overview" && (
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-fadl-grid">
              {[
                { icon: "🏆", text: "الحج المبرور ليس له جزاء إلا الجنة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة.", ref: "متفق عليه" },
                { icon: "✨", text: "من حج فلم يرفث ولم يفسق رجع كيوم ولدته أمه — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم.", ref: "متفق عليه" },
                { icon: "💰", text: "تابعوا بين الحج والعمرة فإنهما ينفيان الفقر والذنوب — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.", ref: "سنن الترمذي، صحيح" },
                { icon: "📿", text: "العمرة إلى العمرة كفارة لما بينهما، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة.", ref: "متفق عليه" },
                { icon: "🌍", text: "وفد الله ثلاثة: الحاج والمعتمر والغازي — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم.", ref: "النسائي، صحيح" },
                { icon: "🤲", text: "الحاج والمعتمر من وفد الله؛ دعاهم فأجابوه وسألوه فأعطاهم — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.", ref: "ابن ماجه، حسن" },
              ].map((f) => (
