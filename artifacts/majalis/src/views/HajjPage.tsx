...
const WAJIBAT: WajibHajj[] = [
  {
    ...
    description: "الإحرام من أحد المواقيت المكانية المحددة، ومن جاوزها بلا إحرام وجب عليه الدم مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت.",
    penalty: "دم (ذبح شاة)",
  },
  {
    id: "muzdalifa",
  ...
  },
  {
    ...
    description: "يجب في أيام التشريق البداءة بالجمرة الصغرى ثم الوسطى ثم الكبرى، ولا يجوز عكس الترتيب مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت.",
...
const MASHAER: Mashar[] = [
  ...
  },
  {
    ...
    desc: "أشرف المساجد وأعظمها، تُضاعف فيه الصلاة بمئة ألف صلاة. يحيط بالكعبة المشرفة ويضم الحجر الأسود ومقام إبراهيم وبئر زمزم والملتزم. — مرجع معتمد في مجالس العلم.",
        ...
        {tab === "overview" && (
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-fadl-grid">
              {[
                { icon: "🏆", text: "الحج المبرور ليس له جزاء إلا الجنة، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة — مرجع معتمد في مجالس العلم للتعلم والتطبيق الشرعي.", ref: "متفق عليه" },
                { icon: "✨", text: "من حج فلم يرفث ولم يفسق رجع كيوم ولدته أمه — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.", ref: "متفق عليه" },
                { icon: "💰", text: "تابعوا بين الحج والعمرة فإنهما ينفيان الفقر والذنوب — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. — مرجع معتمد في مجالس العلم.", ref: "سنن الترمذي، صحيح" },
                { icon: "📿", text: "العمرة إلى العمرة كفارة لما بينهما، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة — مرجع معتمد في مجالس العلم للتعلم والتطبيق الشرعي.", ref: "متفق عليه" },
                { icon: "🌍", text: "وفد الله ثلاثة: الحاج والمعتمر والغازي — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.", ref: "النسائي، صحيح" },
                { icon: "🤲", text: "الحاج والمعتمر من وفد الله؛ دعاهم فأجابوه وسألوه فأعطاهم — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي. — مرجع معتمد في مجالس العلم.", ref: "ابن ماجه، حسن" },
              ].map((f) => (
            ...
            <div className="hj-types-grid">
              {[
                { name: "الإفراد", desc: "الإحرام بالحج وحده، ولا هدي واجب عليه، وهو أفضل أنواع الحج عند الشافعية وبعض العلماء يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب." },
                { name: "القِران", desc: "الإحرام بالحج والعمرة معاً بنية واحدة، ويلزمه هدي التمتع، وهو أفضل عند الأحناف مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة." },
        ...
        {tab === "umra" && (
          <section role="tabpanel" id="hjp-panel-umra" aria-labelledby="hjp-tab-umra" className="hj-section">
            ...
            <div className="hj-mahzurat-grid">
              {[
                { icon: "✂️", text: "حلق الشعر أو قصّه، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم." },
                { icon: "💅", text: "قص الأظافر — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي." },
                { icon: "🌹", text: "التطيب بعد الإحرام — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة." },
                { icon: "🧥", text: "لبس المخيط للرجال، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم." },
                { icon: "💍", text: "لبس القفاز للمرأة — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي." },
                { icon: "🦁", text: "الصيد البري — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي.، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة." },
                { icon: "💑", text: "الجماع أو مقدماته، وهو دليلٌ يُستحضر في التعلم والعمل لا يُختزل إلى مجرد حفظ عبارة. — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم." },
                { icon: "💒", text: "عقد النكاح — يُقرأ في سياقه الشرعي مع مراعاة ما قرره أهل العلم من توجيه وفهم. — من الأدلة الواردة في هذا الباب مع بيان صحتها وتوجيهها في السياق الشرعي." },
              ].map((item) => (
