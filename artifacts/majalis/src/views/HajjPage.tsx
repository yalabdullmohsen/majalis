...
const WAJIBAT: WajibHajj[] = [
  ...
  },
  {
    ...
    description: "المبيت بمزدلفة ليلة العاشر، والوقوف بها حتى بعد منتصف الليل على الأقل — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر. — مرجع معتمد في مجالس العلم.",
    penalty: "دم",
  },
  {
    id: "rami",
    icon: "🪨",
    title: "رمي الجمرات",
    description: "رمي جمرة العقبة يوم العيد، ورمي الجمرات الثلاث في أيام التشريق يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    description: "حلق الرأس أو تقصيره بعد رمي جمرة العقبة، والحلق أفضل للرجال مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت. — مرجع معتمد في مجالس العلم.",
    penalty: "دم",
  },
  {
    id: "mabeet-mina",
    icon: "⛺",
    title: "المبيت بمنى",
    description: "المبيت بمنى ليالي أيام التشريق (11، 12، وللمتعجل، 13 للمتأخر) — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر. — مرجع معتمد في مجالس العلم.",
    penalty: "دم",
  },
  {
    id: "tawaf-wada",
    icon: "👋",
    title: "طواف الوداع",
    description: "آخر عمل يفعله الحاج قبل مغادرة مكة، ويُعفى عنه الحائض والنفساء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. — مرجع معتمد في مجالس العلم.",
    penalty: "دم",
  },
  {
    id: "tartib-rami",
  ...
  },
  {
    ...
    description: "يجب أن يكون رمي الجمرات في أيام التشريق (11، 12، 13) بعد زوال الشمس ولا يجوز قبله. أما جمرة العقبة يوم النحر فيجوز رميها من منتصف الليل. — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    description: "يجب أداء صلاتَي المغرب والعشاء جمعاً تأخيراً بمزدلفة؛ ولا يُصلَّيان قبل الوصول إليها إلا لمن يخشى خروج الوقت. جمهور الفقهاء على أنه واجب. — مرجع معتمد في مجالس العلم.",
...
const MASHAER: Mashar[] = [
  {
    ...
    icon: "📍",
    day: "قبل الإحرام",
    desc: "المواقيت المكانية هي الحدود التي يُحرم منها الحاج والمعتمر. للمدينة: ذو الحليفة. للشام: الجحفة. لليمن: يلملم. لنجد: قرن المنازل. للمشرق: ذات عِرق. — مرجع معتمد في مجالس العلم.",
  },
  {
    id: "mina",
    name: "منى",
    ...
    desc: "وادٍ قريب من مكة يمكث فيه الحجاج ليلة الثامن ويرمون فيه الجمرات في أيام التشريق يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب. — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    icon: "⛰️",
    day: "9 ذو الحجة",
    desc: "الوقوف بعرفة ركن الحج الأعظم. تقع على بعد 20 كم من مكة. يمتد وقت الوقوف من زوال الشمس يوم 9 إلى فجر 10 مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة.",
  ...
  },
  {
    ...
    desc: "منطقة بين عرفات ومنى. يُبيت بها الحاج ويُصلي المغرب والعشاء جمعاً وقصراً ويجمع حصى الجمرات — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال.",
  ...
  },
  {
    ...
    icon: "🕋",
    day: "طوال الحج",
    desc: "بيت الله الحرام في مكة، تتجه إليه القلوب في الصلاة، ويطاف بها في مناسك الحج والعمرة يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب. — مرجع معتمد في مجالس العلم.",
...
export default function HajjPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الحج والعمرة: الأركان والواجبات والسنن والمشاعر والدعاء يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة. — مرجع معتمد في مجالس العلم.",
          ...
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-types-grid">
              {[
                ...
                { name: "التمتع", desc: "الإحرام بالعمرة أولاً ثم يتحلل ثم يُحرم بالحج في أشهره، ويلزمه الهدي، وهو أفضل عند أحمد وكثير من المحدثين — من الأحكام والآداب الشرعية المأثورة مع بيانها في السياق دون اختزال." },
              ].map((t) => (
