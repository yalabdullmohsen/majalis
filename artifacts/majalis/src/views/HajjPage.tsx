...
const WAJIBAT: WajibHajj[] = [
  {
    ...
    description: "الإحرام من أحد المواقيت المكانية المحددة، ومن جاوزها بلا إحرام وجب عليه الدم مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت. من فرائض أو سنن الطهارة الشرعية",
    penalty: "دم (ذبح شاة)",
  },
  {
    id: "muzdalifa",
  ...
  },
  {
    ...
    description: "يجب على الحاج ألا يُفيض من عرفة إلا بعد غروب الشمس يوم التاسع؛ فمن انصرف قبل الغروب ولم يعد إلى عرفة قبل طلوع فجر العاشر وجب عليه دم عند جمهور العلماء. من أحكام العبادات عند أهل العلم",
...
const MASHAER: Mashar[] = [
  ...
  },
  {
    ...
    desc: "ثلاث جمرات في منى تُرمى في أيام التشريق: الجمرة الصغرى، الوسطى، والكبرى (العقبة). يُبدأ بالصغرى في أيام التشريق مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة.",
  ...
  },
  {
    ...
    desc: "أشرف المساجد وأعظمها، تُضاعف فيه الصلاة بمئة ألف صلاة. يحيط بالكعبة المشرفة ويضم الحجر الأسود ومقام إبراهيم وبئر زمزم والملتزم. — مرجع معتمد في مجالس العلم. من فرائض أو سنن الطهارة الشرعية",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الحج",
          description: "أركان الحج وأحكامه وخطواته التفصيلية مع الإحالة إلى الأدلة والتفصيل في الأقسام التالية لمن أراد التوسع والتثبت. — دليل عملي منظم يُقرأ للتعلم والعمل لا للاختزال، مع مراعاة الخلاف المعتبر.",
        ...
        {tab === "overview" && (
          <section role="tabpanel" id="hjp-panel-overview" aria-labelledby="hjp-tab-overview" className="hj-section">
            ...
            <div className="hj-types-grid">
              {[
                { name: "الإفراد", desc: "الإحرام بالحج وحده، ولا هدي واجب عليه، وهو أفضل أنواع الحج عند الشافعية وبعض العلماء يُستحسن التثبت من الدليل والعمل بما يرضي الله تعالى في هذا الباب. من أحكام العبادات عند أهل العلم" },
                { name: "القِران", desc: "الإحرام بالحج والعمرة معاً بنية واحدة، ويلزمه هدي التمتع، وهو أفضل عند الأحناف مع التنبيه على ما يُستحب وما يُكره وفق ما ثبت من الكتاب والسنة الصحيحة. من فرائض أو سنن الطهارة الشرعية" },
