...
export default function MutashabihatPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم مع نصوص الآيات وتلميحات الاختلاف الدقيق. عرض موثّق ضمن منهج سُنّة",
      keywords: ["الآيات المتشابهات", "متشابه القرآن", "حفظ القرآن", "تلاوة القرآن"],
      jsonLd: [{
        "@context": "https://schema.org",
        "@type": "WebPage",
        name: "الآيات المتشابهات في القرآن",
        description: "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم. عرض موثّق ضمن منهج سُنّة",
