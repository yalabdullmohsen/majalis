...
const S = {
  ...
  hero: {
    ...
    background: "linear-gradient(160deg, #0d2d22 0%, #143F35 60%, #1a4535 100%)",
  },
          ...
          <div style={{ marginTop: "1rem" }}>
            {pair.refs.map((ref, i) => (
              <div key={i} style={{ marginBottom: "0.75rem" }}>
                <div style={{ fontSize: "0.75rem", fontWeight: 700, color: "#226A56", marginBottom: "0.3rem" }}>
...
export default function MutashabihatPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم مع نصوص الآيات وتلميحات الاختلاف الدقيق. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم........................................................................................................................................................................................................................................................................................................................................................................",
      keywords: ["الآيات المتشابهات", "متشابه القرآن", "حفظ القرآن", "تلاوة القرآن"],
      jsonLd: [{
        "@context": "https://schema.org",
        "@type": "WebPage",
        name: "الآيات المتشابهات في القرآن",
        description: "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس ا؛ محتوى تعليمي معتمد في منهج مجالس العلم",
          ...
          {["الكل", ...MUTASHABIHAT_CATEGORIES].map((cat) => (
            <button
              ...
              style={{
                ...
                borderRadius: "20px",
                border: "1.5px solid",
                borderColor: activeCategory === cat ? "#226A56" : "var(--ds-border,#e5e7eb)",
                background: activeCategory === cat ? "#226A56" : "transparent",
