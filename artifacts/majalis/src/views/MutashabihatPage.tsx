...
export default function MutashabihatPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم مع نصوص الآيات وتلميحات الاختلاف الدقيق. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      keywords: ["الآيات المتشابهات", "متشابه القرآن", "حفظ القرآن", "تلاوة القرآن"],
      jsonLd: [{
        "@context": "https://schema.org",
        "@type": "WebPage",
        name: "الآيات المتشابهات في القرآن",
        description: "نظام متخصص لدراسة الآيات المتشابهات في القرآن الكريم. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس ا",
