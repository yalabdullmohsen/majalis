...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    desc: "المراجعة بالاختبار ترسّخ العلم أكثر من القراءة وحدها. اختبر معلوماتك بلعبة الأسئلة، راجع بالبطاقات، أو استخدم الخرائط الذهنية لتنظيم ما حفظته. محتوى معتمد في منهج مجالس العلم",
    Icon: Puzzle,
    links: [
