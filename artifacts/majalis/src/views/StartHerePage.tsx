...
const STEPS: Step[] = [
  {
    ...
    desc: "ابدأ بمعرفة أركان الإيمان وأركان الإسلام، فهما الأساس الذي تُبنى عليه كل علوم الشريعة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    Icon: Star,
    links: [
  ...
  },
  {
    ...
    desc: "الصلاة عماد الدين. تعلّم كيفية الطهارة الصحيحة ثم دليل الصلاة المفصل. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد",
    Icon: Moon,
    links: [
  ...
  },
  {
    ...
    desc: "دراسة سيرته ﷺ توثّق الصلة بالنبي وتُرسّخ الإيمان بمصداقية الرسالة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في",
    Icon: BookMarked,
    links: [
  ...
  },
  {
    ...
    desc: "أذكار الصباح والمساء حصن يومي لا غنى عنه. ابدأ بالصباح ثم المساء. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في ",
    Icon: Heart,
    links: [
  ...
  },
  {
    num: 6,
    title: "الفقه العملي",
    desc: "تعلّم الفقه المتعلق بحياتك اليومية: الصيام، الزكاة، الحج إن استطعت. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد ف",
    Icon: Scroll,
    links: [
  ...
  },
  {
    ...
    desc: "انضم إلى دروس العلماء الأسبوعية. المداومة على مجلس علم مع شيخ من أعظم أسباب الثبات. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    Icon: GraduationCap,
    links: [
  ...
  },
  {
    num: 9,
    title: "توسيع المعرفة",
    desc: "بعد الأساسيات توسّع في العلوم: الأحاديث، علوم القرآن، الفقه المقارن، السيرة التفصيلية. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    Icon: Target,
    links: [
      ...
      jsonLd: [
        {
          ...
          description: "مسار تعريفي مرتّب لطالب العلم المبتدئ؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع ت",
