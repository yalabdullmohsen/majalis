...
export default function StartHerePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مسار تعريفي مرتّب لطالب العلم المبتدئ: العقيدة، الصلاة، السيرة، القرآن (بما فيه المصحف كاملاً ٦٠٤ صفحة)، الأذكار، الفقه، الدروس، والمراجعة بالاختبارات. خطوات واضحة بروابط مباشرة. محتوى تعليمي للمبتدئ في الإسلام",
