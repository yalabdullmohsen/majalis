...
const STEPS: Step[] = [
  {
    ...
    desc: "ابدأ بمعرفة أركان الإيمان وأركان الإسلام، فهما الأساس الذي تُبنى عليه كل علوم الشريعة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Star,
    links: [
  ...
  },
  {
    ...
    desc: "الصلاة عماد الدين. تعلّم كيفية الطهارة الصحيحة ثم دليل الصلاة المفصل. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Moon,
    links: [
  ...
  },
  {
    ...
    desc: "دراسة سيرته ﷺ توثّق الصلة بالنبي وتُرسّخ الإيمان بمصداقية الرسالة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: BookMarked,
    links: [
  ...
  },
  {
    num: 4,
    title: "القرآن الكريم",
    desc: "اقرأ المصحف كاملاً بترقيم مصحف المدينة (٦٠٤ صفحة) بخط عثماني واضح، أو ابدأ من مركز القرآن للتلاوة والتفسير. ابدأ بصفحتين يومياً واستخدم الورد اليومي للمتابعة. محتوى معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: BookOpen,
    links: [
  ...
  },
  {
    ...
    desc: "أذكار الصباح والمساء حصن يومي لا غنى عنه. ابدأ بالصباح ثم المساء. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Heart,
    links: [
  ...
  },
  {
    num: 6,
    title: "الفقه العملي",
    desc: "تعلّم الفقه المتعلق بحياتك اليومية: الصيام، الزكاة، الحج إن استطعت. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد ف؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Scroll,
    links: [
  ...
  },
  {
    ...
    desc: "انضم إلى دروس العلماء الأسبوعية. المداومة على مجلس علم مع شيخ من أعظم أسباب الثبات. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: GraduationCap,
    links: [
  ...
  },
  {
    ...
    desc: "المراجعة بالاختبار ترسّخ العلم أكثر من القراءة وحدها. اختبر معلوماتك بلعبة الأسئلة، راجع بالبطاقات، أو استخدم الخرائط الذهنية لتنظيم ما حفظته. محتوى معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Puzzle,
    links: [
  ...
  },
  {
    num: 9,
    title: "توسيع المعرفة",
    desc: "بعد الأساسيات توسّع في العلوم: الأحاديث، علوم القرآن، الفقه المقارن، السيرة التفصيلية. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
    Icon: Target,
    links: [
...
export default function StartHerePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مسار تعريفي مرتّب لطالب العلم المبتدئ: العقيدة، الصلاة، السيرة، القرآن (بما فيه المصحف كاملاً ٦٠٤ صفحة)، الأذكار، الفقه، الدروس، والمراجعة بالاختبارات. خطوات واضحة بروابط مباشرة. محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "مسار تعريفي مرتّب لطالب العلم المبتدئ؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم. — مرجع ت؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ محتوى تعليمي للمبتدئ في الإسلام؛ يُستفاد في البناء العلمي — مرجع مجالس العلم",
