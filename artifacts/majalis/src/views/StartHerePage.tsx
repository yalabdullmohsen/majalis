...
const STEPS: Step[] = [
  ...
  },
  {
    num: 4,
    title: "القرآن الكريم",
    desc: "اقرأ المصحف كاملاً بترقيم مصحف المدينة (٦٠٤ صفحة) بخط عثماني واضح، أو ابدأ من مركز القرآن للتلاوة والتفسير. ابدأ بصفحتين يومياً واستخدم الورد اليومي للمتابعة. محتوى معتمد في منهج مجالس العلم",
    Icon: BookOpen,
    links: [
