...
export default function ProphetStoriesPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قصص ٢٥ نبياً ورسولاً مذكورين في القرآن الكريم، سِيَرهم ومعجزاتهم وأقوامهم والدروس المستفادة، مع خط زمني ومقارنة وأولو العزم. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
