...
const MIRACLES_LIST = [
  ...
  { slug: "idris",    nabi: "إدريس ﷺ", miracle: "رفعه الله مكانًا عليًا",                        ayah: "مريم: ٥٦" },
  { slug: "hud",      nabi: "هود ﷺ",   miracle: "نجاته من العذاب الذي أصاب عادًا",               ayah: "هود: ٥٠" },
  { slug: "ismail",   nabi: "إسماعيل ﷺ", miracle: "الرؤيا والذبح والفداء العظيم",               ayah: "الصافات: ١٠٢" },
  { slug: "ayyub",    nabi: "أيوب ﷺ",  miracle: "كشف الضر بعد البلاء",                          ayah: "الأنبياء: ٨٣" },
  { slug: "harun",    nabi: "هارون ﷺ", miracle: "وزير موسى في الدعوة",                           ayah: "طه: ٢٩" },
  { slug: "yahya",    nabi: "يحيى ﷺ",  miracle: "النبوة والكتاب وهو صبي",                        ayah: "مريم: ١٢" },
];
