...
export default function ProphetStoriesPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قصص ٢٥ نبياً ورسولاً مذكورين في القرآن الكريم، سِيَرهم ومعجزاتهم وأقوامهم والدروس المستفادة، مع خط زمني ومقارنة وأولو العزم. يُعرض للتعلّم والاطلاع. ",
