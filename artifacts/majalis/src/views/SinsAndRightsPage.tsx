...
export default function SinsAndRightsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "منظومة معرفية شرعية مترابطة تشرح أنواع الذنوب والتمييز بين حقوق الله وحقوق العباد وشروط التوبة الصحيحة لكل نوع، مع الأدلة من القرآن والسنة. محتوى معتمد في منهج مجالس العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم",
