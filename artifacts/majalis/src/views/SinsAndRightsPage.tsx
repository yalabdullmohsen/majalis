...
const GUIDE_OPTIONS: { value: string; label: string; steps: string[]; notes?: string[]; needsScholar?: boolean }[] = [
  ...
  },
  {
    ...
    notes: [
      "رد المال واجب شرعي لا تكتمل التوبة بدونه ما أمكن الوصول لصاحبه.",
      "طلب المسامحة يُستحسن إن أمكن دون مفسدة أكبر؛ إن خُشي ضررٌ أعظم يُحال التفصيل لأهل العلم مع ردّ الحق قدر المستطاع.",
    ],
    needsScholar: true,
  },
  {
