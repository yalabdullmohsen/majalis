...
export default function SinsAndRightsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "منظومة معرفية شرعية مترابطة تشرح أنواع الذنوب والتمييز بين حقوق الله وحقوق العباد وشروط التوبة الصحيحة لكل نوع، مع الأدلة من القرآن والسنة. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "شرح أنواع الذنوب والتمييز بين حقوق الله وحقوق العباد وشروط التوبة الصحيحة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي ",
