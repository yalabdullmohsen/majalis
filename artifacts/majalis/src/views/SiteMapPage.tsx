...
const SECTIONS = [
  ...
  },
  {
    ...
    icon: "info",
    links: [
      { href: "/about-us", label: "من نحن",       desc: "رسالتنا ومنهجنا" },
      { href: "/about",    label: "حول التطبيق",  desc: "الأقسام والإصدار" },
      ...
      { href: "/terms",    label: "شروط الاستخدام", desc: "شروط استخدام المنصة" },
