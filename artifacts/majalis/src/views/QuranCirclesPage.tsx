...
export default function QuranCirclesPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل حلقات تحفيظ القرآن قيد التجهيز — أدوات الحفظ وخطط المراجعة متاحة الآن. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي",
