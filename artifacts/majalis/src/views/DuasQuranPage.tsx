...
const DUAS: QuranDua[] = [
  ...
  },
  {
    ...
    category: ["الكل", "الأسرة", "الأنبياء"],
    context: "دعاء زكريا ﵇ بعد أن شاخ، فاستجاب الله له ووهب له يحيى ﵇ مع كِبر سنه وعقم امرأته",
  ...
  },
  {
    ...
    context: "دعاء الربيين المؤمنين مع أنبيائهم عند لقاء العدو، يجمع المغفرة والثبات والنصر عند الشدائد",
  ...
  },
  {
    ...
    context: "قاله نوح ﵇ حين ركب السفينة، ويُستأنس به عند ركوب وسائل السفر مع أذكار الركوب الثابتة في السنة",
  ...
  },
  {
    ...
    category: ["الكل", "الرزق والهداية", "الأنبياء"],
    context: "دعاء سليمان ﵇، قاله بعد ابتلائه وطلب به ملكاً خاصاً لا ينبغي لأحد من بعده؛ فيُقرأ للاعتبار بصدق الافتقار إلى الله لا لطلب ما اختص الله به نبيه",
  ...
  },
  {
    ...
    name: "دعاء طلب العلم",
    category: ["الكل", "الرزق والهداية"],
    context: "من أقصر أدعية القرآن وأجمعها في طلب العلم، أمر الله نبيه ﷺ بقوله، ويُناسب طالب العلم في درسه ومراجعته",
