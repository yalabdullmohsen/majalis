...
const DUAS: QuranDua[] = [
  ...
  },
  {
    ...
    category: ["الكل", "الأسرة", "الأنبياء"],
    context: "قاله زكريا ﵇ وهو شيخ كبير وامرأته عاقر، دعاء صريح بالحاجة مع حسن الظن بالله وعدم اليأس، فاستجاب الله ووهبه يحيى ﵇",
  ...
  },
  {
    ...
    arabic: "رَبِّ إِنِّي مَسَّنِيَ الضُّرُّ وَأَنتَ أَرْحَمُ الرَّاحِمِينَ",
    ref: "الأنبياء: 83",
    name: "دعاء أيوب في الضراء",
    category: ["الكل", "الصبر والنصر", "الأنبياء"],
    context: "دعاء أيوب ﵇ بعد سنوات من المرض والبلاء، قاله دون شكوى صريحة بل بمجرد الإخبار عن حاله مع توسل برحمة الله. فاستجاب الله وكشف ضره وآتاه أهله وضاعف عطاءه",
    benefitTags: ["ضراء", "مرض", "بلاء", "رجاء"],
    prophet: "أيوب ﵇",
  },
  {
    id: "sulayman-shukr",
    ...
    category: ["الكل", "الرزق والهداية", "الأنبياء"],
    context: "قاله سليمان ﵇ حين أُعطي ملكاً عظيماً وسمع نملةً تأمر قومها، فأدرك أن النعمة تستوجب الشكر والعمل لا الغرور. دعاء يجمع شكر النعمة وحسن العمل ودخول زمرة الصالحين",
      ...
      jsonLd: [
        {
          ...
          description: "أجمل أدعية الأنبياء والمؤمنين الواردة في القرآن الكريم",
