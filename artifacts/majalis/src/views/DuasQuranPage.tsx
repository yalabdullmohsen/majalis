...
const DUAS: QuranDua[] = [
  ...
  },
  {
    ...
    context: "دعاء أيوب ﵇ بعد سنوات من البلاء؛ حكاه القرآن بلا شكوى صريحة، بل بالإخبار عن الحال والتوسل برحمة الله، فقال سبحانه بعده: ﴿فَاسْتَجَبْنَا لَهُ فَكَشَفْنَا مَا بِهِ مِن ضُرٍّ﴾ — الأنبياء: 84",
