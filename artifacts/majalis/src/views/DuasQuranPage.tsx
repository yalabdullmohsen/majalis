...
export default function DuasQuranPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "أجمل الأدعية المأثورة من كتاب الله: دعاء الأنبياء والمؤمنين في القرآن الكريم يُعرض بأسلوب تعليمي منضبط يراعي أصول أهل السنة والجماعة دون إغفال الأدلة.",
