...
const DUAS: QuranDua[] = [
  ...
  },
  {
    ...
    context: "كان أكثر دعاء النبي ﷺ كما في الصحيحين عن أنس رضي الله عنه.",
  ...
  },
  {
    ...
    context: "دعاء إبراهيم عليه السلام لنفسه ولذريته بإقامة الصلاة، درس في الاهتمام بأبناء وأحفاد المؤمن",
  ...
  },
  {
    ...
    context: "دعاء موسى عليه السلام حين بعثه الله لفرعون، دعاء العلماء وأهل الدعوة والمتحدثين",
  ...
  },
  {
    ...
    category: ["الكل", "الأسرة", "الأنبياء"],
    context: "دعاء زكريا عليه السلام بعد أن شاخ، فاستجاب الله له ووهب له يحيى عليه السلام وهو شيخ عقيم الامرأة",
  ...
  },
  {
    ...
    category: ["الكل", "الرزق والهداية", "الأنبياء"],
    context: "قاله سليمان عليه السلام حين سمع كلام النملة، دعاء الشكر على النعم وطلب الصلاح والدخول في الصالحين",
  ...
  },
  {
    ...
    context: "دعاء الإخوة في الإيمان، يجمع الاستغفار للسابقين وسلامة الصدر للمؤمنين، وهو من أنقى أدعية الأخوة",
  ...
  },
  {
    ...
    context: "قال ﷺ: «من قرأ بالآيتين من آخر سورة البقرة في ليلة كفتاه» — متفق عليه.",
  ...
  },
  {
    ...
    context: "دعاء إبراهيم عليه السلام للوالدين وعموم المؤمنين؛ يُستحب الإكثار منه دون الجزم بأنه الأفضل مطلقاً.",
  ...
  },
  {
    ...
    category: ["الكل", "الرزق والهداية", "الأنبياء"],
    context: "قاله موسى عليه السلام في مدين حين لم يكن له طعام وهو يحتاج، دعاء المضطر المتوكل على الله",
  ...
  },
  {
    ...
    context: "قاله يوسف عليه السلام بعد أن لمَّ الله شمله وجمعه بأهله، دعاء حسن الخاتمة على الإسلام",
  ...
  },
  {
    ...
    category: ["الكل", "الرزق والهداية", "الأنبياء"],
    context: "دعاء سليمان عليه السلام، قاله بعد ابتلائه، يُستشهد به في طلب ما لا يملكه أحد سواك",
