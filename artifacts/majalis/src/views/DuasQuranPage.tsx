...
const DUAS: QuranDua[] = [
  ...
  },
  {
    ...
    context: "قاله يونس عليه السلام في ظلمات ثلاث، روى النبي ﷺ أنه ما دعا به مكروب إلا فرّج الله عنه",
  ...
  },
  {
    ...
    context: "دعاء إبراهيم عليه السلام للوالدين وعموم المؤمنين، أفضل دعاء لتكريم الوالدين بعد مماتهما",
  ...
  },
  {
    ...
    category: ["الكل", "الصبر والنصر", "الأنبياء"],
    context: "قاله نوح عليه السلام حين ركب السفينة، يُقرأ عند الركوب في السيارة أو السفينة أو الطائرة",
