...
export default function FiqhCouncilResearchAssistantPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "مساعد البحث الفقهي", url: "https://www.ssunnah.com/fiqh-council/assistant", about: { "@type": "Thing", name: "أدوات البحث الفقهي الذكية" } }],
    });
  }, []);
