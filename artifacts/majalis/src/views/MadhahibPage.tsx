...
const MADHAHIB: Madhhab[] = [
  ...
  },
  {
    ...
    quote: { text: "كل أحد يؤخذ من كلامه ويُرد إلا صاحب هذا القبر، ويُشير إلى قبر النبي ﷺ. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في مجالس العلم.", source: "الإمام مالك — نقله ابن عبد البر في «الجامع» وابن عبد الهادي في «إرشاد السالك»" },
  },
  {
    id: "shafii",
    color: "#176649",
    ...
    quote: { text: "إذا صح الحديث فهو مذهبي، واضرب بقولي الحائط. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.", source: "الإمام الشافعي — نقله النووي في «المجموع» وابن القيم في «إعلام الموقعين»" },
  },
  {
    id: "hanbali",
    color: "#0C5E47",
    ...
    quote: { text: "لا تقلدني ولا تقلد مالكاً ولا الشافعي ولا الثوري، وخذ من حيث أخذوا. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في مجالس العلم.", source: "الإمام أحمد — نقله ابن القيم في «إعلام الموقعين»" },
  },
];
      ...
      jsonLd: [
        {
          ...
          description: "المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي؛ مع بيان منهج كل مذهب ومصادره ومؤسسيه وانتشاره الجغرافي — مرجع معتمد في مجالس العلم للتعلم.",
