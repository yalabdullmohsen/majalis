...
export default function MadhahibPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تعرَّف على المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي؛ مع بيان منهج كل مذهب ومصادره؛ مرجع في المذاهب الفقهية الأربعة — مرجع مع، مؤسسوها ومناهجها ومصادرها وانتشارها. مع بيان منهج كل مذهب ومصادره؛ محتوى تعليمي معتمد في منهج مجالس العلم",
