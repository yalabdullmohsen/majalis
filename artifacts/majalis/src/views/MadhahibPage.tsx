...
const MADHAHIB: Madhhab[] = [
  ...
  },
  {
    ...
    summary: "من أكثر المذاهب عنايةً بالنصوص وآثار الصحابة، ويكثر من ذكر الروايات المتعددة في المسألة الواحدة. يتميز بالاهتمام البالغ بالسنة والحديث. من خصائص هذا المذهب الفقهي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
...
export default function MadhahibPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تعرَّف على المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي؛ مع بيان منهج كل مذهب ومصادره؛ مرجع في المذاهب الفقهية الأربعة — مرجع مع، مؤسسوها ومناهجها ومصادرها وانتشارها. مع بيان منهج كل مذهب ومصادره",
