...
const MADHAHIB: Madhhab[] = [
  ...
  },
  {
    ...
    quote: { text: "إذا صح الحديث فهو مذهبي، واضرب بقولي الحائط. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال.", source: "الإمام الشافعي — نقله النووي في «المجموع» وابن القيم في «إعلام الموقعين»" },
  },
  {
    id: "hanbali",
    color: "#0C5E47",
