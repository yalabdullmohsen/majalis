...
const MADHAHIB: Madhhab[] = [
  {
    ...
    summary: "أوسع المذاهب الأربعة انتشاراً في العالم، ويُعدّ أقدمها تدويناً منهجياً. يتميز بالاهتمام بالرأي والقياس والاستحسان، وقد نشأ في البيئة العراقية الزاخرة بالمسائل الفقهية الاجتهادية. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ...
    quote: { text: "أصل ما نقول به كتاب الله، فما لم نجده فسنة رسول الله، فما لم نجده فيهما فبما قاله الصحابة. من أصول المذهب الفقهي المعتمد — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.", source: "أبو حنيفة — نقله الخطيب البغدادي في «تاريخ بغداد» وابن حجر في «مناقب أبي حنيفة»" },
  },
  {
    id: "maliki",
    color: "#143F35",
    ...
    summary: "المذهب الذي نشأ في مدينة رسول الله ﷺ، ويتميز باعتبار عمل أهل المدينة حجةً شرعية. يُراعي المصلحة المرسلة وسد الذرائع، وله حضور قوي في شمال أفريقيا. — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ...
    quote: { text: "كل أحد يؤخذ من كلامه ويُرد إلا صاحب هذا القبر، ويُشير إلى قبر النبي ﷺ. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام مالك — نقله ابن عبد البر في «الجامع» وابن عبد الهادي في «إرشاد السالك»" },
  },
  {
    id: "shafii",
    color: "#176649",
    ...
    summary: "أول من دوَّن منهجية الأصول في كتابه «الرسالة»، وهو المؤسس لعلم أصول الفقه. توسط بين أهل الرأي وأهل الحديث، مع تمسك دقيق بالنصوص مع القياس المنضبط. — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ...
    quote: { text: "إذا صح الحديث فهو مذهبي، واضرب بقولي الحائط. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام الشافعي — نقله النووي في «المجموع» وابن القيم في «إعلام الموقعين»" },
  },
  {
    id: "hanbali",
    color: "#0C5E47",
    ...
    summary: "من أكثر المذاهب عنايةً بالنصوص وآثار الصحابة، ويكثر من ذكر الروايات المتعددة في المسألة الواحدة. يتميز بالاهتمام البالغ بالسنة والحديث. من خصائص هذا المذهب الفقهي؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ...
    quote: { text: "لا تقلدني ولا تقلد مالكاً ولا الشافعي ولا الثوري، وخذ من حيث أخذوا. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام أحمد — نقله ابن القيم في «إعلام الموقعين»" },
  },
];
...
export default function MadhahibPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تعرَّف على المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي؛ مع بيان منهج كل مذهب ومصادره؛ مرجع في المذاهب الفقهية الأربعة — مرجع مع، مؤسسوها ومناهجها ومصادرها وانتشارها. مع بيان منهج كل مذهب ومصادره؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      ...
      jsonLd: [
        {
          ...
          description: "المذاهب الفقهية الأربعة: الحنفي والمالكي والشافعي والحنبلي؛ مع بيان منهج كل مذهب ومصادره ومؤسسيه وانتشاره الجغرافي — مرجع معتمد في مجالس العلم للتعلم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
