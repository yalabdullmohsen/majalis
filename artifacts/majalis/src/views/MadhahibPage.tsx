...
const MADHAHIB: Madhhab[] = [
  {
    ...
    quote: { text: "أصل ما نقول به كتاب الله، فما لم نجده فسنة رسول الله، فما لم نجده فيهما فبما قاله الصحابة. من أصول المذهب الفقهي المعتمد — مرجع معتمد في المجلس العلمي. دليل تعليمي منظم.", source: "أبو حنيفة — نقله الخطيب البغدادي في «تاريخ بغداد» وابن حجر في «مناقب أبي حنيفة»" },
  },
  {
    id: "maliki",
    color: "var(--mj-brand-deep)",
    ...
    quote: { text: "كل أحد يؤخذ من كلامه ويُرد إلا صاحب هذا القبر، ويُشير إلى قبر النبي ﷺ. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في المجلس العلمي. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام مالك — نقله ابن عبد البر في «الجامع» وابن عبد الهادي في «إرشاد السالك»" },
  },
  {
    id: "shafii",
    color: "#176649",
    ...
    quote: { text: "إذا صح الحديث فهو مذهبي، واضرب بقولي الحائط. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع — مرجع معتمد في المجلس العلمي. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام الشافعي — نقله النووي في «المجموع» وابن القيم في «إعلام الموقعين»" },
  },
  {
    id: "hanbali",
    color: "#0C5E47",
    ...
    summary: "من أكثر المذاهب عنايةً بالنصوص وآثار الصحابة، ويكثر من ذكر الروايات المتعددة في المسألة الواحدة. يتميز بالاهتمام البالغ بالسنة والحديث. من",
    ...
    quote: { text: "لا تقلدني ولا تقلد مالكاً ولا الشافعي ولا الثوري، وخذ من حيث أخذوا. من أصول المذهب الفقهي المعتمد يُستحضر في فهم منهج الاستدلال — مرجع معتمد في المجلس العلمي. من أبواب الفقه وأحكامه عند أهل العلم", source: "الإمام أحمد — نقله ابن القيم في «إعلام الموقعين»" },
  },
];
