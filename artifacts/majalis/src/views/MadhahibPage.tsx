...
const MADHAHIB: Madhhab[] = [
  ...
  },
  {
    ...
    summary: "المذهب الذي نشأ في مدينة رسول الله ﷺ، ويتميز باعتبار عمل أهل المدينة حجةً شرعية. يُراعي المصلحة المرسلة وسد الذرائع، وله حضور قوي في شمال أفريقيا. — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    summary: "أول من دوَّن منهجية الأصول في كتابه «الرسالة»، وهو المؤسس لعلم أصول الفقه. توسط بين أهل الرأي وأهل الحديث، مع تمسك دقيق بالنصوص مع القياس المنضبط. — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    summary: "من أكثر المذاهب عنايةً بالنصوص وآثار الصحابة، ويكثر من ذكر الروايات المتعددة في المسألة الواحدة. يتميز بالاهتمام البالغ بالسنة والحديث. من خصائص هذا المذهب الفقهي",
