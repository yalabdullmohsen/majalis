...
const MADHAHIB: Madhhab[] = [
  {
    ...
    summary: "أوسع المذاهب الأربعة انتشاراً في العالم، ويُعدّ أقدمها تدويناً منهجياً. يتميز بالاهتمام بالرأي والقياس والاستحسان، وقد نشأ في البيئة العراقية الزاخرة بالمسائل الفقهية الاجتهادية. محتوى تعليمي معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    summary: "المذهب الذي نشأ في مدينة رسول الله ﷺ، ويتميز باعتبار عمل أهل المدينة حجةً شرعية. يُراعي المصلحة المرسلة وسد الذرائع، وله حضور قوي في شمال أفريقيا. — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    summary: "أول من دوَّن منهجية الأصول في كتابه «الرسالة»، وهو المؤسس لعلم أصول الفقه. توسط بين أهل الرأي وأهل الحديث، مع تمسك دقيق بالنصوص مع القياس المنضبط. — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم",
