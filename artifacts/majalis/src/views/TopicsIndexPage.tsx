...
export default function TopicsIndexPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "استعرض المحتوى الشرعي مجمّعاً حسب الموضوع، فقه، عقيدة، أخلاق، قرآن، حديث، سيرة. آيات وأحاديث وفتاوى ودروس. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
