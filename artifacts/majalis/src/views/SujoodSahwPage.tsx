...
const RULINGS: Ruling[] = [
  {
    ...
    evidence: "حديث عبدالله بن بُحينة ﵁: أن النبي ﷺ قام في صلاة الظهر وعليه جلوس، فلما أتمّ صلاته سجد سجدتين يُكبّر في كل سجدة وهو جالس قبل أن يُسلّم — متفق عليه: البخاري 829، مسلم 570.",
    color: "#7c3aed",
  },
  {
    id: "r2",
    ...
    evidence: "حديث ابن مسعود ﵁ أن النبي ﷺ صلّى الظهر خمساً، فقيل له: أزِيد في الصلاة؟ فقال: «وما ذاك؟» قالوا: صلّيت خمساً، فسجد سجدتين بعدما سلّم — متفق عليه: البخاري 1226، مسلم 572.",
    color: "#0284c7",
  },
  {
    id: "r3",
    ...
    evidence: "عند غلبة الظن: «فليتحرَّ الصواب فليُتمَّ عليه ثم ليُسلّم ثم يسجد سجدتين» — متفق عليه من حديث ابن مسعود ﵁: البخاري 401، مسلم 572. وعند عدم ترجيح شيء: «فليطرح الشكّ وليَبْنِ على ما استيقن، ثم يسجد سجدتين قبل أن يُسلّم» — رواه مسلم 571 من حديث أبي سعيد الخدري ﵁.",
  ...
  },
  {
    ...
    evidence: "حديث أبي هريرة ﵁ في قصة ذي اليدين: سلّم النبي ﷺ من ركعتين في الظهر، فكلّمه ذو اليدين، ثم أتمّ ﷺ ما بقي وسلّم، ثم كبّر وسجد سجدتين ثم سلّم — متفق عليه: البخاري 482، مسلم 573.",
  ...
  },
  {
    ...
    evidence: "داخلٌ في عموم قوله ﷺ: «إذا نسي أحدكم فليسجد سجدتين» — رواه مسلم 572 من حديث ابن مسعود ﵁، وفي رواية: «إذا زاد الرجل أو نقص في صلاته فليسجد سجدتين».",
    color: "#0f766e",
  },
  {
    id: "r7",
    ...
    evidence: "أصله حديث ابن بحينة ﵁ في التشهد الأول — متفق عليه: البخاري 829، مسلم 570؛ فدلّ على أن الواجب المتروك سهواً يُجبَر بسجود السهو.",
  ...
  },
  {
    ...
    evidence: "«يُكبّر في كل سجدة وهو جالس» — متفق عليه من حديث ابن بحينة ﵁: البخاري 829، مسلم 570.",
      ...
      <div className="max-w-3xl mx-auto px-4 mb-8">
        <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-5">
          <p className="text-emerald-900 dark:text-emerald-200 text-sm leading-relaxed">
            ...
            وأصلُ مشروعيته قولُه ﷺ: «إذا نسي أحدكم فليسجد سجدتين» — رواه مسلم (572) من حديث ابن مسعود ﵁،
