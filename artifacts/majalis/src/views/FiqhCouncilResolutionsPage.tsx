...
export default function FiqhCouncilResolutionsPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      title: "قرارات المجمع الفقهي | سُنّة",
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "قرارات المجمع الفقهي", url: "https://www.ssunnah.com/fiqh-council/resolutions", about: { "@type": "Thing", name: "القرارات الفقهية الجماعية الإسلامية" } }],
    });
  }, []);
