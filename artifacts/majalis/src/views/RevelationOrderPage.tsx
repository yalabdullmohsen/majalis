...
export default function RevelationOrderPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "خريطة ترتيب نزول سور القرآن الكريم الـ114 كاملة حسب تسلسل نزولها التاريخي على النبي ﷺ، مع تمييز السور المكية والمدنية. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
