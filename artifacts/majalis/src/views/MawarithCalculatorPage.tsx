...
export default function MawarithCalculatorPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "احسب أنصبة الورثة الشرعية تلقائيًا وفق الفرائض والتعصيب والحجب والعول والردّ، مع شرح خطوة بخطوة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
