...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "100+ فتوى موثقة تشمل فقه المرأة والعبادات والمعاملات والمواريث والنوازل، 55+ حكماً شرعياً، 53+ مسألة فقهية معاصرة، 37+ قرار مجمعي، مع أدلة ومراجع وجلسات المجمع الفقهي.",
    progress: 90,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "65+ معجزة علمية موثّقة من القرآن والسنة في الكون والطب والحيوان والبحار والإنسان وعلم الحشرات والفلك والنبات، مع التحقق العلمي والمراجع.",
    progress: 85,
    status: "beta",
  },
  {
