...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "108 كتاب في التفسير والحديث والفقه والعقيدة والأصول واللغة والبلاغة والتاريخ، مع بحث وتصفية.",
    progress: 93,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "70+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين إلى علماء الكويت والخليج المعاصرين.",
    progress: 90,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "670+ سؤال في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق، بمستويات متعددة وإحصائيات أداء.",
    progress: 90,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "44+ دورة علمية في التفسير والحديث والعقيدة والفقه والنحو والفرائض والسيرة، مع جداول ومتون وروابط تسجيل.",
    progress: 80,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "52+ معجزة علمية موثّقة من القرآن والسنة في الكون والطب والحيوان والنبات والتاريخ، مع التحقق العلمي والمراجع.",
    progress: 83,
    status: "beta",
  },
  {
    title: "الفوائد والنوادر العلمية",
    description: "320+ فائدة منتقاة في العقيدة والفقه والحديث والقرآن والتفسير والسيرة والتربية، بقلم العلماء والمحققين.",
    progress: 80,
    status: "beta",
  },
  {
    title: "القصص الإسلامية",
    description: "19 قصة مفصّلة من تاريخ الصحابة والفتوحات والحضارة الإسلامية، مؤلَّفة بأسلوب أدبي رصين مع التوثيق والمراجع.",
    progress: 78,
    status: "beta",
  },
  {
