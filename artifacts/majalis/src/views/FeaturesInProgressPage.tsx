...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "91+ مصطلح في العقيدة والفقه والحديث والقرآن والسيرة، مع تعريفات دقيقة ومصادر موثّقة.",
    progress: 88,
    status: "beta",
  },
  {
    title: "موسوعة علوم الحديث",
    description: "54+ مصطلح في علوم الحديث، أنواع السند والراوي والجرح والتعديل وكتب الحديث الكبرى.",
    progress: 90,
    status: "beta",
  },
  {
