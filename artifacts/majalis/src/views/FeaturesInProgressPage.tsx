...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "111+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الخليج والعالم المعاصرين؛ منهم الذهبي وابن حجر وابن القيم وابن باز وابن عثيمين والألباني والفوزان والخضير والغفيص والعوني والطريفي، وابن قدامة والرازي والماوردي وابن الصلاح والبغوي والسبكي. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
    title: "مسابقة الاختبار الإسلامي",
    description: "856+ سؤال في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق والأنبياء والفتوحات والأذكار والأمر بالمعروف والحضارة الإسلامية والصيام والهجرة والقراءات وعلوم الحديث، بمستويات متعددة وإحصائيات أداء.",
    progress: 95,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "64+ دورة علمية في التفسير والحديث والعقيدة والفقه والبلاغة والنحو والفرائض والمواريث والأذكار والسيرة وأصول الفقه ومقاصد الشريعة والأربعين النووية وتفسير جزء عم والورقات، مع جداول ومتون وروابط تسجيل.",
    progress: 85,
    status: "beta",
  },
  {
    title: "قسم الإعجاز العلمي",
    description: "90+ معجزة علمية موثّقة من القرآن والسنة في الكون والطب والحيوان والبحار والإنسان وعلم الحشرات والفلك والنبات والحديد والجلد والنجوم والمياه والنحل والنمل والأجنة وتوسع الكون والدورة المائية، مع التحقق العلمي والمراجع.",
    progress: 85,
    status: "beta",
  },
  {
    title: "الفوائد والنوادر العلمية",
    description: "393+ فائدة منتقاة في العقيدة والفقه والحديث والقرآن والتفسير والسيرة والتربية والأخلاق والرقائق والدعاء والأمر بالمعروف والإخلاص والغيبة والصدقة الجارية ومعاني الدنيا، بقلم العلماء والمحققين.",
    progress: 85,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "59+ قصة كاملة غير مختصرة من تاريخ الصحابة والفتوحات والحضارة الإسلامية؛ منها صلاح الدين وطارق بن زياد ومالك بن أنس وخديجة وبدر الكبرى وعمر بن عبدالعزيز وعثمان بن عفان، مع توثيق كامل ودروس مستفادة.",
    progress: 80,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "115+ مصطلح في العقيدة والفقه والحديث والقرآن والسيرة والأصول والبلاغة والتزكية، مع تعريفات دقيقة ومصادر موثّقة.",
    progress: 94,
    status: "beta",
  },
  {
    title: "موسوعة علوم الحديث",
    description: "86+ مصطلح في علوم الحديث، أنواع الأحاديث والسند والراوي والجرح والتعديل وطبقات المحدثين وكتب الحديث الكبرى، مع نقد المتن والرواية بالمعنى والمتواتر.",
    progress: 94,
    status: "beta",
  },
  {
