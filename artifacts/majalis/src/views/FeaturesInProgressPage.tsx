...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "20+ خريطة ذهنية تفاعلية في العقيدة والفقه وأصوله والحديث والتجويد والتفسير والسيرة والبلاغة والزهد والفرائض والتاريخ الإسلامي والصحابة، قابلة للطيّ والتوسيع.",
    progress: 94,
    status: "beta",
  },
  {
