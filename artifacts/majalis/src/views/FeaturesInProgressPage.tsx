...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "91+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الكويت والخليج المعاصرين؛ منهم الذهبي وابن حجر وابن القيم وابن باز وابن عثيمين والألباني وابن الجوزي. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
