...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "81+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الكويت والخليج المعاصرين؛ منهم الترمذي وابن ماجه وأبو داود والبيهقي وابن قدامة وعبد الرزاق الصنعاني وابن الجوزي والليث بن سعد. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
    title: "مسابقة الاختبار الإسلامي",
    description: "780+ سؤال في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق، بمستويات متعددة وإحصائيات أداء.",
    progress: 95,
    status: "beta",
  },
  {
    title: "قسم الفتاوى والأحكام",
    description: "105 فتوى موثقة تشمل فقه المرأة والعبادات والمعاملات والمواريث والنوازل والأيمان والأطعمة، 58+ حكماً شرعياً، 53+ مسألة فقهية معاصرة، 37+ قرار مجمعي، مع أدلة ومراجع وجلسات المجمع الفقهي.",
    progress: 90,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "55+ دورة علمية في التفسير والحديث والعقيدة والفقه والبلاغة والنحو والفرائض والأذكار والسيرة وأصول الفقه والقراءات العشر والحج والعمرة والكلام والرد على الشبهات، مع جداول ومتون وروابط تسجيل.",
    progress: 85,
    status: "beta",
  },
  {
    title: "قسم الإعجاز العلمي",
    description: "72 معجزة علمية موثّقة من القرآن والسنة في الكون والطب والحيوان والبحار والإنسان وعلم الحشرات والفلك والنبات والحديد والجلد والنجوم والمياه، مع التحقق العلمي والمراجع.",
    progress: 85,
    status: "beta",
  },
  {
    title: "الفوائد والنوادر العلمية",
    description: "350+ فائدة منتقاة في العقيدة والفقه والحديث والقرآن والتفسير والسيرة والتربية والأخلاق، بقلم العلماء والمحققين.",
    progress: 83,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "50 قصة مفصّلة من تاريخ الصحابة والفتوحات والحضارة الإسلامية؛ منها مصعب بن عمير وجعفر بن أبي طالب وأم سلمة ونور الدين زنكي وفاطمة الفهري وسليمان القانوني والإمام النووي، مع التوثيق الكامل.",
    progress: 80,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "71+ موضوع في الطب النبوي: الأعشاب كالحبة السوداء والسنا والكمون واليانسون، الأغذية كالتلبينة والتمر والعسل وماء زمزم، الممارسات الصحية كالسواك والمضمضة وسنن الفطرة، مع الأدلة والمستجدات العلمية.",
    progress: 88,
    status: "beta",
  },
  {
