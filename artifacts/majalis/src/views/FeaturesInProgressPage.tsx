...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "105+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الخليج والعالم المعاصرين؛ منهم الذهبي وابن حجر وابن القيم وابن باز وابن عثيمين والألباني والفوزان والخضير والغفيص والعوني والطريفي. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
    title: "مسابقة الاختبار الإسلامي",
    description: "847+ سؤال في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق والأنبياء والفتوحات والأذكار والأمر بالمعروف والحضارة الإسلامية، بمستويات متعددة وإحصائيات أداء.",
    progress: 95,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "385+ فائدة منتقاة في العقيدة والفقه والحديث والقرآن والتفسير والسيرة والتربية والأخلاق والرقائق والدعاء والأمر بالمعروف والإخلاص، بقلم العلماء والمحققين.",
    progress: 83,
    status: "beta",
  },
  {
