...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "78+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الكويت والخليج المعاصرين. 55+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "106+ مصطلح في العقيدة والفقه والحديث والقرآن والسيرة والأصول والبلاغة، مع تعريفات دقيقة ومصادر موثّقة.",
    progress: 91,
    status: "beta",
  },
  {
    title: "موسوعة علوم الحديث",
    description: "69+ مصطلح في علوم الحديث، أنواع السند والراوي والجرح والتعديل وطبقات المحدثين وكتب الحديث الكبرى.",
    progress: 92,
    status: "beta",
  },
  {
