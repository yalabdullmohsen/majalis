...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "108+ فتوى موثقة تشمل فقه المرأة والعبادات والمعاملات والمواريث والنوازل والأيمان والأطعمة والمعاملات الرقمية، 62+ حكماً شرعياً، 56+ مسألة فقهية معاصرة، 37+ قرار مجمعي، مع أدلة ومراجع وجلسات المجمع الفقهي.",
    progress: 90,
    status: "beta",
  },
  {
