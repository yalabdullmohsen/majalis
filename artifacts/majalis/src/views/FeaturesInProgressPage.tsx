...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "86+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الكويت والخليج المعاصرين؛ منهم الترمذي وابن ماجه وأبو داود والبيهقي وابن قدامة وعبد الرزاق الصنعاني وابن الجوزي والذهبي وابن حجر العسقلاني. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
