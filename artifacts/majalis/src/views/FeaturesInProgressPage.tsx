...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: `${COUNTS.books} كتاباً في التفسير والحديث والفقه والعقيدة والأصول واللغة والبلاغة والتاريخ والآداب؛ منها الموافقات للشاطبي والفقه على المذاهب الأربعة والأدب المفرد للبخاري وروضة الطالبين والتحرير والتنوير، مع بحث وتصفية متكاملة.`,
    progress: 95,
    status: "released",
  },
  {
    title: "قسم العلماء والمشايخ",
    description: `${COUNTS.scholars} ترجمة لعلماء من أئمة المذاهب والمحدثين والمفسرين والفقهاء إلى المعاصرين؛ مادة مرجعية أولية تُراجع دوريًا ولا تُعرض كلها كتراجم موثّقة قطعًا.`,
    progress: 92,
    status: "released",
  },
  {
    title: "مسابقة الاختبار الإسلامي",
    description: `${COUNTS.quizQuestions} سؤالاً في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق والأنبياء والفتوحات والأذكار والأمر بالمعروف والحضارة الإسلامية والصيام والهجرة والقراءات وعلوم الحديث، بمستويات متعددة وإحصائيات أداء.`,
    progress: 95,
    status: "released",
  },
  {
    title: "قسم الفتاوى والأحكام",
    description: "مسائل فقهية ونوازل معاصرة وقرارات مجمعية ضمن قسم الفقه والأحكام، مع أدلة ومراجع حيث توفرت، وتنبيه بأن النوازل الشخصية تُحال إلى أهل العلم.",
    progress: 90,
    status: "released",
  },
  {
    title: "موسوعة الأحكام الشرعية",
    description: `${COUNTS.rulings} مسألة فقهية مع أدلة ومراجع حيث توفرت، في الطهارة والصلاة والزكاة والمعاملات والأسرة والميراث والحج والصيام والنوازل.`,
    progress: 90,
    status: "released",
  },
  {
  ...
  },
  {
    ...
    description: `${COUNTS.courses} دورة علمية في التفسير والحديث والعقيدة والفقه والبلاغة والنحو والفرائض والمواريث والأذكار والسيرة وأصول الفقه ومقاصد الشريعة والأربعين النووية وتفسير جزء عم والورقات، مع جداول ومتون وروابط تسجيل.`,
    progress: 85,
    status: "beta",
  },
  {
    title: "قسم الإعجاز العلمي",
    description: `${COUNTS.miracles} موضوعًا في الإعجاز العلمي من إشارات القرآن والسنة، مع مراجع علمية وتنبيه منهجي على حدود الاستدلال — مادة أولية تحتاج مراجعة متخصصة.`,
    progress: 85,
    status: "beta",
  },
  {
    title: "الفوائد والنوادر العلمية",
    description: `${COUNTS.fawaid} فائدة منتقاة في العقيدة والفقه والحديث والقرآن والتفسير والسيرة والتربية والأخلاق والرقائق والدعاء والأمر بالمعروف والإخلاص والغيبة والصدقة الجارية ومعاني الدنيا، بقلم العلماء والمحققين.`,
    progress: 85,
    status: "beta",
  },
  {
    title: "تنبيهات الأذان",
    description: "إعدادات تنبيه الأذان ومواقيت الصلاة — ليست قسم «مكتبة مؤذنين» عامًا في الواجهة.",
    progress: 70,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: `${COUNTS.mindMaps} خريطة ذهنية تفاعلية في العقيدة والفقه ومقاصد الشريعة وأصوله والحديث والتجويد والتفسير والسيرة والبلاغة والزهد والفرائض والتاريخ الإسلامي والصحابة ومراتب العلم، قابلة للطيّ والتوسيع.`,
    progress: 96,
    status: "released",
  },
  {
  ...
  },
  {
    ...
    description: "مصطلحات في العقيدة والفقه والحديث والقرآن والسيرة والأصول والبلاغة والتزكية، مع تعريفات ومصادر عند توفرها.",
    progress: 94,
    status: "released",
  },
  {
    title: "موسوعة علوم الحديث",
    description: "مصطلحات علوم الحديث، أنواع الأحاديث والسند والراوي والجرح والتعديل وطبقات المحدثين وكتب الحديث الكبرى، مع نقد المتن والرواية بالمعنى والمتواتر.",
    progress: 94,
    status: "released",
  },
  {
  ...
  },
  {
    ...
    description: "مناسبات هجرية: أعياد، ليالٍ مفضلة، أيام مستحبة، شهور الحج، وأعمال يُستأنس لها بأدلة من السنة عند ذكرها، مع تمييز الثابت عن المشهور.",
    progress: 82,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "تقليل حزمة JavaScript الرئيسية بنسبة 80%، حِزم منفصلة للأذكار والفتاوى والمجمع الفقهي وقاعدة الأسئلة، تحميل خطوط غير معيق، تحسين Service Worker v17 مع cache-first لأصول الموقع المُبعثرة.",
    progress: 88,
    status: "beta",
  },
  {
    title: "تحسين محركات البحث (SEO)",
    description: "صفحات مُعالَجة مسبقاً بمحتوى HTML كامل تقرؤه محركات البحث، metadata مخصصة لكل صفحة، JSON-LD لصفحات العلماء والكتب ومسارات المحتوى، وsitemap مولَّد آلياً من المسارات المنشورة.",
    progress: 93,
    status: "released",
  },
];
