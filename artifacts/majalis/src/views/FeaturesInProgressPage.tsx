...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "73+ كتاباً في التفسير والحديث والفقه والعقيدة والأصول واللغة، مع بحث وتصفية.",
    progress: 90,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "50+ شيخاً من الكويت والخليج والعالم العربي والتاريخ الإسلامي، مع بيانات كاملة.",
    progress: 88,
    status: "beta",
  },
  {
    title: "قسم الفتاوى والأحكام",
    description: "52+ فتوى موثقة، 30+ حكم شرعي، 20+ مسألة فقهية معاصرة مع أدلة ومراجع.",
    progress: 85,
    status: "beta",
  },
  {
