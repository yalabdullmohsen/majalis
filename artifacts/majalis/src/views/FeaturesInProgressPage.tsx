...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "984+ سؤال في السيرة والفقه والعقيدة والقرآن والتاريخ والرقائق والأنبياء والفتوحات والأذكار والأمر بالمعروف والحضارة الإسلامية والصيام والهجرة والقراءات وعلوم الحديث، بمستويات متعددة وإحصائيات أداء.",
    progress: 95,
    status: "released",
  },
  {
  ...
  },
  {
    ...
    description: "191+ مصطلح في العقيدة والفقه والحديث والقرآن والسيرة والأصول والبلاغة والتزكية، مع تعريفات دقيقة ومصادر موثّقة.",
    progress: 94,
    status: "released",
  },
  {
    title: "موسوعة علوم الحديث",
    description: "98+ مصطلح في علوم الحديث، أنواع الأحاديث والسند والراوي والجرح والتعديل وطبقات المحدثين وكتب الحديث الكبرى، مع نقد المتن والرواية بالمعنى والمتواتر.",
    progress: 94,
    status: "released",
  },
  {
