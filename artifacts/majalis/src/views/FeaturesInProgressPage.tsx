...
const FEATURES: RoadmapFeature[] = [
  ...
  {
    title: "إشارات كونية في الوحي",
    description: `${COUNTS.miracles} موضوعًا للتأمل في آيات الخلق من القرآن والسنة، مع حجب الربط العلمي غير المحرَّر، والتنبيه أن المعتمد منهجيًا هو الإعجاز البياني والغيبي والتشريعي.`,
    progress: 85,
    status: "beta",
  },
  {
