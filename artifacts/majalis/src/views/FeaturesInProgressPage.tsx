...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: `${COUNTS.rulings} حكماً شرعياً موثقاً مع الأدلة والمراجع في الطهارة والصلاة والزكاة والمعاملات والأسرة والميراث والحج والصيام والنوازل.`,
    progress: 90,
    status: "released",
  },
  {
  ...
  },
  {
    ...
    description: `${COUNTS.miracles} معجزة علمية موثّقة من القرآن والسنة في الكون والطب والحيوان والبحار والإنسان وعلم الحشرات والفلك والنبات والحديد والجلد والنجوم والمياه والنحل والنمل والأجنة وتوسع الكون والدورة المائية، مع المراجع العلمية والتنبيه المنهجي على حدود الاستدلال.`,
    progress: 85,
    status: "beta",
  },
  {
  ...
  },
  {
    ...
    description: "مصطلحات في العقيدة والفقه والحديث والقرآن والسيرة والأصول والبلاغة والتزكية، مع تعريفات دقيقة ومصادر موثّقة.",
    progress: 94,
    status: "released",
  },
  {
