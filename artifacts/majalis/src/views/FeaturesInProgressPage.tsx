...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "44 قصة مفصّلة من تاريخ الصحابة والفتوحات والحضارة الإسلامية كطارق بن زياد وابن بطوطة والخوارزمي وابن تيمية والإمام البخاري وأبي ذر الغفاري، مع التوثيق والمراجع.",
    progress: 80,
    status: "beta",
  },
  {
