...
const FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: "78+ عالماً وشيخاً من أئمة المذاهب الأربعة والمحدثين والمفسرين والفقهاء الكبار إلى علماء الكويت والخليج المعاصرين. 61+ صحابي موثق بسيرتهم وفضائلهم.",
    progress: 92,
    status: "beta",
  },
  {
