...
export default function KnowledgeGraphPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description:
        "واجهة تجريبية لاستكشاف علاقات بين مفاهيم إسلامية. هذه الصفحة قيد الإعداد ولا تُعدّ توثيقاً نهائياً للعلاقات المعروضة.",
      keywords: ["رسم بياني معرفي", "علاقات إسلامية", "استكشاف المعرفة"],
      ...
      {tab === "graph" && (
        <div role="tabpanel" id="kng-panel-graph" aria-labelledby="kng-tab-graph">
          ...
          <p className="kng-note">
            هذه الخريطة قيد الإعداد. العلاقات المعروضة للاطلاع الاستكشافي، ولا تُعتمد كتوسيع علمي نهائي حتى تُربط كل علاقة بمصدر موثّق.
          </p>
        </div>
      )}
