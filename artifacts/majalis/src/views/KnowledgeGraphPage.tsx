...
export default function KnowledgeGraphPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "استكشف العلاقات بين المفاهيم الإسلامية، رسم بياني تفاعلي يربط العلماء والكتب والمسائل الفقهية. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
