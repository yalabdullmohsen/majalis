...
const HUQUQ = [
  { num: 1, title: "مئونة التجهيز والدفن", desc: "تُخرج من أصل التركة نفقات تجهيز الميت وتكفينه ودفنه بالمعروف، وهي أول حق يؤخذ. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم", priority: "الأول" },
  ...
  { num: 3, title: "الوصية", desc: "تُنفَّذ الوصية الشرعية وحدّها الأقصى ثلث التركة لغير الوارث؛ «الثلث والثلث كثير» متفق عليه، و«لا وصية لوارث» حسّنه الألباني. من أصول علم الفرائض المعتمد؛ من أبواب الفقه وأحكامه عند أهل العلم", priority: "الثالث" },
...
const ASBAB_MAWAANI = {
  ...
  mawaani: [
    ...
    { title: "الرقّ", desc: "العبد لا يرث ولا يُورث، وهو حكم تاريخي لا وجود لموضوعه الآن؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم" },
  ],
};
...
const MASAIL = [
  ...
  },
  {
    ...
    desc: "زوج + أم + أخوان لأم + إخوة أشقاء. سُمّيت الحِمارية لأن بعض الأشقاء قال لعمر: هبْ أن أبانا كان حماراً! فأشركهم في الثلث. من أحكام المواريث في الفقه الإسلامي؛ من أبواب الفقه وأحكامه عند أهل العلم",
    formula: "الزوج ½ + الأم ⅙ + الإخوة لأم ⅓ + الأشقاء يشاركونهم في الثلث",
  },
  {
    title: "الميراث عبر الحساب",
    desc: "أصل المسألة: أصغر عدد صحيح تنقسم عليه التركة، كالجذر المشترك للمقامات. ثم تُضرب النسبة × أصل المسألة. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم",
  ...
  },
  {
    ...
    desc: "توفيت وعنها زوج وأبوان فقط أو زوجة وأبوان — يكون للأم ثلث الباقي بعد نصيب الزوج/الزوجة، لا ثلث الجميع. من أصول علم الفرائض المعتمد — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم",
...
export default function MawarithPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل في علم الفرائض: الورثة وحصصهم وأسباب الإرث وموانعه وأحكام العَصَبة والحجب؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع معتمد في مجالس العلم للتعلم. من أبواب الفقه وأحكامه عند أهل العلم",
      ...
      jsonLd: [
        {
          ...
          description: "الورثة وأنصبتهم وشروط إرثهم في الفقه الإسلامي؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع شامل في علم الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم",
