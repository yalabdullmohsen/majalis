...
const MASAIL = [
  ...
  },
  {
    ...
    desc: "اتفاق بعض الورثة على أن يأخذ أحدهم مبلغاً معيناً من التركة مقابل تنازله عن حصته للباقين. جائز فقهياً وفق اتفاق الحنفية والمالكية والحنابلة بشروط السلامة من الغرر والجهالة. محتوى تعليمي معتمد في منهج مجالس العلم",
  ...
  },
  {
    ...
    desc: "يموت أحد الورثة قبل أن تُقسَّم التركة الأولى، فتُنقل حصته إلى ورثته — مما ينشئ مسألةً ثانية متشعبة من الأولى. تحلّ بدمج المسألتين في أصل مشترك — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم",
