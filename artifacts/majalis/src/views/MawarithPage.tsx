...
const HUQUQ = [
  ...
  { num: 2, title: "الديون", desc: "كل دين ثابت في ذمة الميت سواء كان لله كالزكاة والكفارة أو للناس، يُسدَّد قبل الإرث. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم.", priority: "الثاني" },
  ...
  { num: 4, title: "الإرث", desc: "بعد استيفاء الحقوق السابقة تُوزَّع التركة الباقية على الورثة وفق أنصبتهم الشرعية. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم.", priority: "الرابع" },
];
...
const ASBAB_MAWAANI = {
  asbab: [
    ...
    { title: "الولاء", desc: "عتق العبد، المعتِق يرث معتَقه إن لم يكن له وارث أقرب؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم." },
  ],
  mawaani: [
    { title: "القتل العمد", desc: "من قتل مورّثه عمداً وعدواناً لا يرثه، درءاً لتعجيل الإرث؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم." },
...
const ASAB_TYPES = [
  {
    type: "عَصَبة بنفسه",
    desc: "كل ذكر لا تتوسط في نسبته للميت أنثى، يأخذ ما بقي بعد أصحاب الفروض. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.",
    ex: ["الابن وابن الابن", "الأب والجدّ", "الأخ الشقيق والأخ لأب", "العم وابن العم"],
  },
  {
    type: "عَصَبة بغيره",
    desc: "الأنثى تصير عَصَبة بوجود ذكر من نفس الدرجة يُعصّبها، فيقتسمان للذكر مثل حظ الأنثيين. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم.",
    ex: ["البنت مع الابن", "بنت الابن مع ابن الابن", "الأخت الشقيقة مع الأخ الشقيق"],
  },
  {
    type: "عَصَبة مع غيره",
    desc: "الأخت الشقيقة أو لأب تصير عَصَبة مع البنت أو بنت الابن، فيأخذن الباقي بعد نصيب البنات. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم.",
...
const MASAIL = [
  {
    ...
    desc: "إذا اجتمع زوج وأبوان، أو زوجة وأبوان، فللزوج أو الزوجة نصيبه، وللأم ثلث الباقي لا ثلث جميع المال، وسُمّيتا بالعُمَريَّتَين لقضاء عمر ﵁ بهما — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    desc: "توفي رجل عن زوجة وبنتين وأبوين؛ لما سُئل عنها علي ﵁ على المنبر أجاب في الحال، فسُمّيت بالمنبرية. من أحكام المواريث في الفقه الإسلامي — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    desc: "مَن لا يُعلم أذكر أم أنثى — يُوقف جزء من التركة حتى يتبين، وعند تعذر التبين يأخذ نصف نصيب ذكر ونصف نصيب أنثى. من أصول علم الفرائض المعتمد — مرجع معتمد في مجالس العلم.",
  ...
  },
  {
    ...
    desc: "يموت أحد الورثة قبل أن تُقسَّم التركة الأولى، فتُنقل حصته إلى ورثته — مما ينشئ مسألةً ثانية متشعبة من الأولى. تحلّ بدمج المسألتين في أصل مشترك — مرجع معتمد في مجالس العلم.",
