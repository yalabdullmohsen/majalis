...
const WARASA: Warith[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { condition: "مع أخ شقيق", share: "عَصَبة بالغير؛ للذكر مثل حظ الأنثيين" },
    ],
...
const HUQUQ = [
  { num: 1, title: "مئونة التجهيز والدفن", desc: "تُخرج من أصل التركة نفقات تجهيز الميت وتكفينه ودفنه بالمعروف، وهي أول حق يؤخذ. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي", priority: "الأول" },
  { num: 2, title: "الديون", desc: "كل دين ثابت في ذمة الميت سواء كان لله كالزكاة والكفارة أو للناس، يُسدَّد قبل الإرث. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي", priority: "الثاني" },
  { num: 3, title: "الوصية", desc: "تُنفَّذ الوصية الشرعية وحدّها الأقصى ثلث التركة لغير الوارث؛ «الثلث والثلث كثير» متفق عليه، و«لا وصية لوارث» حسّنه الألباني. من أصول علم الفرائض المعتمد؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي", priority: "الثالث" },
  { num: 4, title: "الإرث", desc: "بعد استيفاء الحقوق السابقة تُوزَّع التركة الباقية على الورثة وفق أنصبتهم الشرعية. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي", priority: "الرابع" },
];

/* ── أسباب الإرث وموانعه ── */
const ASBAB_MAWAANI = {
  asbab: [
    { title: "النكاح الصحيح", desc: "عقد الزواج الصحيح، يُورث بين الزوجين ولو قبل الدخول؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
    { title: "النسب", desc: "رابطة الدم، الأصول والفروع والحواشي؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم للتعلم والتطبيق الشرعي. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
    { title: "الولاء", desc: "عتق العبد، المعتِق يرث معتَقه إن لم يكن له وارث أقرب؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
  ],
  mawaani: [
    { title: "القتل العمد", desc: "من قتل مورّثه عمداً وعدواناً لا يرثه، درءاً لتعجيل الإرث؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
    { title: "اختلاف الدين", desc: "المسلم لا يرث الكافر والكافر لا يرث المسلم، الحديث والإجماع؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
    { title: "الرقّ", desc: "العبد لا يرث ولا يُورث، وهو حكم تاريخي لا وجود لموضوعه الآن؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي" },
  ],
};
...
const ASAB_TYPES = [
  {
    type: "عَصَبة بنفسه",
    desc: "كل ذكر لا تتوسط في نسبته للميت أنثى، يأخذ ما بقي بعد أصحاب الفروض. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ex: ["الابن وابن الابن", "الأب والجدّ", "الأخ الشقيق والأخ لأب", "العم وابن العم"],
  },
  {
    type: "عَصَبة بغيره",
    desc: "الأنثى تصير عَصَبة بوجود ذكر من نفس الدرجة يُعصّبها، فيقتسمان للذكر مثل حظ الأنثيين. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    ex: ["البنت مع الابن", "بنت الابن مع ابن الابن", "الأخت الشقيقة مع الأخ الشقيق"],
  },
  {
    type: "عَصَبة مع غيره",
    desc: "الأخت الشقيقة أو لأب تصير عَصَبة مع البنت أو بنت الابن، فيأخذن الباقي بعد نصيب البنات. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
...
const MASAIL = [
  {
    ...
    desc: "إذا اجتمع زوج وأبوان، أو زوجة وأبوان، فللزوج أو الزوجة نصيبه، وللأم ثلث الباقي لا ثلث جميع المال، وسُمّيتا بالعُمَريَّتَين لقضاء عمر ﵁ بهما — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "زوج ½ أو زوجة ¼ + أم ⅓ الباقي + أب الباقي",
  },
  {
    title: "مسألة المشتركة (الحِمارية)",
    desc: "زوج + أم + أخوان لأم + إخوة أشقاء. سُمّيت الحِمارية لأن بعض الأشقاء قال لعمر: هبْ أن أبانا كان حماراً! فأشركهم في الثلث. من أحكام المواريث في الفقه الإسلامي؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "الزوج ½ + الأم ⅙ + الإخوة لأم ⅓ + الأشقاء يشاركونهم في الثلث",
  },
  {
    title: "الميراث عبر الحساب",
    desc: "أصل المسألة: أصغر عدد صحيح تنقسم عليه التركة، كالجذر المشترك للمقامات. ثم تُضرب النسبة × أصل المسألة. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "أصل المسألة = م.م.م (للمقامات) ← ثم توزيع الحصص",
  },
  {
    title: "المسألة المنبرية",
    desc: "توفي رجل عن زوجة وبنتين وأبوين؛ لما سُئل عنها علي ﵁ على المنبر أجاب في الحال، فسُمّيت بالمنبرية. من أحكام المواريث في الفقه الإسلامي — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "زوجة ⅛ + بنتان ⅔ + أم ⅙ + أب ⅙ = تعول من ٢٤ إلى ٢٧",
  },
  {
    title: "مسألة الغرَّاوَين",
    desc: "توفيت وعنها زوج وأبوان فقط أو زوجة وأبوان — يكون للأم ثلث الباقي بعد نصيب الزوج/الزوجة، لا ثلث الجميع. من أصول علم الفرائض المعتمد — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "زوج ½ + أم ثلث الباقي (⅙) + أب الباقي (⅙+تعصيب)",
  },
  {
    title: "مسألة الأكدرية",
    desc: "زوج وأم وجد وأخت شقيقة — سُميت كذلك لكدرها قواعد الجد، إذ كدّرت على الجد بأخذه جزءاً من نصيب الأخت. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "زوج ½ + أم ⅓ + جد ⅙ + أخت ½ ← ثم تعول المسألة إلى ٩ وتُصحَّح بقسمة نصيب الجد والأخت",
  },
  {
    title: "مسألة العَوْل",
    desc: "إذا زادت السهام عن رأس المال يُزاد في أصل المسألة حتى تستوعب الحصص — هذا هو العَوْل، وبه قضى عمر ﵁. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "مثال: زوج ½ + أختان ⅔ = ٤/٦+٤/٦ > ١ → أصل ٩ بدل ٦",
  },
  {
    title: "مسألة الرَّدّ",
    desc: "إذا بقي من التركة فضل بعد توزيع ذوي الفروض وانعدم العصبة — يُردّ الباقي على أصحاب الفروض بنسب حصصهم. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "مثال: أم ⅙ + بنت ½ + لا عصبة → يُرد الثلث الباقي بالنسبة",
  },
  {
    title: "توريث الخنثى المُشكِل",
    desc: "مَن لا يُعلم أذكر أم أنثى — يُوقف جزء من التركة حتى يتبين، وعند تعذر التبين يأخذ نصف نصيب ذكر ونصف نصيب أنثى. من أصول علم الفرائض المعتمد — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "نصيبه = (نصيب ذكر + نصيب أنثى) ÷ ٢",
  },
  {
    title: "مسألة الجدّ مع الإخوة (مسائل ابن مسعود)",
    desc: "الجدّ مع الإخوة موضع خلاف مشهور: ذهب أبو بكر وعثمان وابن عباس إلى أن الجد يحجب الإخوة تماماً كالأب. وذهب عمر وعلي وزيد بن ثابت وجمهور الفقهاء إلى مقاسمتهم أو المقدَّم له من الثلث أو السدس. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "الجد: أفضل ثلاثة: ثلث الكل / السدس / المقاسمة",
  },
  {
    title: "المفقود وتوزيع ميراثه",
    desc: "المفقود الذي انقطع خبره يُنتظر حتى يُحكم بموته من المحكمة (أو مضي مدة اجتهادية)، وحينئذ يُوزَّع ميراثه على ورثته الأحياء وقت الحكم بوفاته لا وقت فقدانه. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "تاريخ الوفاة الحكمية ← يُعاد احتساب الورثة والحصص",
  },
  {
    title: "ميراث ما أُدلي بمحرومَين (ذوو الأرحام)",
    desc: "ذوو الأرحام هم القرابة الذين لا يرثون بفرض ولا تعصيب كابن البنت والخال وبنت الأخ. ورَّثهم الحنفية والحنابلة عند غياب أصحاب الفروض والعصبة، بخلاف المالكية والشافعية. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "يرثون عند تعذر وجود صاحب فرض أو عصبة",
  },
  {
    title: "ميراث الحمل (الجنين في بطن أمه)",
    desc: "يُحجز للجنين نصيبه حتى يُولد، فإن وُلد حياً ورث، وإن ولد ميتاً أو أُسقط فلا إرث له. ويُعطى الورثةُ الآخرون أقلَّ الحظَّين احتياطاً: إذ يُفترض الجنين ذكراً أو أنثى أيهما أضرّ بالورثة. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
    formula: "تأجيل التقسيم أو منح الورثة أقل حصة محتملة حتى الولادة",
  },
  {
    title: "مسألة التخارج (الصلح على الميراث)",
    desc: "اتفاق بعض الورثة على أن يأخذ أحدهم مبلغاً معيناً من التركة مقابل تنازله عن حصته للباقين. جائز فقهياً وفق اتفاق الحنفية والمالكية والحنابلة بشروط السلامة من الغرر والجهالة. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
  ...
  },
  {
    ...
    desc: "يموت أحد الورثة قبل أن تُقسَّم التركة الأولى، فتُنقل حصته إلى ورثته — مما ينشئ مسألةً ثانية متشعبة من الأولى. تحلّ بدمج المسألتين في أصل مشترك — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
...
export default function MawarithPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل في علم الفرائض: الورثة وحصصهم وأسباب الإرث وموانعه وأحكام العَصَبة والحجب؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع معتمد في مجالس العلم للتعلم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      ...
      jsonLd: [
        {
          ...
          description: "الورثة وأنصبتهم وشروط إرثهم في الفقه الإسلامي؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع شامل في علم الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
