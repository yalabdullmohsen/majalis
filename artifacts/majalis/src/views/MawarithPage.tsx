...
const HUQUQ = [
  { num: 1, title: "مئونة التجهيز والدفن", desc: "تُخرج من أصل التركة نفقات تجهيز الميت وتكفينه ودفنه بالمعروف، وهي أول حق يؤخذ. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم.", priority: "الأول" },
  ...
  { num: 3, title: "الوصية", desc: "تُنفَّذ الوصية الشرعية وحدّها الأقصى ثلث التركة لغير الوارث؛ «الثلث والثلث كثير» متفق عليه، و«لا وصية لوارث» حسّنه الألباني. من أصول علم الفرائض المعتمد", priority: "الثالث" },
...
const ASBAB_MAWAANI = {
  asbab: [
    { title: "النكاح الصحيح", desc: "عقد الزواج الصحيح، يُورث بين الزوجين ولو قبل الدخول؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم." },
    { title: "النسب", desc: "رابطة الدم، الأصول والفروع والحواشي؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم للتعلم والتطبيق الشرعي." },
  ...
  mawaani: [
    ...
    { title: "اختلاف الدين", desc: "المسلم لا يرث الكافر والكافر لا يرث المسلم، الحديث والإجماع؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم." },
    { title: "الرقّ", desc: "العبد لا يرث ولا يُورث، وهو حكم تاريخي لا وجود لموضوعه الآن؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم." },
  ],
};
...
const MASAIL = [
  ...
  },
  {
    ...
    desc: "زوج + أم + أخوان لأم + إخوة أشقاء. سُمّيت الحِمارية لأن بعض الأشقاء قال لعمر: هبْ أن أبانا كان حماراً! فأشركهم في الثلث. من أحكام المواريث في الفقه الإسلامي",
    formula: "الزوج ½ + الأم ⅙ + الإخوة لأم ⅓ + الأشقاء يشاركونهم في الثلث",
  },
  {
    title: "الميراث عبر الحساب",
    desc: "أصل المسألة: أصغر عدد صحيح تنقسم عليه التركة، كالجذر المشترك للمقامات. ثم تُضرب النسبة × أصل المسألة. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة",
  ...
  },
  {
    ...
    desc: "توفيت وعنها زوج وأبوان فقط أو زوجة وأبوان — يكون للأم ثلث الباقي بعد نصيب الزوج/الزوجة، لا ثلث الجميع. من أصول علم الفرائض المعتمد — مرجع معتمد في مجالس العلم.",
    formula: "زوج ½ + أم ثلث الباقي (⅙) + أب الباقي (⅙+تعصيب)",
  },
  {
    title: "مسألة الأكدرية",
    desc: "زوج وأم وجد وأخت شقيقة — سُميت كذلك لكدرها قواعد الجد، إذ كدّرت على الجد بأخذه جزءاً من نصيب الأخت. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة",
    formula: "زوج ½ + أم ⅓ + جد ⅙ + أخت ½ ← ثم تعول المسألة إلى ٩ وتُصحَّح بقسمة نصيب الجد والأخت",
  },
  {
    title: "مسألة العَوْل",
    desc: "إذا زادت السهام عن رأس المال يُزاد في أصل المسألة حتى تستوعب الحصص — هذا هو العَوْل، وبه قضى عمر ﵁. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة",
    formula: "مثال: زوج ½ + أختان ⅔ = ٤/٦+٤/٦ > ١ → أصل ٩ بدل ٦",
  },
  {
    title: "مسألة الرَّدّ",
    desc: "إذا بقي من التركة فضل بعد توزيع ذوي الفروض وانعدم العصبة — يُردّ الباقي على أصحاب الفروض بنسب حصصهم. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة",
...
export default function MawarithPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل في علم الفرائض: الورثة وحصصهم وأسباب الإرث وموانعه وأحكام العَصَبة والحجب؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع معتمد في مجالس العلم للتعلم.",
      ...
      jsonLd: [
        {
          ...
          description: "الورثة وأنصبتهم وشروط إرثهم في الفقه الإسلامي؛ مع أمثلة ومسائل شائعة وحاسبة تطبيقية؛ مرجع شامل في علم الفرائض — مرجع معتمد في مجالس العلم. دليل تعليمي منظم.",
