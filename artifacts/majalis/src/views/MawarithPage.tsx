...
const ASBAB_MAWAANI = {
  asbab: [
    { title: "النكاح الصحيح", desc: "عقد الزواج الصحيح، يُورث بين الزوجين ولو قبل الدخول؛ من أصول علم الفرائض المعتمد؛ يُراعى في توزيع التركة — مرجع معتمد في مجالس العلم. دليل تعليمي منظم. من أبواب الفقه وأحكامه عند أهل العلم" },
    { title: "النسب", desc: "رابطة الدم، الأصول والفروع والحواشي؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم للتعلم والتطبيق الشرعي. من أبواب الفقه وأحكامه عند أهل العلم" },
  ...
  mawaani: [
    ...
    { title: "اختلاف الدين", desc: "المسلم لا يرث الكافر والكافر لا يرث المسلم، الحديث والإجماع؛ من أحكام المواريث في الفقه الإسلامي؛ يُستفاد في حاسبة الفرائض — مرجع معتمد في مجالس العلم. من أبواب الفقه وأحكامه عند أهل العلم" },
...
const MASAIL = [
  ...
  },
  {
    ...
    desc: "زوج وأم وجد وأخت شقيقة — سُميت كذلك لكدرها قواعد الجد، إذ كدّرت على الجد بأخذه جزءاً من نصيب الأخت. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم",
    formula: "زوج ½ + أم ⅓ + جد ⅙ + أخت ½ ← ثم تعول المسألة إلى ٩ وتُصحَّح بقسمة نصيب الجد والأخت",
  },
  {
    title: "مسألة العَوْل",
    desc: "إذا زادت السهام عن رأس المال يُزاد في أصل المسألة حتى تستوعب الحصص — هذا هو العَوْل، وبه قضى عمر ﵁. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم",
    formula: "مثال: زوج ½ + أختان ⅔ = ٤/٦+٤/٦ > ١ → أصل ٩ بدل ٦",
  },
  {
    title: "مسألة الرَّدّ",
    desc: "إذا بقي من التركة فضل بعد توزيع ذوي الفروض وانعدم العصبة — يُردّ الباقي على أصحاب الفروض بنسب حصصهم. من أصول علم الفرائض المعتمد يُراعى في توزيع التركة؛ من أبواب الفقه وأحكامه عند أهل العلم",
  ...
  },
  {
    ...
    desc: "المفقود الذي انقطع خبره يُنتظر حتى يُحكم بموته من المحكمة (أو مضي مدة اجتهادية)، وحينئذ يُوزَّع ميراثه على ورثته الأحياء وقت الحكم بوفاته لا وقت فقدانه. من أبواب الفقه وأحكامه عند أهل العلم",
