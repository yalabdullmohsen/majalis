...
const WARASA: Warith[] = [
  ...
  },
  {
    ...
    gender: "ذكر",
    subs: [
      { condition: "إذا لم يكن أب ولا فرع وارث ذكر", share: "يرث بالتعصيب كالأب" },
      { condition: "مع الفرع الوارث الذكر", share: "السدس فرضاً، ⅙" },
      { condition: "مع الإخوة الأشقاء أو لأب", share: "مسألة خلافية بين الصحابة والفقهاء" },
    ],
    dalil: "لم يُذكر الجدّ في آيات المواريث باسمه صراحةً، وإنما أُخذ حكمه من دخوله في اسم «الأب» في قوله تعالى: ﴿وَلِأَبَوَيْهِ لِكُلِّ وَاحِدٍ مِّنْهُمَا السُّدُسُ﴾ (النساء: 11) عند من قال بذلك، وقد سمّى القرآن الجدّ أباً في قوله: ﴿مِّلَّةَ أَبِيكُمْ إِبْرَاهِيمَ﴾ (الحج: 78). وميراثُ الجدّ مع الإخوة من أشهر مسائل الخلاف بين الصحابة رضي الله عنهم: فذهب أبو بكر وابن عباس رضي الله عنهما إلى أن الجدّ يحجب الإخوة كالأب، وذهب عمر وعلي وزيد بن ثابت رضي الله عنهم إلى مقاسمتهم؛ ولا يُجزم في المسألة بقولٍ واحد لعدم النص الصريح فيها.",
  },
  {
    name: "الأخت الشقيقة",
    gender: "أنثى",
...
const MASAIL = [
  {
    ...
    desc: "إذا اجتمع زوج وأبوان: للزوج النصف، وللأم ثلث الباقي (لا ثلث الكل)، سُمّيت بعُمَريَّتَين لقضاء عمر رضي الله عنه بها.",
  ...
  },
  {
    ...
    desc: "توفي رجل عن زوجة وبنتين وأبوين — لما قرأها علي رضي الله عنه على المنبر أجاب في الحال بدون حساب ظاهر، فسميت بالمنبرية.",
  ...
  {
    title: "مسألة العَوْل",
    desc: "إذا زادت السهام عن رأس المال يُزاد في أصل المسألة حتى تستوعب الحصص — هذا هو العَوْل، وبه قضى عمر رضي الله عنه.",
            ...
            <div className="mw-radd-box">
              ...
              <div className="mw-awl-box">
                ...
                <p className="mw-awl-box__text">
                  ...
                  حصة كل وارث بنفس النسبة. اتفق عليه الصحابة في عهد عمر رضي الله عنه.
                </p>
              </div>
            </div>
          </div>
