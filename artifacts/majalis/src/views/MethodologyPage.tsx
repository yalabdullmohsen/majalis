...
const STEPS = [
  ...
  },
  {
    ...
    desc: "كل مادة تُستورد آلياً تُحفظ بحالة needs_review / pending_review؛ تُعرض للاطلاع بوسمها الصريح، ولا تُعتمد ولا تُوسم «موثّقة» تلقائياً.",
  },
  {
    Icon: Users,
  ...
  },
  {
    ...
    desc: "أي مادة مرَّ ملخّصها أو تصنيفها على نموذج لغوي تُوسم provenance = ai_generated، وتظهر بشارة «مُولَّد آلياً — غير مراجَع» ولا تُوثَّق أبداً تلقائياً.",
  },
  {
    Icon: Shield,
