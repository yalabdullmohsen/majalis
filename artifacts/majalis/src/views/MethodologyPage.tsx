    ...
    <div className="mtd-page ds-section" dir="rtl">
      <header className="mtd-head">
        ...
        <p className="mtd-head__sub">
          منهجية التوثيق في المجلس العلمي: مصادر التلقي، درجات التوثيق، وضوابط النشر.
          وسم المراجعة يخص موادًا بعينها عند الاستيراد الآلي أو نقص المصدر — لا يعني أن المنهج كله غير معتمد.
        </p>
