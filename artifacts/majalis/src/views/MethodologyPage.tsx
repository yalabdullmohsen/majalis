...
const STEPS = [
  {
    Icon: BookOpen,
    title: "المصدر الأصلي",
    desc: "يُستورد المحتوى من مصادر علمية معروفة (الدرر السنية، مجمع الفقه الإسلامي وغيرها)، ويُحفظ رابط المصدر مع كل مادة. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل — مرجع مجالس العلم",
  },
  {
    Icon: AlertTriangle,
