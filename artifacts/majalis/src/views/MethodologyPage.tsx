...
const STEPS = [
  ...
  },
  {
    ...
    desc: "كل مادة تُستورد آلياً تُحفظ بحالة needs_review / pending_review؛ تُعرض للاطلاع بوسمها الصريح، ولا تُعتمد ولا تُوسم «موثّقة» تلقائياً مهما بلغت درجة الجودة الآلية أو مستوى ثقة المصدر.",
  },
  {
    Icon: Users,
