...
const SOURCES = [
  { name: "dorar.net", desc: "موسوعة الدرر السنية للأحاديث والآثار؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "sunnah.com", desc: "موسوعة الأحاديث النبوية المترجمة؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "aladhan.com", desc: "خدمة حسابات مواقيت الصلاة والتقويم؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "alquran.cloud", desc: "بيانات القرآن الكريم بالرسم العثماني؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "shamela.ws", desc: "المكتبة الشاملة — أكبر مكتبة إسلامية رقمية للتراث؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "dar-alifta.net", desc: "دار الإفتاء المصرية — فتاوى رسمية معتمدة؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "binbaz.org.sa", desc: "موقع الشيخ ابن باز — أحكام وفتاوى محقَّقة؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "islamhouse.com", desc: "دار الإسلام — مواد شرعية مترجمة لأكثر من ٧٠ لغة تحت إشراف علمي متخصص؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
  { name: "iifa-fiqh.org", desc: "مجمع الفقه الإسلامي الدولي — قرارات وتوصيات فقهية صادرة بإجماع هيئات علمية دولية؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في" },
  { name: "noor-book.com", desc: "مكتبة نور — أكبر مكتبة رقمية مفتوحة للكتب العلمية والتراثية الإسلامية؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل" },
];
...
const STEPS = [
  {
    Icon: BookOpen,
    title: "المصدر الأصلي",
    desc: "يُستورد المحتوى من مصادر علمية معروفة (الدرر السنية، مجمع الفقه الإسلامي وغيرها)، ويُحفظ رابط المصدر مع كل مادة. من آداب طلب العلم عند أهل",
  },
  {
    Icon: AlertTriangle,
    title: "الاستيراد = «قيد المراجعة» دائماً",
    desc: "كل مادة تُستورد آلياً تُحفظ بحالة needs_review / pending_review؛ تُعرض للاطلاع بوسمها الصريح، ولا تُعتمد ولا تُوسم «موثّقة» تلقائياً مهما",
  },
  {
    Icon: Users,
    title: "المراجعة البشرية شرط الاعتماد",
    desc: "لا تُوسم مادة «موثّقة» إلا بعد أن يراجعها إنسان مُسمّى، فيُسجَّل اسمه وتاريخ مراجعته (reviewed_by / reviewed_at) مع مصدر خارجي. من آداب طلب",
  },
  {
    Icon: CheckCircle2,
    title: "الشارة تتبع البيانات لا النية",
    desc: "شارة «محتوى موثّق» مشروطة في الكود بوجود مراجِع بشري وتاريخ مراجعة ومصدر خارجي. وما عدا ذلك يُعرض بشارة «قيد المراجعة الشرعية». من آداب طلب",
  },
  {
    Icon: Bot,
    title: "وسم المحتوى المولَّد آلياً",
    desc: "أي مادة مرَّ ملخّصها أو تصنيفها على نموذج لغوي تُوسم provenance = ai_generated، وتظهر بشارة «مُولَّد آلياً — غير مراجَع» ولا تُوثَّق أبداً",
  },
  {
    Icon: Shield,
    title: "المساعد العلمي أداة تعليمية",
    desc: "المساعد الذكي في المنصة أداة للبحث والتعلّم وتقريب المعنى — لا يُفتي، ولا تُعدّ إجاباته فتوى ولا حجّة شرعية. من آداب طلب العلم عند أهل",
  },
];
...
const TRUST_GRADES = [
  {
    name: "نص أصلي",
    code: "primary_text",
    meaning: "آية بسورة ورقم، أو حديث بمصنَّف ورقم، مع حكم وحاكم عند الحديث. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
  },
  {
    name: "مصدر علمي",
    code: "scholarly_source",
    meaning: "نقل عن عالم أو كتاب مسمّى بموضع يمكن الرجوع إليه (جزء/صفحة أو ما يعادلهما). من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
  },
  {
    name: "قرار مؤسسي",
    code: "institutional_ruling",
    meaning: "قرار مجمع أو هيئة برقم وتاريخ. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
  },
  {
    name: "استدلال عام",
    code: "general_reasoning",
    meaning: "قاعدة فقهية أو مقصد عام بلا نص مسمّى. هذا ليس دليلاً مكتملاً. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
  },
  {
    name: "بلا مصدر",
    code: "unsourced",
    meaning: "لا يوجد ما يمكن التحقق منه بعد. نعلّمه صراحةً ولا نعرضه كموثَّق. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
  },
];
...
export default function MethodologyPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مصادر التحقق، منهجية المراجعة البشرية، وضمانات الجودة في المجلس العلمي. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل",
      ...
      jsonLd: [
        {
          ...
          description: "منهجية المجلس العلمي: لا وسم توثيق بلا مراجعة بشرية ومصدر خارجي، ووسم صريح للمحتوى المولَّد آلياً؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر",
          publisher: {
            "@type": "Organization",
            name: "المجلس العلمي",
