...
const STEPS = [
  ...
  },
  {
    ...
    desc: "أي مادة مرَّ ملخّصها أو تصنيفها على نموذج لغوي تُوسم provenance = ai_generated، وتظهر بشارة «مُولَّد آلياً — غير مراجَع» ولا تُوثَّق أبداً بهذه الصفة. من آداب طلب العلم عند أهل العلم",
  },
  {
    Icon: Shield,
    title: "المساعد العلمي أداة تعليمية",
    desc: "المساعد الذكي في المنصة أداة للبحث والتعلّم وتقريب المعنى — لا يُفتي، ولا تُعدّ إجاباته فتوى ولا حجّة شرعية. من آداب طلب العلم عند أهل العلم يُستحضر قبل الشروع في التحصيل — مرجع مجالس العلم",
  },
];
      ...
      jsonLd: [
        {
          ...
          description: "منهجية المجلس العلمي: لا وسم توثيق بلا مراجعة بشرية ومصدر خارجي، ووسم صريح للمحتوى المولَّد آلياً؛ من آداب طلب العلم عند أهل العلم؛ يُستحضر قبل الشروع في التحصيل — مرجع مجالس العلم",
          publisher: {
            "@type": "Organization",
            name: "المجلس العلمي",
