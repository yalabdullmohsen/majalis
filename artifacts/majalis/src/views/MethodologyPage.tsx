...
const STEPS = [
  ...
  {
    Icon: AlertTriangle,
    title: "استيراد المواد يبقى «قيد المراجعة»",
    desc: "كل مادة تُستورد آلياً تُحفظ بحالة «قيد المراجعة» على مستوى السجل؛ تُعرض للاطلاع بوسمها الصريح، ولا تُعتمد ولا تُوسم «موثّقة» تلقائياً. هذا لا يطعن في منهجية المنصة العامة.",
  },
  {
    Icon: Users,
    ...
    <div className="mtd-page ds-section" dir="rtl">
      <header className="mtd-head">
        ...
        <p className="mtd-head__sub">
          منهجية التوثيق المعتمدة في المجلس العلمي: مصادر التلقي، درجات التوثيق، وضوابط النشر.
          وسم «قيد المراجعة الشرعية» يخص مواداً بعينها (استيراد آلي أو نقص مصدر) — لا يعني أن المنهج كله غير معتمد.
        </p>
      ...
      <section className="mtd-section">
        ...
        <p className="mtd-section__body">
          ...
          . وكل مادة مستوردة آلياً أو ناقصة التوثيق تُعرض بوسم{" "}
          <strong>«قيد المراجعة الشرعية»</strong> على تلك المادة وحدها، للاطلاع لا للاحتجاج — دون أن
          يُفهم من ذلك أن منهجية المنصة العامة غير معتمدة.
        </p>
        <p className="mtd-section__body">
