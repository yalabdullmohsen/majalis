...
const ADAB_DARS: AdabItem[] = [
  ...
  },
  {
    ...
    text: "قال ابن جماعة: «من لازم الشيخ ودأب على حضور دروسه كان كمن لازم الرياضة؛ نشاطه يتواصل واطِّراده يظهر». والانقطاع المتقطع يُفقد الترابط بين الدروس ويجعل الطالب يُعيد ما فات دون أن يُضيف جديداً.",
    source: "تذكرة السامع والمتكلم لابن جماعة",
  },
];
