...
export default function PrayerCountdownPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "عد تنازلي لوقت الصلاة القادمة، الفجر والظهر والعصر والمغرب والعشاء في الكويت. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع ترب",
