...
export default function ZakatPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الزكاة: أنواعها وشروطها ونصابها ومصارفها، مع حاسبة مبسطة وأدلة من القرآن والسنة. مع حاسبة مبسّطة وأدلة من القرآن والسنة — مرجع معتمد في مجالس العلم. محتوى تعليمي معتمد في منهج مجالس العلم",
