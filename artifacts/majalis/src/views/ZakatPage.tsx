...
export default function ZakatPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "دليل شامل لأحكام الزكاة: أنواعها وشروطها ونصابها ومصارفها، مع حاسبة مبسطة وأدلة من القرآن والسنة. مع حاسبة مبسّطة وأدلة من القرآن والسنة — مرجع معتمد في مجالس العلم.",
      ...
      jsonLd: [
        {
          ...
          description: "أنواع الزكاة المختلفة مع النصاب والشروط والأدلة الشرعية؛ مع حاسبة مبسّطة وأدلة من القرآن والسنة؛ دليل شامل في أحكام الزكاة — مرجع م — مرجع معتمد في مجالس العلم.",
