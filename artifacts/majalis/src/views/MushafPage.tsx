...
export default function MushafPage() {
  ...
  useEffect(() => {
    ...
    applyPageSeo({
      ...
      description: "اقرأ القرآن الكريم بترقيم مصحف المدينة (604 صفحة)، بخط عثماني واضح، مع الاستماع والتفسير والمشاركة لكل آية. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
