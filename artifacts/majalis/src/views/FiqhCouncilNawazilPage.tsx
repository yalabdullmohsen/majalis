...
export default function FiqhCouncilNawazilPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "WebPage", name: "النوازل المعاصرة", url: "https://www.ssunnah.com/fiqh-council/nawazil", about: { "@type": "Thing", name: "النوازل الفقهية والمستجدات المعاصرة" } }],
    });
  }, []);
  ...
  return (
    <div className="page-shell narrow content-hub-page fiqh-council-page fiqh-nawazil-page">
      ...
      <div className="twh-share">
        <ShareButtons title="نوازل فقهية معاصرة — سُنّة" url="https://www.ssunnah.com/fiqh-council/nawazil" />
      </div>
