...
export default function CardsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "أنشئ بطاقات اقتباسات إسلامية جميلة قابلة للمشاركة، اختر القالب والحجم وصدّر بجودة عالية. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description: "أنشئ بطاقات اقتباسات إسلامية جميلة قابلة للمشاركة؛ عرض موثّق ضمن منهج سُنّة",
