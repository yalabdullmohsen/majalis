...
function RecitationTestPageInner() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      title: "اختبار التلاوة بالذكاء الاصطناعي | المجلس العلمي",
      description:
        "سمّع من حفظك بعد إذن الميكروفون، واحصل على تقرير فوري. المعالجة قد تتم على الجهاز أو عبر خادم مشفّر عند الحاجة. راجع سياسة الخصوصية.",
    });
  }, []);
