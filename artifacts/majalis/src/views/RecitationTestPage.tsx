...
function RecitationTestPageInner() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "سمّع من حفظك واستمع التطبيق لتلاوتك لحظيًا، مع كشف تدريجي للمصحف وتقرير تفصيلي. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع ت",
    });
  }, []);
