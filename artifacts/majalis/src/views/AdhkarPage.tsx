...
export default function AdhkarPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "أذكار الصباح والمساء وما بعد الصلاة وسائر الأذكار المأثورة، مع التسبيح التفاعلي وعداد الذكر. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "أذكار الصباح والمساء والصلاة والسفر والنوم وسائر المناسبات؛ محتوى معتمد في منهج مجالس العلم",
