...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "آية الكرسي، سيدة آي القرآن — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "باسمك اللهم أموت وأحيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "صحيح البخاري",
  ...
  },
  {
    ...
    meaning: "اللهم افتح لي أبواب رحمتك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك من فضلك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    meaning: "حسبنا الله ونعم الوكيل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم اجعل خير عمري آخره وخير عملي خواتيمه وخير أيامي يوم ألقاك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح الجامع",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "سنن الترمذي، صحيح",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، رب اغفر لي — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── إضافات النوم ─── */
  {
    ...
    meaning: "اللهم إني أستخيرك بعلمك وأستقدرك بقدرتك وأسألك من فضلك العظيم، فإنك تقدر ولا أقدر وتعلم ولا أعلم وأنت علام الغيوب؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم، لا إله إلا الله رب السماوات ورب الأرض ورب العرش الكريم؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
