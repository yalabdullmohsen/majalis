...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "آية الكرسي، سيدة آي القرآن — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "سبحانك اللهم وبحمدك، وتبارك اسمك، وتعالى جدك، ولا إله غيرك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "سبحان ربي العظيم، تسبيح في الركوع — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "سبحان ربي الأعلى، تسبيح في السجود — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من عذاب جهنم ومن عذاب القبر — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "بسم الله، تسمية عند بدء الطعام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أطعمنا وسقانا وجعلنا مسلمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي سقانا عذباً فراتاً برحمته — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "بسم الله توكلت على الله ولا حول ولا قوة إلا بالله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "باسمك اللهم أموت وأحيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح البخاري",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أحيانا بعد ما أماتنا وإليه النشور — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
  ...
  },
  {
    ...
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "الأنبياء: 87",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    meaning: "ربنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "يا مقلب القلوب ثبت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "اللهم صلّ على محمد وعلى آل محمد كما صليت على إبراهيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إنك عفو تحب العفو فاعف عني — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح الترمذي",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم افتح لي أبواب رحمتك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك من فضلك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  /* ── أدعية إضافية، الصلاة ── */
  {
    ...
    meaning: "التشهد في الصلاة، أفضل ما يُقال في الجلوس — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، دعاء الجلسة بين السجدتين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    meaning: "حسبنا الله ونعم الوكيل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "البقرة: 286",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين، دعاء ذي النون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── دعاء عام، إضافية ── */
  {
    ...
    meaning: "اللهم انفعني بما علمتني وعلمني ما ينفعني وزدني علماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس اشفه وأنت الشافي لا شفاء إلا شفاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم اكفني بحلالك عن حرامك وأغنني بفضلك عمن سواك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── أدعية النوم، إضافية ── */
  {
    ...
    meaning: "المعوذتان والإخلاص ثلاثاً، ثم ينفث في الكفين ويمسح الجسد — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    meaning: "آيبون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "السفر",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك خير المولج وخير المخرج، دعاء دخول البيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "سنن أبي داود، صحيح",
    category: "السفر",
  ...
  /* ── كرب، إضافية ── */
  {
    ...
    meaning: "دعاء جامع لإزالة الهم والحزن بالتوسل بأسماء الله الحسنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "اللهم أهل علينا هذا الهلال بالأمن والإيمان والسلامة والإسلام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "سنن الترمذي، حسن",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "يرحمك الله، الرد على العاطس بعد حمد الله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح البخاري",
    category: "المناسبات",
  ...
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله الكاملة التامة من شر كل ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "بسم الله في أوله وآخره، يقولها من نسي التسمية في بداية طعامه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "اللهم بارك لنا فيه وزدنا منه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "اللهم لك صمت وعلى رزقك أفطرت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "أفطر عندكم الصائمون وأكل طعامكم الأبرار وصلت عليكم الملائكة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "بارك الله لك وبارك عليك وجمع بينكما في خير — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ─── إضافات الصباح والمساء ─── */
  {
    ...
    meaning: "اللهم إني أسألك علماً نافعاً ورزقاً طيباً وعملاً متقبلاً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك العفو والعافية في الدنيا والآخرة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من شر ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "أستودعك الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "زودك الله التقوى وغفر ذنبك ويسر لك الخير حيثما كنت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، رب اغفر لي — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي بنعمته تتم الصالحات — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم ومن شر هذه الرؤيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ─── إضافات الدعاء العام ─── */
  {
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "يا مقلِّب القلوب ثبِّت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── الأكل والشرب ── */
  {
    ...
    arabic: "بِسْمِ اللَّهِ",
    transliteration: "Bismillah",
    meaning: "التسمية عند الشرب سنة مؤكدة كالتسمية عند الأكل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "مسلم: ٢٠٢٢",
    category: "الأكل والشرب",
    occasion: "قبل الشرب",
  ...
  },
  {
    ...
    meaning: "أكل طعامكم الأبرار وصلّت عليكم الملائكة وأفطر عندكم الصائمون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── السفر ── */
  {
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "راجعون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر",
  ...
  },
  {
    ...
    meaning: "أودعكم الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ─── الدعاء العام — إضافي ─── */
  {
    ...
    meaning: "اللهم إني أسألك الهدى والتقى والعفاف والغنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "مسلم: ٢٧٢١",
    category: "الدعاء العام",
  ...
  /* ─── الأكل والشرب — إضافي ─── */
  {
    ...
    meaning: "الحمد لله الذي أطعمني هذا ورزقنيه من غير حول مني ولا قوة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
      ...
      jsonLd: [
        {
          ...
          description: "مكتبة الأدعية الشرعية من القرآن والسنة مع المعنى والمصدر — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل.",
