...
const DUAS: DuaEntry[] = [
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "سبحان ربي العظيم، تسبيح في الركوع — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "سبحان ربي الأعلى، تسبيح في السجود — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من عذاب جهنم ومن عذاب القبر — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "بسم الله، تسمية عند بدء الطعام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أطعمنا وسقانا وجعلنا مسلمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي سقانا عذباً فراتاً برحمته — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "الأنبياء: 87",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    meaning: "اللهم إني عبدك وابن عبدك، ناصيتي بيدك، ماضٍ فيَّ حكمك، عدلٌ فيَّ قضاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "يا مقلب القلوب ثبت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم إنك عفو تحب العفو فاعف عني — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "صحيح الترمذي",
    category: "المناسبات",
  ...
  /* ── أدعية إضافية، الصلاة ── */
  {
    ...
    meaning: "التشهد في الصلاة، أفضل ما يُقال في الجلوس — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، دعاء الجلسة بين السجدتين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "البقرة: 286",
    category: "الكرب والهم",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    meaning: "آيبون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "متفق عليه",
    category: "السفر",
  ...
  },
  {
    ...
    meaning: "يرحمك الله، الرد على العاطس بعد حمد الله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح البخاري",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أشهد أن لا إله إلا الله وحده لا شريك له وأشهد أن محمداً عبده ورسوله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أمسينا وأمسى الملك لله، والحمد لله لا شريك له، دعاء جامع لمساء المسلم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله الواحد القهار رب السماوات والأرض وما بينهما العزيز الغفار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "اللهم بارك لنا فيه وزدنا منه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم لك صمت وعلى رزقك أفطرت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "بارك الله لك وبارك عليك وجمع بينكما في خير — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من شر ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "أستودعك الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "سبحان الله والحمد لله والله أكبر، ثلاثاً وثلاثين لكل، ثم ختماً: لا إله إلا الله وحده لا شريك له له الملك وله الحمد وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي بنعمته تتم الصالحات — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── إضافات الدعاء العام ─── */
  {
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "يا مقلِّب القلوب ثبِّت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── السفر ── */
  {
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "راجعون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر",
  ...
  },
  {
    ...
    meaning: "أودعكم الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── الصلاة — إضافي ─── */
  {
    ...
    meaning: "اللهم لك الحمد أنت نور السماوات والأرض ومن فيهن، ولك الحمد أنت قيوم السماوات والأرض ومن فيهن، ولك الحمد أنت الحق ووعدك الحق؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── السفر — إضافي ─── */
  {
    ...
    meaning: "سبحان الذي سخّر لنا هذا وما كنا له مقرنين، وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ─── الدعاء العام — إضافي ─── */
  {
    ...
    meaning: "اللهم إني أسألك الهدى والتقى والعفاف والغنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "مسلم: ٢٧٢١",
    category: "الدعاء العام",
