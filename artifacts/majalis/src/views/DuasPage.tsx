...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    category: "الصباح والمساء",
    occasion: "بعد الصلاة وقبل النوم، وتُقرأ كذلك في الأذكار",
  ...
  },
  {
    ...
    source: "سنن أبي داود، صحيح",
    category: "السفر",
    occasion: "عند دخول البيت مع التسمية والتوكل",
    virtue: "التسمية وذكر الله عند الدخول سبب لحرمان الشيطان من المبيت والطعام",
  },
  /* ── كرب، إضافية ── */
  {
    id: "karb-7",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    virtue: "دعاء خاص بما يُشرب من اللبن طلباً للبركة والزيادة",
  },
  {
    id: "akl-6",
    title: "دعاء الإفطار",
    ...
    meaning: "ذهب الظمأ وابتلت العروق وثبت الأجر إن شاء الله",
  ...
  },
  {
    ...
    source: "سنن الترمذي وابن ماجه، وفي ثبوته خلاف",
    category: "المناسبات",
    occasion: "عند دخول الأسواق والمراكز التجارية",
    virtue: "ذِكرٌ للتوحيد في موضع تكثر فيه الغفلة والبيع والشراء",
  },
  ...
  /* ─── إضافات النوم ─── */
  {
    ...
    category: "المناسبات",
    occasion: "يُصلى ركعتان ثم يُدعى بهذا الدعاء عند التردد في أمر مهم",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    virtue: "قال ﷺ عن رجل غضب: إني لأعلم كلمة لو قالها لذهب عنه ما يجد",
  },
  {
    id: "karb-9",
  ...
  },
  {
    ...
    category: "الأكل والشرب",
    occasion: "يقوله الضيف لمن أطعمه أو أفطر عنده",
  ...
  /* ─── الدعاء العام، إضافي ─── */
  {
    ...
    virtue: "يجمع أربعة أصول عظيمة: هداية القلب، وتقوى الله، وعفة النفس، والاستغناء عن الناس",
  },
  /* ─── الأكل والشرب، إضافي ─── */
  {
    id: "akl-9",
