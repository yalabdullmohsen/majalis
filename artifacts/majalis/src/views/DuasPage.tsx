...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "سبحانك اللهم وبحمدك، وتبارك اسمك، وتعالى جدك، ولا إله غيرك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "متفق عليه",
  ...
  },
  {
    ...
    meaning: "ربنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    transliteration: "La ilaha illa anta subhanaka inni kuntu minaz-zalimin",
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين، دعاء ذي النون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس اشفه وأنت الشافي لا شفاء إلا شفاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "متفق عليه",
    category: "الدعاء العام",
  ...
  /* ── أدعية النوم، إضافية ── */
  {
    ...
    meaning: "المعوذتان والإخلاص ثلاثاً، ثم ينفث في الكفين ويمسح الجسد — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك خير المولج وخير المخرج، دعاء دخول البيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "سنن أبي داود، صحيح",
    category: "السفر",
  ...
  /* ── كرب، إضافية ── */
  {
    ...
    meaning: "دعاء جامع لإزالة الهم والحزن بالتوسل بأسماء الله الحسنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "اللهم أهل علينا هذا الهلال بالأمن والإيمان والسلامة والإسلام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "سنن الترمذي، حسن",
    category: "المناسبات",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "بسم الله في أوله وآخره، يقولها من نسي التسمية في بداية طعامه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "أفطر عندكم الصائمون وأكل طعامكم الأبرار وصلت عليكم الملائكة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله وحده لا شريك له، له الملك وله الحمد يحيي ويميت وهو حي لا يموت، بيده الخير وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  /* ─── إضافات الصباح والمساء ─── */
  {
    ...
    meaning: "اللهم إني أسألك علماً نافعاً ورزقاً طيباً وعملاً متقبلاً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ─── إضافات الصلاة ─── */
  {
    ...
    meaning: "اللهم باعد بيني وبين خطاياي كما باعدت بين المشرق والمغرب، اللهم نقني من الخطايا كما يُنقى الثوب الأبيض من الدنس؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من الهم والحزن والعجز والكسل والجبن والبخل وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ برضاك من سخطك وبمعافاتك من عقوبتك وأعوذ بك منك، لا أحصي ثناءً عليك أنت كما أثنيت على نفسك؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
  ...
  },
  {
    ...
    meaning: "أكل طعامكم الأبرار وصلّت عليكم الملائكة وأفطر عندكم الصائمون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    meaning: "اللهم أعوذ بك من الهم والحزن، والعجز والكسل، والجبن والبخل، وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "البخاري: ٦٣٦٩",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة",
    source: "مسلم: ٢٧٢٣",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "اللهم رب جبريل وميكائيل وإسرافيل، فاطر السماوات والأرض، عالم الغيب والشهادة، أنت تحكم بين عبادك فيما كانوا فيه يختلفون، اهدني لما اختلف فيه من الحق بإذنك؛ فائدة الدعاء وفضله في الشرع",
    source: "مسلم: ٧٧٠",
    category: "النوم واليقظة",
  ...
  /* ─── الأكل والشرب — إضافي ─── */
  {
    ...
    meaning: "الحمد لله الذي أطعمني هذا ورزقنيه من غير حول مني ولا قوة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
