...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك، وأنا على عهدك ووعدك ما استطعت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح البخاري",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "بسم الله توكلت على الله ولا حول ولا قوة إلا بالله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أحيانا بعد ما أماتنا وإليه النشور — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  },
  {
    ...
    meaning: "اللهم صلّ على محمد وعلى آل محمد كما صليت على إبراهيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  /* ── دعاء عام، إضافية ── */
  {
    ...
    meaning: "اللهم انفعني بما علمتني وعلمني ما ينفعني وزدني علماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم اكفني بحلالك عن حرامك وأغنني بفضلك عمن سواك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك خير المولج وخير المخرج، دعاء دخول البيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "سنن أبي داود، صحيح",
    category: "السفر",
  ...
  /* ── كرب، إضافية ── */
  {
    ...
    meaning: "دعاء جامع لإزالة الهم والحزن بالتوسل بأسماء الله الحسنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله الكاملة التامة من شر كل ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من غضبه وعقابه وشر عباده ومن همزات الشياطين وأن يحضرون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس واشفه أنت الشافي لا شفاء إلا شفاؤك شفاءً لا يترك سقماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك العفو والعافية في الدنيا والآخرة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "زودك الله التقوى وغفر ذنبك ويسر لك الخير حيثما كنت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم اهدني فيمن هديت، وعافني فيمن عافيت، وتولني فيمن توليت، وبارك لي فيما أعطيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم ومن شر هذه الرؤيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من الهم والحزن والعجز والكسل والجبن والبخل وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── الأكل والشرب ── */
  {
    ...
    arabic: "بِسْمِ اللَّهِ",
    transliteration: "Bismillah",
    meaning: "التسمية عند الشرب سنة مؤكدة كالتسمية عند الأكل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "مسلم: ٢٠٢٢",
    category: "الأكل والشرب",
    occasion: "قبل الشرب",
  ...
  /* ─── الصباح والمساء — إضافي ─── */
  {
    ...
    meaning: "اللهم أعوذ بك من الهم والحزن، والعجز والكسل، والجبن والبخل، وغلبة الدين وقهر الرجال — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "البخاري: ٦٣٦٩",
    category: "الصباح والمساء",
...
export default function DuasPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مكتبة الأدعية الشرعية الموثقة: أدعية الصباح والمساء والصلاة والسفر والكرب مع المعنى والمصدر — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل. محتوى تعليمي معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "مكتبة الأدعية الشرعية من القرآن والسنة مع المعنى والمصدر — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل. من الأدعية المأثورة في القرآن والسنة؛ محتوى تعليمي معتمد في منهج مجالس العلم",
