...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "آية الكرسي، سيدة آي القرآن — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "باسمك اللهم أموت وأحيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح البخاري",
  ...
  },
  {
    ...
    meaning: "اللهم افتح لي أبواب رحمتك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك من فضلك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  /* ── أدعية الكرب والهم، إضافية ── */
  {
    ...
    meaning: "حسبنا الله ونعم الوكيل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── الأكل والشرب، إضافية ── */
  {
    ...
    meaning: "اللهم بارك لنا فيه وزدنا منه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم لك صمت وعلى رزقك أفطرت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، رب اغفر لي — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ─── إضافات الكرب والهم ─── */
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله العظيم الحليم، لا إله إلا الله رب العرش العظيم، لا إله إلا الله رب السماوات ورب الأرض ورب العرش الكريم؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ─── الصلاة — إضافي ─── */
  {
    ...
    meaning: "اللهم لك الحمد أنت نور السماوات والأرض ومن فيهن، ولك الحمد أنت قيوم السماوات والأرض ومن فيهن، ولك الحمد أنت الحق ووعدك الحق؛ فائدة الدعاء وفضله في الشرع؛ يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
