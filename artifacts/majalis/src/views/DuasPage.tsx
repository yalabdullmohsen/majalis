...
const DUAS: DuaEntry[] = [
  {
    ...
    meaning: "أصبحنا وأصبح الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك، وأنا على عهدك ووعدك ما استطعت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح البخاري",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "اللهم إني أعوذ بك من عذاب جهنم ومن عذاب القبر — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أطعمنا وسقانا وجعلنا مسلمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي سقانا عذباً فراتاً برحمته — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخّر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "السفر",
  ...
  },
  {
    ...
    meaning: "بسم الله توكلت على الله ولا حول ولا قوة إلا بالله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي أحيانا بعد ما أماتنا وإليه النشور — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "صحيح البخاري",
    category: "النوم واليقظة",
  ...
  },
  {
    ...
    meaning: "لا إله إلا أنت سبحانك إني كنت من الظالمين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "الأنبياء: 87",
    category: "الكرب والهم",
  ...
  },
  {
    ...
    meaning: "اللهم إني عبدك وابن عبدك، ناصيتي بيدك، ماضٍ فيَّ حكمك، عدلٌ فيَّ قضاؤك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "اللهم صلّ على محمد وعلى آل محمد كما صليت على إبراهيم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  /* ── أدعية إضافية، الصلاة ── */
  {
    ...
    meaning: "التشهد في الصلاة، أفضل ما يُقال في الجلوس — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "رب اغفر لي، دعاء الجلسة بين السجدتين — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ── دعاء عام، إضافية ── */
  {
    ...
    meaning: "اللهم انفعني بما علمتني وعلمني ما ينفعني وزدني علماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "سنن ابن ماجه، صحيح",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "اللهم اكفني بحلالك عن حرامك وأغنني بفضلك عمن سواك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "اللهم اجعل خير عمري آخره وخير عملي خواتيمه وخير أيامي يوم ألقاك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح الجامع",
    category: "الدعاء العام",
  ...
  },
  {
    ...
    meaning: "يرحمك الله، الرد على العاطس بعد حمد الله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "صحيح البخاري",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "أشهد أن لا إله إلا الله وحده لا شريك له وأشهد أن محمداً عبده ورسوله — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "المناسبات",
  ...
  /* ── الصباح والمساء، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله الكاملة التامة من شر كل ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  },
  {
    ...
    meaning: "أمسينا وأمسى الملك لله، والحمد لله لا شريك له، دعاء جامع لمساء المسلم — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "صحيح مسلم",
    category: "الصباح والمساء",
  ...
  /* ── النوم واليقظة، إضافية ── */
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من غضبه وعقابه وشر عباده ومن همزات الشياطين وأن يحضرون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "لا إله إلا الله الواحد القهار رب السماوات والأرض وما بينهما العزيز الغفار — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  /* ── مناسبات، إضافية ── */
  {
    ...
    meaning: "بارك الله لك وبارك عليك وجمع بينكما في خير — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "اللهم رب الناس أذهب البأس واشفه أنت الشافي لا شفاء إلا شفاؤك شفاءً لا يترك سقماً — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "متفق عليه",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "سبحان الذي سخر لنا هذا وما كنا له مقرنين وإنا إلى ربنا لمنقلبون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
    source: "سنن الترمذي، صحيح",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "اللهم إني أسألك العفو والعافية في الدنيا والآخرة — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "أعوذ بكلمات الله التامات من شر ما خلق — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "زودك الله التقوى وغفر ذنبك ويسر لك الخير حيثما كنت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "اللهم اهدني فيمن هديت، وعافني فيمن عافيت، وتولني فيمن توليت، وبارك لي فيما أعطيت — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي.",
  ...
  },
  {
    ...
    meaning: "سبحان الله والحمد لله والله أكبر، ثلاثاً وثلاثين لكل، ثم ختماً: لا إله إلا الله وحده لا شريك له له الملك وله الحمد وهو على كل شيء قدير؛ فائدة الدعاء وفضله في الشرع",
  ...
  },
  {
    ...
    meaning: "أعوذ بالله من الشيطان الرجيم ومن شر هذه الرؤيا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ─── إضافات الدعاء العام ─── */
  {
    ...
    arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
    transliteration: "Ya Muqallibal-qulub, thabbit qalbi 'ala dinik",
    meaning: "يا مقلِّب القلوب ثبِّت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
  ...
  /* ── الأكل والشرب ── */
  {
    ...
    arabic: "بِسْمِ اللَّهِ",
    transliteration: "Bismillah",
    meaning: "التسمية عند الشرب سنة مؤكدة كالتسمية عند الأكل — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "مسلم: ٢٠٢٢",
    category: "الأكل والشرب",
    occasion: "قبل الشرب",
  ...
  /* ─── الدعاء العام — إضافي ─── */
  {
    ...
    meaning: "اللهم إني أسألك الهدى والتقى والعفاف والغنى — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع",
    source: "مسلم: ٢٧٢١",
    category: "الدعاء العام",
...
export default function DuasPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مكتبة الأدعية الشرعية الموثقة: أدعية الصباح والمساء والصلاة والسفر والكرب مع المعنى والمصدر — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل.",
      ...
      jsonLd: [
        {
          ...
          description: "مكتبة الأدعية الشرعية من القرآن والسنة مع المعنى والمصدر — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل. من الأدعية المأثورة في القرآن والسنة",
