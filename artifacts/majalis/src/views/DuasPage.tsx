...
const DUAS: DuaEntry[] = [
  ...
  },
  {
    ...
    meaning: "سبحان ربي العظيم، تسبيح في الركوع — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "سبحان ربي الأعلى، تسبيح في السجود — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "الصلاة",
  ...
  },
  {
    ...
    meaning: "بسم الله، تسمية عند بدء الطعام — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح مسلم",
  ...
  },
  {
    ...
    meaning: "يا مقلب القلوب ثبت قلبي على دينك — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "اللهم إنك عفو تحب العفو فاعف عني — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "صحيح الترمذي",
    category: "المناسبات",
  ...
  },
  {
    ...
    meaning: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "البقرة: 286",
    category: "الكرب والهم",
  ...
  /* ── السفر، إضافية ── */
  {
    ...
    meaning: "آيبون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "متفق عليه",
    category: "السفر",
  ...
  /* ─── إضافات السفر ─── */
  {
    ...
    meaning: "أستودعك الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  },
  {
    ...
    meaning: "الحمد لله الذي بنعمته تتم الصالحات — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
  ...
  /* ── السفر ── */
  {
    ...
    arabic: "آيِبُونَ تَائِبُونَ عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
    transliteration: "Ayibuna ta'ibuna 'abiduna, li-rabbina hamidun",
    meaning: "راجعون تائبون عابدون لربنا حامدون — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
    source: "البخاري: ١٧٩٧",
    category: "السفر",
    occasion: "عند العودة من السفر",
  ...
  },
  {
    ...
    meaning: "أودعكم الله الذي لا تضيع ودائعه — يُستحضر المعنى في الذكر والدعاء بحسب ما ثبت من الكتاب والسنة، مع مراعاة السياق والموعد الشرعي. فائدة الدعاء وفضله في الشرع يُستحب حفظه والعمل به — من أدعية القرآن والسنة؛ معنى شرعي يُفهم على ضوء الكتاب والسنة",
