...
export default function SurahIndexPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "فهرس سور القرآن الكريم الـ114 كاملة: رقم السورة واسمها وعدد آياتها وتصنيفها المكي أو المدني، مع بحث سريع ومفضلة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
