...
const ARKAN: Rukn[] = [
  ...
  },
  {
    ...
    icon: "🕌",
    summary: "الصلاة هي الركن الثاني من أركان الإسلام، وهي أول ما يُسأل عنه العبد يوم القيامة. وهي الصلة المباشرة بين العبد وربه. وتُقام خمس مرات في اليوم والليلة في أوقاتها المفروضة.",
    dalilQuran: [
    ...
    dalilHadith: [
      ...
      { text: "أول ما يُحاسَب به العبد يوم القيامة الصلاة، فإن صلحت صلح سائر عمله.", source: "النسائي ٤٦٥ والترمذي ٤١٣ — صححه الألباني" },
    ],
    details: [
  ...
  },
  {
    ...
    icon: "💰",
    summary: "الزكاة هي الركن الثالث من أركان الإسلام، وهي حق الفقراء في أموال الأغنياء. وهي تطهير للمال والنفس، وفيها تحقيق للتكافل الاجتماعي. وقد قرنها الله بالصلاة في مواضع كثيرة من كتابه.",
    dalilQuran: [
  ...
  },
  {
    ...
    icon: "🌙",
    summary: "صيام رمضان هو الركن الرابع من أركان الإسلام. وهو شهر كريم خصّه الله بنزول القرآن الكريم، وفُرض الصيام في السنة الثانية من الهجرة. وفيه مغفرة ورحمة ومضاعفة للأجر لمن صامه إيمانًا واحتسابًا.",
    dalilQuran: [
  ...
  },
  {
    ...
    icon: "🕋",
    summary: "الحج هو الركن الخامس من أركان الإسلام، وهو فريضة على المستطيع مرة واحدة في العمر. وهو جامع لجميع أنواع العبادة: صلاة ودعاء وذكر وطواف وسعي ووقوف بعرفة.",
    dalilQuran: [
      ...
      jsonLd: [
        {
          ...
          description: "شرح أركان الإسلام الخمسة بالأدلة وأقوال العلماء؛ مع الأدلة من القرآن والسنة وأقوال العلماء",
          numberOfItems: ARKAN.length,
          itemListElement: ARKAN.map((r, i) => ({
            "@type": "ListItem",
            position: i + 1,
            name: r.title,
            url: `https://www.ssunnah.com/arkan#rukn-${r.num}`,
          })),
        },
      ],
    });
