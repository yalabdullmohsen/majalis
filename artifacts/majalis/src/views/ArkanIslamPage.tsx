...
const ARKAN: Rukn[] = [
  ...
  },
  {
    ...
    icon: "🕌",
    summary: "الصلاة هي الركن الثاني من أركان الإسلام، وهي أول ما يُسأل عنه العبد يوم القيامة. وهي الصلة المباشرة بين العبد وربه. وتُقام خمس مرات في",
    dalilQuran: [
  ...
  },
  {
    ...
    icon: "💰",
    summary: "الزكاة هي الركن الثالث من أركان الإسلام، وهي حق الفقراء في أموال الأغنياء. وهي تطهير للمال والنفس، وفيها تحقيق للتكافل الاجتماعي. وقد قرنها",
    dalilQuran: [
  ...
  },
  {
    ...
    icon: "🌙",
    summary: "صيام رمضان هو الركن الرابع من أركان الإسلام. وهو شهر كريم خصّه الله بنزول القرآن الكريم، وفُرض الصيام في السنة الثانية من الهجرة. وفيه",
    dalilQuran: [
  ...
  },
  {
    ...
    icon: "🕋",
    summary: "الحج هو الركن الخامس من أركان الإسلام، وهو فريضة على المستطيع مرة واحدة في العمر. وهو جامع لجميع أنواع العبادة: صلاة ودعاء وذكر وطواف",
    dalilQuran: [
...
export default function ArkanIslamPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "شرح تفصيلي لأركان الإسلام الخمسة: الشهادتان، الصلاة، الزكاة، الصوم، الحج، مع الأدلة وأقوال العلماء. مع الأدلة من القرآن والسنة وأقوال",
