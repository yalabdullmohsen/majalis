...
const ARKAN: Rukn[] = [
  {
    ...
    icon: "☝️",
    summary: "الشهادتان هما أول أركان الإسلام وأعظمها، وهما كلمة التوحيد التي لا يُقبل إسلام أحد بدونها. وهي إقرار باللسان واعتقاد بالقلب وعمل بالجوارح. من أركان الإسلام الخمسة المعتمدة",
    dalilQuran: [
      { text: "فَاعْلَمْ أَنَّهُ لَا إِلَٰهَ إِلَّا اللَّهُ وَاسْتَغْفِرْ لِذَنبِكَ؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم", ref: "محمد: 19" },
      { text: "شَهِدَ اللَّهُ أَنَّهُ لَا إِلَٰهَ إِلَّا هُوَ وَالْمَلَائِكَةُ وَأُولُو الْعِلْمِ؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم", ref: "آل عمران: 18" },
    ],
    dalilHadith: [
      { text: "بُنِيَ الإسلام على خمس: شهادة أن لا إله إلا الله وأن محمداً رسول الله... من أدلة أركان الإسلام يُستحضر في التعليم", source: "متفق عليه" },
      { text: "من شهد أن لا إله إلا الله وحده لا شريك له وأن محمداً عبده ورسوله، وأن عيسى عبد الله... من أدلة أركان الإسلام يُستحضر في التعليم", source: "رواه البخاري" },
    ],
    details: [
    ...
    scholarQuote: { text: "لا إله إلا الله كلمة يتضمن إثباتها ونفيها توحيد الله في ربوبيته وألوهيته وأسمائه وصفاته. من أدلة أركان الإسلام", scholar: "ابن تيمية" },
    color: "#143F35",
  },
  {
    num: 2,
    ...
    dalilQuran: [
      { text: "وَأَقِيمُوا الصَّلَاةَ وَآتُوا الزَّكَاةَ وَارْكَعُوا مَعَ الرَّاكِعِينَ؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم", ref: "البقرة: 43" },
      { text: "إِنَّ الصَّلَاةَ كَانَتْ عَلَى الْمُؤْمِنِينَ كِتَابًا مَّوْقُوتًا؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم —", ref: "النساء: 103" },
    ],
    dalilHadith: [
      { text: "الصلوات الخمس والجمعة إلى الجمعة كفارة لما بينهن ما اجتُنبت الكبائر. من أدلة أركان الإسلام يُستحضر في التعليم —", source: "رواه مسلم" },
      { text: "أول ما يُحاسَب به العبد يوم القيامة الصلاة، فإن صلحت صلح سائر عمله. من أدلة أركان الإسلام يُستحضر في التعليم — ", source: "النسائي ٤٦٥ والترمذي ٤١٣ — صححه الألباني" },
    ],
    details: [
    ...
    scholarQuote: { text: "الصلاة معراج المؤمنين، وإقامتها على وجهها تُصلح باقي الأعمال. من أدلة أركان الإسلام يُستحضر في التعليم — مرجع م", scholar: "الإمام النووي" },
    color: "#143F35",
  },
  {
    num: 3,
    ...
    dalilQuran: [
      { text: "وَأَقِيمُوا الصَّلَاةَ وَآتُوا الزَّكَاةَ وَمَا تُقَدِّمُوا لِأَنفُسِكُم مِّنْ خَيْرٍ تَجِدُوهُ عِندَ اللَّهِ؛ من أدلة أركان الإسلام", ref: "البقرة: 110" },
      { text: "خُذْ مِنْ أَمْوَالِهِمْ صَدَقَةً تُطَهِّرُهُمْ وَتُزَكِّيهِم بِهَا؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم —", ref: "التوبة: 103" },
    ],
    dalilHadith: [
      { text: "ما نقصت صدقة من مال، ومن تواضع لله رفعه الله. من أدلة أركان الإسلام يُستحضر في التعليم — مرجع معتمد في مجالس ال", source: "رواه مسلم" },
      { text: "ما من صاحب ذهب ولا فضة لا يؤدي منها حقها إلا إذا كان يوم القيامة صُفِّحَت له صفائح. من أدلة أركان الإسلام يُستحضر في التعليم", source: "رواه مسلم" },
    ],
    details: [
    ...
    scholarQuote: { text: "الزكاة قنطرة الإسلام، فمن عبرها كان في الجنة ومن تخلف عنها هلك. من أدلة أركان الإسلام يُستحضر في التعليم — مرجع", scholar: "أبو بكر الصديق" },
    color: "#126650",
  },
  {
    num: 4,
    ...
    dalilQuran: [
      ...
      { text: "شَهْرُ رَمَضَانَ الَّذِي أُنزِلَ فِيهِ الْقُرْآنُ هُدًى لِّلنَّاسِ؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم —", ref: "البقرة: 185" },
    ],
    dalilHadith: [
      { text: "من صام رمضان إيماناً واحتساباً غُفر له ما تقدم من ذنبه. من أدلة أركان الإسلام يُستحضر في التعليم — مرجع معتمد ف", source: "متفق عليه" },
      { text: "إذا جاء رمضان فُتِّحت أبواب الجنة وغُلِّقت أبواب النار وصُفِّدت الشياطين. من أدلة أركان الإسلام يُستحضر في التعليم", source: "متفق عليه" },
    ],
    details: [
    ...
    scholarQuote: { text: "رمضان موسم الطاعات، فأكثِر فيه من القرآن والذكر والصدقة، واجعله بداية التحول. من أدلة أركان الإسلام يُستحضر في التعليم", scholar: "ابن القيم" },
    color: "#052E16",
  },
  {
    num: 5,
    ...
    dalilQuran: [
      { text: "وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا؛ من أدلة أركان الإسلام؛ يُستحضر في التعليم", ref: "آل عمران: 97" },
      { text: "وَأَذِّن فِي النَّاسِ بِالْحَجِّ يَأْتُوكَ رِجَالًا وَعَلَىٰ كُلِّ ضَامِرٍ يَأْتِينَ مِن كُلِّ فَجٍّ عَمِيقٍ؛ من أدلة أركان الإسلام", ref: "الحج: 27" },
    ],
    dalilHadith: [
      { text: "من حج هذا البيت فلم يرفث ولم يفسق رجع كيوم ولدته أمه. من أدلة أركان الإسلام يُستحضر في التعليم — مرجع معتمد في ", source: "متفق عليه" },
      { text: "العمرة إلى العمرة كفارة لما بينهما، والحج المبرور ليس له جزاء إلا الجنة. من أدلة أركان الإسلام يُستحضر في التعليم", source: "رواه مسلم" },
    ],
    details: [
    ...
    scholarQuote: { text: "الحج مؤتمر إسلامي سنوي يجمع المسلمين على كلمة التوحيد ويذكّرهم بيوم القيامة. من أدلة أركان الإسلام يُستحضر في التعليم", scholar: "الإمام الشافعي" },
    color: "#143F35",
  },
];
...
export default function ArkanIslamPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "شرح تفصيلي لأركان الإسلام الخمسة: الشهادتان، الصلاة، الزكاة، الصوم، الحج، مع الأدلة وأقوال العلماء. مع الأدلة من القرآن والسنة وأقوال العلماء",
      ...
      jsonLd: [
        {
          ...
          description: "شرح أركان الإسلام الخمسة بالأدلة وأقوال العلماء؛ مع الأدلة من القرآن والسنة وأقوال العلماء؛ مرجع معتمد في مجالس العلم — مرجع معتمد ",
