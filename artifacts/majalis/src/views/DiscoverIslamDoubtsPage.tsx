...
export default function DiscoverIslamDoubtsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "ردود موثّقة وهادئة على أشهر الشبهات المثارة حول الإسلام، بصياغة الشبهة الحقيقية دون تحريف. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
    });
