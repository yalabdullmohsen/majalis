...
export default function QuranTajweedPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قواعد علم التجويد الكاملة، أحكام النون الساكنة والتنوين، الميم الساكنة، المدود، صفات الحروف ومخارجها. من أحكام النون والميم والمدود وصفات الحروف",
