...
const RULES: TajweedRule[] = [
  ...
  {
    id: "izhar-halqi", category: "النون الساكنة والتنوين", color: "var(--mj-brand-deep)",
  ...
  {
    id: "idgham-bighunnah", category: "النون الساكنة والتنوين", color: "var(--mj-brand-deep)",
    title: "الإدغام بغنة",
  ...
  {
    id: "idgham-bila-ghunnah", category: "النون الساكنة والتنوين", color: "var(--mj-brand-deep)",
  ...
  {
    id: "iqlab", category: "النون الساكنة والتنوين", color: "var(--mj-brand-deep)",
    title: "الإقلاب",
    definition: "قلب النون الساكنة أو التنوين ميماً مخفاةً بغنة عند حرف الباء.",
    example: "أَنبِئُونِي · سَمِيعٌ بَصِيرٌ · مِن بَعْدِ",
  },
  {
    id: "ikhfa-haqiqi", category: "النون الساكنة والتنوين", color: "var(--mj-brand-deep)",
  ...
  },
  {
    ...
    definition: "التفخيم: تغليظ صوت الحرف وامتلاء صداه. والترقيق: تنحيف صوته. أحرف الاستعلاء السبعة تُفخَّم بحسب مراتبها (خص ضغط قظ)، واللام في لفظ الجلالة تُفخَّم بعد فتح أو ضم.",
  ...
  },
  {
    ...
    title: "الغنة",
    definition: "صوت أغنّ يخرج من الخيشوم. تكون في النون والميم المشددتين، وتظهر في أحكام الإخفاء والإدغام والإقلاب. مقدارها حركتان.",
  ...
  },
  {
    ...
    types: [
      ...
      { name: "اللام القمرية", definition: "تُظهَر مع 14 حرفاً: أ ب ج ح خ ع غ ف ق ك م و ه ي، فتُنطق اللام ساكنة واضحة", example: "الْقَمَرُ · الْكِتَابُ · الْحَمْدُ · الْبَيْتُ · الْعَالَمِينَ · الْغَيْبِ" },
    ],
  },
  {
  ...
  },
  {
    ...
    types: [
      ...
      { name: "الصفير", definition: "صوت حاد شبيه بالصفارة يصاحب حروف الصفير الثلاثة: الصاد والزاي والسين", example: "الصَّادِقُونَ · الزَّكَاةَ · السَّبِيلَ" },
    ],
  },
  {
  ...
  /* ══ الأحكام العامة، توسعة ══ */
  {
    ...
    definition: "إدغام حرف ساكن في مثله أو مجانسه أو مقاربه عند التقاء الحروف، وله صور مقررة في التلاوة بحسب الرواية.",
    types: [
  ...
  },
  {
    ...
    definition: "السكت: قطع الصوت على الحرف لحظةً يسيرة دون تنفس ثم متابعة القراءة. والمشهور في رواية حفص عن عاصم أربعة مواضع في القرآن الكريم.",
    types: [
      ...
      { name: "﴿بَلْ ۜ رَانَ﴾ المطففين: ١٤", definition: "السكت على لام (بَلْ) قبل (رَانَ) منعاً من الإدغام", example: "﴿كَلَّا بَلْ ۜ رَانَ عَلَىٰ قُلُوبِهِم﴾" },
    ],
  },
...
export default function QuranTajweedPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قواعد علم التجويد الكاملة، أحكام النون الساكنة والتنوين، الميم الساكنة، المدود، صفات الحروف ومخارجها. من أحكام النون والميم والمدود وصفات",
      ...
      jsonLd: [
        {
          ...
          "@type": "Course",
          name: "علم التجويد",
          description: "قواعد تجويد القرآن الكريم من أحكام النون الساكنة إلى المدود وصفات الحروف؛ من أحكام النون والميم والمدود وصفات الحروف؛ قواعد تجويد القرآن",
    ...
    <div className="page-shell ds-page tj-page">
      ...
      <div className="tj-intro-box">
        <p>
          ...
          مخرجه الصحيح. تعلّمه فرض كفاية وتطبيق القدر الذي تصح به القراءة فرض عين على كل قارئ للقرآن الكريم.
        </p>
        <p className="tj-hadith" lang="ar">
          قال النبي ﷺ: «زَيِّنُوا الْقُرْآنَ بِأَصْوَاتِكُمْ»، رواه أبو داود وابن ماجه، وصححه الألباني
        </p>
      </div>
