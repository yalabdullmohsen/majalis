...
export default function ArbaeenLovePage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مجموعة أحاديث نبوية موثقة في محبة الله لعباده ومحبة العبد لربه، من صحيح البخاري ومسلم وغيرهما — مراجَعة علميًا قبل النشر. يُعرض للتعلّم والاطلاع. ",
