...
export default function OccasionsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تقويم المناسبات الإسلامية والأعياد والمواسم الدينية، رمضان وعيد الفطر وعيد الأضحى والمواسم الهجرية. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "تقويم الأعياد والمناسبات الدينية في الشهور الهجرية؛ محتوى معتمد في منهج مجالس العلم",
          numberOfItems: 12,
          itemListElement: [
