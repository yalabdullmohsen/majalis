    ...
    >
      ...
      <g transform={`rotate(${arrowRot} 100 100)`}>
        ...
        <polygon
          ...
          fill={aligned ? "var(--majalis-emerald, #143F35)" : "#22C55E"}
        ...
        />
        {/* رأس السهم: القبلة */}
        <polygon points="100,6 93,20 107,20" fill="var(--majalis-emerald, #143F35)" opacity="0.75" />
        {/* مركز الوصلة */}
        <circle cx="100" cy="100" r="7" fill={aligned ? "var(--majalis-emerald, #143F35)" : "#22C55E"} />
