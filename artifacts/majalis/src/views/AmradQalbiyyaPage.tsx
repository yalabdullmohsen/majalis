...
const DISEASES: Disease[] = [
  ...
  },
  {
    ...
    arabic: "حسد",
    icon: "👁",
    definition: "تمنّي زوال نعمة الغير، أو كراهة ما أنعم الله به عليه، وهو من أخطر أمراض القلوب.",
    signs: [
  ...
  },
  {
    ...
    arabic: "بخل وشح",
    icon: "🔒",
    definition: "البخل: الإمساك عن الإنفاق الواجب أو المستحب. والشح: شدة حرص النفس مع منع الحقوق أو التضييق فيها.",
    signs: [
      ...
      <div className="max-w-3xl mx-auto px-4 mb-8">
        <div className="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 rounded-2xl p-5">
          <p className="text-rose-900 dark:text-rose-200 text-sm leading-relaxed">
            القلب هو مدار الصلاح والفساد؛ قال ﷺ: «ألا وإن في الجسد مُضغة إذا صلحت صلح الجسد كله وإذا فسدت فسد الجسد كله ألا وهي القلب»، فكان علاج أمراضه من آكد واجبات المسلم. وفيما يلي أبرز هذه الأمراض مع علاماتها وطريق علاجها.
          </p>
        </div>
      </div>
