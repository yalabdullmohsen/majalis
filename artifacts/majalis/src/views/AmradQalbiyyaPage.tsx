...
const DISEASES: Disease[] = [
  {
    ...
    evidence: "قال ﷺ: «لا يدخل الجنة من كان في قلبه مثقالُ ذرةٍ من كِبر»، فقيل: إن الرجل يحب أن يكون ثوبه حسناً ونعله حسنة، قال: «إن الله جميل يحب الجمال، الكِبْرُ بَطَرُ الحقّ وغَمْطُ الناس» — رواه مسلم (91) من حديث ابن مسعود ﵁.",
    color: "#dc2626",
  },
  {
    id: "hasad",
    ...
    evidence: "قال ﷺ: «لا تحاسدوا ولا تناجشوا ولا تباغضوا ولا تدابروا، وكونوا عباد الله إخواناً» — رواه مسلم (2564) من حديث أبي هريرة ﵁. وقال تعالى: ﴿وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ﴾ — الفلق: 5.",
    color: "#7c3aed",
  },
  {
    id: "riyaa",
  ...
  },
  {
    ...
    evidence: "أوصى ﷺ رجلاً استوصاه فقال: «لا تغضب»، فردّد مراراً، قال: «لا تغضب» — رواه البخاري (6116) من حديث أبي هريرة ﵁. وقال ﷺ: «ليس الشديد بالصُّرَعة، إنما الشديد الذي يملك نفسه عند الغضب» — متفق عليه.",
    color: "#ea580c",
  },
  {
    id: "hiqd",
  ...
  },
  {
    ...
    evidence: "قال ﷺ: «واتقوا الشحّ، فإن الشحّ أهلك من كان قبلكم، حملهم على أن سفكوا دماءهم واستحلوا محارمهم» — رواه مسلم (2578) من حديث جابر ﵁. وقال تعالى: ﴿وَمَن يُوقَ شُحَّ نَفْسِهِ فَأُولَٰئِكَ هُمُ الْمُفْلِحُونَ﴾ — الحشر: 9.",
    color: "#1d4ed8",
  },
];
