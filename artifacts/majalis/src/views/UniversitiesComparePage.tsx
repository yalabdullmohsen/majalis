...
export default function UniversitiesComparePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قارن بين الجامعات الإسلامية، التخصصات والاعتمادات والبرامج الأكاديمية جنباً إلى جنب. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي؛ محتوى تعليمي معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "مقارنة تفصيلية بين الجامعات الإسلامية في التخصصات والبرامج الأكاديمية؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معت؛ محتوى تعليمي معتمد في منهج مجالس العلم",
