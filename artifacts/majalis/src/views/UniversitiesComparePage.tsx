...
export default function UniversitiesComparePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قارن بين الجامعات الإسلامية، التخصصات والاعتمادات والبرامج الأكاديمية جنباً إلى جنب. عرض موثّق ضمن منهج سُنّة",
      ...
      jsonLd: [
        {
          ...
          description: "مقارنة تفصيلية بين الجامعات الإسلامية في التخصصات والبرامج الأكاديمية؛ عرض موثّق ضمن منهج سُنّة",
