...
export default function UniversitiesComparePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "قارن بين الجامعات الإسلامية، التخصصات والاعتمادات والبرامج الأكاديمية جنباً إلى جنب. يُعرض للتعلّم والاطلاع. في المجلس العلمي",
      ...
      jsonLd: [
        {
          ...
          description: "مقارنة تفصيلية بين الجامعات الإسلامية في التخصصات والبرامج الأكاديمية؛ يُعرض للتعلّم والاطلاع. في المجلس العلمي",
