...
const HIKAM: Hikma[] = [
  /* ─── الإيمان والتوحيد ─── */
  {
    ...
    explanation: "تربية قلبية: تُقرّب العبد إلى معرفة ربه ومحبته، فمن عرف الله استقام سلوكه وخشي عقابه ورجا ثوابه؛ والحكمة هنا تذكيرٌ بأن الإيمان أصل كل خير.",
    scholar: "ابن تيمية",
    died: "728ه",
  ...
  /* ─── العلم والعمل ─── */
  {
    ...
    explanation: "توجيه علمي: العلم بلا عمل كالشجر بلا ثمر، والعمل بلا علم كالبناء بلا أساس؛ فالحكمة تدعو إلى تعلّم ما ينفع وترك ما يُضيّع الوقت في الجدل بلا عمل.",
    scholar: "ابن مسعود",
    died: "32ه",
  ...
  /* ─── الدنيا والزهد ─── */
  {
    ...
    explanation: "زهد عملي: الدنيا دار ممر لا مقر، والزهد ليس تحريم الحلال بل إيثار الآخرة وعدم تعلّق القلب بما يفنى؛ فالحكمة تُذكّر بقصر الأمل وطول الأمل في الدار الآخرة.",
  ...
  /* ─── التوبة والاستغفار ─── */
  {
    ...
    explanation: "توبة واستدراك: الذنب لا يُيئس العبد إذا تبعته توبة صادقة، والندم انكسارٌ يُقرب إلى الله؛ فالحكمة تدعو إلى المبادرة بالاستغفار قبل أن يُغلق باب التوبة.",
    scholar: "الحسن البصري",
    died: "110ه",
  ...
  /* ─── الصبر والشكر ─── */
  {
    ...
    explanation: "صبر وشكر: النعمة تزيد بالشكر وتُوبق بالكفر، والبلاء للمؤمن تكفير ورفعة؛ فالحكمة تُعلّم أن الرضا بالقضاء من أعلى مقامات اليقين.",
    scholar: "ابن مسعود",
    died: "32ه",
  ...
  /* ─── الأخلاق ─── */
  {
    ...
    explanation: "خلق راسخ: حسن الخلق من أثقل ما في ميزان العبد، والتواضع والإنصاف من مكارم الدين؛ فالحكمة تدعو إلى تهذيب النفس قبل تقييم غيرها.",
    scholar: "الإمام الشافعي",
    died: "204ه",
    category: "الأخلاق",
  },
  ...
  /* ─── الموت والآخرة ─── */
  {
    ...
    explanation: "تذكير بالآخرة: الموت هادم اللذات وقاطع شهوات الدنيا، والاستعداد له بزاد من عمل صالح؛ فالحكمة تُوقظ الغافل قبل أن يُفاجأ بلا زاد.",
    scholar: "الحسن البصري",
    died: "110ه",
  ...
  /* ─── القرآن والذكر ─── */
  {
    ...
    explanation: "قرآن وذكر: القرآن شفاء وهدى، والذكر للقلب كالماء للسمكة؛ فالحكمة تدعو إلى تدبر آيات الله وكثرة ذكره في السر والعلن.",
    scholar: "الحسن البصري",
    died: "110ه",
      ...
      jsonLd: [
        {
          ...
          description: "مختارات من حكم السلف الصالح وأقوال الأئمة الكبار — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل.",
