...
export default function HikamSalafPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "مختارات من حكم السلف الصالح وأقوال الأئمة: الحسن البصري وابن تيمية وابن القيم والشافعي وأحمد وغيرهم — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل.",
