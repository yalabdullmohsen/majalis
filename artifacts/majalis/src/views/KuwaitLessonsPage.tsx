...
export default function KuwaitLessonsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "جميع الدروس العلمية القادمة لمشايخ الكويت، محدَّثة تلقائياً من مصادر معتمدة. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "قائمة الدروس الشرعية القادمة لعلماء ومشايخ الكويت؛ محتوى معتمد في منهج مجالس العلم",
        ...
        },
        {
          ...
          description: "دروس شرعية منتظمة في مساجد ومراكز الكويت العلمية؛ محتوى معتمد في منهج مجالس العلم",
          location: {
            "@type": "Country",
            name: "الكويت",
          },
