...
export default function KuwaitLessonsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "جميع الدروس العلمية القادمة لمشايخ الكويت، محدَّثة تلقائياً من مصادر معتمدة. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربو",
      ...
      jsonLd: [
        {
          ...
          description: "قائمة الدروس الشرعية القادمة لعلماء ومشايخ الكويت؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس الع",
        ...
        },
        {
          ...
          description: "دروس شرعية منتظمة في مساجد ومراكز الكويت العلمية؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العل",
          location: {
            "@type": "Country",
            name: "الكويت",
          },
