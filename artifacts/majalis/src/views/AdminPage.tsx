...
import { QuranCirclesSection } from "@/views/admin/QuranCirclesSection";
import { MutoonSection } from "@/views/admin/MutoonSection";
...
function SectionContent({ section }: { section: AdminSection }) {
  switch (section) {
    ...
    case "quran-circles":
      return <QuranCirclesSection />;
    case "mutoon":
      return <MutoonSection />;
