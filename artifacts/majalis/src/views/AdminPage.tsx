...
import { PermanentCommitteeAdminSection } from "@/views/admin/PermanentCommitteeAdminSection";
...
import { PersonalLearningAdminSection } from "@/views/admin/PersonalLearningAdminSection";
import {
  adminSectionPath,
...
function SectionContent({ section }: { section: AdminSection }) {
  switch (section) {
    ...
    case "permanent-committee":
      return <PermanentCommitteeAdminSection />;
    case "rulings":
    ...
    case "personal-learning":
      return <PersonalLearningAdminSection />;
    default:
      return <DashboardSection />;
  }
}
