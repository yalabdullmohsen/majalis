...
export default function ArbaeenNawawiPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الأربعون حديثاً النووية مع شرح موجز وفوائد ومصدر لكل حديث، مرجع حديثي مختصر لطالب العلم. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      ...
      jsonLd: [
        {
          ...
          description: "الأربعون حديثاً النووية الجامعة لأحكام الإسلام؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في منهج مجالس العلم.",
