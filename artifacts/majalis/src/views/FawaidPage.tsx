...
export default function FawaidPage({
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "منصة لنشر ومشاركة الفوائد العلمية والشرعية، فوائد قرآنية وحديثية وعقدية وفقهية وتربوية. محتوى معتمد في منهج مجالس العلم",
      ...
      jsonLd: [
        {
          ...
          description: "أقسام الفوائد العلمية والشرعية على المنصة؛ محتوى معتمد في منهج مجالس العلم",
