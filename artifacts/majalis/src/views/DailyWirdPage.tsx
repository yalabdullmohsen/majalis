...
export default function DailyWirdPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تتبّع وردك اليومي من القرآن الكريم، حدّد هدفك اليومي من الصفحات وتابع تقدمك نحو ختم القرآن. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
      ...
      jsonLd: [
        {
          ...
          description: "تتبّع وردك اليومي من القرآن الكريم وتابع تقدمك نحو ختم القرآن؛ محتوى معتمد في منهج مجالس العلم؛ يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي — مرجع تربوي معتمد في من",
