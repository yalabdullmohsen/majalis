      ...
      <section className="fq-hero">
        <div className="fq-hero__inner">
          ...
          <div className="fq-hero__stats">
            ...
            <div className="fq-stat"><span className="fq-stat__num">١٢</span><span className="fq-stat__label">قاعدة فرعية</span></div>
            <div className="fq-stat"><span className="fq-stat__num">٤</span><span className="fq-stat__label">ضوابط تخصصية</span></div>
            <div className="fq-stat"><span className="fq-stat__num">٦</span><span className="fq-stat__label">تطبيق معاصر</span></div>
          </div>
        </div>
      </section>
