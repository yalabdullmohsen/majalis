...
const TATBIQAT: TatbiqMasala[] = [
  ...
  },
  {
    ...
    answer: "ترى أغلب المجامع الفقهية أن العملات الرقمية المركزية تنزل منزلة النقود الورقية القانونية في أحكامها، إذ تصدرها الدولة وتضمن قيمتها. ويجري عليها ما يجري على النقود من أحكام الصرف والربا وزكاة الأموال. وتختلف عن العملات الرقمية اللامركزية (Bitcoin) في وجود جهة ضامنة تُخفف إشكالية الغرر.",
    source: "بيان مجمع الفقه الإسلامي الدولي ٢٠٢٣، ندوة فقه المال والأعمال — الكويت",
  },
  {
    ...
    source: "ورقة مجمع الفقه الإسلامي الدولي حول التحول الرقمي في الأوقاف ٢٠٢٤",
  },
  {
