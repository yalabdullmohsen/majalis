...
const TATBIQAT: TatbiqMasala[] = [
  ...
  },
  {
    ...
    source: "ندوات فقه المال والأعمال المعاصرة حول العملات الرقمية المركزية",
  },
  {
    ...
    source: "دراسات فقهية معاصرة في التحول الرقمي وإدارة الأوقاف",
  },
  {
    ...
    source: "قرار مجمع الفقه الإسلامي الدولي رقم ٥٢ (المعدَّل)، وورقة المجلس الأوروبي للإفتاء",
  },
];
