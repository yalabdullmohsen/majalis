...
const QAWAID_FARAA: FariyaQaaida[] = [
  { text: "الغُنم بالغُرم", parent: 1, explanation: "الغانم بالنفع ضامن للضرر، من يستفيد من شيء فعليه تحمل مسؤوليته — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من انتفع بعينٍ مضمونة تحمل ضمانها عند التلف" },
  { text: "الخراج بالضمان", parent: 1, explanation: "نفع الشيء لمن عليه ضمانه، من يضمن شيئاً يستحق خراجه ومنافعه — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "إذا اشترى شخص سلعة ثم تبين عيبها وردّها، فغلتها في مدة حيازته له بضمانه" },
  { text: "لا عبرة بالدلالة في مقابلة التصريح", parent: 2, explanation: "إذا وُجد نص صريح لم يُعتبر ما يُفهم بالدلالة خلافاً له — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "إذا نصّ المُوصي على ما يُوصي به صراحةً، لا يُعتبر خلافه بأي دلالة" },
  { text: "لا ثواب إلا بنية", parent: 1, explanation: "العمل الصالح لا يُثاب عليه العبد إلا إذا أتى به قاصداً — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من أطعم الفقير عادةً لا صدقةً لم يُثب ثواب الصدقة" },
  { text: "الضرورات تبيح المحظورات", parent: 3, explanation: "ما حُرّم ابتداءً قد يُباح عند الضرورة القصوى لرفع الحرج والمشقة الشديدة — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "المضطر يأكل الميتة بقدر ما يسدّ الرمق" },
  { text: "الأصل بقاء ما كان على ما كان", parent: 2, explanation: "الحكم الثابت يبقى حتى يثبت ما يرفعه بدليل شرعي — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من تيقن الطهارة وشك في الحدث فهو طاهر" },
  { text: "إذا ضاق الأمر اتّسع", parent: 3, explanation: "عند الحرج والشدة تتوسع مساحة الحكم الشرعي رحمةً بالعباد — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "التيمم عند عدم الماء، والصلاة قاعداً عند العجز" },
  { text: "درء المفاسد أولى من جلب المصالح", parent: 4, explanation: "عند تعارض المصالح والمفاسد، تُقدّم إزالة المفسدة على تحصيل المصلحة — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "إغلاق بيع السلاح لمن يُخشى منه الفساد رغم المصلحة الاقتصادية" },
  { text: "يُتحمل الضرر الخاص لدفع الضرر العام", parent: 4, explanation: "يجوز إلحاق الضرر بالفرد حفاظاً على المجتمع وصون مصلحته العامة — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "هدم بناء متداعٍ يُهدد الجيران رغم اعتراض صاحبه" },
  { text: "التابع تابع", parent: 5, explanation: "ما كان تابعاً لشيء لا يُفرد بحكم مستقل بل يتبع أصله — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من اشترى بستاناً، فالشجر فيه تابع له بلا حاجة لذكره" },
  { text: "المعروف عرفاً كالمشروط شرطاً", parent: 5, explanation: "ما تعارف الناس عليه وجرى به العُرف يُعدّ كأنه مشروط في العقد وإن لم يُذكر — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "إذا جرى العرف بتسليم المبيع دون تأخير، التزم البائع ذلك وإن لم ينص عليه" },
  { text: "العبرة في العقود للمقاصد والمعاني لا للألفاظ والمباني", parent: 1, explanation: "يُنظر في العقود إلى ما قصده العاقدان حقيقةً، لا إلى الألفاظ المجردة — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من قال «بعتك» وكلاهما يقصد الهبة، فالهبة هي الحكم" },
  { text: "الأمور تُقدَّر بقدرها", parent: 3, explanation: "ما أُبيح لضرورة أو مشقة لا يتجاوز مقدارها بل يُقدَّر بالحاجة الفعلية — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "المضطر يأكل من الميتة بقدر سدّ الرمق لا التشبع والادخار" },
  { text: "الأصل في الإنسان البراءة من التكاليف حتى يثبت الإلزام", parent: 2, explanation: "لا يُطالب أحد بتكليف أو دين حتى يثبت بدليل معتبر — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "المدّعى عليه في دين لا يُلزم بالأداء حتى تُقام البيّنة" },
  { text: "رفع الحرج عن الأمة مقصد شرعي أصيل", parent: 3, explanation: "الشريعة جاءت لرفع الحرج والمشقة في التكاليف بتيسير الأحكام عند الاقتضاء — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "جواز الجمع بين الصلاتين في السفر وتقصير الرباعية رفعاً للحرج" },
  { text: "لا اجتهاد مع النص", parent: 2, explanation: "إذا وُجد نص شرعي صريح لم يُجز مخالفته بالاجتهاد أو القياس — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "نصاب الزكاة المقدَّر شرعاً لا يُغيَّر باجتهاد الفقيه وإن ادُّعيت المصلحة" },
  { text: "الحاجة تنزل منزلة الضرورة عامةً كانت أو خاصة", parent: 3, explanation: "إذا بلغت الحاجة حداً يُفضي إلى حرج شديد جاز التوسع في الحكم كما يُباح عند الضرورة — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "جواز بيوع المساومة التي فيها جهالة يسيرة دفعاً للحرج في التعاملات اليومية" },
  { text: "إذا بطل الأصل بطل الفرع", parent: 2, explanation: "لا يصحّ الفرع وحده إذا انتفى أصله الذي يقوم عليه — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "إذا بطل عقد الإجارة بطل شرط الأجر المترتب عليه" },
  { text: "المشقة لا تُثبَت بالتوهم", parent: 3, explanation: "لا يُحكم بوجود المشقة المُبيحة للرخصة بمجرد الوهم أو الإمكان بل لا بد من تحققها فعلاً — قاعدة فقهية كلية يستدل بها الفقهاء على جزئيات الأحكام، ويُراعى في تطبيقها شروطها واستثناءاتها عند أهل العلم.", example: "من خشي مرضاً موهوماً لا يُفطر في رمضان استناداً لتلك الخشية" },
];
      ...
      jsonLd: [
        {
          ...
          description: "القواعد الفقهية الخمس الكبرى وفروعها وتطبيقاتها — مرجع تعليمي للمسلم الباحث عن العلم الشرعي الموثّق، مع التحفّظ من الاجتهاد بلا دليل.",
