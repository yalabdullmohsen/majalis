...
const ABWAB_KHALQ: ShamilBab[] = [
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "كانَ رسولُ اللهِ ﷺ أَجهَرَ الناسِ صوتاً إذا تكلَّمَ وأَفصَحَهُم لساناً وأَبيَنَهم بياناً", rawi: "البراء بن عازب رضي الله عنه", source: "الطبراني في الكبير — يُراجع إسناده؛ لا يُجزم بصحته" },
    ],
  },
  {
    id: 10,
...
const ABWAB_SIRA: ShamilBab[] = [
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "ما جَلَسَ إليه أحدٌ إلا أَقبَلَ عليه بوجهِه كلِّه كأنَّه ليسَ عِندَه غيرُه", rawi: "أبو الدرداء رضي الله عنه", source: "الطبراني — يُراجع إسناده" },
    ],
  },
  {
    id: 5,
