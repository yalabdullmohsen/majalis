...
const ABWAB_KHALQ: ShamilBab[] = [
  {
    ...
    hadiths: [
      ...
      { text: "كان رسولُ الله ﷺ إذا سُرَّ استنارَ وجهُه كأنَّه قِطعةُ قمرٍ، وكنَّا نعرفُ ذلك منه", rawi: "كعب بن مالك رضي الله عنه", source: "البخاري ومسلم" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "كان وجهُ رسولِ الله ﷺ مثلَ الشمسِ والقمرِ، وكان مستديراً", rawi: "جابر بن سمرة رضي الله عنه", source: "مسلم" },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "رأيتُ النبيَّ ﷺ يتسوَّكُ حتى أُرى أنَّه يريدُ أن يَقتَلِعَ أسنانَه", rawi: "حذيفة بن اليمان رضي الله عنه", source: "أبو داود ٤٧ — صححه الألباني" },
    ],
  },
  {
    id: 9,
    ...
    hadiths: [
      ...
      { text: "كانَ كلامُه فُصولاً يَفصِلُ بينَ الكلامِ فَصلاً بيِّناً يَحفَظُه من أَرادَ أن يَحفَظَه", rawi: "عائشة رضي الله عنها", source: "أبو داود ٤٨٣٥ — صححه الألباني" },
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "ما مسستُ ديباجاً ولا حريراً ألينَ من كفِّ رسولِ الله ﷺ", rawi: "أنس بن مالك رضي الله عنه", source: "البخاري ومسلم" },
...
const ABWAB_KHULUQ: ShamilBab[] = [
  ...
  },
  {
    ...
    icon: "🤲",
    hadiths: [
      { text: "ابغُوني الضُّعفاء، فإنَّما تُرزَقونَ وتُنصَرونَ بضُعَفائِكُم", rawi: "أبو الدرداء رضي الله عنه", source: "أبو داود ٢٥٩٤ والترمذي ١٧٠٢ — صححه الألباني" },
      { text: "كان النبيُّ ﷺ يمرُّ بالصِّبيان فيسلِّم عليهم", rawi: "أنس بن مالك رضي الله عنه", source: "البخاري ومسلم" },
...
const ABWAB_SIRA: ShamilBab[] = [
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "مَن عادَ مريضاً لم يَزَل في خُرفةِ الجنَّة حتى يَرجِعَ", rawi: "ثوبان رضي الله عنه", source: "مسلم" },
    ],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    hadiths: [
      ...
      { text: "كانَ ﷺ يُكثِرُ من قولِه: «يا مُقَلِّبَ القلوبِ ثبِّتْ قلبِي على دِينِكَ»", rawi: "أم سلمة رضي الله عنها", source: "الترمذي ٢١٤٠ — صححه الألباني" },
...
const MAHABBAH_ABWAB: MahabbahBab[] = [
  ...
  },
  {
    ...
    text: "أصدق دلائل المحبة أن يقدّم المؤمن هدي النبي ﷺ على هواه، ويتعلم سنته ويعمل بها برفق وثبات",
...
const MAWLID_STATS = [
  { label: "عام الميلاد", value: "نحو ٥٧٠–٥٧١ م (عام الفيل)" },
  ...
  { label: "تاريخ الوفاة", value: "ربيع الأول ١١ هـ / ٦٣٢ م، والمشهور ١٢ ربيع الأول مع خلاف في تعيين اليوم" },
  { label: "عدد الغزوات", value: "نحو ٢٧ غزوة، ويختلف العدّ باختلاف اصطلاح أهل السيرة" },
  { label: "عدد السرايا", value: "نحو ٦٠ سريّة وبعثاً، والعدد تقريبي بحسب طريقة العد" },
...
export default function ShimaelPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "تعرّف على صفة النبي محمد ﷺ خَلقاً وخُلُقاً وهَديه في حياته من أصحِّ الروايات. محتوى معتمد في مجالس العلم يُستفاد منه في التعلم والتدبر؛ من",      keywords: ["شمائل النبي", "صفة النبي", "الشمائل المحمدية", "سيرة نبوية", "حب النبي"],
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          name: "أبواب الشمائل المحمدية، الخَلق",
          description: "صفة النبي ﷺ خَلقاً من أصح الروايات؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر — من مراجع مجالس العلم الم؛ من شمائله ﷺ",          numberOfItems: ABWAB_KHALQ.length,
