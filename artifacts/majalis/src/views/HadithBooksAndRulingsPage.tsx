...
export default function HadithBooksAndRulingsPage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "المتون الحديثية وأحاديث الأحكام: الأربعون النووية، وعمدة الأحكام، وبلوغ المرام، والمنتقى من أخبار المصطفى. محتوى معتمد في منهج مجالس العلم يُستفاد في التعلم والتطبيق — مرجع تربوي شرعي",
