      ...
      <div className="set-grid">
        ...
        <section className="set-section">
          ...
          <p className="set-notice">
            يمكن إدارة الدروس وفهرس المصادر والإشارات الكونية والفوائد والأسئلة والأذكار من القائمة الجانبية في لوحة الإدارة.
          </p>
        </section>
        ...
        <section className="set-section">
          ...
          <p className="set-notice set-notice--sm">
            أُلغيت بطاقات «X اليوم» (حديث/واجب/اسم/دعاء…) من الأقسام والرئيسية.
            شريط الإعلان العلوي ما زال يعرض نبذًا قصيرة من المحتوى المعتمد، والورد اليومي والسنن اليومية صفحات مستقلة.
          </p>
        </section>
