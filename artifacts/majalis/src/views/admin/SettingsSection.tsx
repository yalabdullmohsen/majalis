      ...
      <div className="set-grid">
        ...
        <section className="set-section">
          ...
          <p className="set-notice">
            يمكن إدارة الدروس والمكتبة والإشارات الكونية والفوائد والأسئلة والأذكار من القائمة الجانبية في لوحة الإدارة.
          </p>
        </section>
        ...
        <section className="set-section">
          ...
          <p className="set-notice set-notice--sm">
            «مجلس اليوم» في الصفحة الرئيسية يتدوّر تلقائيًا حسب تاريخ الكويت (المصدر الوحيد لمحتوى اليوم — لا تكرار في أقسام أخرى). المحتوى الجديد يُضاف من لوحة الإدارة ثم يُعتمد قبل النشر.
          </p>
        </section>
