      ...
      {loading ? <SkeletonCardGrid count={6} /> : (
        <>
          <div className="mke-stats-row">
            <StatCard label="\u0635\u062d\u0629 \u0627\u0644\u0646\u0638\u0627\u0645" value={stats?.health?.score ?? "\u2014"} color={stats?.health?.status === "healthy" ? "var(--majalis-emerald-deep)" : "#143F35"} />
            ...
            <StatCard label="\u0628\u0627\u0646\u062a\u0638\u0627\u0631 \u0627\u0644\u0645\u0631\u0627\u062c\u0639\u0629" value={stats?.counts?.pendingReview ?? stats?.pendingReview ?? 0} color="#143F35" />
            ...
            {akp && (
              <>
                ...
                <StatCard label="\u0645\u0631\u0627\u062c\u0639\u0629 AKP" value={akp.counts?.reviewPending ?? 0} color="#143F35" />
              </>
            )}
          </div>
