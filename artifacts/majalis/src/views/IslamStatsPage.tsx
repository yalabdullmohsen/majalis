...
const GLOBAL_STATS: StatCard[] = [
  { value: "٢ مليار", label: "مسلم في العالم", sub: "٢٦٪ من سكان الأرض — مركز بيو، بيانات ٢٠٢٠م", color: "#173D35" },
  { value: "٢١٪", label: "نمو عدد المسلمين", sub: "بين ٢٠١٠م و٢٠٢٠م، أسرع نمو بين الديانات — مركز بيو", color: "#1a5a7a" },
  { value: "٤٩", label: "دولة ذات أغلبية مسلمة", sub: "من أصل نحو ١٩٥ دولة — تقدير مركز بيو", color: "#28584D" },
  ...
  { value: "١٧٪", label: "نمو الصيرفة الإسلامية", sub: "في سنة واحدة (٢٠٢٤م) — تقرير الاستقرار المالي الإسلامي ٢٠٢٥", color: "#173D35" },
  { value: "٨٥٩ م", label: "أقدم جامعة عاملة في العالم", sub: "القرويين في فاس — مسجَّلة لدى اليونسكو وموسوعة غينيس", color: "#28584D" },
...
const POPULATION_BARS: BarItem[] = [
  { label: "إندونيسيا", value: 240, max: 270, unit: "م", color: "#173D35" },
  { label: "باكستان",   value: 233, max: 270, unit: "م", color: "#1a5a7a" },
  { label: "الهند",     value: 213, max: 270, unit: "م", color: "#28584D" },
  ...
  { label: "إيران",      value: 86,  max: 270, unit: "م", color: "#173D35" },
  ...
  { label: "السودان",   value: 35,  max: 270, unit: "م", color: "#173D35" },
...
const QURAN_STATS: StatCard[] = [
  { value: "١١٤",  label: "سورة",        sub: "منها ٨٦ مكية و٢٨ مدنية", color: "#173D35" },
  { value: "٦٢٣٦", label: "آية",          sub: "في الرواية الأكثر شيوعاً", color: "#1a5a7a" },
  { value: "٣٠",   label: "جزءاً",        sub: "قسمة اصطلاحية للتلاوة والمراجعة لا توقيفية", color: "#28584D" },
  ...
  { value: "٤",    label: "جمعوا القرآن على عهده ﷺ", sub: "أبيّ بن كعب، ومعاذ، وزيد بن ثابت، وأبو زيد ﵃ — رواه البخاري", color: "#173D35" },
  { value: "١",    label: "مصدر أول للتشريع", sub: "ثم السنة النبوية المبيّنة له", color: "#1E3A5F" },
  { value: "٧",    label: "أحرف أُنزل عليها", sub: "الأحرف السبعة غير القراءات؛ والقراءات المتواترة عشر", color: "#173D35" },
  ...
  { value: "٦٠", label: "حزباً", sub: "كل حزب أربعة أرباع، والمجموع ٢٤٠ ربعاً", color: "#28584D" },
  { value: "٢٥",   label: "نبياً مذكوراً باسمه", sub: "أكثرهم ذكراً موسى ﵁ في نحو ١٣٦ موضعاً", color: "#1a5a7a" },
  { value: "١٥",   label: "سجدة تلاوة", sub: "موزَّعة على ١٤ سورة وفق قول الجمهور", color: "#173D35" },
...
const HISTORY_ACHIEVEMENTS: StatCard[] = [
  { value: "٩٨٠–١٠٣٧ م", label: "ابن سينا — صاحب القانون", sub: "نُسبت إليه مئات المصنفات في الطب والفلسفة والفلك", color: "#173D35" },
  ...
  { value: "مئات", label: "الألفاظ العربية في الإنجليزية", sub: "مثل: algebra, alcohol, coffee, sugar, cotton", color: "#28584D" },
  { value: "٨٠٥ م", label: "أول بيمارستان في بغداد", sub: "أُنشئ في عهد هارون الرشيد على نمط البيمارستانات المنظَّمة", color: "#1E3A5F" },
  { value: "١٠٥٨–١١١١ م", label: "الإمام الغزالي", sub: "صاحب «إحياء علوم الدين» — جمع بين الفقه والتزكية", color: "#173D35" },
  ...
  { value: "١٢٠٠+", label: "نبات عشبي موثَّق طبياً", sub: "وثَّق ابن البيطار الأندلسي نحو 1400 دواء وعقار في موسوعته النباتية", color: "#28584D" },
  { value: "٨٥٩ م", label: "القرويين — أقدم جامعة في العالم", sub: "تأسست في فاس بالمغرب على يد فاطمة الفهرية، لا تزال تعمل حتى اليوم", color: "#173D35" },
];
