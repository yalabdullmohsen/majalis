...
export default function IslamStatsPage() {
  ...
  useEffect(() => {
    applyPageSeo({
      ...
      description: "إحصاءات وأرقام مثيرة عن الإسلام في العالم: المسلمون، القرآن، الحضارة الإسلامية، والدلالات الكونية. من انتشار الإسلام إلى إعجاز القرآن؛ محتوى معتمد في منهج مجالس العلم؛ محتوى تعليمي معتمد في منهج مجالس العلم",
