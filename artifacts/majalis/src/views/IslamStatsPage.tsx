...
const GLOBAL_STATS: StatCard[] = [
  ...
  { value: "٣٠٠٠+", label: "إذاعة إسلامية عالمية", sub: "تبث محتوى إسلامياً بعشرات اللغات", color: "#4A2008" },
];
...
const HISTORY_ACHIEVEMENTS: StatCard[] = [
  ...
  { value: "٩٠٠+", label: "مدرسة وجامعة في الأندلس", sub: "المدارس والمكتبات ودور العلم في الحضارة الأندلسية", color: "#4A2008" },
];
