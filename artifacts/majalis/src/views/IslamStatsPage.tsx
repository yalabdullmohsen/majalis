...
const GLOBAL_STATS: StatCard[] = [
  { value: "١.٩ مليار", label: "مسلم في العالم", sub: "٢٤٪ من سكان الأرض", color: "#143F35" },
  { value: "٢٠٥٠", label: "أكبر ديانة متوقعة", sub: "وفق تقديرات مركز بيو", color: "#1a5a7a" },
  { value: "٤٩", label: "دولة ذات أغلبية مسلمة", sub: "من أصل ١٩٥ دولة في العالم", color: "#226A56" },
  ...
  { value: "٣٠٠٠+", label: "إذاعة إسلامية عالمية", sub: "تبث محتوى إسلامياً بعشرات اللغات", color: "#143F35" },
  { value: "٣ مليون+", label: "حافظ للقرآن في العالم", sub: "تتزايد أعداد الحفاظ سنوياً بشكل ملحوظ", color: "#226A56" },
...
const POPULATION_BARS: BarItem[] = [
  { label: "إندونيسيا", value: 231, max: 270, unit: "م", color: "#143F35" },
  { label: "باكستان",   value: 212, max: 270, unit: "م", color: "#1a5a7a" },
  { label: "بنغلاديش",  value: 153, max: 270, unit: "م", color: "#226A56" },
  ...
  { label: "تركيا",     value: 75,  max: 270, unit: "م", color: "#143F35" },
  ...
  { label: "السعودية",  value: 33,  max: 270, unit: "م", color: "#143F35" },
  { label: "الكويت",    value: 4,   max: 270, unit: "م", color: "#312E81" },
  { label: "الهند",    value: 200, max: 270, unit: "م", color: "#143F35" },
...
const QURAN_STATS: StatCard[] = [
  ...
  { value: "٣٠",   label: "جزءاً",        sub: "موزعة على ٦٠ حزباً", color: "#226A56" },
  ...
  { value: "٥",    label: "حفاظ في عهده ﷺ أشهرهم", sub: "عثمان، علي، ابن مسعود، زيد، أبيّ", color: "#143F35" },
  { value: "١",    label: "مصدر للتشريع", sub: "أولاً وقبل كل شيء", color: "#1E3A5F" },
  { value: "٧",    label: "أحرف أُنزل عليها", sub: "القراءات السبع المتواترة المعتمدة", color: "#143F35" },
  ...
  { value: "٤٠٠٠+", label: "موضوع علمي في القرآن", sub: "يتناولها العلماء في التفسير الموضوعي", color: "#226A56" },
...
const HISTORY_ACHIEVEMENTS: StatCard[] = [
  { value: "٨٠٠+", label: "طبيب وعالم مسلم", sub: "في العصور الوسطى أسهموا في الطب والعلوم", color: "#143F35" },
  { value: "٤٠٠+", label: "كتاب لابن سينا", sub: "شاملة للطب والفلسفة والفلك", color: "#1a5a7a" },
  { value: "١٢٠٠+", label: "لفظ عربي في الإنجليزية", sub: "مثل: algebra, alcohol, coffee, sugar", color: "#226A56" },
  ...
  { value: "١١٢١ م", label: "الغزالي يُجدد الفقه", sub: "أحيا الإمام الغزالي علوم الدين بمنهج متكامل", color: "#143F35" },
  ...
  { value: "٩٠٠+", label: "مدرسة وجامعة في الأندلس", sub: "المدارس والمكتبات ودور العلم في الحضارة الأندلسية", color: "#143F35" },
  { value: "١٠ آلاف", label: "مخطوطة في مكتبة بغداد", sub: "قبل حرقها: خزينة العلم الإسلامي في العصر الذهبي", color: "#143F35" },
