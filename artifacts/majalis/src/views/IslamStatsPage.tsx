...
const GLOBAL_STATS: StatCard[] = [
  { value: "٢ مليار", label: "مسلم في العالم", sub: "٢٦٪ من سكان الأرض — مركز بيو، بيانات ٢٠٢٠م", color: "#143F35" },
  { value: "٢١٪", label: "نمو عدد المسلمين", sub: "بين ٢٠١٠م و٢٠٢٠م، أسرع نمو بين الديانات — مركز بيو", color: "#1a5a7a" },
  { value: "٤٩", label: "دولة ذات أغلبية مسلمة", sub: "من أصل نحو ١٩٥ دولة — تقدير مركز بيو", color: "#226A56" },
  { value: "٦٥٪", label: "من مسلمي العالم في ١٠ دول", sub: "نحو ١.٣ مليار مسلم — مركز بيو، بيانات ٢٠٢٠م", color: "#143F35" },
  { value: "٣٦٩ مليون", label: "مسلم في أفريقيا جنوب الصحراء", sub: "٣٣٪ من سكان المنطقة، و١٨٪ من مسلمي العالم — مركز بيو ٢٠٢٠م", color: "#065F46" },
  { value: "١٬٧٠٧٬٣٠١", label: "حاج في موسم ١٤٤٧هـ", sub: "الهيئة العامة للإحصاء السعودية — رقم رسمي مُعلن", color: "#9B1C1C" },
  { value: "٤٦ مليون", label: "مسلم في أوروبا", sub: "نحو ٦٪ من سكان القارة — مركز بيو، بيانات ٢٠٢٠م", color: "#143F35" },
  { value: "٥.٩ مليون", label: "مسلم في أمريكا الشمالية", sub: "الولايات المتحدة وكندا — مركز بيو، بيانات ٢٠٢٠م", color: "#065F46" },
  ...
  { value: "١٧٪", label: "نمو الصيرفة الإسلامية", sub: "في سنة واحدة (٢٠٢٤م) — تقرير الاستقرار المالي الإسلامي ٢٠٢٥", color: "#143F35" },
  { value: "٨٥٩ م", label: "أقدم جامعة عاملة في العالم", sub: "القرويين في فاس — مسجَّلة لدى اليونسكو وموسوعة غينيس", color: "#226A56" },
...
const POPULATION_BARS: BarItem[] = [
  { label: "إندونيسيا", value: 240, max: 270, unit: "م", color: "#143F35" },
  { label: "باكستان",   value: 233, max: 270, unit: "م", color: "#1a5a7a" },
  { label: "الهند",     value: 213, max: 270, unit: "م", color: "#226A56" },
  { label: "بنغلاديش",  value: 151, max: 270, unit: "م", color: "#143F35" },
  { label: "نيجيريا",   value: 96,  max: 270, unit: "م", color: "#065F46" },
  { label: "مصر",       value: 87,  max: 270, unit: "م", color: "#9B1C1C" },
  { label: "إيران",      value: 86,  max: 270, unit: "م", color: "#143F35" },
  { label: "تركيا",     value: 75,  max: 270, unit: "م", color: "#1E3A5F" },
  { label: "الجزائر",   value: 44,  max: 270, unit: "م", color: "#065F46" },
  { label: "المغرب",    value: 36,  max: 270, unit: "م", color: "#1a5a7a" },
  { label: "السودان",   value: 35,  max: 270, unit: "م", color: "#143F35" },
  { label: "إثيوبيا",   value: 35,  max: 270, unit: "م", color: "#143F35" },
  { label: "السعودية",  value: 33,  max: 270, unit: "م", color: "#065F46" },
  { label: "أوزبكستان", value: 29,  max: 270, unit: "م", color: "#1a5a7a" },
  { label: "الكويت",    value: 2,   max: 270, unit: "م", color: "#143F35" },
];

const QURAN_STATS: StatCard[] = [
  { value: "١١٤",  label: "سورة",        sub: "منها ٨٦ مكية و٢٨ مدنية", color: "#143F35" },
  { value: "٦٢٣٦", label: "آية",          sub: "في الرواية الأكثر شيوعاً", color: "#1a5a7a" },
  { value: "٣٠",   label: "جزءاً",        sub: "قسمة اصطلاحية للتلاوة والمراجعة لا توقيفية", color: "#226A56" },
  { value: "٧٧٤٣٩", label: "كلمة",       sub: "على أشهر أعداد العادّين، والعدّ فيه اختلاف يسير", color: "#143F35" },
  { value: "٣٢٣٠١٥", label: "حرف",       sub: "فيما نقله السيوطي في الإتقان، ولأهل العدّ أقوال أخرى", color: "#065F46" },
  { value: "٢٣",   label: "سنة للنزول",  sub: "بدأ في رمضان سنة ٦١٠م تقريباً", color: "#9B1C1C" },
  { value: "٤",    label: "جمعوا القرآن على عهده ﷺ", sub: "أبيّ بن كعب، ومعاذ، وزيد بن ثابت، وأبو زيد رضي الله عنهم — رواه البخاري", color: "#143F35" },
  { value: "١",    label: "مصدر أول للتشريع", sub: "ثم السنة النبوية المبيّنة له", color: "#1E3A5F" },
  { value: "٧",    label: "أحرف أُنزل عليها", sub: "الأحرف السبعة غير القراءات؛ والقراءات المتواترة عشر", color: "#143F35" },
  { value: "١٠",   label: "قراءات متواترة", sub: "رواها العشرة، وأشهرها اليوم رواية حفص عن عاصم", color: "#065F46" },
  { value: "٧٨", label: "لغة تُرجمت إليها معاني القرآن", sub: "ترجمات صادرة عن مجمع الملك فهد لطباعة المصحف الشريف", color: "#143F35" },
  { value: "٦٠", label: "حزباً", sub: "كل حزب أربعة أرباع، والمجموع ٢٤٠ ربعاً", color: "#226A56" },
  { value: "٢٥",   label: "نبياً مذكوراً باسمه", sub: "أكثرهم ذكراً موسى رضي الله عنه في نحو ١٣٦ موضعاً", color: "#1a5a7a" },
  { value: "١٥",   label: "سجدة تلاوة", sub: "موزَّعة على ١٤ سورة وفق قول الجمهور", color: "#143F35" },
  { value: "٢٩",   label: "سورة بحروف مقطعة", sub: "مثل الم وحم وطس — والحروف المقطعة ١٤ حرفاً", color: "#143F35" },
  { value: "٣",    label: "مراحل للجمع والتدوين", sub: "عهد النبي ﷺ ثم أبي بكر ثم عثمان رضي الله عنهم", color: "#065F46" },
];
...
const HISTORY_ACHIEVEMENTS: StatCard[] = [
  ...
  { value: "٦٠٠ سنة", label: "القانون مرجعاً طبياً", sub: "ظل يُدرَّس في جامعات أوروبا حتى القرن السابع عشر", color: "#143F35" },
  ...
  { value: "عشرات", label: "النجوم بأسماء عربية معتمدة دولياً", sub: "مثل: الدبران (Aldebaran)، وآخر النهر (Achernar)، والنسر الواقع (Vega)", color: "#143F35" },
  { value: "آلاف", label: "الألفاظ العربية في الإسبانية", sub: "إرث الحضارة الأندلسية في اللغة الإسبانية الحديثة", color: "#065F46" },
  ...
  { value: "١٢٠٠+", label: "نبات عشبي موثَّق طبياً", sub: "وثَّق ابن البيطار الأندلسي نحو 1400 دواء وعقار في موسوعته النباتية", color: "#226A56" },
  { value: "٨٥٩ م", label: "القرويين — أقدم جامعة في العالم", sub: "تأسست في فاس بالمغرب على يد فاطمة الفهرية، لا تزال تعمل حتى اليوم", color: "#143F35" },
];
