...
/* ── الشروط والأركان ── */
const SHURUT = [
  { title: "الإسلام", desc: "الصلاة لا تصح من كافر؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — م؛ مرجع تربوي معتمد" },
  { title: "العقل", desc: "لا تجب على المجنون حتى يُفيق؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد" },
  { title: "البلوغ", desc: "تجب على البالغ ويُؤمَر بها الصبي لسبع؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعت؛ مرجع تربوي معتمد" },
  { title: "دخول الوقت", desc: "لكل صلاة وقت محدد شرعاً بدايةً ونهايةً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد" },
  { title: "الطهارة من الحدث", desc: "الوضوء للأصغر والغسل للأكبر؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من ؛ مرجع تربوي معتمد" },
  { title: "الطهارة من النجاسة", desc: "في البدن والثوب والمكان؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج؛ مرجع تربوي معتمد" },
  ...
  { title: "النية", desc: "في القلب لا يشترط التلفظ بها؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد" },
];
...
const ARKAN = [
  ...
  { num: 4, title: "الركوع", desc: "الانحناء حتى تطمئن اليدان على الركبتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع؛ مرجع تربوي معتمد" },
  { num: 5, title: "الاعتدال من الركوع", desc: "الرفع حتى يستوي قائماً مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمد؛ مرجع تربوي معتمد" },
  ...
  { num: 7, title: "الرفع من السجود", desc: "الجلوس بين السجدتين مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. ؛ مرجع تربوي معتمد" },
  { num: 8, title: "السجدة الثانية", desc: "كسجود الركعة الأولى في الهيئة والطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ال؛ مرجع تربوي معتمد" },
  { num: 9, title: "الطمأنينة", desc: "استقرار الأعضاء في كل ركن زمناً يسيراً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد" },
  ...
  { num: 11, title: "التشهد الأخير", desc: "الجلوس له وقراءة التشهد فيه؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من ؛ مرجع تربوي معتمد" },
  ...
  { num: 13, title: "التسليم", desc: "السلام عليكم ورحمة الله، مرتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — ؛ مرجع تربوي معتمد" },
];
...
const MUBTILATAT = [
  ...
  { title: "الكلام العمد", desc: "الكلام الآدمي عمداً دون ضرورة يبطل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد" },
  { title: "الضحك", desc: "الضحك الصوتي (القهقهة)، بخلاف التبسم؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد" },
  { title: "الأكل والشرب", desc: "ولو شيئاً يسيراً بالعمد؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج؛ مرجع تربوي معتمد" },
  ...
  { title: "كشف العورة", desc: "إذا انكشف شيء من العورة عمداً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم المعتمدة. ؛ مرجع تربوي معتمد" },
  { title: "ترك ركن أو شرط", desc: "كنسيان تكبيرة الإحرام أو الفاتحة عمداً؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع؛ مرجع تربوي معتمد" },
...
const KHUSHUU_WAYS = [
  ...
  { icon: "🎵", title: "التدبر في القراءة", desc: "تأمل معاني ما تقرأ وحاول أن تشعر بالكلمات؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد" },
  ...
  { icon: "🌟", title: "تصغير الدنيا في قلبك", desc: "استحضر عظمة الله وحقارة الدنيا قبل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد" },
...
export default function SalahGuidePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الدليل الشامل للصلاة: شروطها وأركانها وسورها ومراتب المصلين والنوافل والخشوع؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر؛ من",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الصلاة",
          description: "أركان الصلاة الثلاثة عشر مع الأدلة؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر — من مراجع مجالس العلم الم؛ من أحكام الفقه",
