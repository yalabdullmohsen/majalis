...
/* ── الشروط والأركان ── */
const SHURUT = [
  { title: "الإسلام", desc: "الصلاة لا تصح من كافر؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — م؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "العقل", desc: "لا تجب على المجنون حتى يُفيق؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "البلوغ", desc: "تجب على البالغ ويُؤمَر بها الصبي لسبع؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعت؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "دخول الوقت", desc: "لكل صلاة وقت محدد شرعاً بدايةً ونهايةً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الطهارة من الحدث", desc: "الوضوء للأصغر والغسل للأكبر؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من ؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الطهارة من النجاسة", desc: "في البدن والثوب والمكان؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "استقبال القبلة", desc: "إلا لعاجز أو خائف أو في صلاة النافلة سفراً؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجال؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  ...
  { title: "النية", desc: "في القلب لا يشترط التلفظ بها؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
];

const ARKAN = [
  { num: 1, title: "القيام", desc: "للقادر في الفريضة؛ والعاجز يصلّي حسب استطاعته؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس الع؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 2, title: "تكبيرة الإحرام", desc: "قول «الله أكبر» ركن قولي لا تصح الصلاة بدونه؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مج؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 3, title: "قراءة الفاتحة", desc: "في كل ركعة، «لا صلاة لمن لم يقرأ بفاتحة الكتاب» من أصول الصلاة عند جمهور الفقهاء يُراعى في التعليم والتطبيق — من مراجع م؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 4, title: "الركوع", desc: "الانحناء حتى تطمئن اليدان على الركبتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 5, title: "الاعتدال من الركوع", desc: "الرفع حتى يستوي قائماً مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمد؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 6, title: "السجود", desc: "على سبعة أعظم: الجبهة مع الأنف، واليدان، والركبتان، وأطراف القدمين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 7, title: "الرفع من السجود", desc: "الجلوس بين السجدتين مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. ؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 8, title: "السجدة الثانية", desc: "كسجود الركعة الأولى في الهيئة والطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ال؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 9, title: "الطمأنينة", desc: "استقرار الأعضاء في كل ركن زمناً يسيراً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 10, title: "الترتيب", desc: "أداء الأركان على الترتيب المشروع دون تقديم أو تأخير؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { num: 11, title: "التشهد الأخير", desc: "الجلوس له وقراءة التشهد فيه؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من ؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  ...
  { num: 13, title: "التسليم", desc: "السلام عليكم ورحمة الله، مرتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — ؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
];
...
/* ── المبطلات والمكروهات ── */
const MUBTILATAT = [
  { title: "الحدث (نقض الطهارة)", desc: "الريح أو البول أو غيره أثناء الصلاة، تبطل فوراً؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الكلام العمد", desc: "الكلام الآدمي عمداً دون ضرورة يبطل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الضحك", desc: "الضحك الصوتي (القهقهة)، بخلاف التبسم؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الأكل والشرب", desc: "ولو شيئاً يسيراً بالعمد؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "العبث الكثير المتوالي", desc: "الحركة المتكررة التي لا تناسب الصلاة؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العل؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "كشف العورة", desc: "إذا انكشف شيء من العورة عمداً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم المعتمدة. ؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "ترك ركن أو شرط", desc: "كنسيان تكبيرة الإحرام أو الفاتحة عمداً؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { title: "الردة في أثناء الصلاة", desc: "من ارتد عن الإسلام ولو لحظة أثناء الصلاة بطلت صلاته؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  ...
  { title: "انحراف الصدر عن القبلة عمداً", desc: "إذا استدار عن القبلة بصدره عمداً من غير ضرورة ولا عذر بطلت صلاته؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق؛ مرجع تربوي معتمد في منهج مجالس العلم." },
...
/* ── الخشوع ── */
const KHUSHUU_WAYS = [
  { icon: "🧠", title: "حضور القلب", desc: "تذكر أنك بين يدي الله، أعظم من خلق السموات والأرض؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { icon: "👁️", title: "إدامة النظر لموضع السجود", desc: "لا تنظر يميناً وشمالاً، وهو خُلسة الشيطان؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { icon: "🎵", title: "التدبر في القراءة", desc: "تأمل معاني ما تقرأ وحاول أن تشعر بالكلمات؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { icon: "⏱️", title: "الطمأنينة والترتيل", desc: "لا تتعجل في الأركان، أقصر صلاة طمأنينة خير من طويلة بلا خشوع؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق؛ مرجع تربوي معتمد في منهج مجالس العلم." },
  { icon: "🌟", title: "تصغير الدنيا في قلبك", desc: "استحضر عظمة الله وحقارة الدنيا قبل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { icon: "🚪", title: "التجديد والتهيؤ", desc: "توضأ بانتباه، واقرأ دعاء الدخول للمسجد، وصلّ تحية المسجد؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراج؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  { icon: "📵", title: "إبعاد المشتتات", desc: "ضع الهاتف في الصامت، واختر مكاناً هادئاً بلا صور؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراج؛ مرجع تربوي معتمد في منهج مجالس العلم؛ للتذكّر والاعتبار." },
  ...
  { icon: "📖", title: "تعلُّم معاني الأذكار والفاتحة", desc: "كلما عرفت معنى ما تقوله ازداد خشوعك، فتعلَّم تفسير الفاتحة وأذكار الركوع والسجود والتشهد بالعربية والمعنى معاً؛ واجب أو سنة في الصلاة حسب المذكور؛ من أحكام العبادات عند أهل العلم" },
...
export default function SalahGuidePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الدليل الشامل للصلاة: شروطها وأركانها وسورها ومراتب المصلين والنوافل والخشوع؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر؛ من أحكام الفقه المعتمدة",
