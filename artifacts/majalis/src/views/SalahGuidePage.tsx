...
const WAJIBAAT: Wajib[] = [
  ...
  },
  {
    ...
    desc: "يقولها الإمام والمنفرد، لا المأموم. دليلها: «وإذا قال سمع الله لمن حمده فقولوا ربنا ولك الحمد» — متفق عليه. من أصول الصلاة عند جمهور الفقهاء",
  },
  {
    num: 3,
    title: "قول «ربنا ولك الحمد» عند الاعتدال",
    dhikr: "ربنا ولك الحمد حمداً كثيراً طيباً مباركاً فيه",
    desc: "يقولها الإمام والمأموم والمنفرد جميعاً في حال الاعتدال من الركوع. الزيادة «حمداً كثيراً...» مستحبة لمن أمكنه. واجب أو سنة في الصلاة حسب المذكور",
  },
  {
    num: 4,
    title: "التسبيح في الركوع",
    dhikr: "سبحان ربي العظيم",
    desc: "يُقال مرة واحدة على أقل الكمال، والسنة ثلاث مرات. دليلها: «فأما الركوع فعظِّموا فيه الرب» — مسلم. واجب أو سنة في الصلاة حسب المذكور",
  ...
  },
  {
    ...
    desc: "يُقال مرة واحدة على أقل الكمال، والسنة ثلاث مرات. السجود أقرب ما يكون العبد من ربه فيُستحب الإكثار من الدعاء فيه — مسلم.",
  ...
  },
  {
    ...
    desc: "يقال في الجلسة بين السجدتين. دليلها: حديث حذيفة أن النبي ﷺ كان يقول بين السجدتين «رب اغفر لي» — أبو داود، صحيح. واجب أو سنة في الصلاة حسب المذكور",
  },
  {
    num: 7,
    title: "التشهد الأول",
  ...
  },
  {
    ...
    dhikr: "",
    desc: "الجلوس الذي يُؤدَّى فيه التشهد الأول واجب مستقل بذاته لمداومة النبي ﷺ عليه. وهو مرتبط بالتشهد الأول لكن يُعدّ واجباً قائماً بنفسه. لا ذِكر مستقل لهذا الركن سوى هيئة الجلوس.",
...
/* ── الشروط والأركان ── */
const SHURUT = [
  { title: "الإسلام", desc: "الصلاة لا تصح من كافر؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — م" },
  { title: "العقل", desc: "لا تجب على المجنون حتى يُفيق؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم" },
  { title: "البلوغ", desc: "تجب على البالغ ويُؤمَر بها الصبي لسبع؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعت" },
  { title: "دخول الوقت", desc: "لكل صلاة وقت محدد شرعاً بدايةً ونهايةً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا" },
  { title: "الطهارة من الحدث", desc: "الوضوء للأصغر والغسل للأكبر؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من " },
  { title: "الطهارة من النجاسة", desc: "في البدن والثوب والمكان؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج" },
  { title: "استقبال القبلة", desc: "إلا لعاجز أو خائف أو في صلاة النافلة سفراً؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجال" },
  { title: "ستر العورة", desc: "عورة الرجل من السرة إلى الركبة، وعورة المرأة البالغة في الصلاة جميع بدنها عدا الوجه، مع خلاف مشهور في الكفين والقدمين؛ من شروط أو أركان الصلاة" },
  { title: "النية", desc: "في القلب لا يشترط التلفظ بها؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم" },
];

const ARKAN = [
  { num: 1, title: "القيام", desc: "للقادر في الفريضة؛ والعاجز يصلّي حسب استطاعته؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس الع" },
  { num: 2, title: "تكبيرة الإحرام", desc: "قول «الله أكبر» ركن قولي لا تصح الصلاة بدونه؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مج" },
  { num: 3, title: "قراءة الفاتحة", desc: "في كل ركعة، «لا صلاة لمن لم يقرأ بفاتحة الكتاب» من أصول الصلاة عند جمهور الفقهاء يُراعى في التعليم والتطبيق — من مراجع م" },
  { num: 4, title: "الركوع", desc: "الانحناء حتى تطمئن اليدان على الركبتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع" },
  { num: 5, title: "الاعتدال من الركوع", desc: "الرفع حتى يستوي قائماً مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمد" },
  { num: 6, title: "السجود", desc: "على سبعة أعظم: الجبهة مع الأنف، واليدان، والركبتان، وأطراف القدمين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق" },
  { num: 7, title: "الرفع من السجود", desc: "الجلوس بين السجدتين مع الطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. " },
  { num: 8, title: "السجدة الثانية", desc: "كسجود الركعة الأولى في الهيئة والطمأنينة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ال" },
  { num: 9, title: "الطمأنينة", desc: "استقرار الأعضاء في كل ركن زمناً يسيراً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم ا" },
  { num: 10, title: "الترتيب", desc: "أداء الأركان على الترتيب المشروع دون تقديم أو تأخير؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجا" },
  { num: 11, title: "التشهد الأخير", desc: "الجلوس له وقراءة التشهد فيه؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من " },
  { num: 12, title: "الصلاة على النبي ﷺ", desc: "في التشهد الأخير بعد التشهد على القول الراجح؛ واجب أو سنة في الصلاة حسب المذكور؛ يُراعى ترتيبه مع الطمأنينة — من مراجع م" },
  { num: 13, title: "التسليم", desc: "السلام عليكم ورحمة الله، مرتين؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — " },
];
...
/* ── المبطلات والمكروهات ── */
const MUBTILATAT = [
  { title: "الحدث (نقض الطهارة)", desc: "الريح أو البول أو غيره أثناء الصلاة، تبطل فوراً؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس ا" },
  { title: "الكلام العمد", desc: "الكلام الآدمي عمداً دون ضرورة يبطل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا" },
  { title: "الضحك", desc: "الضحك الصوتي (القهقهة)، بخلاف التبسم؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتم" },
  { title: "الأكل والشرب", desc: "ولو شيئاً يسيراً بالعمد؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المعتمدة. — من مراج" },
  { title: "العبث الكثير المتوالي", desc: "الحركة المتكررة التي لا تناسب الصلاة؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العل" },
  { title: "كشف العورة", desc: "إذا انكشف شيء من العورة عمداً؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة — من مراجع مجالس العلم المعتمدة. " },
  { title: "ترك ركن أو شرط", desc: "كنسيان تكبيرة الإحرام أو الفاتحة عمداً؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم المع" },
  { title: "الردة في أثناء الصلاة", desc: "من ارتد عن الإسلام ولو لحظة أثناء الصلاة بطلت صلاته؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجا" },
  { title: "مسبوقية الإمام بركنين عمداً", desc: "من سبق إمامه بركنين فعليَّين متعمداً بطلت صلاته عند جمهور الفقهاء؛ من شروط أو أركان الصلاة؛ يُعتنى به قبل الدخول في الصلاة" },
  { title: "انحراف الصدر عن القبلة عمداً", desc: "إذا استدار عن القبلة بصدره عمداً من غير ضرورة ولا عذر بطلت صلاته؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق" },
  { title: "السهو في ترك ركن مع عدم تداركه", desc: "إذا أسقط ركناً كالركوع أو السجود ناسياً ولم يتداركه أبطلت الركعةُ في قول أكثر الفقهاء؛ واجب أو سنة في الصلاة حسب المذكور" },
];
...
/* ── الخشوع ── */
const KHUSHUU_WAYS = [
  { icon: "🧠", title: "حضور القلب", desc: "تذكر أنك بين يدي الله، أعظم من خلق السموات والأرض؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس" },
  { icon: "👁️", title: "إدامة النظر لموضع السجود", desc: "لا تنظر يميناً وشمالاً، وهو خُلسة الشيطان؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراجع مجالس" },
  { icon: "🎵", title: "التدبر في القراءة", desc: "تأمل معاني ما تقرأ وحاول أن تشعر بالكلمات؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا" },
  { icon: "⏱️", title: "الطمأنينة والترتيل", desc: "لا تتعجل في الأركان، أقصر صلاة طمأنينة خير من طويلة بلا خشوع؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق" },
  { icon: "🌟", title: "تصغير الدنيا في قلبك", desc: "استحضر عظمة الله وحقارة الدنيا قبل الصلاة؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراجع مجالس العلم ا" },
  { icon: "🚪", title: "التجديد والتهيؤ", desc: "توضأ بانتباه، واقرأ دعاء الدخول للمسجد، وصلّ تحية المسجد؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مراج" },
  { icon: "📵", title: "إبعاد المشتتات", desc: "ضع الهاتف في الصامت، واختر مكاناً هادئاً بلا صور؛ من أصول الصلاة عند جمهور الفقهاء؛ يُراعى في التعليم والتطبيق — من مراج" },
  { icon: "🤲", title: "الدعاء في السجود", desc: "«أقرب ما يكون العبد من ربه وهو ساجد فأكثروا الدعاء»، مسلم؛ من أحكام الصلاة المعتمدة؛ يُراعى في التعليم والتطبيق — من مرا" },
  { icon: "🌅", title: "الصلاة في أول وقتها", desc: "سُئل النبي ﷺ عن أفضل الأعمال فقال: «الصلاة لوقتها». التبكير بالصلاة يُعين على الخشوع ويجعلها عبادة لا عادة؛ من أصول الصلاة عند جمهور الفقهاء" },
  { icon: "🔄", title: "تجديد النية بين الركعات", desc: "استحضر لماذا تصلي في كل ركعة، كأنك تقف بين يدي الله لأول مرة. هذا التجديد يُبعد الغفلة ويُحيي القلب؛ من أحكام الصلاة المعتمدة" },
  { icon: "📖", title: "تعلُّم معاني الأذكار والفاتحة", desc: "كلما عرفت معنى ما تقوله ازداد خشوعك، فتعلَّم تفسير الفاتحة وأذكار الركوع والسجود والتشهد بالعربية والمعنى معاً؛ واجب أو سنة في الصلاة حسب المذكور" },
...
const AHADITH_FAWAID = [
  { text: "«الصلوات الخمس والجمعة إلى الجمعة كفّارة لما بينهن إذا اجتُنبت الكبائر»  — من مراجع مجالس العلم. — م", source: "مسلم" },
  { text: "«أول ما يُحاسَب الناس به يوم القيامة من أعمالهم الصلاة»  — من مراجع مجالس العلم. — من مراجع مجالس ال", source: "النسائي، صحيح" },
  { text: "«الصلاة نور»، نور في القلب ونور في الوجه ونور في القبر ونور يوم القيامة؛  — من مراجع مجالس العلم. — ", source: "مسلم" },
  { text: "«مثل الصلوات الخمس كمثل نهر غَمْر على باب أحدكم يغتسل منه خمس مرات»  — من مراجع مجالس العلم. — من مر", source: "مسلم" },
  { text: "«من صلى الفجر في جماعة فهو في ذمة الله يوم القيامة»  — من مراجع مجالس العلم. — من مراجع مجالس العلم ", source: "مسلم: ٦٥٧" },
  { text: "«من حافظ على الصلوات الخمس: ركوعها وسجودها ومواقيتها، علم أنني قد حرَّمته على النار»  — من مراجع مجالس العلم.", source: "صحيح ابن حبان، صحيح" },
  { text: "«بين الرجل وبين الكفر والشرك ترك الصلاة»  — من مراجع مجالس العلم. — من مراجع مجالس العلم المعتمدة. —", source: "مسلم: ٨٢" },
  { text: "«من صلى البردين — الفجر والعصر — دخل الجنة»  — من مراجع مجالس العلم. — من مراجع مجالس العلم المعتمدة", source: "البخاري: ٥٧٤، مسلم: ٦٣٥" },
  { text: "«أقرب ما يكون العبد من ربه وهو ساجد، فأكثروا الدعاء»  — من مراجع مجالس العلم. — من مراجع مجالس العلم", source: "مسلم: ٤٨٢" },
  { text: "«إذا قام أحدكم إلى الصلاة فإن الله قِبَل وجهه، فلا يَبصُقنَّ قِبَل وجهه ولا عن يمينه»  — من مراجع مجالس العلم.", source: "البخاري: ٤٠٦" },
  { text: "«من توضأ فأحسن الوضوء، ثم صلى ركعتين لا يُحدِّث فيهما نفسه، غُفر له ما تقدم من ذنبه»  — من مراجع مجالس العلم.", source: "البخاري: ١٦٠، مسلم: ٢٢٦" },
  { text: "«الصلاة في المسجد الحرام خير من مئة ألف صلاة فيما سواه»، وزيادة الأجر ترتبط بالمكان والخشوع؛  — من مراجع مجالس العلم.", source: "ابن ماجه: ١٤٠٦، صحيح" },
];
...
export default function SalahGuidePage() {
  useEffect(() => {
    applyPageSeo({
      ...
      description: "الدليل الشامل للصلاة: شروطها وأركانها وسورها ومراتب المصلين والنوافل والخشوع؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر",
      ...
      jsonLd: [
        {
          ...
          "@type": "ItemList",
          name: "أركان الصلاة",
          description: "أركان الصلاة الثلاثة عشر مع الأدلة؛ محتوى معتمد في مجالس العلم؛ يُستفاد منه في التعلم والتدبر — من مراجع مجالس العلم الم",
