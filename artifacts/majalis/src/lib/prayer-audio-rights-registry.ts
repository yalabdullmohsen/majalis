...
export const PRAYER_AUDIO_RIGHTS_REGISTRY: readonly AudioRightsRecord[] = [
  ...
  {
    audioId: "egypt",
    displayNameAr: "أذان تقليدي",
    originalFileName: "adhan-egypt-full.m4a",
    sourcePlatform: "sunnah-bundle",
    sourceUrl: "/audio/adhan/adhan-egypt-full.m4a",
    licenseType: "internal-app-asset",
    licenseUrl: "/data-licenses",
    attributionRequired: false,
    attributionText: "",
    ...
    inAppPlaybackCompatible: true,
    approvedForProduction: true,
    status: "approved_for_in_app_adhan",
    verificationNotes: "حزمة داخلية بنمط تقليدي — بلا نسبة لمؤذن مشهور؛ إشعار قصير عبر adhan-short-egypt.caf.",
    celebrityNameRisk: false,
    processedDurationSec: 28,
  },
  {
    audioId: "aqsa",
    displayNameAr: "أذان المسجد الأقصى",
    originalFileName: "adhan-aqsa-full.mp3",
    sourcePlatform: "sunnah-bundle",
    sourceUrl: "/audio/adhan/adhan-aqsa-full.mp3",
    licenseType: "internal-app-asset",
    licenseUrl: "/data-licenses",
    attributionRequired: false,
    attributionText: "",
    ...
    approvedForProduction: true,
    status: "approved_for_in_app_adhan",
    verificationNotes: "حزمة داخلية بنمط الأقصى الجغرافي — بلا نسبة لمؤذن مشهور؛ إشعار قصير عبر adhan-short-aqsa.caf.",
    celebrityNameRisk: false,
  ...
  },
  {
    ...
    status: "approved_for_in_app_adhan",
    verificationNotes:
      "CC0 موثّق؛ تحويل إلى adhan-field.m4a (~42ث) + إشعار قصير adhan-short-field.caf (10ث IMA4). وصف نمطي فقط بلا نسبة لمؤذن.",
    celebrityNameRisk: false,
  ...
  {
    audioId: "field-full",
    displayNameAr: "أذان ميداني كامل",
    ...
    status: "approved_for_in_app_adhan",
    verificationNotes:
      "CC0 موثّق؛ مقتطف حزمة adhan-field-full.m4a (~58ث ضمن ميزانية الحزمة) + إشعار قصير adhan-short-field-full.caf (10ث). الأصل الكامل محفوظ في evidence/originals.",
    celebrityNameRisk: false,
    fileChecksum: "35fe06b08fe80505c550c33fed8a783fa9901ddc81ac884958b4be048f5b2a79",
    processedDurationSec: 58,
