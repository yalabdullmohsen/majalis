...
export const UPDATES_SEED: PlatformUpdate[] = [
  ...
  },
  {
    ...
    summary: "أُعلن سابقاً عن توسيع أقسام الاختبارات (فرائض، أسماء حسنى، علماء). العدد المعروض في الواجهة يُحسب من السجلات الفعلية عبر content-counts؛ لا يُعتمد رقم تسويقي ثابت.",
    update_type: "إعلان",
    source_url: "/quiz",
    published_at: "2026-07-11T23:30:00Z",
    status: "approved",
