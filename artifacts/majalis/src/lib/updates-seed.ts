...
export const UPDATES_SEED: PlatformUpdate[] = [
  ...
  },
  {
    ...
    update_type: "إعلان",
    source_type: "annual_course",
    source_id: "course-ramadan-intensive",
...

  {
    ...
    source_url: "/scientific-announcements/sci-usul-fiqh-muqaranah-2026",
...

  {
    ...
    source_url: "/scientific-announcements/sci-rawdat-alafham-muwaiziri",
  ...
  },
  {
    ...
    source_url: "/scientific-announcements/sci-tajweed-mushaf-recitation",
...

  {
    ...
    summary: "إضافة شرح الأربعين النووية للإمام ابن دقيق العيد إلى المصادر المعتمدة.",
    update_type: "كتاب",
    source_type: "library",
  ...
  },
  {
    ...
    source_url: "/scientific-announcements/sci-seerah-series-online",
  ...
  },
  {
    ...
    title: "تحديث: توسيع فهرس المصادر الشرعية",
  ...
  },
  {
    ...
    title: "تحديث: الدورات العلمية",
    summary: "إضافة دورات في شرح الطحاوية والبلاغة القرآنية وفقه المعاملات المالية والأذكار والنحو العربي.",
    update_type: "دورة",
    source_url: "/lessons",
    published_at: "2026-07-08T19:00:00Z",
    status: "approved",
  ...
  },
  {
    ...
    title: "تحديث: مصادر شرعية إضافية",
  ...
  },
  {
    ...
    title: "تحديث: مسائل فقهية معاصرة في قسم الفقه",
    summary: "إتاحة مسارات الفقه العامة في سُنّة؛ دون عرض قرارات مجامع أو محتوى غير موثّق في المنتج.",
    update_type: "إعلان",
    source_url: "/fiqh",
  ...
  },
  {
    ...
    summary: "أُضيف محتوى SEO مُفصَّل لصفحات 99 عالماً (منهم البخاري، الغزالي، ابن تيمية، ابن القيم، الألباني) و50+ مصدرًا مرجعيًا، مع بيانات JSON-LD وعناوين دقيقة.",
    update_type: "إعلان",
    source_url: "/scholars",
    published_at: "2026-07-11T14:00:00Z",
    status: "approved",
  ...
  },
  {
    ...
    title: "توسعة: مصادر شرعية موثّقة إضافية",
  ...
  },
  {
    ...
    summary: "توسيع فهرس الأدعية من 61 إلى 74 دعاءً بإضافة: 4 أدعية الصلاة (الاستفتاح، القنوت، بين السجدتين، التسبيح بعد الصلاة)، 3 أدعية النوم (الاستخارة، الرؤيا الحسنة، الرؤيا المزعجة)، 3 أدعية الكرب (الغضب، قضاء الدين، فرج الكرب بالتوحيد)، 3 أدعية عامة (الثبات، التوكل، الاستعاذة الجامعة). كل دعاء مع النص العربي والمصدر الصحيح.",
    update_type: "إعلان",
    source_url: "/duas",
