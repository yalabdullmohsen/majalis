...
export const UPDATES_SEED: PlatformUpdate[] = [
  ...
  },
  {
    ...
    title: "تبويب آية اليوم في الركن اليومي",
    summary: "إضافة تبويب «آية» في مكوّن الركن اليومي على الصفحة الرئيسية، مع توسيع حوض الآيات اليومية من 7 إلى 30 آية قرآنية تشمل: آيات الصبر والتوكل والرحمة والذكر والتقوى والإيمان والتوبة. التبويبات الآن: ذكر، آية، حديث، فائدة، سؤال.",
    update_type: "إعلان",
    source_url: "/",
    published_at: "2026-07-11T21:00:00Z",
    status: "approved",
  ...
  },
  {
    ...
    title: "القصص الإسلامية — إضافة 5 قصص تاريخية مهمة",
    summary: "توسيع قسم القصص الإسلامية من 59 إلى 64 قصة بإضافة: خديجة بنت خويلد (أم المؤمنين)، عمر بن عبد العزيز (الخليفة الزاهد)، فتح الأندلس (طارق بن زياد)، صلاح الدين الأيوبي (محرر القدس)، فتح القسطنطينية (محمد الفاتح). كل قصة تتضمن المحتوى الكامل والدروس والمراجع.",
    update_type: "إعلان",
    source_url: "/stories",
    published_at: "2026-07-11T22:00:00Z",
    status: "approved",
