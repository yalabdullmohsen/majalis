...
export const UPDATES_SEED: PlatformUpdate[] = [
  ...
  {
    id: "update-fatwas-100",
    title: "تحديث: الفتاوى الشرعية — 100 فتوى",
    summary: "الوصول إلى 100 فتوى موثقة مع توسعة قسم فقه المرأة بإضافة 3 فتاوى: الحجاب وصلاة المرأة وعملها.",
    update_type: "فتوى",
    source_url: "/fatwa",
  ...
  {
    id: "update-stories-44",
    title: "تحديث: القصص الإسلامية — 44 قصة",
    summary: "إضافة 6 قصص: سعد بن أبي وقاص، وسلمان الفارسي، والإمام البخاري، والإمام أحمد في المحنة، وأبو ذر الغفاري، وابن تيمية.",
    update_type: "إعلان",
    source_url: "/stories",
