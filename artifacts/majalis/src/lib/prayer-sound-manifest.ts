...
export const PRAYER_SOUND_MANIFEST: readonly PrayerSoundManifestEntry[] = [
  ...
  {
    id: "notif-field-short",
    labelAr: "تنبيه أذان ميداني قصير",
    category: "CUSTOM_NOTIFICATION_SOUND",
    nativeFileName: "adhan-short-field.caf",
    webPreviewPath: "/audio/adhan/adhan-field.m4a",
    durationSec: 10,
    supportedPlatforms: ["ios", "android"],
    licenseStatus: "approved",
    appStoreSafe: true,
  ...
  {
    id: "notif-field-full-short",
    labelAr: "تنبيه أذان ميداني كامل (قصير)",
    category: "CUSTOM_NOTIFICATION_SOUND",
    nativeFileName: "adhan-short-field-full.caf",
    webPreviewPath: "/audio/adhan/adhan-field-full.m4a",
    durationSec: 10,
    supportedPlatforms: ["ios", "android"],
    licenseStatus: "approved",
    appStoreSafe: true,
  ...
  {
    id: "in-app-field",
    labelAr: "أذان ميداني (داخل التطبيق)",
    category: "IN_APP_ADHAN",
    nativeFileName: null,
    webPreviewPath: "/audio/adhan/adhan-field.m4a",
    durationSec: 42,
  ...
  {
    id: "in-app-field-full",
    labelAr: "أذان ميداني كامل (داخل التطبيق)",
    category: "IN_APP_ADHAN",
    nativeFileName: null,
    webPreviewPath: "/audio/adhan/adhan-field-full.m4a",
    durationSec: 58,
