...
export const TAWHID_TOPICS: Record<TawhidTopicSlug, TawhidTopic> = {
  "tawhid-issues": {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: "إثبات ما أثبته الله ورسوله من الأسماء والصفات على الوجه اللائق به سبحانه، بلا تحريف ولا تعطيل ولا تكييف ولا تمثيل.",
        ayah: {
  ...
  "aqeedah-foundations": {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: "الإيمان بأن الله علم كل شيء وكتبه وشاءه وخلقه. ومراتب القدر عند أهل السنة أربع: العلم، والكتابة، والمشيئة، والخلق.",
      },
      {
  ...
  "tawhid-types": {
    ...
    blocks: [
      ...
      {
        title: "توحيد الألوهية",
        body: "إفراد الله بالعبادة كلها ظاهرًا وباطنًا؛ وهو مضمون لا إله إلا الله وأصل دعوة الرسل، فلا يُصرف شيء من العبادة لغيره.",
        ayah: {
          text: "وَمَا أَرْسَلْنَا مِن قَبْلِكَ مِن رَّسُولٍ إِلَّا نُوحِي إِلَيْهِ أَنَّهُ لَا إِلَٰهَ إِلَّا أَنَا فَاعْبُدُونِ",
          ref: "الأنبياء: ٢٥",
        },
      ...
      {
        title: "توحيد الأسماء والصفات",
        body: "إثبات ما أثبته الله ورسوله من الأسماء والصفات على الوجه اللائق به، بلا تحريف ولا تعطيل ولا تكييف ولا تمثيل.",
        ayah: {
          text: "لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ الْبَصِيرُ",
          ref: "الشورى: ١١",
        },
  ...
  "nawaaqid": {
    ...
    slug: "nawaaqid",
    title: "نواقض الإسلام",
    description: "مدخل منضبط لنواقض الإسلام مع بيان ضوابط التكفير عند أهل السنة والتحذير من التساهل والغلو",
    emoji: "",
    blocks: [
      {
        title: "الشرك الأكبر",
