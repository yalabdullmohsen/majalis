...
export const TAWHID_TOPICS: Record<TawhidTopicSlug, TawhidTopic> = {
    ...
    blocks: [
      {
        ...
        body: "الإقرار بأن الله وحده الخالق الرازق المدبّر؛ وهذا إقرار فطريّ لا يكفي وحده للنجاة حتى يُضمّ إليه توحيد العبادة وإفراد الله بالطاعة.",
        ayah: {
      ...
      },
      {
        ...
        body: "إفراد الله بالعبادة كلها ظاهرًا وباطنًا؛ وهو مضمون لا إله إلا الله وأصل دعوة الرسل، فلا يُصرف دعاء ولا ذبح ولا نذر لغير الله.",
        ayah: {
      ...
      },
      {
        ...
        body: "إثبات ما أثبته الله ورسوله من الأسماء والصفات على الوجه اللائق به سبحانه، بلا تحريف ولا تعطيل ولا تكييف ولا تمثيل، مع نفي مماثلة المخلوقين.",
        ayah: {
      ...
      },
      {
        ...
        body: "أعظم ما أمر الله به التوحيد، وأعظم ما نهى عنه الشرك. قال تعالى: ﴿وَاعْبُدُوا اللَّهَ وَلَا تُشْرِكُوا بِهِ شَيْئًا﴾ [النساء: ٣٦]، فمدار الدين على هذين الأصلين.",
      },
      {
        title: "الشرك الأكبر",
      ...
      {
        title: "الشرك الأصغر",
        body: "ما أطلق عليه الشرعُ اسم الشرك ولم يبلغ حدّ الأكبر، كالرياء والسمعة والحلف بغير الله؛ يُحذَّر منه لأنه وسيلة إلى الأكبر ومُناقض لكمال التوحيد.",
        hadith: {
      ...
      },
      {
        ...
        body: "يُشرع التوسل بأسماء الله وصفاته، وبالعمل الصالح، وبدعاء الرجل الصالح الحي الحاضر. أما دعاء الأموات وطلب المدد منهم فهو من الشرك الأكبر الذي يُنافي التوحيد.",
      },
      {
  ...
  "aqeedah-foundations": {
    ...
    blocks: [
      ...
      {
        title: "الإيمان بالله",
        body: "الإيمان بوجود الله وربوبيته وألوهيته وأسمائه وصفاته الكاملة كما وردت في النصوص. وهو أصل الأصول وأساس بقية أركان الإيمان.",
      },
      {
        title: "الإيمان بالملائكة",
        body: "الإيمان بوجود الملائكة وأنهم عباد الله المكرمون، يُنفّذون أوامره ولا يعصونه؛ ومن أشهرهم جبريل وميكائيل وإسرافيل عليهم السلام.",
      },
      {
        title: "الإيمان بالكتب",
        body: "الإيمان بجميع الكتب التي أنزلها الله على رسله: التوراة والإنجيل والزبور وصحف إبراهيم، والقرآن الكريم الذي نسخها وهو المهيمن عليها.",
      },
      {
        title: "الإيمان بالرسل",
        body: "الإيمان بجميع الأنبياء والمرسلين من آدم حتى محمد ﷺ خاتمهم، وأنهم بلّغوا الرسالة وأدّوا الأمانة، وأن شريعته ناسخة لما قبلها.",
      },
      {
      ...
      },
      {
        ...
        body: "الإيمان بأن الله علم كل شيء وكتبه وشاءه وخلقه. ومراتب القدر عند أهل السنة أربع: العلم، والكتابة، والمشيئة، والخلق؛ فمن جحد مرتبة منها لم يستقم إيمانه بالقدر.",
      },
      {
  ...
  "tawhid-types": {
    ...
    blocks: [
      ...
      {
        title: "توحيد الألوهية",
        body: "إفراد الله بالعبادة كلها ظاهرًا وباطنًا؛ وهو مضمون لا إله إلا الله وأصل دعوة الرسل، فلا يُصرف دعاء ولا نذر ولا ذبح لغير الله.",
        ayah: {
          text: "وَمَا أَرْسَلْنَا مِن قَبْلِكَ مِن رَّسُولٍ إِلَّا نُوحِي إِلَيْهِ أَنَّهُ لَا إِلَٰهَ إِلَّا أَنَا فَاعْبُدُونِ",
          ref: "الأنبياء: ٢٥",
        },
      ...
      {
        title: "توحيد الأسماء والصفات",
        body: "إثبات ما أثبته الله ورسوله من الأسماء والصفات على الوجه اللائق به، بلا تحريف ولا تعطيل ولا تكييف ولا تمثيل، ردًّا على المعطّلة والممثّلة.",
        ayah: {
          text: "لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ الْبَصِيرُ",
          ref: "الشورى: ١١",
        },
