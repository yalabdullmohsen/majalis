...
export const EMPTY = {
  generic: "لا يتوفر محتوى منشور هنا الآن؛ جرّب قسمًا قريبًا من القائمة أو عد لاحقًا.",
  search: "لم نجد نتيجة مطابقة. جرّب كلمات بحث أخرى.",
  searchShort: "لم نجد نتيجة مطابقة.",
  lessonsCategory: "لا دروس منشورة في هذا التصنيف بعد؛ تصفّح تصنيفات أخرى أو المكتبة.",
  competitions: "لا مسابقات معلنة الآن؛ راجع لاحقًا أو تابع إشعارات المنصة.",
  data: "لا بيانات معروضة هنا الآن؛ حدّث الصفحة أو عد إلى القائمة الرئيسية.",
  library: "لا كتب في هذا التصنيف بعد؛ جرّب بحث المكتبة أو تصنيفًا آخر.",
  librarySearch: "لم نجد نتيجة مطابقة. جرّب كلمة أخرى أو أزل التصفية.",
  notifications: "صندوقك فارغ من الإشعارات الجديدة.",
  notificationsArchived: "لا إشعارات في الأرشيف بعد.",
  citations: "احفظ المواد المهمة لتعود إليها بسهولة.",
  folders: "لم تُنشئ مجلدات بعد؛ أضف مجلدًا لتنظيم محفوظاتك.",
  ...
  downloads: "لا مواد منزّلة على هذا الجهاز بعد.",
  seriesLessons: "لا دروس منشورة في هذه السلسلة بعد؛ عد لاحقًا أو تصفّح سلاسل أخرى.",
