...
export const EMPTY = {
  generic: "لا يتوفر محتوى في هذا القسم الآن. تصفّح قسمًا آخر أو عد لاحقًا.",
  search: "لم نجد نتيجة مطابقة. جرّب كلمات أوضح أو أقل تقييدًا.",
  searchShort: "لم نجد نتيجة مطابقة.",
  lessonsCategory: "لا دروس في هذا التصنيف الآن. جرّب تصنيفًا آخر.",
  competitions: "لا مسابقات حالية الآن.",
  data: "لا يتوفر محتوى في هذا القسم الآن.",
  library: "لا كتب في هذا القسم الآن.",
  ...
  continueEmpty: "ابدأ رحلتك في طلب العلم من المصحف أو الدروس.",
  ...
  fiqhSearch: "لا نتائج مطابقة داخل الفقه — جرّب كلمة أخرى.",
  fiqhCategory: "لا كتب في هذا التصنيف الآن.",
  learningPath: "المقررات غير منشورة هنا. تصفّح الدروس المتاحة للمتابعة.",
...
export const SECTION_LEAD = {
  ...
  lessons: "دروس ودورات علمية مرتّبة للحضور والمتابعة.",
  hadith: "أحاديث وشروح ومصطلح الحديث بمصادر معتمدة.",
  prayer: "مواقيت الصلاة والقبلة وتنبيهات الأذان بدقّة محلّك.",
  adhkar: "أذكار الصباح والمساء وما بينهما — ورد يومي ثابت.",
  quran: "المصحف والتلاوة والتجويد والحفظ وعلوم القرآن.",
  sections: "فهرس الأقسام الشرعية والأدوات في مكان واحد.",
