...
export const FEATURED: { href: string; Icon: LucideIcon; title: string; desc: string; cta: string }[] = [
  ...
  { href: "/lessons", Icon: GraduationCap, title: seoNavLabel("/lessons", "الدروس والدورات"), desc: "مسارات علمية مرتّبة للمتابعة المنتظمة", cta: "افتح" },
...
const FEATURE_CATS_RAW: FeatureCat[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/akhlaq",             Icon: Heart,        title: seoNavLabel("/akhlaq", "مكارم الأخلاق"), desc: "آيات وأحاديث في الخلق الحسن والتحلّي به" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/fawaid",       Icon: Lightbulb,   title: seoNavLabel("/fawaid", "الفوائد الشرعية"),      desc: "مقتطفات موثّقة ومنتقاة للتأمل والعمل" },
      { href: "/miracles",     Icon: Sparkles,    title: seoNavLabel("/miracles", "الإعجاز العلمي"),      desc: "تأملات علمية منضبطة في إشارات الوحي" },
