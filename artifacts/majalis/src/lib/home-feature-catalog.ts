...
const FEATURE_CATS_RAW: FeatureCat[] = [
  {
    ...
    items: [
      ...
      { href: "/anbiya",          Icon: Star,     title: seoNavLabel("/anbiya", "الأنبياء والرسل"),   desc: "٢٥ نبياً مذكورًا بالاسم في القرآن، بقصصهم ودروسها" },
      ...
      { href: "/prophets",        Icon: Star,     title: seoNavLabel("/prophets", "قصص الأنبياء"),     desc: "من آدم إلى محمد ﷺ" },
      { href: "/stories",         Icon: Map,      title: seoNavLabel("/stories", "القصص الإسلامية"),  desc: "سير الصحابة والفتوحات ووقائع من التاريخ الإسلامي" },
    ],
  },
  {
    id: "fiqh",
    ...
    items: [
      { href: "/qa",                 Icon: HelpCircle,   title: seoNavLabel("/qa", "الأسئلة والأجوبة"),  desc: "أسئلة شرعية موثقة" },
      { href: "/rulings",            Icon: Scale,        title: seoNavLabel("/rulings", "الأحكام الشرعية"),   desc: "موسوعة الفقه والعبادات" },
  ...
  },
  {
    ...
    items: [
      { href: "/adhkar",          Icon: Star,        title: seoNavLabel("/adhkar", "الأذكار"),              desc: "أذكار الصباح والمساء" },
      { href: "/sunan-yawmiyya",  Icon: Check,       title: seoNavLabel("/sunan-yawmiyya", "السنن النبوية"),        desc: "25+ سنة يومية مع تتبع التطبيق" },
      { href: "/duas",        Icon: Heart,       title: seoNavLabel("/duas", "الأدعية الشرعية"),    desc: "أدعية مأثورة مع مصدر كل دعاء" },
