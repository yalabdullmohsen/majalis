...
export const QUICK_LINKS: { href: string; Icon: LucideIcon; label: string; desc: string }[] = [
  ...
  { href: "/adhkar",     Icon: RotateCw,      label: seoNavLabel("/adhkar", "أذكار اليوم"),     desc: "أذكار الصباح والمساء والنوم وما بينهما مرتّبة للورد" },
];
...
export const FEATURED: { href: string; Icon: LucideIcon; title: string; desc: string; cta: string }[] = [
  ...
  { href: "/fiqh", Icon: Scale, title: seoNavLabel("/fiqh", "الفقه والأحكام"), desc: "أحكام العبادات والمعاملات بأدلتها تحت باب واحد", cta: "افتح" },
...
const FEATURE_CATS_RAW: FeatureCat[] = [
  {
    ...
    items: [
      ...
      { href: "/sahabah",         Icon: Users,    title: seoNavLabel("/sahabah", "أعلام الصحابة"),     desc: "٦٣ صحابياً بالتفصيل: سيرة وإرث وفضل ثابت" },
      ...
      { href: "/wasaya-nabawiyya", Icon: Scroll,  title: seoNavLabel("/wasaya-nabawiyya", "الوصايا النبوية"),    desc: "وصايا جامعة وخاصة بالصحابة مع مواضع للتطبيق" },
  ...
  },
  {
    ...
    items: [
      { href: "/fiqh",               Icon: Scale,        title: seoNavLabel("/fiqh", "الفقه الإسلامي"),  desc: "مدخل ميسّر للأحكام والأسئلة والمجمع الفقهي" },
      ...
      { href: "/janaza",              Icon: BookOpen,     title: seoNavLabel("/janaza", "أحكام الجنائز"),         desc: "الغسل والتكفين والصلاة والدفن وآداب التعزية" },
  ...
  },
  {
    ...
    items: [
      { href: "/adhkar",          Icon: Star,        title: seoNavLabel("/adhkar", "الأذكار والأدعية"),     desc: "أذكار الصباح والمساء والأدعية المأثورة للورد اليومي" },
      ...
      { href: "/hikam-salaf",  Icon: BookOpen,    title: seoNavLabel("/hikam-salaf", "حكم السلف الصالح"),     desc: "حكم مأثورة عن الصحابة والتابعين والأئمة للتربية" },
      ...
      { href: "/amr-bil-maruf", Icon: Scroll,      title: seoNavLabel("/amr-bil-maruf", "الأمر بالمعروف والنهي عن المنكر"), desc: "مراتبه الثلاث وشروطه وضوابطه عند أهل العلم" },
      { href: "/daily-wird",  Icon: BookOpen,    title: seoNavLabel("/daily-wird", "الورد اليومي"),         desc: "ختم يومي منتظم للقرآن الكريم مع خطط ميسّرة" },
      { href: "/occasions-lessons", Icon: CalendarDays, title: seoNavLabel("/occasions-lessons", "المناسبات والدروس"), desc: "تقويم المناسبات الشرعية والدروس المرتبطة بها" },
      { href: "/tasbih",      Icon: RotateCw,    title: seoNavLabel("/tasbih", "التسبيح والذكر"),       desc: "عداد للتسبيح والذكر مع أهداف يومية وتتبع الورد" },
    ],
  },
  {
    id: "tools",
    ...
    items: [
      ...
      { href: "/academic-research", Icon: Scroll, title: seoNavLabel("/academic-research", "رسائل الماجستير والدكتوراه"), desc: "فهرس الأبحاث والرسائل الشرعية الموثّقة للباحثين" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/tafsir",               Icon: BookOpen,     title: seoNavLabel("/tafsir", "علم التفسير"),            desc: "أنواع التفسير وأصوله وأشهر كتب المفسرين للدارس" },
  ...
  },
  {
    ...
    items: [
      { href: "/qibla",        Icon: Compass,     title: seoNavLabel("/qibla", "اتجاه القبلة"),    desc: "حدد اتجاه القبلة من موقعك للصلاة والسفر بسهولة" },
