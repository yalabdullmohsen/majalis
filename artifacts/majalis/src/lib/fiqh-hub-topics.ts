...
export const FIQH_HUB_TOPICS: FiqhHubTopic[] = [
  ...
  },
  {
    ...
    desc: "القواعد الخمس الكبرى ومعانيها وكيف تُستحضر في أبواب الفقه.",
    href: "/fiqh-qawaid",
    color: "var(--mj-brand-deep)",
    kind: "guide",
  },
  {
    ...
    desc: "نبذة عن المذاهب الأربعة ومناهجها ومدارسها في الاستنباط.",
    href: "/madhahib",
    color: "#7C3AED",
    kind: "guide",
  },
  {
    ...
    emoji: "🏛️",
    title: "المجمع الفقهي",
    desc: "قرارات المجامع والنوازل عبر إحالات بوابة الفقه المعتمدة.",
    href: "/fiqh-council",
    color: "#0F5132",
    kind: "council",
  },
