...
export const FIQH_HUB_TOPICS: FiqhHubTopic[] = [
  ...
  },
  {
    ...
    desc: "الأسئلة والأجوبة الشرعية: مسائل يطرحها طلاب العلم، مع ربط تدريجي بالأدلة من القرآن والسنة عند توفرها.",
    href: "/quiz",
    color: "var(--mj-brand)",
    kind: "qa",
  },
  ...
  },
  {
    ...
    desc: "موسوعة الأحكام الشرعية: مواد فقهية يجري ربطها بالأدلة والمصادر تدريجيًا.",
