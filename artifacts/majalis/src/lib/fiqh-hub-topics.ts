...
export const FIQH_HUB_TOPICS: FiqhHubTopic[] = [
  ...
  },
  {
    ...
    relatedGuides: [
      { href: "/zakat", label: "الزكاة" },
      { href: "/waqf", label: "الوقف" },
      { href: "/fiqh", label: "النوازل المعاصرة" },
    ],
  },
  {
    id: "usul-fiqh",
  ...
  },
  {
    ...
    desc: "النوازل المعاصرة تُحال إلى هيئات الفتوى المعتمدة عبر بوابة الفقه؛ لا يُفتى فيها ابتداءً هنا.",
    href: "/fiqh",
    color: "#5C5C56",
    kind: "topic",
  },
  ...
  },
  {
    ...
    emoji: "",
    title: "فقه الأقليات",
    desc: "فقه الأقليات: مسائل المسلمين في غير بلاد الإسلام، عبر الفتاوى الرسمية المعتمدة.",
    href: "/fiqh",
    color: "var(--mj-brand-deep)",
    kind: "topic",
    rulingsCategory: "النوازل المعاصرة",
  ...
  },
  {
    ...
    emoji: "",
    title: "فقه التقنية",
    desc: "فقه التقنية: نوازل الإنترنت والذكاء الاصطناعي والعملات الرقمية ضمن أبواب الفقه المعتمدة.",
    href: "/fiqh",
    color: "var(--mj-brand)",
    kind: "topic",
    rulingsCategory: "النوازل المعاصرة",
