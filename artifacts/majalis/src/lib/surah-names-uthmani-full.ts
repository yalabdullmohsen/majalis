/** أسماء السور بالرسم العثماني المشكّل (من ملفات surah-NNN.json) — لعناوين شارة المصحف فقط. */
export const SURAH_NAMES_UTHMANI_FULL: readonly string[] = [
...
export function uthmaniSurahTitle(surahId: number): string {
  if (surahId < 1 || surahId > 114) return "";
  return SURAH_NAMES_UTHMANI_FULL[surahId - 1] ?? "";
}
