/**
 * Monotonic clocks for dwell / session duration.
...
/**
 * Wall-clock ISO / stamps still use Date for persistence calendars.
 * Use this only when a human-readable absolute time is required.
 */
