...
const SYNONYM_GROUPS: string[][] = [
  ...
  // قيام الليل ↔ صلاة الليل / التهجد (استعلام دلالي شائع)
  ["قيام الليل", "صلاة الليل", "تهجد", "التهجد", "تراويح", "قيام"],
  ...
  ["تجويد", "tajweed", "تلاوة", "حفظ", "قراءة", "تسميع"],
  ["سورة", "سور", "آية", "آيات", "juz", "جزء", "حزب"],
  ["أسماء الحسنى", "اسم الله", "صفات الله"],
  ["فرعون", "فرعون موسى"],
  ["الكهف", "أصحاب الكهف", "اصحاب الكهف"],
  ["الذين ذكروا في القرآن", "الذين ذكروا في القران", "أشخاص القرآن", "اشخاص القران", "أعلام القرآن", "شخصيات القرآن", "مذكورون في القرآن", "الأشخاص في القرآن", "الاشخاص في القران"],
  ["تفسير صوتي", "استماع تفسير", "تفسير مسموع"],
  ["ذو القرنين", "ذي القرنين"],
  ["إبليس", "الشيطان"],
  ["أبو لهب", "ابو لهب", "لهب"],
  ...
  ["توحيد", "عقيدة", "العقيدة", "التوحيد", "أهل السنة"],
  ["شرك", "بدعة", "الشرك", "البدعة", "نواقض"],
  ["نبي", "رسول", "أنبياء", "رسل", "النبوة"],
  ["سيرة", "نبوية", "السيرة النبوية", "الشمائل"],
  ["أذكار", "دعاء", "أدعية", "الذكر", "أوراد"],
  ["جنة", "نعيم", "الفردوس", "دار السلام"],
  ["نار", "جهنم", "عذاب", "السعير"],
  ["أمم", "سابقة", "قوم", "عاد", "ثمود"],
  ["قصص", "الأنبياء", "قصة", "ابتلاء"],
  ["تفسير", "معاني", "بيان", "تدبر"],
  ["قراءات", "رواية", "ورش", "حفص", "قالون"],
  ["تجويد", "مخارج", "مدود", "غنّة"],
  ["مصحف", "آية", "سورة", "جزء"],
  ["حديث", "سنة", "أثر", "رواية حديث"],
  ["ضعيفة", "ضعيف", "موضوع", "موضوعة", "واه"],
  ["صحيحة", "صحيح", "متفق عليه", "البخاري"],
  ["وضوء", "الوضوء", "طهور", "استنجاء"],
  ["طهارة", "طهاره", "غسل", "تيمم"],
  ["صيام", "صوم", "رمضان", "إمساك"],
  ["أذان", "إقامة", "مؤذن", "نداء"],
  ["قبلة", "كعبة", "استقبال"],
  ["مكتبة", "كتب", "مؤلفات", "مصنفات"],
  ["دروس", "محاضرات", "شروح", "حلقات"],
  ["مصطلحات", "معجم", "قاموس", "تعريفات"],
  ["جامعات", "كليات", "شرعية", "أزهر"],
  ["اكتشف", "تعريف بالإسلام", "مبتدئ", "هداية"],
  ["تاريخ", "خلفاء", "دولة", "فتوحات"],
  ["مذكورون", "أعلام القرآن", "شخصيات"],
  ["حفظ", "مراجعة", "تثبيت", "ورد حفظ"],
  ["أرقام", "إحصاء", "عدّ", "معجم قرآني"],
];
