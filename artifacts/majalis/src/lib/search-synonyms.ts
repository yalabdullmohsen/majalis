...
const SYNONYM_GROUPS: string[][] = [
  ...
  ["وضوء", "طهارة", "غسل", "نجاسة", "الوضوء", "الطهارة", "نواقض الوضوء", "ماء", "طهور"],
  ["غسل", "غسل الجنابة", "جنابة", "حيض", "نفاس", "اغتسال"],
  ["تيمم", "التيمم", "تراب", "صعيد"],
  ["نكاح", "زواج", "طلاق", "marriage", "divorce", "مهر", "صداق", "عقد"],
  ["ميراث", "المواريث", "تركة", "ورثة", "فرائض"],
  ["ربا", "فائدة", "قرض", "معاملة", "بيع", "شراء"],
  ...
  ["المذكورون في القرآن الكريم", "الذين ذكروا في القرآن", "الذين ذكروا في القران", "أشخاص القرآن", "اشخاص القران", "أعلام القرآن", "شخصيات القرآن", "مذكورون في القرآن", "الأشخاص في القرآن", "الاشخاص في القران"],
  ...
  // الأذكار والعبادة
  ["أذكار", "ذكر", "adhkar", "تسبيح", "دعاء", "استغفار", "أدعية"],
  ["دعاء", "أدعية", "duas", "دعوة", "دعوات"],
  ["اذكار الصباح", "أذكار الصباح", "اذكار المساء", "أذكار المساء", "حصن المسلم"],
  ["تسبيح", "تحميد", "تهليل", "تكبير"],
  ["ورد", "حزب", "ذكر اليوم", "الأذكار اليومية"],

  // الفوائد والمحتوى
  ["فوائد", "فائدة", "benefit", "fawaid", "فوائد علمية", "فوائد شرعية", "الفوائد"],
  ["إعجاز", "i'jaz", "معجزة", "معجزات", "إعجاز علمي", "إعجاز قرآني"],
  ["كتب الحديث", "كتب الفقه", "كتاب", "book"],
