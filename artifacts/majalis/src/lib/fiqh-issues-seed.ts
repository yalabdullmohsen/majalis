...
export const FIQH_ISSUES_PUBLISHED_SEED: Array<FiqhCouncilIssue & CitationTrustFields> = [
  ...
  { id: "seed-issue-human-cloning",
    ...
    description:
      "تتناول المسألة أنواع الاستنساخ وحكم كل نوع، والآثار الفقهية على النسب والإرث والعلاقات الأسرية فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
    category: "الطب والنوازل",
    subcategory: "الطب",
    ruling_summary:
  ...
  { id: "seed-issue-misyar-marriage",
    ...
    description:
      "يُقصد بزواج المسيار عقد زواج يتنازل فيه أحد الطرفين عن بعض حقوقه الشرعية كالنفقة والمبيت مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
    category: "الأسرة",
    subcategory: "النكاح",
    ruling_summary:
  ...
  },
  {
    ...
    evidence_summary:
      "قياس الكتابة الإلكترونية على الكتابة الخطية في باب الطلاق عند الفقهاء والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
  ...
  },
  {
    ...
    evidence_summary:
      "الاستدلال بآية الفدية وإجماع الفقهاء على سقوط الصوم بالعجز الدائم ويُفرَّق بين الحكم الكلي وتنزيله على الواقعة.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  { id: "seed-issue-zakat-crypto",
    ...
    description:
      "تستعرض المسألة حكم إخراج زكاة البيتكوين والعملات الرقمية الأخرى ونسبتها ووقت وجوبها فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
    category: "الزكاة والوقف",
    subcategory: "الاقتصاد",
    ruling_summary:
  ...
  { id: "seed-issue-health-insurance-ruling",
    ...
    description:
      "تتناول المسألة الفرق بين التأمين التجاري والتعاوني والأثر الفقهي على مدى جوازهما ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
    category: "الاقتصاد الإسلامي",
    subcategory: "الاقتصاد",
    ruling_summary:
  ...
  { id: "seed-issue-organ-donation-will",
    ...
    description:
      "تتناول المسألة صحة الوصية بالتبرع بالأعضاء من الناحية الشرعية ومدى إلزامها للورثة ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
    category: "الطب والنوازل",
    subcategory: "الطب",
    ruling_summary:
  ...
  { id: "seed-issue-milk-bank-breastfeeding",
    ...
    description:
      "تستعرض المسألة خطورة اختلاط الأنساب وضوابط التحريم بالرضاعة عند استخدام بنوك الحليب مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
    category: "الأسرة",
    subcategory: "الرضاعة",
    ruling_summary:
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم توظيف المسلم في البنوك والمؤسسات المالية التي تتعامل بالربا وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    description:
    ...
    evidence_summary:
      "حديث لعن آكل الربا وموكله وكاتبه وشاهديه، وقواعد درء المفسدة وسد الذريعة وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم التأمين التجاري على الحياة وما يشتمل عليه من غرر وربا والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم من يؤدي عمرة ثم يخرج إلى الحل ليُحرم مجدداً بعمرة أخرى ويُفرَّق بين الحكم الكلي وتنزيله على الواقعة.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم صلاة الجمعة للموظف الذي يعمل من المنزل (العمل عن بُعد) ويُفرَّق بين الحكم الكلي وتنزيله على الواقعة.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة في حكم شراء وبيع شهادات الكربون البيئية في أسواق الطاقة والاستدامة وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    description:
  ...
  "crypto-currency": [
    {
      ...
      description: "بيان حول حكم التعامل بالعملات الرقمية ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
  ...
  "organ-donation": [
    {
      ...
      description: "توصية بشروط التبرع بعد الوفاة ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "general-anesthesia": [
    {
      ...
      description: "بيان جواز التخدير الكلي للضرورة الطبية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "artificial-organ-transplant": [
    {
      ...
      description: "بيان حكم تركيب الأعضاء الاصطناعية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "human-cloning": [
    {
      ...
      description: "بيان حكم أنواع الاستنساخ البشري فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "abortion-rape-cases": [
    {
      ...
      description: "ضوابط الإجهاض الاستثنائي قبل نفخ الروح مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
  ...
  "misyar-marriage": [
    {
      ...
      description: "بيان أحكام وضوابط زواج المسيار ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "electronic-divorce": [
    {
      ...
      description: "بيان وقوع الطلاق عبر الوسائل الرقمية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "artificial-breastfeeding": [
    {
      ...
      description: "توضيح ثبوت المحرمية بالرضاعة الاصطناعية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "fasting-elderly-disabled": [
    {
      ...
      description: "بيان حكم الفدية عن العاجز عن الصيام ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
  ...
  "astronaut-prayer": [
    {
      ...
      description: "بيان أوقات الصلاة والقبلة في المدار الأرضي مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
  ...
  "health-insurance-ruling": [
    {
      ...
      description: "التفريق بين التأمين التعاوني والتجاري فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "stock-market-trading": [
    {
      ...
      description: "ضوابط جواز التعامل في أسهم الشركات ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
  ...
  "organ-donation-will": [
    {
      ...
      description: "بيان الأثر الشرعي لوصية التبرع بالأعضاء ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "milk-bank-breastfeeding": [
    {
      ...
      description: "تحذير من استخدام بنوك الحليب المختلط فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "hair-transplant-cosmetic": [
    {
      ...
      description: "بيان جواز زراعة الشعر وضوابطها الشرعية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "crowdfunding-investment": [
    {
      ...
      description: "بيان أنواع التمويل الجماعي وأحكامها الشرعية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
  ...
  "deception-marriage-annulment": [
    {
      ...
      description: "بيان أثر التدليس على عقد النكاح وحق الفسخ ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
  ...
  "medicinal-cannabis-cbd": [
    {
      ...
      description: "بيان ضوابط استخدام مستخلصات القنب الطبية فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "carbon-credits-islamic-ruling": [
    {
      ...
      description: "دراسة فقهية في حكم تداول شهادات الكربون البيئية ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
