...
export const FIQH_ISSUES_PUBLISHED_SEED: FiqhCouncilIssue[] = [
  ...
  // ── الدعوة والإعلام ──────────────────────────────────────────────
  {
    ...
    description:
      "مع انتشار منصات التعليم الإلكتروني، ظهرت فتاوى متباينة حول مشروعية أن تُقدّم المرأة المتخصصة في العلم الشرعي دروساً ومحاضرات لمخلوط الجنسين عبر الإنترنت والتلفزيون. ما الضوابط الشرعية لذلك؟",
    category: "الدعوة والإعلام",
    subcategory: "الدعوة",
    ruling_summary:
      "يجوز للمرأة المتخصصة في العلم الشرعي أن تُدرّس وتُحاضر ببرامج إلكترونية بضوابط: أن يكون الأسلوب حشيشماً، وأن يكون الصوت بلا فتنة، وأن لا تخضع لأجنبي بالقول. وتعليم النساء أولى وأوجب.",
    evidence_summary:
