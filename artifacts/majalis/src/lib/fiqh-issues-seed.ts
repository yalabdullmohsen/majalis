...
export const FIQH_ISSUES_PUBLISHED_SEED: Array<FiqhCouncilIssue & CitationTrustFields> = [
  ...
  { id: "seed-issue-artificial-organ-transplant",
    ...
    description:
      "تشمل المسألة أحكام تركيب الأطراف الصناعية والأعضاء الميكانيكية كالقلب الاصطناعي والرئة الاصطناعية مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
    category: "الطب والنوازل",
    subcategory: "الطب",
  ...
  },
  {
    ...
    description:
      "تتناول المسألة حكم الطلاق الواقع عبر الرسائل القصيرة والبريد الإلكتروني ووسائل التواصل الاجتماعي مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
    category: "الأسرة",
    subcategory: "الطلاق",
    ruling_summary:
  ...
  },
  {
    ...
    summary: "مسألة فقهية حول حكم صيام رمضان لمن بلغ حداً من الكبر عجز معه عن الصيام كلياً والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    category: "العبادات",
    subcategory: "الصيام",
    ruling_summary:
  ...
  { id: "seed-issue-astronaut-prayer",
    ...
    description:
      "تتناول المسألة كيفية تحديد أوقات الصلاة والقبلة لمن يكون في مدار لا تُعرف فيه أوقات الشمس بصورة طبيعية ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
    category: "العبادات",
    subcategory: "الصلاة",
    ruling_summary:
  ...
  },
  {
    ...
    description:
      "تستعرض المسألة شروط جواز التعامل في أسهم الشركات من حيث نشاطها وطريقة التداول وأثر الديون ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
    category: "الاقتصاد الإسلامي",
    subcategory: "الاقتصاد",
    ruling_summary:
      "يجوز تداول أسهم الشركات المباحة النشاط بضوابط تصفية الحرام وتجنب المحرمات والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    evidence_summary:
      "أحكام الشركات في الفقه الإسلامي، وفتاوى المجامع الفقهية في المعايير الشرعية ويُفرَّق بين الحكم الكلي وتنزيله على الواقعة.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  },
  {
    ...
    description:
      "تتناول المسألة الشروط والضوابط التي وضعها العلماء لتحقيق المصلحة الدينية والأسرية لدى المسلمين في الغرب ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
    category: "الأسرة",
    subcategory: "النكاح",
    ruling_summary:
  ...
  { id: "seed-issue-covid-vaccine",
    ...
    description:
      "أثار انتشار وباء كوفيد-19 تساؤلات فقهية حول شرعية التطعيم الإجباري وما يترتب على الامتناع عنه من عقوبات أو قيود فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة.",
    category: "الطب والنوازل",
    subcategory: "الطب",
    ruling_summary:
  ...
  },
  {
    ...
    evidence_summary:
      "وجوب الأمر بالمعروف والنهي عن المنكر، وأحكام الاجتهاد والإفتاء والمسؤولية الشرعية والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    documentation_level: "official_verified",
  ...
  },
  {
    ...
    evidence_summary:
      "النهي عن بيع الغرر، والأحاديث الواردة في الميسر، وقرارات مجمع الفقه الإسلامي الدولي وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  // ── الحج والعمرة ──────────────────────────────────────────────────
  {
    ...
    summary: "مسألة فقهية في حكم أداء فريضة الحج أو العمرة من مال مكتسب بالعمل في مؤسسة ربوية والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    description:
  ...
  },
  {
    ...
    evidence_summary:
      "فعل عائشة رضي الله عنها في اعتمارها بتوجيه النبي ﷺ، وعدم ثبوت نهي صريح عن التكرار وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم صلاة الجماعة وراء إمام يُبثّ عبر الإنترنت أو التلفاز في المنزل ويُفرَّق بين الحكم الكلي وتنزيله على الواقعة.",
    description:
  ...
  },
  {
    ...
    evidence_summary:
      "قاعدة «الفتوى لا تؤخذ إلا من أهلها»، ومسؤولية الناشر عن تضليل المسلمين في دينهم والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    documentation_level: "official_verified",
    trust_level: "general_reasoning",
    editorial_review_status: "unreviewed",
    last_updated_at: "2026-07-25T00:00:00.000Z",
  ...
  },
  {
    ...
    summary: "مسألة فقهية في حكم المسلم الذي يؤدي يمين الولاء للحصول على جنسية دولة غير إسلامية والعمدة فيها الدليل والمصلحة الشرعية المنضبطة.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة فقهية في صحة الوقف الرقمي وإنشاء مشاريع خيرية دائمة عبر المنصات الإلكترونية وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة فقهية في صحة عقد النكاح الذي يُعقد عن بُعد عبر الاتصال المرئي بين الأطراف وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    description:
  ...
  },
  {
    ...
    summary: "مسألة فقهية معاصرة حول حكم تناول الحشرات (كمصدر بديل للبروتين) وتسويقها تجارياً وتُعرض بأدلتها وضوابطها دون اختزال مخلّ.",
    category: "الأطعمة والأشربة",
    subcategory: "الأطعمة الحديثة",
    ruling_summary:
  ...
  "zakat-crypto": [
    {
      ...
      description: "بيان نسبة الزكاة وكيفية حسابها على العملات الرقمية مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
  ...
  "minorities-kitabiyya-marriage": [
    {
      ...
      description: "ضوابط وحكم زواج المسلم من الكتابية في بيئة الأقليات ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
  ...
  "polar-regions-fasting": [
    {
      ...
      description: "ضوابط تقدير أوقات الصلاة والصيام في البلاد الشمالية مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
  ...
  "ai-generated-fatwa-ruling": [
    {
      ...
      description: "تحذير المجمع من الاعتماد على برامج الذكاء الاصطناعي كمرجع فقهي ملزم فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "online-nikah-video-call": [
    {
      ...
      description: "بيان شروط صحة عقد النكاح عبر الاتصال المرئي مع الأحوط بالحضور فالغاية فقهٌ عملي منضبط لا جدل بلا ثمرة ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع.",
  ...
  "metaverse-prayer-virtual": [
    {
      ...
      description: "تأكيد اشتراط الحضور الجسدي الحقيقي في صلاة الجماعة مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح ويُحال التفصيل إلى بحوث المجامع والمراجع المعتمدة.",
  ...
  "biometric-authentication-banking": [
    {
      ...
      description: "اعتماد البصمة البيولوجية توقيعاً شرعياً معتبراً في العقود ويُستعرض فيها الخلاف والأدلة باختصار تعليمي نافع مع ضبط المصطلحات وبيان محل النزاع قبل الترجيح.",
