...
export const ISLAMIC_OCCASIONS: IslamicOccasion[] = [
  {
    ...
    deeds: ["صيام يوم عاشوراء", "صيام التاسع (تاسوعاء) معه", "الإكثار من ذكر الله", "الصدقة"],
  ...
  },
  {
    ...
    deeds: ["الاجتهاد في العشر الأواخر كلها لا ليلة واحدة", "الدعاء بـ«اللهم إنك عفوٌّ تحب العفو فاعفُ عني»", "قيام الليل", "قراءة القرآن", "الاستغفار"],
  ...
  },
  {
    ...
    deeds: ["صيام الأيام البيض", "الإكثار من الذكر", "الصدقة"],
  ...
  },
  {
    ...
    hijriMonth: 1,
    hijriDay: 1,
    summary: "مناسبة لاستحضار التوبة والعمل الصالح، دون بدع في الاحتفال؛ فالسنة حسن البدايات بالعبادة.",
  ...
  },
  {
    ...
    deeds: ["الإكثار من الصلاة على النبي ﷺ في كل وقت", "قراءة السيرة النبوية والاقتداء بها", "صيام الاثنين لأنه اليوم الذي وُلد فيه ﷺ", "الصدقة"],
  ...
  },
  {
    ...
    deeds: ["صيام الاثنين والخميس", "صيام الأيام البيض (13 و14 و15)", "الاستغفار", "الصدقة"],
  ...
  },
  {
    ...
    deeds: ["الاستغفار", "الإقبال على الطاعة", "اجتناب المعاصي لعِظَم الوزر في الأشهر الحرم", "الصيام تطوعاً من غير تخصيص"],
  ...
  },
  {
    ...
    deeds: ["اجتناب المعاصي لعِظَم الوزر في الأشهر الحرم", "الاستعداد للحج وتصحيح النية", "الدعاء للحجاج", "الصيام تطوعاً والصدقة"],
