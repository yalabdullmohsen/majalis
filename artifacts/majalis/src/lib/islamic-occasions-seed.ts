...
export const ISLAMIC_OCCASIONS: IslamicOccasion[] = [
  ...
  },
  {
    ...
    evidence: "رواه البزار والطبراني في الأوسط بإسناد ضعيف (فيه زائدة بن أبي الرقاد)، لكن معناه صحيح ويجوز الدعاء به دون اعتقاد ثبوته حديثاً مرفوعاً",
    recurring: true,
  },
  {
    id: "isra-miraj",
    ...
    hijriMonth: 7,
    hijriDay: 27,
    summary: "رحلة النبي ﷺ إلى بيت المقدس ثم إلى السماوات ثابتة بنص القرآن، وفيها فُرضت الصلوات الخمس. وقيل إن الإسراء والمعراج كان في ليلة السابع والعشرين من رجب، ولم يثبت في تعيين ليلتها حديث صحيح، وقد اختلف أهل السير في ذلك اختلافًا كبيرًا.",
  ...
  },
  {
    ...
    evidence: "رواه مسلم عن عثمان بن عفان رضي الله عنه: «ومن صلى الصبح في جماعة فكأنما صلى الليل كله»",
    recurring: true,
  },
  {
    id: "isha-prayer",
    ...
    evidence: "رواه مسلم عن عثمان بن عفان رضي الله عنه: «من صلى العشاء في جماعة فكأنما قام نصف الليل»",
    recurring: true,
  },
  {
    id: "jumadal-oula",
  ...
  },
  {
    ...
    evidence: "قال تعالى: ﴿إِنَّ عِدَّةَ الشُّهُورِ عِنْدَ اللَّهِ... مِنْهَا أَرْبَعَةٌ حُرُمٌ﴾ — التوبة: 36",
    recurring: true,
  },
  {
  ...
  },
  {
    ...
    hijriMonth: 0,
    hijriDay: 0,
    summary: "لا يرد نص صحيح صريح يخص يوم السبت بفضل خاص عن سائر الأيام؛ يُستحب في كل الأيام الإكثار من الدعاء والذكر (حديث خلق التربة يوم السبت اختُلف في صحته، ورجّح البخاري وابن معين أنه من كلام كعب الأحبار لا من كلام النبي ﷺ).",
  ...
  },
  {
    ...
    deeds: ["صيام يوم الاثنين", "صيام يوم الخميس", "الإكثار من الدعاء", "ذكر الله", "قراءة القرآن"],
