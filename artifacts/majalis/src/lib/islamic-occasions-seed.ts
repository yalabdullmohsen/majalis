...
export const ISLAMIC_OCCASIONS: IslamicOccasion[] = [
  ...
  {
    id: "ayyam-beed",
    name: "صيام الأيام البيض",
    hijriMonth: 0,
    hijriDay: 13,
    summary: "الأيام البيض هي 13 و14 و15 من كل شهر هجري — يُستحب صيامها اقتداءً بالنبي ﷺ.",
    deeds: ["صيام ثلاثة أيام البيض", "التأمل في آيات الله", "الشكر على نعمة الصحة"],
    evidence: "قال ﷺ: «صم من الشهر ثلاثة أيام: ثلاث عشرة وأربع عشرة وخمس عشرة» — الترمذي: 761، حسن",
    recurring: true,
  },
  {
    id: "laylatun-nisf-shaban",
    name: "ليلة النصف من شعبان",
    hijriMonth: 8,
    hijriDay: 15,
    summary: "ثبت فضل هذه الليلة في بعض الروايات، وهي فرصة للتوبة والدعاء والاستغفار مع التحفظ من البدع.",
    deeds: ["الدعاء والاستغفار", "التوبة الصادقة", "قيام الليل"],
    evidence: "روى ابن ماجه وصححه الألباني: «إن الله يطلع ليلة النصف من شعبان فيغفر لجميع خلقه إلا لمشرك أو مشاحن»",
    recurring: true,
  },
];
