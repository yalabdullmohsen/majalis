...
export const FOUNDER_EXTENDED_ANSWER =
  "منصة المجلس العلمي هي مشروع شخصي أسسه يوسف عبدالمحسن يوسف المطيري بهدف جمع الدروس والدورات الشرعية والمكتبة العلمية والقرآن الكريم والأذكار والفوائد والأسئلة والأجوبة العلمية في منصة رقمية واحدة، مع التركيز على سهولة الوصول إلى المحتوى العلمي الموثوق وجودة تجربة المستخدم.";
