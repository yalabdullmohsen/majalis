...
export const ARABIC_PRONUNCIATION_LEXICON: readonly LexiconEntry[] = [
  ...
  // علماء وكتب — نطق أوضح دون تغيير المعنى
  entry("ابن تيمية", "ابن تَيميّة", "scholar"),
  entry("ابن القيم", "ابن القَيّم", "scholar"),
  entry("النووي", "النَّوَوي", "scholar"),
  entry("ابن حجر", "ابن حَجَر", "scholar"),
  entry("الذهبي", "الذَّهَبي", "scholar"),
  entry("الطبري", "الطَّبَري", "scholar"),
  entry("ابن كثير", "ابن كَثير", "scholar"),
  entry("الشافعي", "الشّافعي", "scholar"),
  entry("أحمد بن حنبل", "أحمد بن حَنبَل", "scholar"),
  entry("مالك", "مالِك", "scholar"),
  entry("أبو حنيفة", "أبو حَنيفة", "scholar"),
  entry("الألباني", "الألباني", "scholar"),
  entry("ابن باز", "ابن باز", "scholar"),
  entry("ابن عثيمين", "ابن عُثَيمين", "scholar"),
  entry("صحيح البخاري", "صحيح البُخاري", "book"),
  entry("صحيح مسلم", "صحيح مُسلم", "book"),
  entry("رياض الصالحين", "رياض الصّالحين", "book"),
  entry("الأربعين النووية", "الأربعين النَّوَوية", "book"),
  entry("العقيدة", "العَقيدة", "term"),
  entry("التوحيد", "التّوحيد", "term"),
  entry("الفقه", "الفِقه", "term"),
  entry("أصول الفقه", "أصول الفِقه", "term"),
  entry("الجرح والتعديل", "الجَرح والتّعديل", "term"),
  entry("الإسناد", "الإسناد", "term"),
] as const;
