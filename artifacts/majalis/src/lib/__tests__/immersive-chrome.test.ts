...
assert.equal(isImmersiveChromePath("/mushaf"), true, "المصحف غمري أثناء القراءة");
...
assert.equal(appSrc.includes("MushafComingSoonPage"), false, "صفحة قريبًا غير موصولة للمصحف");
