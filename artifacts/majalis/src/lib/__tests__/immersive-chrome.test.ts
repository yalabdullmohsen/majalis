...
assert.equal(isCompactHeaderPath("/hadith"), true, "قسم الحديث بلا تيكر/بحث رئيسي");
assert.equal(isCompactHeaderPath("/hadith/sahih"), true);
assert.equal(isCompactHeaderPath("/hadith-science"), true);
