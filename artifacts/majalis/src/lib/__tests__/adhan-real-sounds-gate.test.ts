...
assert.match(catalog, /adhan-field\.m4a/);
assert.match(catalog, /adhan-field-full\.m4a/);
...
assert.ok(options.some((o) => o.group === "adhan" && o.id === "field"));
assert.ok(options.some((o) => o.group === "adhan" && o.id === "field-full"));
