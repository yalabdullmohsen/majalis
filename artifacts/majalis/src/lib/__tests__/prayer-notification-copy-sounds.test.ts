...
assert.equal(resolvePrayerNotificationSound("clear", "auto"), "adhan-makkah-short.caf");
assert.equal(resolvePrayerNotificationSound("soft", "clear"), "adhan-makkah-short.caf");
