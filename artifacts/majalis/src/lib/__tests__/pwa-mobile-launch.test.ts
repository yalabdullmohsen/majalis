...
assert.equal(siteManifest.theme_color, "#F7F3EB");
assert.equal(siteManifest.background_color, "#F7F3EB");
...
assert.equal(jsonManifest.theme_color, "#F7F3EB");
assert.equal(jsonManifest.background_color, "#F7F3EB");
...
assert.ok(String(seoRoutes.defaultImage).includes("/brand/og-home.png"));
