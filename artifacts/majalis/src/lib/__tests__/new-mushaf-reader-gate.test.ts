...
assert.match(
  css,
  /#fbf4d7|#fcf5db|#fff9e5|#f8f1d4|#fcf7ec|--mushaf-paper-warm-yellow:\s*#fbf4d7|--mushaf-paper-light:\s*var\(--mushaf-paper-warm-yellow\)|--mushaf-page-bg:\s*var\(--mushaf-paper-warm-yellow\)/i,
...
assert.match(css, /\.nm-verse-menu__head/);
assert.match(css, /\.nm-verse-menu__close/);
assert.match(read("src/features/mushaf-reader/MushafControlsLayer.tsx"), /nm-verse-menu__close/);
