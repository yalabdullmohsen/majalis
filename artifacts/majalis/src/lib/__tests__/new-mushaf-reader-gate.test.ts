...
assert.match(
  css,
  /#f8f1d4|#fbf5da|#f7edc8|#fcf7ec|--mushaf-paper-warm-yellow:\s*#f8f1d4|--mushaf-paper-light:\s*var\(--mushaf-paper-warm-yellow\)|--mushaf-page-bg:\s*var\(--mushaf-paper-warm-yellow\)/i,
