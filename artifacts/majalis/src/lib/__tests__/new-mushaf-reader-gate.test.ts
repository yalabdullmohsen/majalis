...
assert.match(
  css,
  /#faf0e0|#fbf4e8|#fcf7ec|--mushaf-paper-light:\s*#fcf7ec|--nm-paper:\s*#faf0e0|--mushaf-page-bg:\s*(?:#faf0e0|var\(--mushaf-paper-light\))/i,
  "لون ورق المصحف (عاجي أصيل سُنّة أو المرجع السابق)",
);
