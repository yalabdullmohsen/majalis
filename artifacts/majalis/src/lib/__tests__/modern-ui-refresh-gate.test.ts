...
assert.match(unify, /border:\s*1px solid var\(--surface-feature-border/, "حد موحّد خفيف بلا شريط جانبي");
assert.doesNotMatch(unify, /border-inline-start:\s*[34]px/, "unify بلا عمود زخرفي");
