...
assert.match(view, /أصوات الصلاة|صوت إشعار الصلاة|الأذان داخل التطبيق/);
...
assert.match(view, /معاينة الصوت|اختبار الصوت/);
assert.match(view, /تنبيهات الصلاة/);
assert.match(view, /تفعيل الإقامة|تذكيرات إضافية|تذكيرات إيمانية/);
assert.match(view, /إعادة جدولة التنبيهات/);
assert.match(view, /إذن الإشعارات/);
assert.match(view, /إذن الموقع/);
assert.match(view, /اختبار التنبيهات|اختبار الإشعارات/);
assert.match(view, /اختبار إشعار خلال ١٠ ثوانٍ|اختبار الإشعار بعد ١٠ ثوانٍ/);
assert.match(view, /حالة الجدولة|صحة تنبيهات الصلاة/);
assert.match(view, /ads-section-label/);
