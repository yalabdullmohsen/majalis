...
assert.match(css, /\[data-mushaf-accent="gold"\][\s\S]{0,500}--mushaf-accent-fill:\s*var\(--quran-gold\)/);
assert.match(css, /\[data-mushaf-accent="gold"\][\s\S]{0,600}--mushaf-marker-background:\s*var\(--mushaf-accent-fill\)/);
