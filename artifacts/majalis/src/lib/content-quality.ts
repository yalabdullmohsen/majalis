...
const WEAK_FAWAID_PATTERNS = [
  ...
  /^تفريغ:/,
  /^ملخص مرئي/,
  // عناقيد قوالب مولَّدة (موضوع × باب) — تُحجب إن أفلتت من تنقية البذرة
  /يربي طالب العلم على ضبط باب/,
  /من مفاتيح ضبط باب/,
  /يعين على ضبط باب/,
  /تعين على ضبط باب/,
  /في باب \S+ يربي طالب العلم/,
  /^من فقه .+ في (?:العقيدة|الفقه|القرآن|السنة|السيرة|الحديث) أن /,
];
