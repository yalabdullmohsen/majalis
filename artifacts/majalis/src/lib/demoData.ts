const sheikhNames = [
  ...
  ["الشيخ بلال النجدي", "فقه الأسرة", "السعودية"],
  ["د. ياسر الرباطي", "علوم الحديث", "المغرب"],
  ["الشيخ صهيب الكويتي", "العقيدة", "الكويت"],
  ["د. محمود الحلبي", "أصول التفسير", "سوريا"],
  ["الشيخ عادل المدني", "السيرة", "السعودية"],
  ["د. ريان الأندلسي", "الأخلاق", "إسبانيا"],
  ["الشيخ مالك المصري", "الدعوة", "مصر"],
  ["د. حمزة الحنبلي", "فقه المعاملات", "الأردن"],
  ["الشيخ إلياس الجزائري", "القراءات", "الجزائر"],
  ["د. بكر الزاهد", "تزكية النفوس", "قطر"],
  ["الشيخ معاذ الحضرمي", "شرح السنة", "اليمن"],
  ["د. نافع التونسي", "القواعد الفقهية", "تونس"],
  ["الشيخ قاسم المقدسي", "الشمائل", "فلسطين"],
  ["د. رائد النجدي", "العقيدة", "السعودية"],
  ["الشيخ أسامة الشنقيطي", "أصول الفقه", "موريتانيا"],
  ["د. نبيل البغدادي", "الآداب الشرعية", "العراق"],
  ["الشيخ راشد العماني", "فقه الصلاة", "عمان"],
  ["د. سامر الدمشقي", "نقد الحديث", "سوريا"],
  ["الشيخ فيصل الإماراتي", "خطاب الدعوة", "الإمارات"],
  ["د. إلياس القيرواني", "تفسير السور", "تونس"],
  ["الشيخ عبد السلام البصري", "العقيدة", "السعودية"],
  ["د. مصعب المراكشي", "الفقه المالكي", "المغرب"],
  ["الشيخ حمد الكويتي", "التفسير", "الكويت"],
  ["د. أسعد الشامي", "الحديث", "سوريا"],
  ["الشيخ مراد المدني", "السيرة", "السعودية"],
  ["د. سفيان الأندلسي", "الأخلاق والتربية", "إسبانيا"],
  ["الشيخ هاشم المصري", "الدعوة والإصلاح", "مصر"],
  ["د. عاصم الحنبلي", "الفقه المقارن", "الأردن"],
  ["الشيخ أنور الجزائري", "علوم القرآن", "الجزائر"],
  ["د. عبد الملك الزاهد", "التربية الإيمانية", "قطر"],
];
...
export const demoSheikhs = sheikhNames.map(([name, specialty, country], index) => ({
  ...
  city: country,
  country,
  photo_url: `/demo/sheikhs/sheikh-${index + 1}.svg`,
...
export const demoLessons = Array.from({ length: 100 }, (_, index) => {
  ...
  return {
    ...
    city: sheikh.country,
    audience: "الكل",
    lesson_type: index % 2 === 0 ? "درس" : "محاضرة",
