...
const RAW_PUBLISHED_SEED: FiqhCouncilItem[] = [
  ...
  // لم تنعقدا أصلاً. لم يبقَ إلا ما يحمل رابط قرار رسمي محدَّداً ورقم قرار.
  {
    ...
    summary: "قرار فقهي حول حكم تناول وتسويق اللحوم المصنَّعة من خلايا حيوانية تُزرَع معملياً دون ذبح مباشر ويُراجع النص الكامل عند الحاجة إلى التفصيل.",
...
3. وجوب الإفصاح عن المعلومات المتعلقة بالمنتج المعدَّل وراثياً وطريقة تحضيره.`,
  ...
  },
  {
    ...
    summary: "مسألة فقهية معاصرة حول حكم التعامل بالعملات الرقمية المشفَّرة المبنية على تقنية سلسلة الكتل ويُراجع النص الكامل عند الحاجة إلى التفصيل.",
    content: `**التعريف:**
...
لم يصدر المجمع حكماً قاطعاً في المسألة، وقرَّر تأجيل البتّ فيها لمزيد من الدراسة، نظراً لعدم استقرار قيمة هذه العملات وارتفاع المخاطر المرتبطة بها، وعدم حسم مسألتي: هل تُعدّ سلعة أم خدمة أم أصلاً استثمارياً؟ وهل لها قيمة نقدية معتبرة شرعاً؟`,
  ...
  },
  {
    ...
    summary: "مسألة فقهية معاصرة حول حكم العقود التي تُنفَّذ تلقائياً عبر تقنية سلسلة الكتل دون وسيط بشري ويُراجع النص الكامل عند الحاجة إلى التفصيل.",
    content: `**التعريف:**
