...
«اللحوم المستزرَعة: غذاء مُصنّعٌ من خلايا تؤخذ من حيوان حي في الغالب، ثم تُزرع في مختبر آمِنٍ على مدار أسابيع بإضافة عناصر غذائية».
...
4. «أن يكون المنتج النهائي صالحًا للأكل وغير مضر بالصحة، وفقًا للمعايير والإجراءات».
5. «ألّا تكون اللحوم المستزرعة بديلًا عن لحوم الحيوان، وتجوز الاستفادة منها إلى جانب اللحم الحيواني».
6. «أن تُفصح الشركات عن المعلومات اللازمة للمستهلكين بما يحقق الضوابط الواردة في البند السابق».`,
