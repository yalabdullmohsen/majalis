...
export const SECTION_PROMOS: Omit<TickerContentItem, "kind" | "previewText">[] = [
  ...
  { id: "promo:hadith", label: "قسم", text: "الأحاديث النبوية — أحاديث موثّقة مع التخريج", href: "/hadith" },
  { id: "promo:quran", label: "قسم", text: "المصحف الشريف — مصحف وتلاوة وأدوات التعلّم", href: "/mushaf" },
  ...
  { id: "promo:learn", label: "قسم", text: "الدروس — دروس ودورات علمية منظمة", href: "/lessons" },
];
