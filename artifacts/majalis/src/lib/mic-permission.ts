...
export function micHelpSteps(platform: MicHelpPlatform): string {
  switch (platform) {
    case "ios":
      return "افتح إعدادات آيفون ← مرِّر لتطبيق «سُنّة» ← فعِّل «الميكروفون» و«التعرّف على الكلام»، ثم عد وحاول مجددًا.";
    case "android":
      return "افتح إعدادات الجهاز ← التطبيقات ← «سُنّة» ← الأذونات ← فعِّل «الميكروفون»، ثم عد وحاول مجددًا.";
    case "safari":
