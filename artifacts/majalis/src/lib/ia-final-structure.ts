...
export const IA_HOME_PRIMARY = [
  { href: "/quran-hub", title: "القرآن", desc: "المصحف والتلاوة والتجويد والحفظ وعلوم القرآن" },
  { href: "/lessons", title: "الدروس والدورات", desc: "دروس ودورات علمية مرتّبة للحضور والمتابعة" },
  { href: "/prayer-times", title: "مواقيت الصلاة", desc: "المواقيت والقبلة وتنبيهات الأذان بدقّة موقعك" },
  { href: "/fiqh", title: "الفقه والأحكام", desc: "كتب ومسائل فقهية موثّقة تحت باب واحد" },
  { href: "/adhkar", title: "الأذكار اليومية", desc: "أذكار الصباح والمساء وما بينهما — ورد ثابت" },
  { href: "/sections", title: "جميع الأقسام", desc: "حديث وعقيدة وسيرة ومسارات العلم والأدوات" },
] as const;
