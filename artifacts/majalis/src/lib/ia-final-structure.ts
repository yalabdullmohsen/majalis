...
export const IA_HOME_PRIMARY = [
  { href: "/quran-hub", title: "القرآن", desc: "مصحف وتلاوة وتجويد وحفظ — من موضعك الأخير" },
  { href: "/lessons", title: "الدروس والدورات", desc: "دروس علمية مرتّبة للحضور أو المتابعة لاحقًا" },
  { href: "/prayer-times", title: "مواقيت الصلاة", desc: "أوقات الصلاة والقبلة وتنبيه الأذان لموقعك" },
  { href: "/fiqh", title: "الفقه والأحكام", desc: "مسائل وكتب فقهية موثّقة في موضع واحد" },
  { href: "/adhkar", title: "الأذكار اليومية", desc: "أذكار الصباح والمساء وما بينهما" },
  { href: "/sections", title: "جميع الأقسام", desc: "عقيدة وحديث وسيرة ومكتبة وأدوات طالب العلم" },
] as const;
