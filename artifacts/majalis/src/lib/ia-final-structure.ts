...
export const IA_HOME_PRIMARY = [
  { href: "/quran-hub", title: "القرآن", desc: "المصحف والتلاوة والتجويد والحفظ وعلوم القرآن في باب واحد" },
  { href: "/lessons", title: "الدروس والدورات", desc: "دروس ودورات علمية مرتّبة للحضور والمتابعة" },
  { href: "/prayer-times", title: "مواقيت الصلاة", desc: "مواقيت الصلوات واتجاه القبلة وتنبيهات الأذان" },
  { href: "/fiqh", title: "الفقه والأحكام", desc: "العبادات والمعاملات والقواعد والمجامع تحت باب واحد" },
  { href: "/adhkar", title: "الأذكار اليومية", desc: "أذكار الصباح والمساء والنوم وما ثبت بينهما في السنة" },
  { href: "/sections", title: "جميع الأقسام", desc: "حديث وأعلام وتاريخ ومسارات علم — فهرس كامل للأبواب" },
] as const;
