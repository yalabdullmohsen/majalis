...
export const lessonAds: LessonAd[] = [
  ...
  },
  {
    ...
    shortDescription: "التعليق على المختصر في تفسير القرآن الكريم — تفسير المفصل من سورة (ق) إلى (الناس) — كل ثلاثاء 9:15 مساءً، مع بث مباشر.",
    category: "weekly",
    tags: ["تفسير", "أسبوعي", "حضوري", "بث مباشر"],
    sessions: [
      {
        ...
        district: "صباح الأحمد – ق2 – ش227 – م382 (الديوانية خلف المنزل)",
        liveUrl: "https://www.saltaweel.com",
        referenceUrl: "https://www.saltaweel.com",
        note: "بث مباشر عبر حسابات الشيخ: إنستغرام salemaltaweel — تويتر saltaweel — هاتف: 0096555199147",
      },
    ],
  },
  {
    ...
    sessions: [
      {
        ...
        day: "الأحد",
        time: "بعد صلاة العصر",
        venue: "مسجد عمر بن الخطاب",
        district: "الرميثية",
        note: "التفسير من المنهج التحليلي مع انتخاب الأقوال الراجحة.",
      },
    ],
  },
  {
    ...
    category: "course",
    tags: ["عقيدة", "دورة علمية", "واسطية", "ابن تيمية"],
    hasWomenSection: true,
    startDate: "2026-10-01",
    sessions: [
      {
        label: "الدورة الكاملة",
        day: "الخميس",
        time: "بعد صلاة المغرب",
        venue: "معهد إعداد الدعاة",
        district: "العدلية",
        note: "الدورة تشمل قراءة المتن وشرحه مع التطبيق والحفظ.",
      },
    ],
  },
  {
    ...
    category: "weekly",
    tags: ["سيرة", "أسبوعي", "حضوري", "تاريخ إسلامي"],
    hasWomenSection: true,
    sessions: [
      {
        label: "المجلس الأسبوعي",
        ...
        venue: "مسجد الرحمة",
        district: "السالمية",
        note: "المتابعة الحالية: غزوة أُحد.",
      },
    ],
  },
  {
    ...
    category: "program",
    tags: ["فقه", "مالكي", "رسالة", "برنامج تعليمي"],
    hasWomenSection: false,
    ...
    sessions: [
      {
        ...
        venue: "مركز الدراسات الشرعية",
        district: "العدلية",
        note: "يُدرس الكتاب مع الحواشي المختارة.",
      },
    ],
  },

  // ── الفعاليات الجديدة (يوليو 2026) ───────────────────────────────────

  // 1 — دورة مهمات في العقيدة (نسائية) — الجهراء
  {
    id: "jahraa-muhimmat-aqeeda-women-2026",
    provider: "المراقبة الثقافية — إدارة مساجد محافظة الجهراء (وزارة الأوقاف والشؤون الإسلامية)",
    teacher: "أ. جميلة الهاجري",
    teacherImage: "/sheikhs/default-sheikh.svg",
    title: "دورة مهمات في العقيدة",
    shortDescription: "شرح ثلاثة الأصول والقواعد الأربع ونواقض الإسلام — دورة علمية صيفية نسائية بالجهراء.",
    category: "course",
    tags: ["دورة علمية", "عقيدة", "نساء", "حضوري"],
    hasWomenSection: true,
    startDate: "2026-07-08",
    sessions: [
      {
        label: "ثلاثة الأصول — القواعد الأربع — نواقض الإسلام",
        day: "الأربعاء",
        time: "بعد صلاة المغرب",
        venue: "مسجد الشيخ مبارك الحمد الصباح",
        district: "القيروان — مصلى النساء",
        note: "يوجد شهادات لحضور الدورة. دورة نسائية.",
      },
    ],
  },

  // 2 — دورة عمدة الأحكام — الشيخ محمد هشام طاهري — السرة
  {
    ...
    category: "course",
    tags: ["دورة علمية", "حديث", "فقه", "حضوري"],
    hasWomenSection: false,
    startDate: "2026-07-07",
    sessions: [
      {
        label: "عمدة الأحكام — 18 مجلساً",
        day: "من الأحد إلى الخميس يومياً",
        time: "بعد صلاة العصر (إقامة الصلاة بعد 10 دقائق)",
        venue: "مسجد محمد عبدالرحمن البحر",
        district: "السرة",
        note: "تبدأ 7/7/2026 وتنتهي 30/7/2026 — 18 مجلساً — سيجيز الشيخ الحاضرين بالإسناد المتصل في نهاية الدورة.",
      },
    ],
  },

  // 3 — الشيخ فهد الدوسري — عمدة الأحكام + كتاب التوحيد — المهبولة
  {
    ...
    category: "course",
    tags: ["دورة علمية", "فقه", "عقيدة", "حضوري"],
    hasWomenSection: false,
    startDate: "2026-07-07",
    sessions: [
      {
        label: "شرح عمدة الأحكام (كتاب الطهارة)",
        day: "يومياً على فترتين",
        time: "بعد العصر",
        venue: "مسجد الشيخ خليفة الصباح",
        district: "منطقة المهبولة ق3",
        note: "مدة الدورة 9 أيام — ابتداءً الثلاثاء 22 محرم / 7/7/2026. الدعوة عامة للجميع.",
      },
      {
        label: "شرح كتاب التوحيد",
        day: "يومياً عدا الاثنين والخميس",
        time: "بعد المغرب",
        venue: "مسجد الشيخ خليفة الصباح",
        district: "منطقة المهبولة ق3",
        note: "يومياً بعد المغرب — ما عدا الاثنين والخميس.",
      },
    ],
  },

  // 4 — زاد المسلم: الميسر في علوم القرآن — لافي العازمي — الأحمدي
  {
    ...
    category: "course",
    tags: ["دورة علمية", "علوم القرآن", "تفسير", "حضوري", "بث مباشر", "نساء"],
    hasWomenSection: true,
    startDate: "2026-07-05",
    sessions: [
      {
        label: "المجلس الأول — علوم القرآن",
        day: "5 و6 و7 يوليو 2026",
        time: "4:25–5:15 عصراً",
        venue: "مسجد فروة بن عمرو الأنصاري",
        district: "منطقة فهد الأحمد قطعة 4",
        note: "للاستفسار: 55777114",
      },
      {
        label: "المجلس الثاني — علوم القرآن",
        day: "5 و6 و7 يوليو 2026",
        time: "5:30–6:20 عصراً",
        venue: "مسجد فروة بن عمرو الأنصاري",
        district: "منطقة فهد الأحمد قطعة 4",
        note: "بث مباشر عبر الحسابات — يوجد أماكن مخصصة للنساء.",
      },
    ],
  },

  // 5 — مجالس التعليق على الكلم الطيب — الجهراء
  {
    id: "jahraa-alkalam-altayib-weekly-2026",
    provider: "المراقبة الثقافية — إدارة مساجد محافظة الجهراء",
    teacher: "إدارة مساجد الجهراء",
    teacherImage: "/sheikhs/default-sheikh.svg",
    title: "مجالس التعليق على كتاب الكلم الطيب",
    shortDescription: "مجالس أسبوعية في شرح الكلم الطيب لشيخ الإسلام ابن تيمية — كل ثلاثاء بعد العصر بجامع عثمان بن عفان.",
    category: "weekly",
    tags: ["أسبوعي", "أذكار", "دعاء", "حضوري", "نساء"],
    hasWomenSection: true,
    sessions: [
      {
        label: "المجلس الأسبوعي",
        day: "الثلاثاء",
        time: "بعد صلاة العصر",
        venue: "جامع عثمان بن عفان",
        district: "شرق تيماء — الجهراء",
        note: "يوجد مكان للنساء — للاستفسار: 99487505 أو 50727855",
      },
    ],
  },

  // 7 — زاد المسلم: ثلاثة الأصول والقواعد الأربع — د. محمد العتيبي — الأحمدي
  {
    ...
    category: "course",
    tags: ["دورة علمية", "عقيدة", "حضوري", "بث مباشر", "نساء"],
    hasWomenSection: true,
    startDate: "2026-07-08",
    sessions: [
      {
        label: "خارطة طريق مفيدة لطالب علم العقيدة",
        day: "8 يوليو 2026",
        time: "4:25–5:15 عصراً",
        venue: "مسجد فروة بن عمرو الأنصاري",
        district: "منطقة فهد الأحمد قطعة 4",
      ...
      {
        label: "القواعد الأربعة",
        day: "8 يوليو 2026",
        time: "5:30–6:20 عصراً",
        venue: "مسجد فروة بن عمرو الأنصاري",
        district: "منطقة فهد الأحمد قطعة 4",
        note: "بث مباشر — أماكن مخصصة للنساء.",
      },
      {
        label: "الأصول الثلاثة — الجلسة الأولى والثانية",
        day: "9 يوليو 2026",
        time: "4:25–6:20 عصراً",
        venue: "مسجد فروة بن عمرو الأنصاري",
        district: "منطقة فهد الأحمد قطعة 4",
        note: "مجلسان في اليوم نفسه.",
      },
    ],
  },

  // 8 — مشروع زاد المسلم الدعوي — المجلس 13 — أحاديث في الفتن
  {
    ...
    category: "program",
    tags: ["حديث", "عقيدة", "فتن", "حضوري"],
    hasWomenSection: false,
    startDate: "2026-07-08",
    sessions: [
      {
        label: "المجلس الثالث عشر",
        day: "الأربعاء",
        time: "9:15 مساءً",
        venue: "مجلس راشد المري",
        district: "منطقة الأحمدي ق14 — ش3 الشمالي — م33",
        note: "الموافق 23 محرم 1448هـ",
      },
    ],
  },

  // 9 — عمدة الأحكام — د. دهام أبو خشبة — صباح الأحمد
  {
    ...
    sessions: [
      {
        ...
        day: "الثلاثاء",
        time: "بعد صلاة العصر",
        venue: "مسجد أبو طاهر السلفي",
        district: "صباح الأحمد",
        note: "بدأ من 16 يونيو 2026 — بالتعاون مع إدارة مساجد الأحمدي.",
      },
    ],
  },
];
