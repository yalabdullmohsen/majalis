...
export const HOME_MORE_SECTIONS = [
  ...
  { href: "/library", title: "المكتبة", description: "كتب · مقالات · أبحاث" },
  { href: "/library/books", title: "الكتب", description: "كتب ومتون وشروح" },
  { href: "/library/articles", title: "المقالات", description: "مقالات علمية منفصلة" },
