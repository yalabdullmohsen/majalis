...
export const HOME_MORE_SECTIONS = [
  ...
  { href: "/tawhid", title: "التوحيد والعقيدة", description: "أنواع التوحيد وأركان الإيمان والأسماء الحسنى على منهج أهل السنة" },
  { href: "/learn/aqeedat-ahl-sunnah", title: "عقيدة أهل السنة والجماعة", description: "معالم المنهج: التلقي والإيمان والصفات والصحابة والقدر" },
  { href: "/islamic-sects", title: "الفرق والمذاهب", description: "عرض تاريخي للفرق مع بيان موقف أهل السنة" },
  ...
  { href: "/durus-imaniyya", title: "دروس إيمانية", description: "أمراض القلوب وأعمالها وتزكية النفس بأسلوب تربوي موجز" },
  { href: "/durus-mutanawwia", title: "دروس متنوعة", description: "فهارس دراسية في أبواب العلم والعمل والواقع" },
  { href: "/iman-topics", title: "موضوعات إيمانية", description: "موضوعات مركّزة في الإيمان والعمل" },
  { href: "/quran-studies", title: "دراسات قرآنية", description: "قصص وأمثال ومحاور قرآنية بمتن موجز موثّق" },
  { href: "/sunnah-studies", title: "دراسات سنية", description: "أبواب من السنة النبوية بمتن موجز" },
  { href: "/tazkiya-topics", title: "موضوعات التزكية", description: "تزكية النفس والأخلاق العملية" },
  { href: "/tarikh-islami", title: "التاريخ الإسلامي", description: "محطات تاريخية بعبرة منهجية بلا إسرائيليات" },
  { href: "/usra-mujtama", title: "الأسرة والمجتمع", description: "بناء البيت المسلم والعلاقات الاجتماعية" },
  { href: "/fikr-waqia", title: "الفكر والواقع", description: "معالجة قضايا الشباب والعمل والواقع المعاصر" },
  { href: "/mawsuaat", title: "فهارس الموسوعات", description: "فهارس دراسية موسوعية مختصرة" },
  { href: "/arabic-language", title: "اللغة العربية", description: "النحو والصرف والبلاغة لطالب العلم" },
  { href: "/maqasid-sharia", title: "مقاصد الشريعة", description: "مقاصد الشريعة وأثرها في فهم الأحكام" },
  { href: "/dalail-nubuwwah", title: "دلائل النبوة", description: "دلائل نبوة النبي ﷺ من القرآن والسنة" },
