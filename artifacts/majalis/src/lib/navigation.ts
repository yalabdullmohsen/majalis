...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    links: [
      ...
      { href: "/continue", label: "واصل" },
      { href: "/profile", label: "لوحتي" },
...
export const HOME_MORE_SECTIONS = [
  ...
  { href: "/discover", title: "اكتشف", description: "محتوى يومي واقتراحات" },
  { href: "/profile", title: "لوحتي", description: "نشاطك وإنجازاتك" },
  { href: "/favorites", title: "المفضلة", description: "كل محفوظاتك" },
  { href: "/challenges", title: "التحديات", description: "تحديات يومية" },
