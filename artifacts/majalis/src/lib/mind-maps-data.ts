...
export const MIND_MAPS: MindMap[] = [
  ...
  /* ═══ 6. السيرة النبوية ═══ */
  {
    ...
    description: "مراحل السيرة النبوية من المولد إلى الوفاة: المرحلة المكية (٥٧٠–٦٢٢م)، والمرحلة المدنية (٦٢٢–٦٣٢م)، ومعهما الصحابة الكرام والأنبياء والرسل.",
    root: {
      id: "r-seerah",
  ...
  /* ═══ 17. التاريخ الإسلامي ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "حقب التاريخ الإسلامي من العصر النبوي (٦١٠–٦٣٢م) إلى العصر الحديث، مرورًا بالخلافة الراشدة والدولتين الأموية والعباسية والدولة العثمانية.",
    root: {
      id: "r-history",
