...
export const MIND_MAPS: MindMap[] = [
  /* ═══ 1. العقيدة الإسلامية ═══ */
  {
    ...
    description: "أصول الإيمان ومسائل العقيدة على منهج أهل السنة والجماعة: التوحيد، وأركان الإيمان الستة، والأسماء الحسنى، ومسائل الغيب والآخرة، مرتَّبةً من الأصل إلى الفروع بروابط دروس المنصة.",
    root: {
      id: "r-aqeeda",
  ...
  /* ═══ 2. الفقه الإسلامي ═══ */
  {
    ...
    description: "أقسام الفقه الإسلامي وأبوابه من الطهارة إلى المعاملات، مع المذاهب الأربعة وأصول الفقه وأقسام الأحكام الشرعية، مرتَّبةً من الأصل إلى الفروع بروابط دروس المنصة.",
    root: {
      id: "r-fiqh",
  ...
  /* ═══ 3. علوم القرآن ═══ */
  {
    ...
    description: "علوم القرآن من التجويد إلى التفسير والإعجاز، مع مباحث علوم القرآن وأدوات القرآن في المنصة، مرتَّبةً من الأصل إلى الفروع.",
    root: {
      id: "r-quran",
      label: "القرآن الكريم",
      children: [
  ...
  /* ═══ 4. الحديث النبوي ═══ */
  {
    ...
    description: "منهج علماء الحديث في الرواية والدراية والتصنيف: مصطلح الحديث، والرواية والسند، وكتب الحديث، وموضوعات السنة النبوية.",
    root: {
      id: "r-hadith",
      label: "الحديث النبوي",
      children: [
  ...
  /* ═══ 5. العبادة والأذكار ═══ */
  {
    ...
    description: "منظومة العبادة اليومية من الصلاة إلى الأذكار والأدعية، مع السنن والآداب والمناسبات والشعائر، بروابط أدوات المنصة.",
    root: {
      id: "r-ibadah",
  ...
  /* ═══ 6. السيرة النبوية ═══ */
  {
    ...
    description: "مراحل السيرة النبوية من المولد إلى الوفاة: المرحلة المكية (570–622م)، والمرحلة المدنية (622–632م)، ومعهما الصحابة الكرام والأنبياء والرسل.",
    root: {
      id: "r-seerah",
      ...
      children: [
        ...
        {
          id: "medina-phase",
          label: "المرحلة المدنية (622–632م)",
          children: [
  ...
  /* ═══ 7. طرق التعلم الإسلامي ═══ */
  {
    ...
    description: "المراحل والأولويات لطالب العلم الشرعي: الأساسيات، ثم التأصيل، ثم التعمق، مع أدوات التعلم المتاحة في المنصة.",
    root: {
      id: "r-learning",
  ...
  /* ═══ 8. الأخلاق والتزكية ═══ */
  {
    ...
    category: "الدروس والمصادر",
    description: "منظومة الأخلاق الإسلامية وتزكية النفس: الأخلاق الحميدة والأخلاق الذميمة، والتزكية والسلوك، وآداب الحياة الإسلامية.",
    root: {
      id: "r-akhlaq",
  ...
  },
  {
    ...
    description: "فروع اللغة العربية وأهميتها في فهم القرآن والسنة: النحو والصرف، والبلاغة، وأدوات اللغة في المنصة.",
    root: {
      id: "r-arabic",
  ...
  },
  {
    ...
    category: "القرآن الكريم",
    description: "طرق التفسير وأنواعه وقواعده: أنواع التفسير، وقواعده، وأبرز كتبه، وأعلام المفسرين في التاريخ الإسلامي.",
    root: {
      id: "r-tafsir",
  ...
  },
  {
    ...
    category: "الفقه والأحكام",
    description: "أحكام المواريث وطريقة حساب الأنصبة: أسباب الإرث وشروطه وموانعه، والأنصبة المقدّرة، وقواعد المواريث.",
    root: {
      id: "r-faraid",
      label: "علم الفرائض",
      children: [
        ...
        },
        {
          ...
          children: [
            { id: "fp-1", label: "النصف: الزوج عند عدم الفرع الوارث، والبنت الواحدة، وبنت الابن" },
            { id: "fp-2", label: "الربع: الزوج مع الفرع والزوجة بلا فرع" },
            { id: "fp-3", label: "الثمن: الزوجة مع الفرع" },
            { id: "fp-4", label: "الثلثان: البنتان فأكثر" },
            { id: "fp-5", label: "الثلث: الأم عند عدم الفرع الوارث، والاثنان فأكثر من الإخوة لأم" },
  ...
  },
  {
    ...
    category: "العبادة والأذكار",
    description: "مفهوم الزهد والرقائق وفضائل الأعمال القلبية: أمراض القلوب وعلاجها، ومنازل القلوب الحسنة، وأشهر كتب الرقائق.",
    root: {
      id: "r-zuhd",
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: "rb-4", label: "مختصر منهاج القاصدين — ابن قدامة" },
          ],
        },
      ],
    },
  },
  {
    ...
    title: "أصول الفقه",
    category: "الفقه والأحكام",
    description: "قواعد الاستنباط الفقهي وطرق الاجتهاد: مصادر التشريع، وأقسام الأحكام الشرعية، والقواعد الأصولية، والاجتهاد والتقليد.",
    root: {
      id: "r-usul",
      label: "أصول الفقه",
      children: [
  ...
  },
  {
    ...
    title: "علم التجويد",
    category: "القرآن الكريم",
    description: "أحكام تجويد القرآن الكريم: مخارج الحروف وصفاتها، وأحكام النون الساكنة والتنوين، وأحكام المد.",
    root: {
      id: "r-tajweed",
      label: "علم التجويد",
      children: [
  ...
  },
  {
    ...
    title: "مصطلح الحديث",
    category: "الحديث والسنة",
    description: "مصطلح الحديث وأنواعه: أقسام الحديث، وأنواع الإسناد، والجرح والتعديل، وكتب الحديث الكبرى.",
    root: {
      id: "r-mustalah",
      label: "مصطلح الحديث",
      children: [
  ...
  /* ═══ 16. التاريخ الإسلامي ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "حقب التاريخ الإسلامي من العصر النبوي (610–632م) إلى العصر الحديث، مرورًا بالخلافة الراشدة والدولتين الأموية والعباسية والدولة العثمانية.",
    root: {
      id: "r-history",
  ...
  /* ═══ 17. الأسماء الحسنى ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تصنيف أسماء الله الحسنى التسعة والتسعين حسب معانيها: أسماء الجلال، والجمال، والرحمة، والقدرة، والعلم.",
    root: {
      id: "r-asma",
      label: "الأسماء الحسنى",
      children: [
  ...
  /* ═══ 18. مناسك الحج ═══ */
  {
    ...
    category: "الفقه والأحكام",
    description: "خطوات أداء الحج والعمرة بالترتيب الصحيح: أعمال العمرة، وأعمال الحج، وأنواع الحج، وشروط وجوبه.",
    root: {
      id: "r-hajj",
  ...
  /* ═══ 19. الصحابة الكرام ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "تصنيف الصحابة الكرام وأبرز فضائلهم وأدوارهم: العشرة المبشرون بالجنة، وأهل بدر، والمكثرون من الرواية، وعلماء الصحابة.",
    root: {
      id: "r-sahaba",
      label: "الصحابة الكرام",
      children: [
        ...
        },
        {
          ...
          children: [
            { id: "mk-1", label: "أبو هريرة — من أكثر الصحابة رواية" },
            { id: "mk-2", label: "عبد الله بن عمر — من المكثرين" },
            { id: "mk-3", label: "أنس بن مالك — صحبة ورواية" },
            { id: "mk-4", label: "عائشة أم المؤمنين — من أكثر النساء رواية" },
          ],
        },
        {
          id: "ahl-ilm",
  ...
  /* ═══ 20. مقاصد الشريعة ═══ */
  {
    ...
    category: "الدروس والمصادر",
    description: "الأهداف الكبرى لأحكام الشريعة وتصنيفاتها: تعريف المقاصد، والمقاصد الضرورية (الكليات الخمس)، والحاجية، والتحسينية، وكبار علماء المقاصد.",
    root: {
      id: "r-maqasid",
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { id: "mq-s1", label: "إمام الحرمين الجويني (ت 478هـ)" },
            { id: "mq-s2", label: "أبو حامد الغزالي (ت 505هـ)" },
            { id: "mq-s3", label: "إمام الشاطبي (ت 790هـ) — الموافقات" },
            { id: "mq-s4", label: "الطاهر بن عاشور (ت 1393هـ)" },
          ],
        },
      ],
    },
  ...
  /* ═══ 21. علم البلاغة ═══ */
  {
    ...
    category: "اللغة والبلاغة",
    description: "الفروع الثلاثة لعلم البلاغة: علم المعاني، وعلم البيان، وعلم البديع، مع مقدمة في البلاغة وأهم مراجعها.",
    root: {
      id: "r-balagha",
      label: "علم البلاغة",
      children: [
  ...
  /* ═══ 22. مراتب طلب العلم ═══ */
  {
    ...
    category: "التعلّم والأدوات",
    description: "ترتيب العلوم الشرعية وخطة الطالب في التلقي: مرحلة التأسيس، فالوسيط، فالمتقدم، مع آداب طلب العلم ومراجع منهجه.",
    root: {
      id: "r-maratib",
  ...
  /* ═══ 23. علم الكلام والمذاهب العقدية ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تاريخ المذاهب العقدية ومناهجها وأبرز قضاياها: أهل السنة والجماعة، والمعتزلة، والشيعة، والخوارج والمرجئة، مع المراجع الأساسية.",
    root: {
      id: "r-kalam",
