...
export const MIND_MAPS: MindMap[] = [
  /* ═══ 1. العقيدة الإسلامية ═══ */
  {
    ...
    description: "أصول الإيمان ومسائل العقيدة على منهج أهل السنة والجماعة وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-aqeeda",
  ...
  /* ═══ 2. الفقه الإسلامي ═══ */
  {
    ...
    description: "أقسام الفقه الإسلامي وأبوابه من الطهارة إلى المعاملات وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-fiqh",
  ...
  /* ═══ 7. طرق التعلم الإسلامي ═══ */
  {
    ...
    description: "المراحل والأولويات لطالب العلم الشرعي المبتدئ والمتوسط والمتقدم ويُستحسن رسمها بخط اليد لتثبيت الفهم.",
    root: {
      id: "r-learning",
  ...
  },
  {
    ...
    description: "فروع اللغة العربية وعلوم البيان والبلاغة وأهميتها في فهم القرآن وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-arabic",
  ...
  },
  {
    ...
    category: "القرآن الكريم",
    description: "طرق التفسير وأنواعه وقواعده وأبرز المفسرين في التاريخ الإسلامي ويُستحسن رسمها بخط اليد لتثبيت الفهم.",
    root: {
      id: "r-tafsir",
  ...
  },
  {
    ...
    category: "العبادة والأذكار",
    description: "مفهوم الزهد والرقائق وفضائل الأعمال القلبية في الإسلام وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-zuhd",
  ...
  /* ═══ 22. علم البلاغة ═══ */
  {
    ...
    category: "اللغة والبلاغة",
    description: "الفروع الثلاثة للبلاغة: المعاني والبيان والبديع وأبرز مسائلها والعمدة فيها التصور الصحيح قبل التفاصيل.",
    root: {
      id: "r-balagha",
      label: "علم البلاغة",
      children: [
  ...
  /* ═══ 23. مراتب طلب العلم ═══ */
  {
    ...
    category: "التعلّم والأدوات",
    description: "ترتيب العلوم الشرعية حسب الأهمية وخطة الطالب في التلقي وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-maratib",
  ...
  /* ═══ 23. علم الكلام والمذاهب العقدية ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تاريخ المذاهب العقدية الإسلامية ومناهجها وأبرز قضاياها وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده.",
    root: {
      id: "r-kalam",
