...
export const MIND_MAPS: MindMap[] = [
  ...
  /* ═══ 3. علوم القرآن ═══ */
  {
    ...
    description: "علوم القرآن من التجويد إلى التفسير والإعجاز وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-quran",
      label: "القرآن الكريم",
      children: [
  ...
  /* ═══ 6. السيرة النبوية ═══ */
  {
    ...
    description: "مراحل السيرة النبوية من المولد إلى الوفاة وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-seerah",
  ...
  },
  {
    ...
    category: "الفقه والأحكام",
    description: "أحكام المواريث وأسبابها وشروطها وطريقة حساب الأنصبة ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-faraid",
      label: "علم الفرائض",
      children: [
  ...
  },
  {
    ...
    title: "علم التجويد",
    category: "القرآن الكريم",
    description: "أحكام تجويد القرآن الكريم ومخارج الحروف وصفاتها مع الانتقال من الأصل إلى الفروع بروابط المنصة ويُستحسن رسمها بخط اليد لتثبيت الفهم. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-tajweed",
      label: "علم التجويد",
      children: [
  ...
  },
  {
    ...
    title: "مصطلح الحديث",
    category: "الحديث والسنة",
    description: "علوم الحديث ومصطلحاته وأنواع الأسانيد والرواة والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-mustalah",
      label: "مصطلح الحديث",
      children: [
