...
export const MIND_MAPS: MindMap[] = [
  ...
  /* ═══ 22. علم البلاغة ═══ */
  {
    ...
    category: "اللغة والبلاغة",
    description: "الفروع الثلاثة للبلاغة: المعاني والبيان والبديع وأبرز مسائلها والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ مع الانتقال من الأصل إلى الفروع بروابط المنصة",
    root: {
      id: "r-balagha",
      label: "علم البلاغة",
      children: [
