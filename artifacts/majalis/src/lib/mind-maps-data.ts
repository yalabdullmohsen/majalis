...
export const MIND_MAPS: MindMap[] = [
  /* ═══ 1. العقيدة الإسلامية ═══ */
  {
    ...
    description: "أصول الإيمان ومسائل العقيدة على منهج أهل السنة والجماعة وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-aqeeda",
  ...
  /* ═══ 2. الفقه الإسلامي ═══ */
  {
    ...
    description: "أقسام الفقه الإسلامي وأبوابه من الطهارة إلى المعاملات وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-fiqh",
  ...
  /* ═══ 5. العبادة والأذكار ═══ */
  {
    ...
    description: "منظومة العبادة اليومية من الصلاة إلى الأذكار والأدعية والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ مع الانتقال من الأصل إلى الفروع بروابط المنصة",
    root: {
      id: "r-ibadah",
  ...
  /* ═══ 7. طرق التعلم الإسلامي ═══ */
  {
    ...
    description: "المراحل والأولويات لطالب العلم الشرعي المبتدئ والمتوسط والمتقدم ويُستحسن رسمها بخط اليد لتثبيت الفهم مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-learning",
  ...
  },
  {
    ...
    category: "القرآن الكريم",
    description: "طرق التفسير وأنواعه وقواعده وأبرز المفسرين في التاريخ الإسلامي ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ مع الانتقال من الأصل إلى الفروع بروابط المنصة",
    root: {
      id: "r-tafsir",
  ...
  },
  {
    ...
    category: "العبادة والأذكار",
    description: "مفهوم الزهد والرقائق وفضائل الأعمال القلبية في الإسلام وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-zuhd",
  ...
  /* ═══ 17. التاريخ الإسلامي ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "حقب التاريخ الإسلامي من البعثة النبوية حتى العصر الحديث والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ مع الانتقال من الأصل إلى الفروع بروابط المنصة",
    root: {
      id: "r-history",
  ...
  /* ═══ 18. الأسماء الحسنى ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تصنيف أسماء الله الحسنى التسعة والتسعين حسب معانيها وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-asma",
      label: "الأسماء الحسنى",
      children: [
  ...
  /* ═══ 23. مراتب طلب العلم ═══ */
  {
    ...
    category: "التعلّم والأدوات",
    description: "ترتيب العلوم الشرعية حسب الأهمية وخطة الطالب في التلقي وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-maratib",
  ...
  /* ═══ 23. علم الكلام والمذاهب العقدية ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تاريخ المذاهب العقدية الإسلامية ومناهجها وأبرز قضاياها وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ مع الانتقال من الأصل إلى الفروع بروابط المنصة",
    root: {
      id: "r-kalam",
