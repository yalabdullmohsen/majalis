...
export const MIND_MAPS: MindMap[] = [
  /* ═══ 1. العقيدة الإسلامية ═══ */
  {
    ...
    description: "أصول الإيمان ومسائل العقيدة على منهج أهل السنة والجماعة وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-aqeeda",
  ...
  /* ═══ 2. الفقه الإسلامي ═══ */
  {
    ...
    description: "أقسام الفقه الإسلامي وأبوابه من الطهارة إلى المعاملات وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-fiqh",
  ...
  /* ═══ 3. علوم القرآن ═══ */
  {
    ...
    description: "علوم القرآن من التجويد إلى التفسير والإعجاز وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-quran",
      label: "القرآن الكريم",
      children: [
  ...
  /* ═══ 4. الحديث النبوي ═══ */
  {
    ...
    description: "منهج علماء الحديث في الرواية والدراية والتصنيف ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-hadith",
      label: "الحديث النبوي",
      children: [
  ...
  /* ═══ 5. العبادة والأذكار ═══ */
  {
    ...
    description: "منظومة العبادة اليومية من الصلاة إلى الأذكار والأدعية والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-ibadah",
  ...
  /* ═══ 6. السيرة النبوية ═══ */
  {
    ...
    description: "مراحل السيرة النبوية من المولد إلى الوفاة وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-seerah",
  ...
  /* ═══ 7. طرق التعلم الإسلامي ═══ */
  {
    ...
    description: "المراحل والأولويات لطالب العلم الشرعي المبتدئ والمتوسط والمتقدم ويُستحسن رسمها بخط اليد لتثبيت الفهم مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-learning",
  ...
  /* ═══ 8. الأخلاق والتزكية ═══ */
  {
    ...
    description: "منظومة الأخلاق الإسلامية وتزكية النفس والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-akhlaq",
  ...
  },
  {
    ...
    description: "فروع اللغة العربية وعلوم البيان والبلاغة وأهميتها في فهم القرآن وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة.",
    root: {
      id: "r-arabic",
  ...
  },
  {
    ...
    category: "القرآن الكريم",
    description: "طرق التفسير وأنواعه وقواعده وأبرز المفسرين في التاريخ الإسلامي ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-tafsir",
  ...
  },
  {
    ...
    category: "الفقه والأحكام",
    description: "أحكام المواريث وأسبابها وشروطها وطريقة حساب الأنصبة ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-faraid",
      label: "علم الفرائض",
      children: [
  ...
  },
  {
    ...
    category: "العبادة والأذكار",
    description: "مفهوم الزهد والرقائق وفضائل الأعمال القلبية في الإسلام وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-zuhd",
  ...
  },
  {
    ...
    title: "أصول الفقه",
    category: "الفقه والأحكام",
    description: "قواعد ومصادر الاستنباط الفقهي وطرق الاجتهاد ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-usul",
      label: "أصول الفقه",
      children: [
  ...
  },
  {
    ...
    title: "علم التجويد",
    category: "القرآن الكريم",
    description: "أحكام تجويد القرآن الكريم ومخارج الحروف وصفاتها مع الانتقال من الأصل إلى الفروع بروابط المنصة ويُستحسن رسمها بخط اليد لتثبيت الفهم. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-tajweed",
      label: "علم التجويد",
      children: [
  ...
  },
  {
    ...
    title: "مصطلح الحديث",
    category: "الحديث والسنة",
    description: "علوم الحديث ومصطلحاته وأنواع الأسانيد والرواة والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-mustalah",
      label: "مصطلح الحديث",
      children: [
  ...
  /* ═══ 17. التاريخ الإسلامي ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "حقب التاريخ الإسلامي من البعثة النبوية حتى العصر الحديث والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-history",
  ...
  /* ═══ 18. الأسماء الحسنى ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تصنيف أسماء الله الحسنى التسعة والتسعين حسب معانيها وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-asma",
      label: "الأسماء الحسنى",
      children: [
  ...
  /* ═══ 19. مناسك الحج ═══ */
  {
    ...
    category: "الفقه والأحكام",
    description: "خطوات أداء الحج والعمرة بالترتيب الصحيح والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-hajj",
  ...
  /* ═══ 20. الصحابة الكرام ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "تصنيف الصحابة الكرام وأبرز فضائلهم وأدوارهم ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-sahaba",
      label: "الصحابة الكرام",
      children: [
  ...
  /* ═══ 21. مقاصد الشريعة ═══ */
  {
    ...
    category: "الدروس والمكتبة",
    description: "الأهداف الكبرى لأحكام الشريعة الإسلامية وتصنيفاتها ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-maqasid",
  ...
  /* ═══ 22. علم البلاغة ═══ */
  {
    ...
    category: "اللغة والبلاغة",
    description: "الفروع الثلاثة للبلاغة: المعاني والبيان والبديع وأبرز مسائلها والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-balagha",
      label: "علم البلاغة",
      children: [
  ...
  /* ═══ 23. مراتب طلب العلم ═══ */
  {
    ...
    category: "التعلّم والأدوات",
    description: "ترتيب العلوم الشرعية حسب الأهمية وخطة الطالب في التلقي وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده مع الانتقال من الأصل إلى الفروع بروابط المنصة. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-maratib",
  ...
  /* ═══ 23. علم الكلام والمذاهب العقدية ═══ */
  {
    ...
    category: "العقيدة والتوحيد",
    description: "تاريخ المذاهب العقدية الإسلامية ومناهجها وأبرز قضاياها وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده",
    root: {
      id: "r-kalam",
