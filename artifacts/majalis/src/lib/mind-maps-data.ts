...
export const MIND_MAPS: MindMap[] = [
  ...
  /* ═══ 4. الحديث النبوي ═══ */
  {
    ...
    description: "منهج علماء الحديث في الرواية والدراية والتصنيف ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-hadith",
      label: "الحديث النبوي",
      children: [
  ...
  /* ═══ 8. الأخلاق والتزكية ═══ */
  {
    ...
    description: "منظومة الأخلاق الإسلامية وتزكية النفس والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-akhlaq",
  ...
  },
  {
    ...
    title: "أصول الفقه",
    category: "الفقه والأحكام",
    description: "قواعد ومصادر الاستنباط الفقهي وطرق الاجتهاد ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-usul",
      label: "أصول الفقه",
      children: [
  ...
  /* ═══ 19. مناسك الحج ═══ */
  {
    ...
    category: "الفقه والأحكام",
    description: "خطوات أداء الحج والعمرة بالترتيب الصحيح والعمدة فيها التصور الصحيح قبل التفاصيل وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-hajj",
  ...
  /* ═══ 20. الصحابة الكرام ═══ */
  {
    ...
    category: "السيرة والتاريخ",
    description: "تصنيف الصحابة الكرام وأبرز فضائلهم وأدوارهم ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-sahaba",
      label: "الصحابة الكرام",
      children: [
  ...
  /* ═══ 21. مقاصد الشريعة ═══ */
  {
    ...
    category: "الدروس والمكتبة",
    description: "الأهداف الكبرى لأحكام الشريعة الإسلامية وتصنيفاتها ويُستحسن رسمها بخط اليد لتثبيت الفهم والعمدة فيها التصور الصحيح قبل التفاصيل. وتُستخدم للمراجعة المنظمة لا للحفظ الأصم وحده؛ خريطة ذهنية لترتيب المفاهيم وتسهيل المراجعة",
    root: {
      id: "r-maqasid",
