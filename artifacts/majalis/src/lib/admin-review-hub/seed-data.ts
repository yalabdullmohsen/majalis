...
const CONTENT: ContentReviewItem[] = [
  {
    ...
    flaggedByAi: false,
    userId: "u-sch-12",
    userName: "د. عبدالرحمن الفقيه",
    category: "tafsir_edit",
    title: "تعديل تفسير آية الكرسي — مختصر ابن كثير",
    originalText:
      "هذه الآية أعظم آية في القرآن، وفيها إثبات الألوهية والقيومية لله تعالى.",
    editedText:
      "هذه الآية أعظم آية في كتاب الله، وفيها إثبات الألوهية والقيومية لله تعالى، وأنّه لا تأخذه سنة ولا نوم، وهو الحي الذي لا يموت.",
    submittedAt: "2026-07-28T07:30:00.000Z",
    notes: "إضافة توضيح من ابن كثير",
  },
  {
    id: "cnt-002",
    stream: "content",
