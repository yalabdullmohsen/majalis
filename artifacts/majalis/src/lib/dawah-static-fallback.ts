...
export const STATIC_NEW_MUSLIM_PATH: NewMuslimDay[] = [
  ...
  { id: "static-nm-14", day_number: 14, audience: "all", title: "مراجعة الأسبوعين", content_ar: "راجع تقدّمك: الصلاة، الأذكار، الأخلاق، الحلال. حدّد سؤالًا واحدًا تبحث عنه أو تسأل أهل العلم عنه. الأيام التالية تبني على هذا الأساس حتى اليوم الثلاثين.", content_en: null },
  { id: "static-nm-15", day_number: 15, audience: "all", title: "صلاة الجماعة والمسجد", content_ar: "إن تيسّر لك، صلِّ صلاة واحدة في المسجد مع الجماعة. المسجد مكان تعلّم ورفقة. إن لم تستطع، فحافظ على صلاتك في بيتك واسأل عن أقرب مسجد لاحقًا.", content_en: null },
  { id: "static-nm-16", day_number: 16, audience: "all", title: "الاستغفار والتوبة", content_ar: "تعلّم أن التوبة مفتوحة: استغفر الله مما تعلم، وانوِ ترك الذنب. قال تعالى: ﴿إن الله يحب التوابين﴾. لا تيأس من رحمة الله.", content_en: null },
  { id: "static-nm-17", day_number: 17, audience: "all", title: "بر الوالدين وصلة الرحم", content_ar: "إن كان والداك على قيد الحياة فأحسن إليهما بالكلام والزيارة. صلة الرحم صدقة وعبادة، ولو برسالة قصيرة.", content_en: null },
  { id: "static-nm-18", day_number: 18, audience: "all", title: "آداب الكلام", content_ar: "اجتنب الغيبة والكذب والسخرية. اختر كلمة طيبة اليوم في موقف صعب. اللسان ميزان الأخلاق.", content_en: null },
  { id: "static-nm-19", day_number: 19, audience: "all", title: "الوضوء والصلاة في السفر", content_ar: "تعرّف باختصار على التيمم عند فقد الماء، وقصر الصلاة للمسافر عند الحاجة. التفاصيل تُسأل عند أهل العلم عند وقوع الحاجة.", content_en: null },
  { id: "static-nm-20", day_number: 20, audience: "all", title: "حفظ أذكار النوم", content_ar: "قبل النوم: آية الكرسي، و«باسمك اللهم أموت وأحيا»، وثلاث قل هو الله أحد. الثبات على قليل خير من انقطاع الكثير.", content_en: null },
  { id: "static-nm-21", day_number: 21, audience: "all", title: "مراجعة الأسبوع الثالث", content_ar: "راجع: الجماعة، الاستغفار، بر الوالدين، آداب الكلام، أذكار النوم. اكتب ثلاثة أمور تحسّنت فيها.", content_en: null },
  { id: "static-nm-22", day_number: 22, audience: "all", title: "الزكاة والصدقة عمليًا", content_ar: "افهم الفرق بين الزكاة المفروضة والصدقة التطوعية. تصدّق ولو بالقليل اليوم. النية والإخلاص أهم من المقدار.", content_en: null },
  { id: "static-nm-23", day_number: 23, audience: "all", title: "الحج والعمرة — تصوّر عام", content_ar: "الحج ركن لمن استطاع. اقرأ مختصرًا عن أركانه دون الدخول في التفاصيل الفقهية الآن. المعرفة الموجزة تمهّد للمستقبل.", content_en: null },
  { id: "static-nm-24", day_number: 24, audience: "all", title: "الدعاء بأسماء الله", content_ar: "اختر ثلاثة أسماء من أسماء الله الحسنى وتأمّل معانيها: الرحمن، الغفور، الحكيم. ادعُ بها في سجودك.", content_en: null },
  { id: "static-nm-25", day_number: 25, audience: "all", title: "مجالس العلم والصحبة", content_ar: "اطلب رفيقًا صالحًا أو حلقة علم موثوقة. الصحبة تؤثر في الثبات أكثر من كثرة المعلومات وحدها.", content_en: null },
  { id: "static-nm-26", day_number: 26, audience: "all", title: "التعامل مع الشبهات", content_ar: "إن سمعت شبهة: لا تجادل بجهل. ارجع إلى مصدر موثوق أو صفحة الشبهات في المنصة. الشك العابر يُعالَج بالعلم لا بالإعراض.", content_en: null },
  { id: "static-nm-27", day_number: 27, audience: "all", title: "حقوق الجيران والناس", content_ar: "أحسن إلى جارك ولو بسلام. كفّ الأذى عبادة. الإسلام خُلق قبل أن يكون شعائر فقط.", content_en: null },
  { id: "static-nm-28", day_number: 28, audience: "all", title: "قراءة سورة قصيرة بفهم", content_ar: "اختر سورة الكافرون أو النصر واقرأ تفسيرًا موجزًا موثوقًا لمعانيها. الفهم مع التلاوة أنفع من الهذّ بلا تدبر.", content_en: null },
  { id: "static-nm-29", day_number: 29, audience: "all", title: "خطة الاستمرار بعد الشهر", content_ar: "ضع جدولًا بسيطًا بعد المسار: صلاة في وقتها، ورد يومي قصير، درس أسبوعي. الاستمرار أهم من الحماس المؤقت.", content_en: null },
  { id: "static-nm-30", day_number: 30, audience: "all", title: "خاتمة المسار والدعاء", content_ar: "احمد الله على الهداية. ادعُ بالثبات وحسن الخاتمة. المسار نهاية بداية لا نهاية علم؛ واصل السؤال والتعلم برفق.", content_en: null },
];
