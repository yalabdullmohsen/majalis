...
export const SERVICES_CENTER_GROUPS: ServicesCenterGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "hadith", label: "الأحاديث النبوية وعلوم الحديث", keywords: ["حديث", "سنة"], Icon: ScrollText, action: { kind: "link", href: "/hadith" } },
      ...
      { id: "scholars", label: "العلماء وكتبهم", keywords: ["علماء", "كتب"], Icon: Library, action: { kind: "link", href: "/scholars" } },
      { id: "glossary", label: "معجم المصطلحات", keywords: ["مصطلحات", "glossary"], Icon: BookMarked, action: { kind: "link", href: "/glossary" } },
    ],
  },
  {
    id: "tools",
