...
export const SERVICES_CENTER_GROUPS: ServicesCenterGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "universities", label: "دليل الجامعات الشرعية", keywords: ["جامعات", "كليات", "شرعية", "دراسة"], Icon: GraduationCap, action: { kind: "link", href: "/universities" } },
      { id: "academic-research", label: "رسائل الماجستير والدكتوراه", keywords: ["أبحاث", "رسائل", "ماجستير", "دكتوراه", "بحث"], Icon: FileText, action: { kind: "link", href: "/academic-research" } },
