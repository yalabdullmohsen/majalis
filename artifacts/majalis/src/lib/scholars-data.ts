...
export const SCHOLARS: Scholar[] = [
  ...
  },
  {
    ...
    era: "العلماء الكبار",
    specialty: ["حديث", "رجال"],
    bio: "حافظ الشام وإمام الجرح والتعديل في القرن الثامن، جمع «تهذيب الكمال في أسماء الرجال» على مدى سنوات طويلة، وهو من أتقن المصنفات في علم الرجال، وكان ابن تيمية يُثني عليه كثيراً",
...
/** مجموعة معرّفات العلماء الذين لهم صفحة ملف كامل — تُستخدم لمنع روابط ملفات مكسورة. */
export const SCHOLAR_PROFILE_IDS: ReadonlySet<string> = new Set(SCHOLARS.map(s => s.id));
