...
function RecCard({ item }: { item: RecommendedItem }) {
  ...
  return (
    <Link href={href} onClick={handleClick} className="block group">
      <div className="relative p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-emerald-400 dark:hover:border-emerald-600 hover:shadow-md transition-all duration-200 h-full">
        {/* شريط ملوَّن */}
        ...
        <div className="pr-2">
          ...
          {/* العنوان */}
          <p className="text-sm font-medium text-gray-800 dark:text-gray-100 leading-snug line-clamp-2 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
            {title}
          </p>
          ...
          {items.map((item) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-emerald-400 hover:shadow-sm transition-all group"
              >
                <span
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm text-gray-800 dark:text-gray-100 truncate group-hover:text-emerald-700 dark:group-hover:text-emerald-400">
                    {title}
                  </p>
                </div>
                <span
