...
import {
  ...
  Brain, Briefcase, Calendar, CalendarDays, CheckCircle, CloudRain,
  Circle, ClipboardList, Clock, Crown, Dog, DoorOpen, Droplets, Info,
  Image as ImageIcon, BarChart3, Volume2,
