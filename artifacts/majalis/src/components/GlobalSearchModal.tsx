...
const KIND_META: Record<string, { label: string; Icon: LucideIcon; color: string }> = {
  ...
  hadith:        { label: "حديث",      Icon: Scroll,        color: "#226A56" },
  ...
  ruling:        { label: "حكم",       Icon: FileText,      color: "#226A56" },
  ...
  course:        { label: "دورة",      Icon: GraduationCap, color: "#226A56" },
  ...
  topic:         { label: "موضوع",     Icon: Tag,           color: "#226A56" },
