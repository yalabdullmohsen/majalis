      ...
      landmarks.forEach((lm) => {
        ...
        marker.bindPopup(
          `<div dir="rtl" style="font-family:inherit;min-width:180px;">
            ...
            <span style="font-size: var(--text-caption);color:#6b7280;">${lm.city}، ${lm.country}</span>
            <br/><span style="font-size: var(--text-caption);color:var(--mj-brand);font-weight:700;">${lm.type} · ${lm.era}</span>
          </div>`
        );
