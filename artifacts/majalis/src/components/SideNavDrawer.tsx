...
import {
  ...
  Heart, HelpCircle, Home, Info, Landmark, Layers, Library, Lightbulb,
...
const DRAWER_GROUPS: NavGroup[] = [
  ...
  {
    id: "content", title: "الدروس والمكتبة", emoji: "🎓",
    items: [
      ...
      { href: "/adab-talab-ilm",   label: "آداب طالب العلم",      Icon: GraduationCap, desc: "منهج التعلم والطلب" },
      { href: "/fawaid",           label: "الفوائد العلمية",      Icon: Heart,         desc: "فوائد ومنقولات موثقة" },
      { href: "/islamic-glossary", label: "المصطلحات الإسلامية",  Icon: BookOpen,      desc: "معجم المصطلحات الفقهية" },
      { href: "/islam-stats",      label: "الإسلام في أرقام",     Icon: BarChart3,     desc: "إحصاءات وأرقام إسلامية" },
    ],
  },
  {
    id: "tools", title: "التعلّم والأدوات", emoji: "🛠️",
    items: [
      ...
      { href: "/learning-plan",        label: "خطة التعلّم",          Icon: BarChart2,  desc: "جدول التعلم الشخصي" },
      ...
      { href: "/about",                label: "عن التطبيق",          Icon: Info,       desc: "التطبيق وفريق العمل" },
    ],
  },
];
