...
const DRAWER_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learning-plan",label: "خطة التعلّم",     Icon: Waypoints },
      { href: "/learning-path",label: "خارطة طالب العلم", Icon: Globe },
      { href: "/my-learning",  label: "لوحتي التعليمية",  Icon: GraduationCap },
    ],
  },
  {
    id: "fiqh",
    ...
    items: [
      ...
      { href: "/rulings",            label: "الأحكام الشرعية",  Icon: BookText },
      { href: "/fiqh-council",       label: "المجمع الفقهي",    Icon: BookMarked },
      { href: "/miracles",           label: "الإعجاز العلمي",   Icon: Waypoints },
      ...
      { href: "/institutions",       label: "دليل المؤسسات",    Icon: Library },
    ],
  },
];
