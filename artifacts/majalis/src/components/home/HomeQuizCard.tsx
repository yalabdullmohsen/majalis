  ...
  return (
    <section className="ds-quiz-home-card" dir="rtl" aria-label="لعبة سين جيم – أسئلة وأجوبة"
      ...
      <svg aria-hidden="true" style={{
        ...
        <polygon points="60,5 75,40 112,40 82,62 95,97 60,75 25,97 38,62 8,40 45,40" fill="var(--mj-brand-deep)"/>
      </svg>
      <svg aria-hidden="true" style={{
        position: "absolute", bottom: "-15px", right: "-15px", opacity: 0.04, pointerEvents: "none",
      }} width="100" height="100" viewBox="0 0 100 100">
        <polygon points="50,5 63,37 97,37 71,57 81,89 50,68 19,89 29,57 3,37 37,37" fill="var(--mj-brand-deep)"/>
      </svg>
