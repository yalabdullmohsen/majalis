...
const PILLARS = [
  ...
  },
  {
    Icon: Users,
    title: "علماء متخصصون",
    desc: "أرشيف يضم 100 عالم من مختلف العصور والتخصصات",
  },
  {
    Icon: Scale,
      ...
      <div className="home-section-head">
        <div style={{ display: "flex", alignItems: "center", gap: "0.55rem" }}>
          <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20">
            <polygon points="10,1 13,7 20,7 15,12 17,19 10,15 3,19 5,12 0,7 7,7" fill="#1F4D3A"/>
            <polygon points="10,4 12.5,8.5 17.5,8.5 13.5,12 15,17 10,14 5,17 6.5,12 2.5,8.5 7.5,8.5" fill="#2d7a5a" opacity="0.5"/>
          </svg>
          <div>
        ...
        {PILLARS.map(({ Icon, title, desc }) => (
          <div key={title} style={{
            ...
            <svg aria-hidden="true" style={{
              ...
              <polygon points="30,3 40,20 57,20 45,33 50,50 30,41 10,50 15,33 3,20 20,20" fill="#1F4D3A"/>
            </svg>
            <span style={{
