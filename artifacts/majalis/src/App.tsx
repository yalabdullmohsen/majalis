...
const FiqhTopicPage = lazy(() => import("@/views/FiqhTopicPage"));
...
const HajjPage = lazy(() => import("@/views/HajjPage"));
...
const TafsirPage = lazy(() => import("@/views/TafsirPage"));
...
function Router() {
  return (
    <Switch>
      ...
      {/* الأسئلة التعليمية داخل لعبة سين جيم فقط — لا واجهة عامة مستقلة لـ /qa */}
      ...
      {/* عُطِّلت: البحوث العلمية كانت تُحوَّل إلى /qa؛ الوجهة الآن لعبة سين جيم. */}
      ...
      <Route path="/start-here"><Redirect to="/learning/paths" /></Route>
