...
- Name: 08-prayer-muezzins.spec.ts >> Prayer Times — مواقيت الصلاة >> prayer times shows qibla link or direction
- Location: tests/08-prayer-muezzins.spec.ts:22:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/prayer-times
Call log:
  - navigating to "http://localhost:5173/prayer-times", waiting until "load"
