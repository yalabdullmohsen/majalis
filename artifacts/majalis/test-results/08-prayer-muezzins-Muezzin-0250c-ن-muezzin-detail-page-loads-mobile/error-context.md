...
- Name: 08-prayer-muezzins.spec.ts >> Muezzins — المؤذنون >> muezzin detail page loads
- Location: tests/08-prayer-muezzins.spec.ts:93:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/muezzins/sudais
Call log:
  - navigating to "http://localhost:5173/muezzins/sudais", waiting until "load"
