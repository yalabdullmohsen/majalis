...
- Name: 13-new-features.spec.ts >> دليل الجامعات — /universities >> يفتح الصفحة بدون تسجيل دخول
- Location: tests/13-new-features.spec.ts:49:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/universities
Call log:
  - navigating to "http://localhost:5173/universities", waiting until "load"
