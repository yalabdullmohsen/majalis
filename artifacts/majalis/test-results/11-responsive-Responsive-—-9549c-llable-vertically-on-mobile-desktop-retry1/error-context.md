...
- Name: 11-responsive.spec.ts >> Responsive — التجاوب مع الشاشات >> quran page — surah list scrollable vertically on mobile
- Location: tests/11-responsive.spec.ts:46:3
