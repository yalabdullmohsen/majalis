...
- Name: 08-prayer-muezzins.spec.ts >> Muezzins — المؤذنون >> muezzin favorites page loads
- Location: tests/08-prayer-muezzins.spec.ts:100:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/muezzins/favorites
Call log:
  - navigating to "http://localhost:5173/muezzins/favorites", waiting until "load"
