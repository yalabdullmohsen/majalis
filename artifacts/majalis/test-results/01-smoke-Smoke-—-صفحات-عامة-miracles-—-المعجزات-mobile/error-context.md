...
- Name: 01-smoke.spec.ts >> Smoke — صفحات عامة >> [/miracles] — المعجزات
- Location: tests/01-smoke.spec.ts:41:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/miracles
Call log:
  - navigating to "http://localhost:5173/miracles", waiting until "domcontentloaded"
