...
- Name: 01-smoke.spec.ts >> Smoke — صفحات عامة >> [/topics] — الموضوعات
- Location: tests/01-smoke.spec.ts:41:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/topics
Call log:
  - navigating to "http://localhost:5173/topics", waiting until "domcontentloaded"
