...
- Name: 10-admin.spec.ts >> Admin — لوحة المشرف >> admin sub-routes are also protected
- Location: tests/10-admin.spec.ts:33:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/admin/lessons
Call log:
  - navigating to "http://localhost:5173/admin/lessons", waiting until "load"
