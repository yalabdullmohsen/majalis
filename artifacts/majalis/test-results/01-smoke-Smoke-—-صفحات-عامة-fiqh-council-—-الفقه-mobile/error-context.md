...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/fiqh-council
Call log:
  - navigating to "http://localhost:5173/fiqh-council", waiting until "domcontentloaded"
