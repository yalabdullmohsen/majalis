...
- Name: 08-prayer-muezzins.spec.ts >> Prayer Times — مواقيت الصلاة >> adhan settings page loads with toggle controls
- Location: tests/08-prayer-muezzins.spec.ts:38:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/adhan-settings
Call log:
  - navigating to "http://localhost:5173/adhan-settings", waiting until "load"
