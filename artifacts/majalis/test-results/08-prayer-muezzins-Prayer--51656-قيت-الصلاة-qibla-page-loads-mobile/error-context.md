...
- Name: 08-prayer-muezzins.spec.ts >> Prayer Times — مواقيت الصلاة >> qibla page loads
- Location: tests/08-prayer-muezzins.spec.ts:31:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/qibla
Call log:
  - navigating to "http://localhost:5173/qibla", waiting until "load"
