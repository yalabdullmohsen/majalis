...
- Name: 09-lessons-library.spec.ts >> Library — المكتبة >> library page loads with books
- Location: tests/09-lessons-library.spec.ts:48:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/library
Call log:
  - navigating to "http://localhost:5173/library", waiting until "load"
