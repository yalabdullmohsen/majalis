...
- Name: 04-search.spec.ts >> Search — البحث >> search query via URL shows results or empty state
- Location: tests/04-search.spec.ts:14:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/search/%D8%B5%D9%84%D8%A7%D8%A9
Call log:
  - navigating to "http://localhost:5173/search/%D8%B5%D9%84%D8%A7%D8%A9", waiting until "load"
