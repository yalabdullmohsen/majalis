...
- Name: 13-new-features.spec.ts >> دليل الجامعات — /universities >> صفحة المقارنة تفتح بدون خطأ
- Location: tests/13-new-features.spec.ts:64:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/universities/compare
Call log:
  - navigating to "http://localhost:5173/universities/compare", waiting until "load"
