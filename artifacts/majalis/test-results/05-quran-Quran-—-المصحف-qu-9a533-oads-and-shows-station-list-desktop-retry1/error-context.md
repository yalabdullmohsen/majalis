...
- Name: 05-quran.spec.ts >> Quran — المصحف >> quran radio page loads and shows station list
- Location: tests/05-quran.spec.ts:42:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/quran-radio
Call log:
  - navigating to "http://localhost:5173/quran-radio", waiting until "load"
