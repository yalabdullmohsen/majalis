...
- Name: 07-adhkar-tasbih.spec.ts >> Tasbih — التسبيح >> clicking main area increments counter
- Location: tests/07-adhkar-tasbih.spec.ts:62:3
...
Call log:
  - navigating to "http://localhost:5173/tasbih", waiting until "load"
