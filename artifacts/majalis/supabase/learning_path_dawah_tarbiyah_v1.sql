...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM courses WHERE slug = 'dawah-raheeq') THEN
    ...
    INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
      (gen_random_uuid(), v_i1, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'مرحلة الدعوة السرية', 'حائز جائزة رابطة العالم الإسلامي الأولى في السيرة — موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة'),
      (gen_random_uuid(), v_i2, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'مرحلة الجهر بالدعوة', 'حائز جائزة رابطة العالم الإسلامي الأولى في السيرة — موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة');
    ...
    BEGIN
      ...
      INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
        (gen_random_uuid(), v_i3, 'السيرة النبوية', 'ابن هشام الحميري', 'أساسية إلزامية', 'دعوة القبائل وبيعتا العقبة', 'أشهر كتب السيرة النبوية على الإطلاق — موجود في مكتبة المنصة (/library/book-seerah-ibn-hisham)', 'مكتبة سُنّة'),
        (gen_random_uuid(), v_i4, 'السيرة النبوية', 'ابن هشام الحميري', 'أساسية إلزامية', 'الهجرة إلى المدينة', 'أشهر كتب السيرة النبوية على الإطلاق — موجود في مكتبة المنصة (/library/book-seerah-ibn-hisham)', 'مكتبة سُنّة');
    END;
    ...
    BEGIN
      ...
      INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
        (gen_random_uuid(), v_i5, 'زاد المعاد', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'هدي النبي ﷺ في الدعوة', 'طب نبوي شامل في السيرة والفقه والآداب والدعوة — موجود في مكتبة المنصة (/library/book-zad)', 'مكتبة سُنّة');
    END;
  ...
  IF NOT EXISTS (SELECT 1 FROM courses WHERE slug = 'tarbiyah-muhlikat') THEN
    ...
    INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
      (gen_random_uuid(), v_i1, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المهلكات — كتاب ذم الغضب', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة سُنّة'),
      (gen_random_uuid(), v_i2, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المهلكات — كتاب ذم الشح', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة سُنّة');
    ...
    BEGIN
      ...
      INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
        (gen_random_uuid(), v_i3b, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المنجيات — كتاب الصبر والشكر', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة سُنّة'),
        (gen_random_uuid(), v_i4b, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المنجيات — كتابا التوبة والخوف', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة سُنّة');
    END;
    ...
    BEGIN
      ...
      INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
        (gen_random_uuid(), v_i5b, 'مدارج السالكين بين منازل إياك نعبد وإياك نستعين', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'منزلة الرضا (فصل مستقل، غير مستخدَم في مسار adab)', 'شرح موسّع لمنازل السائرين للهروي — موجود في مكتبة المنصة (/library/book-madarij)', 'مكتبة سُنّة'),
        (gen_random_uuid(), v_i6b, 'مدارج السالكين بين منازل إياك نعبد وإياك نستعين', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'منزلة الشكر (فصل مستقل، غير مستخدَم في مسار adab)', 'شرح موسّع لمنازل السائرين للهروي — موجود في مكتبة المنصة (/library/book-madarij)', 'مكتبة سُنّة');
    END;
