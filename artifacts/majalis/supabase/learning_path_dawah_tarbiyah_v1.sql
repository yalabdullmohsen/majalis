...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM courses WHERE slug = 'tarbiyah-muhlikat') THEN
    ...
    INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
      (gen_random_uuid(), v_i1, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المهلكات — كتاب ذم الغضب', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة المجلس العلمي'),
      (gen_random_uuid(), v_i2, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المهلكات — كتاب ذم الشح', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة المجلس العلمي');
    ...
    BEGIN
      ...
      INSERT INTO course_books (id, learning_item_id, book_title, book_author, material_role, scope_description, inclusion_reason, source_name) VALUES
        (gen_random_uuid(), v_i3b, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المنجيات — كتاب الصبر والشكر', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة المجلس العلمي'),
        (gen_random_uuid(), v_i4b, 'إحياء علوم الدين', 'أبو حامد الغزالي', 'أساسية إلزامية', 'ربع المنجيات — كتابا التوبة والخوف', 'موسوعة في تزكية النفس تُعدّ من أجمع الكتب في هذا الميدان — موجود في مكتبة المنصة (/library/book-ihya)', 'مكتبة المجلس العلمي');
    END;
