...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'التبيان في آداب حملة القرآن', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'الباب الأول', 'المتن التأسيسي القياسي في آداب حامل القرآن، عشرة أبواب — موجود في مكتبة المنصة (/library/book-tibyan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'التبيان في آداب حملة القرآن', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'الباب الخامس', 'المتن التأسيسي القياسي في آداب حامل القرآن — موجود في مكتبة المنصة (/library/book-tibyan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'التبيان في آداب حملة القرآن', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'الباب السادس (معظم الكتاب)', 'المتن التأسيسي القياسي في آداب حامل القرآن — موجود في مكتبة المنصة (/library/book-tibyan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'الإتقان في علوم القرآن', 'الإمام جلال الدين السيوطي', 'أساسية إلزامية', 'من الأنواع الثمانين — نوع المكي والمدني', 'أشمل الكتب التقليدية في علوم القرآن وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-itqan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i5, 'الإتقان في علوم القرآن', 'الإمام جلال الدين السيوطي', 'أساسية إلزامية', 'من الأنواع الثمانين — نوع أسباب النزول', 'أشمل الكتب التقليدية في علوم القرآن وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-itqan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i6, 'الإتقان في علوم القرآن', 'الإمام جلال الدين السيوطي', 'أساسية إلزامية', 'من الأنواع الثمانين — نوع الناسخ والمنسوخ', 'أشمل الكتب التقليدية في علوم القرآن وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-itqan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i7, 'الإتقان في علوم القرآن', 'الإمام جلال الدين السيوطي', 'أساسية إلزامية', 'من الأنواع الثمانين — نوع جمع القرآن', 'أشمل الكتب التقليدية في علوم القرآن وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-itqan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i8, 'مناهل العرفان في علوم القرآن', 'الشيخ محمد عبد العظيم الزرقاني', 'مادة مساندة', 'مبحث القراءات والقراء', 'معالجة منهجية حديثة وشاملة، من أهم ما كُتب في هذا الموضوع — موجود في مكتبة المنصة (/library/book-manahil-al-irfan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i9, 'البرهان في علوم القرآن', 'الإمام بدر الدين الزركشي', 'مادة مساندة', 'من الأنواع السبعة والأربعين — نوع إعجاز القرآن', 'من أجمع الكتب التي صُنِّفت في علوم القرآن، جمع فيه الزركشي ما كان مفرَّقاً في مصنفات مستقلة — موجود في مكتبة المنصة (/library/book-burhan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i10, 'البرهان في علوم القرآن', 'الإمام بدر الدين الزركشي', 'مادة مساندة', 'من الأنواع السبعة والأربعين — نوع علم المتشابه', 'من أجمع الكتب التي صُنِّفت في علوم القرآن — موجود في مكتبة المنصة (/library/book-burhan)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i11, 'مناهل العرفان في علوم القرآن', 'الشيخ محمد عبد العظيم الزرقاني', 'مادة مساندة', 'مبحث كتابة القرآن ورسمه', 'معالجة منهجية حديثة وشاملة — موجود في مكتبة المنصة (/library/book-manahil-al-irfan)', 'مكتبة سُنّة');
