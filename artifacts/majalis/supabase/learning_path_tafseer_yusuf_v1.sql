...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'تفسير ابن كثير', 'الإمام ابن كثير', 'أساسية إلزامية', 'تفسير سورة يوسف — الآيات 1 إلى 18 (الرؤيا وحسد الإخوة)', 'التفسير الأشهر في السرد القصصي، أنسب لسورة يوسف ذات البناء القصصي المتصل. موجود في مكتبة المنصة (/library/book-tafsir-ibnkathir)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'تفسير ابن كثير', 'الإمام ابن كثير', 'أساسية إلزامية', 'تفسير سورة يوسف — الآيات 21 إلى 34 (فتنة امرأة العزيز)', 'موجود في مكتبة المنصة (/library/book-tafsir-ibnkathir)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'تفسير ابن كثير', 'الإمام ابن كثير', 'أساسية إلزامية', 'تفسير سورة يوسف — الآيات 35 إلى 57 (السجن وتأويل الرؤى)', 'موجود في مكتبة المنصة (/library/book-tafsir-ibnkathir)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'تفسير ابن كثير', 'الإمام ابن كثير', 'أساسية إلزامية', 'تفسير سورة يوسف — الآيات 88 إلى 101 (اللقاء والعفو)', 'موجود في مكتبة المنصة (/library/book-tafsir-ibnkathir)', 'مكتبة سُنّة');
