...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'مقدمة ابن الصلاح في علوم الحديث', 'ابن الصلاح الشهرزوري', 'أساسية إلزامية', 'النوع الأول: معرفة الصحيح من الحديث', 'الأصل الذي بُنيت عليه أغلب المتون اللاحقة في مصطلح الحديث (منها نخبة الفكر ذاتها)، 65 نوعاً — موجود في مكتبة المنصة (/library/book-muqaddimah-ibn-salah)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'مقدمة ابن الصلاح في علوم الحديث', 'ابن الصلاح الشهرزوري', 'أساسية إلزامية', 'النوع الثاني: معرفة الحسن من الحديث', 'الأصل الذي بُنيت عليه أغلب المتون اللاحقة في مصطلح الحديث — موجود في مكتبة المنصة (/library/book-muqaddimah-ibn-salah)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'مقدمة ابن الصلاح في علوم الحديث', 'ابن الصلاح الشهرزوري', 'أساسية إلزامية', 'النوع الثالث: معرفة الضعيف من الحديث', 'الأصل الذي بُنيت عليه أغلب المتون اللاحقة في مصطلح الحديث — موجود في مكتبة المنصة (/library/book-muqaddimah-ibn-salah)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'مقدمة ابن الصلاح في علوم الحديث', 'ابن الصلاح الشهرزوري', 'أساسية إلزامية', 'النوع الرابع والخامس: المتواتر والآحاد', 'الأصل الذي بُنيت عليه أغلب المتون اللاحقة في مصطلح الحديث — موجود في مكتبة المنصة (/library/book-muqaddimah-ibn-salah)', 'مكتبة سُنّة');
