...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'فصل غزوة بدر الكبرى', 'حائز جائزة رابطة العالم الإسلامي الأولى في السيرة النبوية، أسلوب سلس محقق. موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'فصل غزوة أحد', 'موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'فصل غزوة الأحزاب', 'موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'الرحيق المختوم', 'الشيخ صفي الرحمن المباركفوري', 'أساسية إلزامية', 'فصل غزوة فتح مكة', 'موجود في مكتبة المنصة (/library/book-raheeq)', 'مكتبة سُنّة');
