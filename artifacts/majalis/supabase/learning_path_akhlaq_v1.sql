...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'تهذيب الأخلاق', 'أبو علي أحمد بن محمد بن يعقوب مسكويه', 'أساسية إلزامية', 'مبحث النفس والخُلُق', 'أول من نظّم علم الأخلاق الإسلامي في إطار فلسفي متكامل — موجود في مكتبة المنصة (/library/book-tahdhib-al-akhlaq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'تهذيب الأخلاق', 'أبو علي أحمد بن محمد بن يعقوب مسكويه', 'أساسية إلزامية', 'مبحث الفضائل', 'أول من نظّم علم الأخلاق الإسلامي في إطار فلسفي متكامل — موجود في مكتبة المنصة (/library/book-tahdhib-al-akhlaq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'تهذيب الأخلاق', 'أبو علي أحمد بن محمد بن يعقوب مسكويه', 'أساسية إلزامية', 'مبحث المحبة والصداقة', 'أول من نظّم علم الأخلاق الإسلامي في إطار فلسفي متكامل — موجود في مكتبة المنصة (/library/book-tahdhib-al-akhlaq)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'رياض الصالحين', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'باب الإخلاص وإحضار النية (الباب الأول)', 'أشهر مجموع حديثي في الأخلاق والآداب وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-riyadh)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i5, 'رياض الصالحين', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'باب الصبر', 'أشهر مجموع حديثي في الأخلاق والآداب وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-riyadh)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i6, 'رياض الصالحين', 'الإمام يحيى بن شرف النووي', 'أساسية إلزامية', 'باب الصدق', 'أشهر مجموع حديثي في الأخلاق والآداب وأكثرها تداولاً — موجود في مكتبة المنصة (/library/book-riyadh)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i7, 'أدب الدنيا والدين', 'أبو الحسن علي بن محمد الماوردي', 'مادة مساندة', 'الباب الأول: فضل العقل وذم الهوى', 'أوسع كتاب جمع آيات القرآن والحديث وحكم الحكماء في التوازن بين الدين والدنيا — موجود في مكتبة المنصة (/library/book-adab-dunya-din)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i8, 'أدب الدنيا والدين', 'أبو الحسن علي بن محمد الماوردي', 'مادة مساندة', 'الباب الثاني: أدب العلم', 'أوسع كتاب جمع آيات القرآن والحديث وحكم الحكماء في التوازن بين الدين والدنيا — موجود في مكتبة المنصة (/library/book-adab-dunya-din)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i9, 'أدب الدنيا والدين', 'أبو الحسن علي بن محمد الماوردي', 'مادة مساندة', 'الباب الثالث: أدب الدين', 'أوسع كتاب جمع آيات القرآن والحديث وحكم الحكماء في التوازن بين الدين والدنيا — موجود في مكتبة المنصة (/library/book-adab-dunya-din)', 'مكتبة سُنّة');
