...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'العقيدة الواسطية', 'شيخ الإسلام ابن تيمية', 'أساسية إلزامية', 'مبحث توحيد الربوبية', 'النص الذي يُنظِّم أقسام التوحيد الثلاثة نظرياً بوضوح منهجي، بخلاف كتاب التوحيد المنظَّم بأبواب النواقض العملية — لا تكرار محتوى، غرض تعليمي مختلف. موجود في مكتبة المنصة (/library/book-wasitiyyah)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'العقيدة الواسطية', 'شيخ الإسلام ابن تيمية', 'أساسية إلزامية', 'مبحث توحيد الألوهية', 'موجود في مكتبة المنصة (/library/book-wasitiyyah)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'العقيدة الواسطية', 'شيخ الإسلام ابن تيمية', 'أساسية إلزامية', 'مبحث توحيد الأسماء والصفات', 'موجود في مكتبة المنصة (/library/book-wasitiyyah)', 'مكتبة سُنّة');
