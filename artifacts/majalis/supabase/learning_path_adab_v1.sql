...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_i1, 'الأدب المفرد', 'الإمام محمد بن إسماعيل البخاري', 'أساسية إلزامية', 'أبواب بر الوالدين (من الباب الأول)', 'مجموع حديثي مخصَّص للآداب الموقفية التفصيلية بخلاف مسار الأخلاق العام — موجود في مكتبة المنصة (/library/book-adab-al-mufrad)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i2, 'الأدب المفرد', 'الإمام محمد بن إسماعيل البخاري', 'أساسية إلزامية', 'أبواب حق الجار (نحو 15 باباً)', 'مجموع حديثي مخصَّص للآداب الموقفية التفصيلية — موجود في مكتبة المنصة (/library/book-adab-al-mufrad)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i3, 'الأدب المفرد', 'الإمام محمد بن إسماعيل البخاري', 'أساسية إلزامية', 'أبواب إكرام الضيف (نحو 9 أبواب)', 'مجموع حديثي مخصَّص للآداب الموقفية التفصيلية — موجود في مكتبة المنصة (/library/book-adab-al-mufrad)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i4, 'الأدب المفرد', 'الإمام محمد بن إسماعيل البخاري', 'أساسية إلزامية', 'قسم آداب السلام (يفتتحه باب بدء السلام)', 'مجموع حديثي مخصَّص للآداب الموقفية التفصيلية — موجود في مكتبة المنصة (/library/book-adab-al-mufrad)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i5, 'مدارج السالكين بين منازل إياك نعبد وإياك نستعين', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'منزلة التوبة', 'شرح موسّع لمنازل السائرين للهروي، غير مستخدَم في مسار الأخلاق — موجود في مكتبة المنصة (/library/book-madarij)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i6, 'مدارج السالكين بين منازل إياك نعبد وإياك نستعين', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'منزلة الإخلاص', 'شرح موسّع لمنازل السائرين للهروي — موجود في مكتبة المنصة (/library/book-madarij)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_i7, 'مدارج السالكين بين منازل إياك نعبد وإياك نستعين', 'الإمام ابن قيم الجوزية', 'مادة مساندة', 'منزلة الصبر', 'شرح موسّع لمنازل السائرين للهروي — موجود في مكتبة المنصة (/library/book-madarij)', 'مكتبة سُنّة');
