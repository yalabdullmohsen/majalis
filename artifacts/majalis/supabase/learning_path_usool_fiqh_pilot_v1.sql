...
BEGIN
  ...
  VALUES
    (gen_random_uuid(), v_item1_id, 'الورقات في أصول الفقه', 'إمام الحرمين أبو المعالي الجويني', 'أساسية إلزامية',
     'المقدمة وتعريف أصول الفقه', 'المتن التأسيسي القياسي في المعاهد الشرعية لهذا العلم — موجود في مكتبة المنصة (/library/book-waraqat)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_item2_id, 'الورقات في أصول الفقه', 'إمام الحرمين أبو المعالي الجويني', 'أساسية إلزامية',
     'باب الأحكام', 'المتن التأسيسي القياسي في المعاهد الشرعية لهذا العلم — موجود في مكتبة المنصة (/library/book-waraqat)', 'مكتبة سُنّة'),
    (gen_random_uuid(), v_item3_id, 'الورقات في أصول الفقه', 'إمام الحرمين أبو المعالي الجويني', 'أساسية إلزامية',
     'بابا الكتاب والسنة', 'المتن التأسيسي القياسي في المعاهد الشرعية لهذا العلم — موجود في مكتبة المنصة (/library/book-waraqat)', 'مكتبة سُنّة');
