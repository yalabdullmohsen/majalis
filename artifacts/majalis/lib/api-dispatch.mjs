...
const rumRateLimit = createRateLimiter({
  windowMs: 60_000,
  max: 30,
  keyPrefix: "rum",
});
...
export const API_ROUTES = [
  ...
  { prefix: "/api/internal/status", module: "./api-handlers/internal/status.js", allowGet: true, exact: true },
  ...
  { prefix: "/api/client-error-log", module: "./api-handlers/client-error-log.js", allowGet: false, rateLimit: clientErrorLogRateLimit },
  { prefix: "/api/client-error", module: "./api-handlers/client-error-log.js", allowGet: false, exact: true, rateLimit: clientErrorLogRateLimit },
  { prefix: "/api/rum", module: "./rum-http.mjs", allowGet: true, exact: true, rateLimit: rumRateLimit },
  { prefix: "/api/web-vitals", module: "./rum-http.mjs", allowGet: true, exact: true, rateLimit: rumRateLimit },
