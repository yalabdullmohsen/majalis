...
export const API_ROUTES = [
  ...
  { prefix: "/api/cron/tkn-retry-queue", module: "./api-handlers/cron/trusted-knowledge-network.js", allowGet: true, exact: true },
  { prefix: "/api/cron/tkn-health", module: "./api-handlers/cron/trusted-knowledge-network.js", allowGet: true, exact: true },
  { prefix: "/api/cron/tkn-fetch", module: "./api-handlers/cron/trusted-knowledge-network.js", allowGet: true, exact: true },
