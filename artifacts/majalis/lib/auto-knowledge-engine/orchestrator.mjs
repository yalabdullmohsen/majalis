...
async function processConnector(admin, connectorConfig, runId, existingItems, options) {
  ...
  try {
    ...
    for (const item of allItems) {
      ...
      if (gate.confidenceAction === "reject" || gate.confidenceDecision?.action === "reject") {
        noteRejection(gate.confidenceDecision?.reason || "confidence_reject", { ...item, stage: "confidence", gate });
        continue;
      }
