...
export const ISLAMIC_QUERY_PATTERNS = [
  /(?:^|[\s،.!?])حكم(?:\s|$|[\s،.!?])/u,
  /ما (حكم|فضل|معنى|دليل)/u,
  /هل (يجوز|يحرم|واجب|فرض|صحيح)/u,
  /(حديث|آية|سورة|قرآن|سنة|فقه|تفسير|عقيدة|توحيد|صلاة|زكاة|صيام|حج|وضوء|ذكر|دعاء|أذكار)/u,
  /(شيخ|عالم|مفتي|فقيه|محدث)/u,
  /(فتوى|فتاوى|مسألة|حكم شرعي)/u,
  /(كتاب|تفسير|صحيح|سنن|مسند)/u,
];
