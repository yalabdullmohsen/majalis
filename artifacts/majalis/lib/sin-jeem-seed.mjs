...
export const CATEGORY_SEED = [
  ...
  { slug: "zakat", name_ar: "الزكاة", icon: "💰", parent_slug: "fiqh", sort_order: 74 },
  { slug: "hajj", name_ar: "الحج", icon: "🕋", parent_slug: "fiqh", sort_order: 75 },
  { slug: "hijra", name_ar: "الهجرة", icon: "🐪", parent_slug: "seera", sort_order: 42 },
  { slug: "tawheed", name_ar: "التوحيد", icon: "1️⃣", parent_slug: "aqeeda", sort_order: 21 },
  { slug: "names-attributes", name_ar: "الأسماء والصفات", icon: "🏷️", parent_slug: "aqeeda", sort_order: 22 },
  { slug: "akhlaq", name_ar: "الأخلاق", icon: "💎", sort_order: 110 },
