...
export const FOUNDER_EXTENDED_ANSWER =
  "منصة سُنّة هي مشروع شخصي أسسه يوسف عبدالمحسن يوسف المطيري بهدف جمع الدروس والمحاضرات والدورات الشرعية والقرآن الكريم والفقه والحديث والأذكار والفوائد والأسئلة الشرعية في منصة رقمية واحدة، مع التركيز على سهولة الوصول إلى المحتوى العلمي الموثوق وجودة تجربة المستخدم.";
