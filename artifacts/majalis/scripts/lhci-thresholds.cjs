...
const FIXED_PREVIEW = {
  /*
   * main CI 2026-08-30 قاسَ ≈1315–1650 تحت throttling؛ 1300 ثم 1800 صارا يفشلان متذبذبًا.
   * CI 2026-09-10 على `/` (home mobile): أفضل جولة ≈1828–1996 > 1800 — هامش خفيف دون إرخاء كبير.
   */
  tbtMs: 2100,
  /*
   ...
   * لا تُرفع إلى 0.15 — lhci-budget-gate وmain يثبتان 0.14.
   */
  cls: 0.14,
  domSize: 1200,
