#!/usr/bin/env node
/**
 * Round 103 seed raises — fawaid-seed ≥295, asma meaning≥190 benefit≥300, glossary ≥310, library ≥340, sins ≥400.
...
const ASMA_MEANING_MIN = 290;
const ASMA_BENEFIT_MIN = 400;
const FAWAID_SEED_MIN = 395;
const GLOSSARY_MIN = 410;
const LIBRARY_DESC_MIN = 440;
const SINS_EXPL_MIN = 500;
