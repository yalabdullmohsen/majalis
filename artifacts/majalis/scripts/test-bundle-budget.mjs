...
/** سقف 120KiB + هامش 320B: تباين gzip بين المنصات عند سقف الإقلاع الضيّق */
const INITIAL_JS_GZIP_BUDGET = 120 * 1024 + 320;
...
console.log(`  ✓ Initial JS gzip ≤ ${120} KiB (+${320}B zlib slack)`);
