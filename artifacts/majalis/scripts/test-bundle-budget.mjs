 ...
 *
 * Budgets (إحكام 2026-08-26 بعد lazy للكروم الثانوي):
 * - Entry JS gzip ≤ 120 KiB (كان 164؛ فعلي ~102 بعد تأجيل الشيتات/الحركة/البنرات)
...
/** سقف 120KiB + هامش 256B: تباين gzip بين المنصات + كروم مشترك لتجربة المعرفة عند الحدّ */
const INITIAL_JS_GZIP_BUDGET = 120 * 1024 + 256;
...
console.log(`  ✓ Initial JS gzip ≤ ${120} KiB (+${256}B zlib/knowledge slack)`);
