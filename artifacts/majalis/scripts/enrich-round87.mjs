#!/usr/bin/env node
/**
 * Round 87 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 500;
const NATIONS_MIN = 500;
const UPDATE_SUMMARY_MIN = 320;
const QURAN_CIRCLE_MIN = 350;
const MUTA_MIN = 350;
const MIND_MAP_MIN = 360;
const AMR_EXPL_MIN = 360;
