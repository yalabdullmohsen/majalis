#!/usr/bin/env node
/**
 * Round 89 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 510;
const NATIONS_MIN = 510;
const UPDATE_SUMMARY_MIN = 330;
const QURAN_CIRCLE_MIN = 360;
const MUTA_MIN = 360;
const MIND_MAP_MIN = 370;
const AMR_EXPL_MIN = 370;
