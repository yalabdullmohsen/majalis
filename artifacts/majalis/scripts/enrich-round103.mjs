#!/usr/bin/env node
/**
 * Round 103 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 570;
const NATIONS_MIN = 570;
const UPDATE_SUMMARY_MIN = 390;
const QURAN_CIRCLE_MIN = 420;
const MUTA_MIN = 420;
const MIND_MAP_MIN = 430;
const AMR_EXPL_MIN = 430;
