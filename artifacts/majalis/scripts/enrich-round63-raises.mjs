#!/usr/bin/env node
/**
 * Round 63 — fawaid-seed ≥225, asma meaning≥155 benefit≥230, glossary ≥240, library ≥270, sins ≥320.
 * Usage: node scripts/enrich-round63-raises.mjs [--apply] [--verify]
 */
...
const ASMA_MEANING_MIN = 155;
const ASMA_BENEFIT_MIN = 230;
const FAWAID_SEED_MIN = 225;
const GLOSSARY_MIN = 240;
const LIBRARY_DESC_MIN = 270;
const SINS_EXPL_MIN = 320;
