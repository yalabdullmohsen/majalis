#!/usr/bin/env node
/**
 * Round 71 — fawaid-seed ≥265, asma meaning≥175 benefit≥270, glossary ≥280, library ≥310, sins ≥360.
 * Usage: node scripts/enrich-round71-raises.mjs [--apply] [--verify]
 */
...
const ASMA_MEANING_MIN = 175;
const ASMA_BENEFIT_MIN = 270;
const FAWAID_SEED_MIN = 265;
const GLOSSARY_MIN = 280;
const LIBRARY_DESC_MIN = 310;
const SINS_EXPL_MIN = 360;
