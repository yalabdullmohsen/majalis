#!/usr/bin/env node
/**
 * Round 99 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 560;
const NATIONS_MIN = 560;
const UPDATE_SUMMARY_MIN = 380;
const QURAN_CIRCLE_MIN = 410;
const MUTA_MIN = 410;
const MIND_MAP_MIN = 420;
const AMR_EXPL_MIN = 420;
