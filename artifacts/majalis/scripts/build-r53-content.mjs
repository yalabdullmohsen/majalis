...
const OUT = path.join(__dirname, "r53-content-data.mjs");
...
const qaPicked = pickQa(existingQa, 40, 750);
const fawaidPicked = pickFawaid(curated, 25, 140);
