#!/usr/bin/env node
/**
 * Round 93 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 530;
const NATIONS_MIN = 530;
const UPDATE_SUMMARY_MIN = 350;
const QURAN_CIRCLE_MIN = 380;
const MUTA_MIN = 380;
const MIND_MAP_MIN = 390;
const AMR_EXPL_MIN = 390;
