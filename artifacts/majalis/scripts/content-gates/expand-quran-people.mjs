...
function expandBody(item, evs) {
  ...
  const sections = [
    `## التعريف\n${name} من الذين ذُكروا في القرآن ضمن فئة «${cat}». يُعرض هنا ما دلّ عليه النص أولاً، مع ضابط: لا تُبنى عقيدة على خبر لم يثبت، ولا يُجزم بما سكت عنه الوحي. منهج سُنّة: المصحف المحلي ثم فهم السلف عبر تفاسير الطبري وابن كثير والبغوي والسعدي، وترك الإسرائيليات المخالفة.`,
