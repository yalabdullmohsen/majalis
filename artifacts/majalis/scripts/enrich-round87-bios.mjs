#!/usr/bin/env node
/**
 * Round 87 bios-only — scholars/sheikhs/prophets raises (no horizontal adds).
...
const SCHOLAR_BIO_MIN = 640;
const SHEIKH_BIO_MIN = 390;
const PROPHET_BIO_MIN = 600;
const PROPHET_LESSON_MIN = 240;
