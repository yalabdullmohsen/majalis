#!/usr/bin/env node
/**
 * Round 73 — fawaid-seed ≥275, asma meaning≥180 benefit≥280, glossary ≥290, library ≥320, sins ≥380.
...
const ASMA_MEANING_MIN = 180;
const ASMA_BENEFIT_MIN = 280;
const FAWAID_SEED_MIN = 275;
const GLOSSARY_MIN = 290;
const LIBRARY_DESC_MIN = 320;
const SINS_EXPL_MIN = 380;
