#!/usr/bin/env node
/**
 * Round 85 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 490;
const NATIONS_MIN = 490;
const UPDATE_SUMMARY_MIN = 310;
const QURAN_CIRCLE_MIN = 340;
const MUTA_MIN = 340;
const MIND_MAP_MIN = 350;
const AMR_EXPL_MIN = 350;
