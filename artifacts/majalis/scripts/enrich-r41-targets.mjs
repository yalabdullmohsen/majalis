...
const FIQH_DESC = {
  ...
  "أسئلة شرعية موثقة":
    "الأسئلة والأجوبة الشرعية: مسائل يطرحها طلاب العلم مع إحالات ومصادر يجري استكمال توثيقها.",
  "قرارات المجامع الفقهية":
    "قرارات المجامع الفقهية المعتمدة في النوازل والمسائل المختلف فيها، مع بيان الأدلة والترجيح.",
  "أحكام شرعية موثقة بالأدلة":
    "موسوعة الأحكام الشرعية: مسائل فقهية مع إحالات ومصادر يجري استكمال توثيقها.",
