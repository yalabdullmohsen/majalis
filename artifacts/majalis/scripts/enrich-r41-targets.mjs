...
const TARGETS = [
  ...
  { gap: "views_UlumQuranPage.tsx.json", file: "src/views/UlumQuranPage.tsx", kind: "ulum-quran" },
  ...
  { gap: "views_QuranTajweedPage.tsx.json", file: "src/views/QuranTajweedPage.tsx", kind: "tajweed" },
