...
const OUT = path.join(__dirname, "r67-content-data.mjs");
...
const qaPicked = pickQa(existingQa, 40, 1310);
const fawaidPicked = pickFawaid(curated, 25, 490);
