#!/usr/bin/env node
/**
 * Round 95 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 540;
const NATIONS_MIN = 540;
const UPDATE_SUMMARY_MIN = 360;
const QURAN_CIRCLE_MIN = 390;
const MUTA_MIN = 390;
const MIND_MAP_MIN = 400;
const AMR_EXPL_MIN = 400;
