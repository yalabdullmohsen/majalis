#!/usr/bin/env node
/**
 * Round 81 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 470;
const NATIONS_MIN = 470;
const UPDATE_SUMMARY_MIN = 290;
const QURAN_CIRCLE_MIN = 320;
const MUTA_MIN = 320;
const MIND_MAP_MIN = 330;
const AMR_EXPL_MIN = 330;
