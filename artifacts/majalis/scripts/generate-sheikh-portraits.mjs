...
function svg({ label, initial }) {
  ...
  <text x="160" y="148" text-anchor="middle" fill="#FAF5EA" font-family="IBM Plex Sans Arabic, Noto Sans Arabic, sans-serif" font-size="52" font-weight="700">${initial}</text>
  <rect x="88" y="210" width="144" height="120" rx="36" fill="#1F6E54"/>
  <text x="160" y="360" text-anchor="middle" fill="#5B5446" font-family="IBM Plex Sans Arabic, Noto Sans Arabic, sans-serif" font-size="17">${label}</text>
</svg>`;
}
