#!/usr/bin/env node
/**
 * Round 91 bios-only — scholars/sheikhs/prophets raises (no horizontal adds).
...
const SCHOLAR_BIO_MIN = 660;
const SHEIKH_BIO_MIN = 410;
const PROPHET_BIO_MIN = 620;
const PROPHET_LESSON_MIN = 260;
