#!/usr/bin/env node
/**
 * Round 95 bios-only — scholars/sheikhs/prophets raises (no horizontal adds).
...
const SCHOLAR_BIO_MIN = 680;
const SHEIKH_BIO_MIN = 430;
const PROPHET_BIO_MIN = 640;
const PROPHET_LESSON_MIN = 280;

const PM_R76_IDS = []; const PM_R76_IDS_UNUSED = [
  "fenugreek-r76",
  "nabidh-dates-r76",
  "curds-r76",
  "saffron-r76",
