...
const TAILS = [
  ...
  /\s*،?\s*وهذا أصل يُسترشد به في فهم الأحكام الشرعية وتطبيقها\.?/gu,
  ...
  /\s*وهذا يُقرأ بضابط العلم والعمل[^.]*\.?/gu,
  /\s*وهذا يقرأ بضابط العلم والعمل[^.]*\.?/gu,
  /\s*وهذه فائدة تعليمية[^.]*\.?/gu,
  /\s*وهي فائدة (?:تعليمية|تربوية|تذكيرية|محررة)[^.]*\.?/gu,
  /\s*وهي فائدة[^.]*\.?/gu,
  /\s*،?\s*وأن محبة النبي ﷺ (?:تظهر|تُصان)[^.]*\.?/gu,
  /\s*،?\s*وأن العلم(?:\s+النافع)?[^.]*\.?/gu,
  /\s*يُستحضر للعمل لا لمجرد الحفظ\.?/gu,
];
