...
assert.ok(String(site.defaultImage).startsWith("/og-image.png"));
...
assert.ok(og.includes("/og-image.png"), "og:image = og-home");
assert.ok(tw.includes("/og-image.png"), "twitter:image = og-home");
