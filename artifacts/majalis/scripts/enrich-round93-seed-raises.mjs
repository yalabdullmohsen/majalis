#!/usr/bin/env node
/**
 * Round 93 seed raises — fawaid-seed ≥295, asma meaning≥190 benefit≥300, glossary ≥310, library ≥340, sins ≥400.
...
const ASMA_MEANING_MIN = 250;
const ASMA_BENEFIT_MIN = 360;
const FAWAID_SEED_MIN = 355;
const GLOSSARY_MIN = 370;
const LIBRARY_DESC_MIN = 400;
const SINS_EXPL_MIN = 460;
