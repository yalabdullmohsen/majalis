#!/usr/bin/env node
/**
 * Round 99 bios-only — scholars/sheikhs/prophets raises (no horizontal adds).
...
const SCHOLAR_BIO_MIN = 700;
const SHEIKH_BIO_MIN = 450;
const PROPHET_BIO_MIN = 660;
const PROPHET_LESSON_MIN = 300;
