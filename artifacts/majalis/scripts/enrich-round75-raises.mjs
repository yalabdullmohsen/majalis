#!/usr/bin/env node
/**
 * Round 75 — fawaid-seed ≥285, asma meaning≥185 benefit≥290, glossary ≥300, library ≥330.
 * Usage: node scripts/enrich-round75-raises.mjs [--apply] [--verify]
 */
...
const ASMA_MEANING_MIN = 185;
const ASMA_BENEFIT_MIN = 290;
const FAWAID_SEED_MIN = 285;
const GLOSSARY_MIN = 300;
const LIBRARY_DESC_MIN = 330;
