#!/usr/bin/env node
/**
 * Round 83 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 480;
const NATIONS_MIN = 480;
const UPDATE_SUMMARY_MIN = 300;
const QURAN_CIRCLE_MIN = 330;
const MUTA_MIN = 330;
const MIND_MAP_MIN = 340;
const AMR_EXPL_MIN = 340;
