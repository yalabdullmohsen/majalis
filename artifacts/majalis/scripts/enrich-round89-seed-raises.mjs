#!/usr/bin/env node
/**
 * Round 89 seed raises — fawaid-seed ≥295, asma meaning≥190 benefit≥300, glossary ≥310, library ≥340, sins ≥400.
...
const ASMA_MEANING_MIN = 230;
const ASMA_BENEFIT_MIN = 340;
const FAWAID_SEED_MIN = 335;
const GLOSSARY_MIN = 350;
const LIBRARY_DESC_MIN = 380;
const SINS_EXPL_MIN = 440;
