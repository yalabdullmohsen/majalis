#!/usr/bin/env node
/**
 * Round 85 seed raises — fawaid-seed ≥295, asma meaning≥190 benefit≥300, glossary ≥310, library ≥340, sins ≥400.
...
const ASMA_MEANING_MIN = 210;
const ASMA_BENEFIT_MIN = 320;
const FAWAID_SEED_MIN = 315;
const GLOSSARY_MIN = 330;
const LIBRARY_DESC_MIN = 360;
const SINS_EXPL_MIN = 420;
