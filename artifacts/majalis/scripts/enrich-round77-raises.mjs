#!/usr/bin/env node
/**
 * Round 77 — fawaid-seed ≥295, asma meaning≥190 benefit≥300, glossary ≥310, library ≥340, sins ≥400.
...
const ASMA_MEANING_MIN = 190;
const ASMA_BENEFIT_MIN = 300;
const FAWAID_SEED_MIN = 295;
const GLOSSARY_MIN = 310;
const LIBRARY_DESC_MIN = 340;
const SINS_EXPL_MIN = 400;
