...
const CONFIG = {
  ...
  hubRelatedPrefixes: {
    ...
    "/islamic-glossary": ["/islamic-glossary", "/fiqh-qawaid", "/madhahib", "/hadith-science", "/tawhid", "/adab-talab-ilm"],
    "/library": ["/library/"],
    "/lessons": ["/lessons/"],
    "/scholars": ["/scholars/"],
    "/rulings": ["/rulings/"],
    ...
    "/durus-mutanawwia": ["/durus-mutanawwia", "/fikr-waqia", "/usra-mujtama", "/fawaid"],
