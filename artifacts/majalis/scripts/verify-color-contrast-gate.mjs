...
const ASSERTIONS = [
  ...
  { route: "/lessons", selector: ".lessons-nearest-card__title", mode: "dark", min: 3 },
  { route: "/lessons", selector: ".lessons-upcoming-card__title", mode: "dark", min: 3 },
  { route: "/lessons", selector: ".lessons-upcoming-card__btn--primary", mode: "dark", min: 4.5 },
  { route: "/lessons", selector: ".lessons-upcoming-card__btn:not(.lessons-upcoming-card__btn--primary)", mode: "dark", min: 4.5 },
  { route: "/lessons", selector: ".lessons-nearest-card__btn", mode: "light", min: 4.5 },
