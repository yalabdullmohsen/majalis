...
const ASSERTIONS = [
  ...
  { route: "/tawhid", selector: ".home-eyebrow", mode: "light", min: 4.5 },
  { route: "/tawhid", selector: ".home-eyebrow", mode: "dark", min: 4.5 },
  { route: "/tawhid", selector: ".twh-hub-hero__title", mode: "light", min: 4.5 },
  { route: "/tawhid", selector: ".twh-hub-hero__title", mode: "dark", min: 4.5 },
