...
const ASSERTIONS = [
  ...
  { route: "/miracles", selector: ".mk-lane-card__title", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".mk-lane-card__title", mode: "dark", min: 4.5 },
  { route: "/miracles", selector: ".mk-lane-card__desc", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".mk-lane-card__desc", mode: "dark", min: 4.5 },
  { route: "/miracles", selector: ".mk-lane-card__cta", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".mk-lane-card__cta", mode: "dark", min: 4.5 },
