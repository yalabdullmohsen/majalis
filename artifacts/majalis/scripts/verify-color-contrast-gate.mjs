...
const ASSERTIONS = [
  ...
  { route: "/prophets/adam", selector: ".prophet-identity-hero__name", mode: "dark", min: 4.5 },
  { route: "/prophets/adam", selector: ".prophet-identity-hero__name", mode: "light", min: 4.5 },
  ...
  // ── إعجاز علمي + فلاتر/شارات الدروس (Hub: SectionEntryCard → .hub-card__*) ──
  { route: "/miracles", selector: ".hub-card__title", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".hub-card__title", mode: "dark", min: 4.5 },
  { route: "/miracles", selector: ".hub-card__desc", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".hub-card__desc", mode: "dark", min: 4.5 },
  { route: "/miracles", selector: ".hub-card__go", mode: "light", min: 3 },
  { route: "/miracles", selector: ".hub-card__go", mode: "dark", min: 3 },
  { route: "/miracles", selector: ".hub-card__meta", mode: "light", min: 4.5 },
  { route: "/miracles", selector: ".hub-card__meta", mode: "dark", min: 4.5 },
  { route: "/miracles/quran", selector: ".mk-card__title", mode: "light", min: 4.5 },
  { route: "/miracles/quran", selector: ".mk-card__title", mode: "dark", min: 4.5 },
  { route: "/miracles/quran", selector: ".mk-card__summary", mode: "light", min: 4.5 },
