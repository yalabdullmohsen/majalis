...
// جميع الأسئلة المقترحة الظاهرة للمستخدم في AssistantChatView،
// بالإضافة لأسئلة شائعة يجب أن تبقى مغطاة في قاعدة المعرفة الاحتياطية.
const SUGGESTED_QUESTIONS = [
  ...
  // أسرة / معاصر / أسئلة شائعة إضافية (قاعدة المعرفة الاحتياطية)
