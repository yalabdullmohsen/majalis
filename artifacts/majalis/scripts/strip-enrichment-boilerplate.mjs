...
const BOILERPLATE_FRAGMENTS = [
  /محتوى تعليمي معتمد في منهج سُنّة[؛.]?\s*يُستفاد في التعلم والتطبيق\s*—\s*مرجع تربوي شرعي/g,
  /محتوى تعليمي معتمد في منهج سُنّة/g,
  ...
  /رواية ضعيفة لا تُعد حجةً ثابتة؛ يُستغنى بما ثبت في الصحيح\s*—\s*سياسة سُنّة\.?/g,
  /—\s*مرجع معتمد[^"«»﴾]*$/g,
  /—\s*مرجع م[^"«»﴾]*$/g,
  /—\s*مرجع[^"«»﴾]*$/g,
];
