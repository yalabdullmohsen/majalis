#!/usr/bin/env node
/**
 * Round 91 — lesson bodies ≥530, pages meta ≥450 (educational), nations ≥450,
...
const PAGE_MIN = 520;
const NATIONS_MIN = 520;
const UPDATE_SUMMARY_MIN = 340;
const QURAN_CIRCLE_MIN = 370;
const MUTA_MIN = 370;
const MIND_MAP_MIN = 380;
const AMR_EXPL_MIN = 380;
