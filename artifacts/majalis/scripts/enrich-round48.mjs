...
function pageSuffix(text, field, fileName) {
  ...
  if (base === "RaqaiqPage") {
    return ["من مواعظ الرقائق والزهد المعتمدة", "يُستحضر في تزكية القلب واستحضار الآخرة — مرجع سُنّة"];
  }
  if (base === "AkhlaqPage") {
    return ["من مكارم الأخلاق في الشرع", "يُستفاد في التربية والسلوك — مرجع سُنّة"];
  }
  if (base === "AmradQalbiyyaPage") {
    return ["من أمراض القلوب وعلاجها", "يُستحضر في محاسبة النفس — مرجع سُنّة"];
  }
