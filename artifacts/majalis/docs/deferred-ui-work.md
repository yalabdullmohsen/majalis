# عمل واجهة مؤجّل — لا يُنفَّذ من نافذة المحتوى

هذه الطلبات تحتاج ملفات تملكها نافذة إصلاح الواجهة. **لا تُدمج قبل اكتمال أعمال تلك النافذة.**

انظر أيضاً PR المؤجّل: `[محتوى] مؤجّل — يدمج بعد انتهاء أعمال الواجهة`.
