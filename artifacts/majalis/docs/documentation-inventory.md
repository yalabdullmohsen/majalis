...
> آخر جرد آلي للأرقام: 2026-07-26 · مزامنة صفحة المنهجية (`/methodology`) مع هذا الجرد: 2026-09-11
الأرقام محسوبة آلياً من الملفات (سكربت `scripts/_inventory-trust.mjs` + قراءة الحقول بعد الرقع)، لا تقديرات.
صفحة المنهجية لا تضمّن أرقامًا قديمة في الواجهة؛ تحيل إلى هذا الملف وإلى `citation-backlog.md`.
