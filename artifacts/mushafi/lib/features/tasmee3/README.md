...
## البرومبت الأربعون - بيانات صفحات المصحف

- `assets/quran/quran_page_metadata.json` مع repository وفحص سلامة.
- بناء الصفحات من metadata مع fallback تقريبي عند غياب الملف.
- الفهرس يقفز عبر `findPageForAyah`.
- شاشة فحص صفحات المصحف من مصادر القرآن.

## البرومبت الواحد والأربعون - إعدادات القراءة والخطوط

- إعدادات قراءة محفوظة محليا (حجم الخط، التباعد، الثيم، الخط).
- ثيمات: فاتح / ورقي / ليلي / أسود.
- Noto Naskh متاح؛ الخط العثماني يحتاج ملف مرخص باسم `UthmanicHafs`.
- شاشة إعدادات القراءة من شريط المصحف.

## تحسين تجربة التسميع النهائية

تم تحسين:

- مراحل شاشة التسميع.
- Banner النطاق القادم من المصحف.
- بطاقة ملخص الجلسة.
- أزرار العودة للمصحف.
- أزرار حفظ مواضع المراجعة وتسجيل الختمة.
- النصوص لتكون "دقة تقريبية" و"أداة مساعدة".
