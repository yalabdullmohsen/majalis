        ...
        body: ListView(
          ...
          children: const [
            ...
            _InfoCard(
              ...
              body:
                  'افتح إدارة التذكيرات أو إعدادات هدف التسميع ثم أوقف التذكيرات التي لا تريدها.',
            ),
            _InfoCard(
              title: 'أنواع التذكيرات',
              body:
                  'يمكنك تفعيل تذكير الهدف اليومي، حماية سلسلة الاستمرار، مراجعة مواضع الضعف، التذكير الذكي، وورد رمضان. كل هذه التذكيرات محلية على جهازك.',
            ),
            _InfoCard(
              title: 'التذكير الذكي',
              body:
                  'التذكير الذكي يقترح وقتاً قريباً من أكثر أوقات نشاطك في الجلسات السابقة عند الحفظ، ويمكنك تعديله يدوياً في أي وقت.',
            ),
          ],
        ),
      ),
