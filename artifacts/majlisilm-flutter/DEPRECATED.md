...
مشروع Flutter تجريبي (`majlisilm_flutter`) لواجهة قرآن/تسميع مبكرة داخل monorepo المجلس العلمي.
...
مرجع منطق التسميع القابل لإعادة البناء: `artifacts/mushafi` (انظر `TASMEE3_INVENTORY.md`) — يُدمج لاحقاً كميزة داخل المجلس العلمي، وليس كتطبيق Flutter مستقل من هذا المجلد.
