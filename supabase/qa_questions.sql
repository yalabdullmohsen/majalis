-- =====================================================================
--  منصة "مجالس العلم" — قسم الأسئلة والأجوبة الدينية
...
(
  'هل الصلاة واجبة؟',
  'نعم، الصلاة واجبة على كل مسلم بالغ عاقل، وهي ركن من أركان الإسلام.',
  (select id from qa_categories where slug = 'rulings'), 'حلال',
